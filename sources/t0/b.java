...
public class b {
    ...
    private static final String[] f8268c = {"*", "FCM", "GCM", ""};
    ...
    public b(C2194f fVar) {
        this.f8269a = fVar.k().getSharedPreferences("com.google.android.gms.appid", 0);
        this.f8270b = b(fVar);
    }
    ...
    private static String b(C2194f fVar) {
        String d5 = fVar.n().d();
        if (d5 != null) {
            return d5;
        }
    ...
    private String g() {
        ...
        synchronized (this.f8269a) {
            string = this.f8269a.getString("|S|id", (String) null);
        }
        return string;
    }
    ...
    private String h() {
        synchronized (this.f8269a) {
            try {
                String string = this.f8269a.getString("|S||P|", (String) null);
                if (string == null) {
                    return null;
                }
    ...
    public java.lang.String i() {
        /*
            r7 = this;
            android.content.SharedPreferences r0 = r7.f8269a
            monitor-enter(r0)
            java.lang.String[] r1 = f8268c     // Catch:{ all -> 0x002d }
        ...
        L_0x0007:
            ...
            java.lang.String r6 = r7.f8270b     // Catch:{ all -> 0x002d }
            java.lang.String r5 = r7.a(r6, r5)     // Catch:{ all -> 0x002d }
            android.content.SharedPreferences r6 = r7.f8269a     // Catch:{ all -> 0x002d }
