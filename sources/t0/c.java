...
public class c {
    ...
    private File a() {
        if (this.f8271a == null) {
            synchronized (this) {
                try {
                    if (this.f8271a == null) {
                        File filesDir = this.f8272b.k().getFilesDir();
                        this.f8271a = new File(filesDir, "PersistedInstallation." + this.f8272b.o() + ".json");
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public d b(d dVar) {
        try {
            ...
            File createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f8272b.k().getFilesDir());
