...
public final class A2 extends C1250y {
    public final C1187i2 J(int i4, C1187i2 i2Var) {
        Objects.requireNonNull(i2Var);
        if (W2.SORTED.n(i4)) {
            return i2Var;
        }
        return W2.SIZED.n(i4) ? new C1152b2(i2Var) : new C1152b2(i2Var);
    }
    ...
    public final E0 G(C1144a aVar, i0 i0Var, IntFunction intFunction) {
        ...
        double[] dArr = (double[]) ((C1251y0) aVar.y(i0Var, true, intFunction)).d();
        Arrays.sort(dArr);
        return new Q0(dArr);
    }
}
