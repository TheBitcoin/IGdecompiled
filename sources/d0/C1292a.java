...
public class C1292a {
    ...
    private final Map f6284b;

    /* renamed from: c  reason: collision with root package name */
    private final Map f6285c = new HashMap();

    public C1292a(String str, Map map) {
        this.f6283a = str;
        this.f6284b = map;
    }
    ...
    public D0.c c() {
        /*
            ...
            z0.C2446g.d()
            r0 = 0
            java.lang.String r1 = r5.f6283a     // Catch:{ all -> 0x0087 }
            java.util.Map r2 = r5.f6284b     // Catch:{ all -> 0x0087 }
            java.lang.String r1 = r5.b(r1, r2)     // Catch:{ all -> 0x0087 }
            v0.g r2 = v0.g.f()     // Catch:{ all -> 0x0087 }
            ...
            java.util.Map r2 = r5.f6285c     // Catch:{ all -> 0x0062 }
        ...
        L_0x0093:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: D0.C1292a.c():D0.c");
    }

    public C1292a d(String str, String str2) {
        this.f6285c.put(str, str2);
        return this;
    }
}
