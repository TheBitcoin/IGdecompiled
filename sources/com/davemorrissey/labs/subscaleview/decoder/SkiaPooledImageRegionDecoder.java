...
public class SkiaPooledImageRegionDecoder implements ImageRegionDecoder {
    ...
    public void initialiseDecoder() throws Exception {
        ...
        if (uri2.startsWith(RESOURCE_PREFIX)) {
            ...
            try {
                j4 = this.context.getResources().openRawResourceFd(i4).getLength();
            } catch (Exception unused2) {
            }
            bitmapRegionDecoder = BitmapRegionDecoder.newInstance(this.context.getResources().openRawResource(i4), false);
        } else if (uri2.startsWith(ASSET_PREFIX)) {
            String substring = uri2.substring(22);
            try {
                j4 = this.context.getAssets().openFd(substring).getLength();
            ...
            try {
                ...
                try {
                    ...
                    if (openAssetFileDescriptor != null) {
                        j4 = openAssetFileDescriptor.getLength();
                    }
    ...
    public boolean allowAdditionalDecoder(int i4, long j4) {
        if (i4 >= 4) {
        ...
        if (j5 > 20971520) {
            ...
            debug("Additional decoder allowed, current count is " + i4 + ", estimated native memory " + (j5 / 1048576) + "Mb");
            return true;
        }
    }

    @NonNull
    public Bitmap decodeRegion(@NonNull Rect rect, int i4) {
