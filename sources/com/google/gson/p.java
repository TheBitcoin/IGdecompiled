...
public enum p implements q {
    DOUBLE {
        /* renamed from: b */
        public Double a(C2079a aVar) {
            return Double.valueOf(aVar.A());
        }
    },
    LAZILY_PARSED_NUMBER {
        public Number a(C2079a aVar) {
            return new f(aVar.J());
        }
    },
    LONG_OR_DOUBLE {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0026, code lost:
            if (r7.v() == false) goto L_0x0029;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x0028, code lost:
            return r2;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x0049, code lost:
            throw new i1.C2082d("JSON forbids NaN and infinities: " + r2 + "; at path " + r7.r());
         */
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x006a, code lost:
            throw new com.google.gson.j("Cannot parse " + r1 + "; at path " + r7.r(), r2);
         */
        ...
        public java.lang.Number a(i1.C2079a r7) {
            /*
                r6 = this;
            ...
            L_0x0020:
                ...
                goto L_0x004a
            L_0x0022:
                boolean r3 = r7.v()     // Catch:{ NumberFormatException -> 0x0020 }
                if (r3 == 0) goto L_0x0029
            L_0x0028:
                return r2
            L_0x0029:
                i1.d r3 = new i1.d     // Catch:{ NumberFormatException -> 0x0020 }
            ...
            L_0x004a:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.p.c.a(i1.a):java.lang.Number");
        }
    },
    BIG_DECIMAL {
        /* renamed from: b */
        public BigDecimal a(C2079a aVar) {
            String J4 = aVar.J();
            try {
                return new BigDecimal(J4);
            } catch (NumberFormatException e5) {
                throw new j("Cannot parse " + J4 + "; at path " + aVar.r(), e5);
            }
        }
    };
}
