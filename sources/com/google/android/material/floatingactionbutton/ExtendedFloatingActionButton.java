...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues("labelOpacity")) {
                ...
                propertyValues5[0].setFloatValues(new float[]{f4, f5});
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public void extendOrShow(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            extendedFloatingActionButton.performMotion(i4, onChangedCallback);
        }
    ...
    private Size getSizeFromExtendStrategyType(int i4) {
        ...
        final AnonymousClass3 r12 = new Size() {
            public int getHeight() {
                ...
                if (ExtendedFloatingActionButton.this.originalHeight == -1) {
                    ...
                    return (view.getHeight() - i4) - paddingTop;
            ...
            public ViewGroup.LayoutParams getLayoutParams() {
                ...
                if (ExtendedFloatingActionButton.this.originalHeight == 0) {
                    ...
                    i4 = ExtendedFloatingActionButton.this.originalHeight;
                }
            ...
            public int getWidth() {
                ...
                return (view.getWidth() - i4) - paddingLeft;
            }
        };
        AnonymousClass4 r22 = new Size() {
            ...
            public ViewGroup.LayoutParams getLayoutParams() {
                ...
                if (ExtendedFloatingActionButton.this.originalWidth == 0) {
                    ...
                    i4 = ExtendedFloatingActionButton.this.originalWidth;
                }
                if (ExtendedFloatingActionButton.this.originalHeight != 0) {
    ...
    /* access modifiers changed from: private */
    public void performMotion(int i4, @Nullable final OnChangedCallback onChangedCallback) {
