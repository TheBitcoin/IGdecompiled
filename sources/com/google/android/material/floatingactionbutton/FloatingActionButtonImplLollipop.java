...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    @NonNull
    private StateListAnimator createDefaultStateListAnimator(float f4, float f5, float f6) {
        StateListAnimator stateListAnimator2 = new StateListAnimator();
        stateListAnimator2.addState(FloatingActionButtonImpl.PRESSED_ENABLED_STATE_SET, createElevationAnimator(f4, f6));
        stateListAnimator2.addState(FloatingActionButtonImpl.HOVERED_FOCUSED_ENABLED_STATE_SET, createElevationAnimator(f4, f5));
        stateListAnimator2.addState(FloatingActionButtonImpl.FOCUSED_ENABLED_STATE_SET, createElevationAnimator(f4, f5));
        stateListAnimator2.addState(FloatingActionButtonImpl.HOVERED_ENABLED_STATE_SET, createElevationAnimator(f4, f5));
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        arrayList.add(ObjectAnimator.ofFloat(this.view, "elevation", new float[]{f4}).setDuration(0));
    ...
    private Animator createElevationAnimator(float f4, float f5) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.view, "elevation", new float[]{f4}).setDuration(0)).with(ObjectAnimator.ofFloat(this.view, View.TRANSLATION_Z, new float[]{f5}).setDuration(100));
        animatorSet.setInterpolator(FloatingActionButtonImpl.ELEVATION_ANIM_INTERPOLATOR);
        return animatorSet;
    }
    ...
    public BorderDrawable createBorderDrawable(int i4, ColorStateList colorStateList) {
        ...
        borderDrawable.setBorderWidth((float) i4);
    ...
    public void onElevationsChanged(float f4, float f5, float f6) {
        if (Build.VERSION.SDK_INT == 21) {
            ...
            StateListAnimator createDefaultStateListAnimator = createDefaultStateListAnimator(f4, f5, f6);
