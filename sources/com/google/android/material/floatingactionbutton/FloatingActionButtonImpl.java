...
class FloatingActionButtonImpl {
        ...
        public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
            ...
            if (!this.validValues) {
                ...
                if (materialShapeDrawable == null) {
                    ...
                    f4 = materialShapeDrawable.getElevation();
                }
                this.shadowSizeStart = f4;
                this.shadowSizeEnd = getTargetShadowSize();
                this.validValues = true;
            }
            FloatingActionButtonImpl floatingActionButtonImpl = FloatingActionButtonImpl.this;
            float f5 = this.shadowSizeStart;
            floatingActionButtonImpl.updateShapeElevation((float) ((int) (f5 + ((this.shadowSizeEnd - f5) * valueAnimator.getAnimatedFraction()))));
        }
    }
    ...
    /* access modifiers changed from: private */
    public void calculateImageMatrixFromScale(float f4, @NonNull Matrix matrix) {
        matrix.reset();
        ...
        if (drawable != null && this.maxImageSize != 0) {
            ...
            rectF2.set(0.0f, 0.0f, (float) i4, (float) i4);
            matrix.setRectToRect(rectF, rectF2, Matrix.ScaleToFit.CENTER);
            int i5 = this.maxImageSize;
            matrix.postScale(f4, f4, ((float) i5) / 2.0f, ((float) i5) / 2.0f);
        }
    }
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f4, float f5, float f6) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.view, View.ALPHA, new float[]{f4});
        motionSpec.getTiming("opacity").apply(ofFloat);
        arrayList.add(ofFloat);
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.view, View.SCALE_X, new float[]{f5});
        motionSpec.getTiming("scale").apply(ofFloat2);
        workAroundOreoBug(ofFloat2);
        arrayList.add(ofFloat2);
        ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(this.view, View.SCALE_Y, new float[]{f5});
        ...
        ObjectAnimator ofObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() {
            public Matrix evaluate(float f4, @NonNull Matrix matrix, @NonNull Matrix matrix2) {
                float unused = FloatingActionButtonImpl.this.imageMatrixScale = f4;
    ...
    private AnimatorSet createDefaultAnimator(float f4, float f5, float f6, int i4, int i5) {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        ...
        final float f7 = this.imageMatrixScale;
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                float unused = FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(f7, f10, floatValue);
                FloatingActionButtonImpl.this.calculateImageMatrixFromScale(AnimationUtils.lerp(f7, f10, floatValue), matrix);
                FloatingActionButtonImpl.this.view.setImageMatrix(matrix);
            }
        });
        arrayList.add(ofFloat);
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration((long) MotionUtils.resolveThemeDuration(this.view.getContext(), i4, this.view.getContext().getResources().getInteger(R.integer.material_motion_duration_long_1)));
        animatorSet.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), i5, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animatorSet;
    }
        ...
        if (Build.VERSION.SDK_INT == 26) {
            objectAnimator.setEvaluator(new TypeEvaluator<Float>() {
                ...
                public Float evaluate(float f4, Float f5, Float f6) {
                    float floatValue = this.floatEvaluator.evaluate(f4, f5, f6).floatValue();
                    if (floatValue < 0.1f) {
                        floatValue = 0.0f;
                    }
    ...
    public void getPadding(@NonNull Rect rect) {
        ...
        int max = Math.max(touchTargetPadding, (int) Math.ceil((double) f4));
        int max2 = Math.max(touchTargetPadding, (int) Math.ceil((double) (f4 * SHADOW_MULTIPLIER)));
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (!this.cancelled) {
                        ...
                        floatingActionButton.internalSetVisibility(i4, z4);
    ...
    public void onScaleChanged() {
        ...
        if (arrayList != null) {
            ...
            int i4 = 0;
            while (i4 < size) {
                InternalTransformationCallback internalTransformationCallback = arrayList.get(i4);
                i4++;
    ...
    public void show(@Nullable final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z4) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            if (arrayList != null) {
                int size = arrayList.size();
                while (i4 < size) {
                    Animator.AnimatorListener animatorListener = arrayList.get(i4);
                    i4++;
                    animatorSet.addListener(animatorListener);
                }
            }
