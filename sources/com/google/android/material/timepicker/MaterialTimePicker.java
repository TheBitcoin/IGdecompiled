...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public static final class Builder {
        ...
        public Builder setInputMode(int i4) {
            this.inputMode = Integer.valueOf(i4);
            return this;
        }
    ...
    public static /* synthetic */ void g(MaterialTimePicker materialTimePicker) {
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i4, @NonNull TimePickerView timePickerView2, @NonNull ViewStub viewStub) {
        if (i4 == 0) {
    ...
    private void restoreState(@Nullable Bundle bundle) {
        if (bundle != null) {
            ...
            this.inputMode = bundle.getInt(INPUT_MODE_EXTRA, i4);
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, i4, i5);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, R.styleable.MaterialTimePicker, i4, i5);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                int unused = materialTimePicker.inputMode = i4;
