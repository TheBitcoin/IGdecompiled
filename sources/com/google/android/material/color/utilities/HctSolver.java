...
public class HctSolver {
    ...
    static double[] bisectToLimit(double d5, double d6) {
        ...
        for (int i6 = 0; i6 < 3; i6++) {
            ...
            if (d7 != d8) {
                if (d7 < d8) {
                    i5 = criticalPlaneBelow(trueDelinearized(d7));
                    i4 = criticalPlaneAbove(trueDelinearized(dArr2[i6]));
                } else {
                    i5 = criticalPlaneAbove(trueDelinearized(d7));
                    i4 = criticalPlaneBelow(trueDelinearized(dArr2[i6]));
                }
                double d9 = hueOf;
                int i7 = i5;
                int i8 = i4;
                double d10 = d9;
                for (int i9 = 0; i9 < 8 && Math.abs(i8 - i7) > 1; i9++) {
                    int floor = (int) Math.floor(((double) (i7 + i8)) / 2.0d);
                    double[] coordinate = setCoordinate(dArr, CRITICAL_PLANES[floor], dArr2, i6);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x017d, code lost:
        if (r1[0] > 100.01d) goto L_0x0191;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0183, code lost:
        if (r1[1] > 100.01d) goto L_0x0191;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0189, code lost:
        if (r1[2] <= 100.01d) goto L_0x018c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0190, code lost:
        return com.google.android.material.color.utilities.ColorUtils.argbFromLinrgb(r1);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static int findResultByJ(double r36, double r38, double r40) {
        /*
            double r2 = java.lang.Math.sqrt(r40)
            ...
            double r13 = r13 * r15
            double r15 = java.lang.Math.sin(r36)
            double r17 = java.lang.Math.cos(r36)
            r19 = 0
            r0 = 0
            r20 = 2
            r21 = 1
        L_0x005e:
            ...
            double r4 = r2 / r22
            r22 = 0
            int r1 = (r38 > r22 ? 1 : (r38 == r22 ? 0 : -1))
            if (r1 == 0) goto L_0x007b
            int r1 = (r2 > r22 ? 1 : (r2 == r22 ? 0 : -1))
            if (r1 != 0) goto L_0x0072
            goto L_0x007b
        L_0x0072:
            double r26 = java.lang.Math.sqrt(r4)
            double r26 = r38 / r26
        L_0x0078:
            r28 = r9
            goto L_0x007e
        ...
        L_0x007e:
            ...
            double r1 = r1 + r11
            r3 = 4627167142146473984(0x4037000000000000, double:23.0)
            double r1 = r1 * r3
            double r1 = r1 * r9
            double r3 = r3 * r13
            double r30 = r9 * r24
            double r30 = r30 * r17
            double r3 = r3 + r30
            r30 = 4637300241308057600(0x405b000000000000, double:108.0)
            double r9 = r9 * r30
            double r9 = r9 * r15
            double r3 = r3 + r9
            double r1 = r1 / r3
            ...
            double r9 = r9 * r3
            double r9 = r9 + r11
            r30 = 4643774165772402688(0x4072000000000000, double:288.0)
            double r30 = r30 * r1
            double r9 = r9 + r30
            r30 = 4653885274701430784(0x4095ec0000000000, double:1403.0)
            double r9 = r9 / r30
            r32 = 4651048534701768704(0x408bd80000000000, double:891.0)
            double r32 = r32 * r3
            double r32 = r11 - r32
            r34 = 4643299176749203456(0x4070500000000000, double:261.0)
            double r34 = r34 * r1
            double r32 = r32 - r34
            double r32 = r32 / r30
            r34 = 4641944578423783424(0x406b800000000000, double:220.0)
            double r3 = r3 * r34
            double r11 = r11 - r3
            r3 = 4663648937956081664(0x40b89c0000000000, double:6300.0)
            double r1 = r1 * r3
            double r11 = r11 - r1
            double r11 = r11 / r30
            double r1 = inverseChromaticAdaptation(r9)
            double r3 = inverseChromaticAdaptation(r32)
            double r9 = inverseChromaticAdaptation(r11)
            r5 = 3
            double[] r5 = new double[r5]
            r5[r19] = r1
            r5[r21] = r3
            r5[r20] = r9
            double[][] r1 = LINRGB_FROM_SCALED_DISCOUNT
            double[] r1 = com.google.android.material.color.utilities.MathUtils.matrixMultiply(r5, r1)
            r2 = r1[r19]
        ...
        L_0x014f:
            ...
            r9 = 4566758108544739836(0x3f60624dd2f1a9fc, double:0.002)
        ...
        L_0x0174:
            ...
            goto L_0x0191
        L_0x018c:
            int r0 = com.google.android.material.color.utilities.ColorUtils.argbFromLinrgb(r1)
            return r0
        L_0x0191:
            return r19
        */
    ...
    static double[] nthVertex(double d5, int i4) {
        double d6;
        int i5 = i4;
    ...
    static double[] setCoordinate(double[] dArr, double d5, double[] dArr2, int i4) {
        return lerpPoint(dArr, intercept(dArr[i4], d5, dArr2[i4]), dArr2);
    }
