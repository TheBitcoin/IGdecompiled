...
public class ColorUtils {
    ...
    public static int alphaFromArgb(int i4) {
        return (i4 >> 24) & 255;
    }
    ...
    public static int argbFromRgb(int i4, int i5, int i6) {
        return ((i4 & 255) << 16) | ViewCompat.MEASURED_STATE_MASK | ((i5 & 255) << 8) | (i6 & 255);
    }
    ...
    public static int blueFromArgb(int i4) {
        return i4 & 255;
    }
    ...
    public static int greenFromArgb(int i4) {
        return (i4 >> 8) & 255;
    }

    public static boolean isOpaque(int i4) {
        if (alphaFromArgb(i4) >= 255) {
            return true;
        }
        return false;
    }
    ...
    public static double[] labFromArgb(int i4) {
        double linearized = linearized(redFromArgb(i4));
        double linearized2 = linearized(greenFromArgb(i4));
        double linearized3 = linearized(blueFromArgb(i4));
    ...
    public static double linearized(int i4) {
        double pow;
    ...
    public static double lstarFromArgb(int i4) {
        return (labF(xyzFromArgb(i4)[1] / 100.0d) * 116.0d) - 16.0d;
    }
    ...
    public static int redFromArgb(int i4) {
        return (i4 >> 16) & 255;
    }
    ...
    public static double[] xyzFromArgb(int i4) {
        return MathUtils.matrixMultiply(new double[]{linearized(redFromArgb(i4)), linearized(greenFromArgb(i4)), linearized(blueFromArgb(i4))}, SRGB_TO_XYZ);
    }
