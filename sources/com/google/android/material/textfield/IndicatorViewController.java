...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYAnimationDuration = MotionUtils.resolveThemeDuration(context2, i4, DEFAULT_CAPTION_TRANSLATION_Y_ANIMATION_DURATION);
        ...
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context2, i4, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        int i5 = R.attr.motionEasingEmphasizedDecelerateInterpolator;
        this.captionTranslationYAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context2, i5, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        TimeInterpolator timeInterpolator = AnimationUtils.LINEAR_INTERPOLATOR;
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context2, i5, timeInterpolator);
    ...
    private boolean isCaptionStateError(int i4) {
        if (i4 != 1 || this.errorView == null || TextUtils.isEmpty(this.errorText)) {
            return false;
        }
        return true;
    }
    ...
    private boolean isCaptionStateHelperText(int i4) {
        if (i4 != 2 || this.helperTextView == null || TextUtils.isEmpty(this.helperText)) {
            return false;
        }
        return true;
    }
    ...
    private void updateCaptionViewsVisibility(int i4, int i5, boolean z4) {
        ...
        if (i4 != i5) {
            if (z4) {
                ...
                int i6 = i4;
                int i7 = i5;
                indicatorViewController.createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i6, i7);
                indicatorViewController.createCaptionAnimators(arrayList, indicatorViewController.errorEnabled, indicatorViewController.errorView, 1, i6, i7);
                AnimatorSetCompat.playTogether(animatorSet, arrayList);
                final TextView captionViewFromDisplayState = getCaptionViewFromDisplayState(i6);
                final TextView captionViewFromDisplayState2 = getCaptionViewFromDisplayState(i7);
                final int i8 = i6;
                final int i9 = i7;
                animatorSet.addListener(new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        int unused = IndicatorViewController.this.captionDisplayed = i9;
