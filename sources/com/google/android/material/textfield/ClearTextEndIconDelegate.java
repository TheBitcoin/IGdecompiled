...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    ClearTextEndIconDelegate(@NonNull EndCompoundLayout endCompoundLayout) {
        ...
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(context, i4, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), i4, DEFAULT_ANIMATION_SCALE_DURATION);
