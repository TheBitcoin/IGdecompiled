...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z4) {
        ...
        if (editText2 instanceof MaterialAutoCompleteTextView) {
            f5 = ((MaterialAutoCompleteTextView) editText2).getPopupElevation();
        } else {
        ...
        MaterialShapeDrawable createWithElevationOverlay = MaterialShapeDrawable.createWithElevationOverlay(getContext(), f5, colorStateList);
    ...
    private static Drawable getFilledBoxBackgroundWithRipple(MaterialShapeDrawable materialShapeDrawable, int i4, int i5, int[][] iArr) {
        return new RippleDrawable(new ColorStateList(iArr, new int[]{MaterialColors.layer(i5, i4, 0.1f), i4}), materialShapeDrawable, materialShapeDrawable);
    }

    private int getLabelLeftBoundAlignedWithPrefixAndSuffix(int i4, boolean z4) {
    ...
    private int getLabelRightBoundAlignedWithPrefixAndSuffix(int i4, boolean z4) {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i4, int[][] iArr) {
        ...
        if (this.editText == null) {
            ...
            this.editText.addTextChangedListener(new TextWatcher(editText2) {
                ...
                public void afterTextChanged(@NonNull Editable editable) {
                    ...
                    if (lineCount != i5) {
                        if (lineCount < i5 && ViewCompat.getMinimumHeight(this.val$editText) != (i4 = TextInputLayout.this.originalEditTextMinimumHeight)) {
    ...
    private void updateCounterTextAppearanceAndColor() {
        ...
        if (textView != null) {
            if (this.counterOverflowed) {
                i4 = this.counterOverflowTextAppearance;
            } else {
                i4 = this.counterTextAppearance;
            }
            setTextAppearanceCompatWithErrorFallback(textView, i4);
    ...
    public void animateToExpansionFraction(float f4) {
        if (this.collapsingTextHelper.getExpansionFraction() != f4) {
            ...
            this.animator.setFloatValues(new float[]{this.collapsingTextHelper.getExpansionFraction(), f4});
            this.animator.start();
        }
    }
    ...
    public void dispatchProvideAutofillStructure(@NonNull ViewStructure viewStructure, int i4) {
        ...
        if (this.originalHint != null) {
            ...
            for (int i5 = 0; i5 < this.inputFrame.getChildCount(); i5++) {
                ...
                ViewStructure a5 = viewStructure.newChild(i5);
                childAt.dispatchProvideAutofillStructure(a5, i4);
    ...
    public void setBoxCornerFamily(int i4) {
        this.shapeAppearanceModel = this.shapeAppearanceModel.toBuilder().setTopLeftCorner(i4, this.shapeAppearanceModel.getTopLeftCornerSize()).setTopRightCorner(i4, this.shapeAppearanceModel.getTopRightCornerSize()).setBottomLeftCorner(i4, this.shapeAppearanceModel.getBottomLeftCornerSize()).setBottomRightCorner(i4, this.shapeAppearanceModel.getBottomRightCornerSize()).build();
        applyBoxAttributes();
    }
    ...
    public void setBoxCornerRadii(float f4, float f5, float f6, float f7) {
        ...
        MaterialShapeDrawable materialShapeDrawable = this.boxBackground;
        if (materialShapeDrawable == null || materialShapeDrawable.getTopLeftCornerResolvedSize() != f8 || this.boxBackground.getTopRightCornerResolvedSize() != f4 || this.boxBackground.getBottomLeftCornerResolvedSize() != f9 || this.boxBackground.getBottomRightCornerResolvedSize() != f6) {
            this.shapeAppearanceModel = this.shapeAppearanceModel.toBuilder().setTopLeftCornerSize(f8).setTopRightCornerSize(f4).setBottomLeftCornerSize(f9).setBottomRightCornerSize(f6).build();
            applyBoxAttributes();
        }
    }
    ...
    public void setEndIconContentDescription(@StringRes int i4) {
        this.endLayout.setEndIconContentDescription(i4);
    }

    public void setEndIconDrawable(@DrawableRes int i4) {
        this.endLayout.setEndIconDrawable(i4);
    }

    public void setEndIconMinSize(@IntRange(from = 0) int i4) {
        this.endLayout.setEndIconMinSize(i4);
    }

    public void setEndIconMode(int i4) {
        this.endLayout.setEndIconMode(i4);
    }
    ...
    public void setErrorAccessibilityLiveRegion(int i4) {
        this.indicatorViewController.setErrorAccessibilityLiveRegion(i4);
    }
    ...
    public void setErrorIconDrawable(@DrawableRes int i4) {
        this.endLayout.setErrorIconDrawable(i4);
    }
    ...
    public void setPasswordVisibilityToggleContentDescription(@StringRes int i4) {
        this.endLayout.setPasswordVisibilityToggleContentDescription(i4);
    }

    @Deprecated
    public void setPasswordVisibilityToggleDrawable(@DrawableRes int i4) {
        this.endLayout.setPasswordVisibilityToggleDrawable(i4);
    }
    ...
    public void setStartIconMinSize(@IntRange(from = 0) int i4) {
        this.startLayout.setStartIconMinSize(i4);
    }
    ...
    public void setSuffixTextAppearance(@StyleRes int i4) {
        this.endLayout.setSuffixTextAppearance(i4);
    }
    ...
    /* access modifiers changed from: package-private */
    public void setTextAppearanceCompatWithErrorFallback(@NonNull TextView textView, @StyleRes int i4) {
        try {
            TextViewCompat.setTextAppearance(textView, i4);
    ...
    private void updateLabelState(boolean z4, boolean z5) {
        ...
        if (!isEnabled) {
            ...
            this.collapsingTextHelper.setCollapsedAndExpandedTextColor(ColorStateList.valueOf(i4));
        } else if (shouldShowError()) {
    ...
    public void updateCounter(@Nullable Editable editable) {
        ...
        if (i4 == -1) {
            ...
            this.counterOverflowed = countLength > i4;
