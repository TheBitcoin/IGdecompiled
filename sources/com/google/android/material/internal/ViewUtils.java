...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i4, int i5) {
        doOnApplyWindowInsets(view, attributeSet, i4, i5, (OnApplyWindowInsetsListener) null);
    }
    ...
    @NonNull
    public static Rect calculateRectFromBounds(@NonNull View view, int i4) {
