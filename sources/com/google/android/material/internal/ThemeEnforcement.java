...
public final class ThemeEnforcement {
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i4, @StyleRes int i5, @StyleableRes @Nullable int... iArr2) {
        boolean z4;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ThemeEnforcement, i4, i5);
        boolean z5 = false;
    ...
    private static boolean isCustomTextAppearanceValid(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i4, @StyleRes int i5, @StyleableRes @NonNull int... iArr2) {
    ...
    @NonNull
    public static TypedArray obtainStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i4, @StyleRes int i5, @StyleableRes int... iArr2) {
    ...
    public static TintTypedArray obtainTintedStyledAttributes(@NonNull Context context, AttributeSet attributeSet, @StyleableRes @NonNull int[] iArr, @AttrRes int i4, @StyleRes int i5, @StyleableRes int... iArr2) {
        checkCompatibleTheme(context, attributeSet, i4, i5);
        checkTextAppearance(context, attributeSet, iArr, i4, i5, iArr2);
