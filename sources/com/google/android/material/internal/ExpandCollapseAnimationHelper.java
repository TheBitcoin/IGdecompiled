...
public class ExpandCollapseAnimationHelper {
    ...
    @NonNull
    public ExpandCollapseAnimationHelper setCollapsedViewOffsetY(int i4) {
        this.collapsedViewOffsetY = i4;
        return this;
    }

    @NonNull
    public ExpandCollapseAnimationHelper setDuration(long j4) {
        this.duration = j4;
        return this;
    }

    @NonNull
    public ExpandCollapseAnimationHelper setExpandedViewOffsetY(int i4) {
        this.expandedViewOffsetY = i4;
        return this;
    }
