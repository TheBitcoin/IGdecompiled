...
public class CheckableGroup<T extends MaterialCheckable<T>> {
    ...
    public void addCheckable(T t4) {
        ...
        t4.setInternalOnCheckedChangeListener(new MaterialCheckable.OnCheckedChangeListener<T>() {
    ...
    public void check(@IdRes int i4) {
        MaterialCheckable materialCheckable = (MaterialCheckable) this.checkables.get(Integer.valueOf(i4));
    ...
    public void removeCheckable(T t4) {
        t4.setInternalOnCheckedChangeListener((MaterialCheckable.OnCheckedChangeListener) null);
