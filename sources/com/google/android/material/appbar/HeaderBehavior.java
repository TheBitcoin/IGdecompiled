...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    /* access modifiers changed from: package-private */
    public final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v4, int i4, int i5, float f4) {
        ...
        if (this.scroller.computeScrollOffset()) {
            FlingRunnable flingRunnable2 = new FlingRunnable(coordinatorLayout, v4);
            this.flingRunnable = flingRunnable2;
            ViewCompat.postOnAnimation(v4, flingRunnable2);
            return true;
        }
    ...
    /* access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v4, int i4, int i5, int i6) {
        int clamp;
