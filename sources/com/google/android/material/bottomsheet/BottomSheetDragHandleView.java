...
public class BottomSheetDragHandleView extends AppCompatImageView implements AccessibilityManager.AccessibilityStateChangeListener {
    ...
    public boolean expandOrCollapseBottomSheetIfPossible() {
        ...
        this.bottomSheetBehavior.setState(i4);
        return true;
    }
    ...
    public void onBottomSheetStateChanged(int i4) {
        ...
        ViewCompat.replaceAccessibilityAction(this, accessibilityActionCompat, str, new d(this));
    }
    ...
    private void updateInteractableState() {
        ...
        ViewCompat.setImportantForAccessibility(this, i4);
