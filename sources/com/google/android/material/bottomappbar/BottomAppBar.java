...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createFabTranslationXAnimation(int i4, @NonNull List<Animator> list) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(findDependentFab(), "translationX", new float[]{getFabTranslationX(i4)});
    ...
    private void createMenuViewTranslationAnimation(final int i4, final boolean z4, @NonNull List<Animator> list) {
        ...
        if (actionMenuView != null) {
            ...
            if (Math.abs(actionMenuView.getTranslationX() - ((float) getActionMenuViewTranslationX(actionMenuView, i4, z4))) > 1.0f) {
                ...
                ofFloat2.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        if (!this.cancelled) {
                            ...
                            BottomAppBar.this.translateActionMenuView(actionMenuView, i4, z4, z4);
                        }
                    }
                });
    ...
    public void dispatchAnimationEnd() {
        ...
        if (i4 == 0 && (arrayList = this.animationListeners) != null) {
            ...
            int i5 = 0;
            while (i5 < size) {
                AnimationListener animationListener = arrayList.get(i5);
                i5++;
    ...
    public float getFabTranslationX(int i4) {
        ...
        if (this.fabAlignmentModeEndMargin == -1 || findDependentView == null) {
            i5 = this.fabOffsetEndMode;
        } else {
            i5 = (findDependentView.getMeasuredWidth() / 2) + this.fabAlignmentModeEndMargin;
        }
        int measuredWidth = (getMeasuredWidth() / 2) - (i7 + i5);
        if (isLayoutRtl) {
            i6 = -1;
        }
        return (float) (measuredWidth * i6);
    }
    ...
    private float getFabTranslationY() {
        ...
        if (findDependentView != null) {
            i4 = (-((getMeasuredHeight() + getBottomInset()) - findDependentView.getMeasuredHeight())) / 2;
        } else {
            i4 = 0;
        }
        return (float) i4;
    ...
    public static void updateFabAnchorGravity(BottomAppBar bottomAppBar, View view) {
        ...
        int i4 = bottomAppBar.fabAnchorMode;
        if (i4 == 1) {
    ...
    /* access modifiers changed from: protected */
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i4, boolean z4) {
        int i5;
        int i6;
        int i7;
        int i8 = 0;
        if (this.menuAlignmentMode != 1 && (i4 != 1 || !z4)) {
            return 0;
        }
        boolean isLayoutRtl = ViewUtils.isLayoutRtl(this);
        if (isLayoutRtl) {
    ...
    public void setFabAlignmentModeEndMargin(@Px int i4) {
        if (this.fabAlignmentModeEndMargin != i4) {
            this.fabAlignmentModeEndMargin = i4;
            setCutoutStateAndTranslateFab();
        }
    }

    public void setFabAnchorMode(int i4) {
        this.fabAnchorMode = i4;
        setCutoutStateAndTranslateFab();
        View findDependentView = findDependentView();
        if (findDependentView != null) {
    ...
    public void setMenuAlignmentMode(int i4) {
        if (this.menuAlignmentMode != i4) {
            this.menuAlignmentMode = i4;
            ActionMenuView actionMenuView = getActionMenuView();
            if (actionMenuView != null) {
    ...
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i4, final boolean z4, boolean z5) {
        AnonymousClass8 r02 = new Runnable() {
            public void run() {
                ...
                actionMenuView.setTranslationX((float) BottomAppBar.this.getActionMenuViewTranslationX(actionMenuView, i4, z4));
            }
        };
        if (z5) {
