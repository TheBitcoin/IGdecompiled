...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(@NonNull Canvas canvas, int i4, float f4) {
        ...
        canvas.drawCircle(revealInfo2.centerX, revealInfo2.centerY, revealInfo2.radius - (f4 / 2.0f), this.debugPaint);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (shouldDrawCircularReveal()) {
            ...
            if (i4 == 0) {
                canvas2 = canvas;
                CircularRevealWidget.RevealInfo revealInfo2 = this.revealInfo;
                canvas2.drawCircle(revealInfo2.centerX, revealInfo2.centerY, revealInfo2.radius, this.revealPaint);
                if (shouldDrawScrim()) {
                    CircularRevealWidget.RevealInfo revealInfo3 = this.revealInfo;
                    canvas2.drawCircle(revealInfo3.centerX, revealInfo3.centerY, revealInfo3.radius, this.scrimPaint);
                }
            } else if (i4 == 1) {
                canvas2 = canvas;
