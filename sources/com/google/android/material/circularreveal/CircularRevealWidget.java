...
public interface CircularRevealWidget extends CircularRevealHelper.Delegate {
    ...
    public static class CircularRevealEvaluator implements TypeEvaluator<RevealInfo> {
        ...
        @NonNull
        public RevealInfo evaluate(float f4, @NonNull RevealInfo revealInfo2, @NonNull RevealInfo revealInfo3) {
            this.revealInfo.set(MathUtils.lerp(revealInfo2.centerX, revealInfo3.centerX, f4), MathUtils.lerp(revealInfo2.centerY, revealInfo3.centerY, f4), MathUtils.lerp(revealInfo2.radius, revealInfo3.radius, f4));
