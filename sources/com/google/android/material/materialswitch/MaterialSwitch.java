...
public class MaterialSwitch extends SwitchCompat {
    ...
    private void refreshThumbDrawable() {
        ...
        int i4 = this.thumbIconSize;
        super.setThumbDrawable(DrawableUtils.compositeTwoLayeredDrawable(drawable, drawable2, i4, i4));
    ...
    private static void setInterpolatedDrawableTintIfPossible(@Nullable Drawable drawable, @Nullable ColorStateList colorStateList, @NonNull int[] iArr, @NonNull int[] iArr2, float f4) {
    ...
    public void setThumbIconResource(@DrawableRes int i4) {
        setThumbIconDrawable(AppCompatResources.getDrawable(getContext(), i4));
    }

    public void setThumbIconSize(@Px int i4) {
        if (this.thumbIconSize != i4) {
            this.thumbIconSize = i4;
            refreshThumbDrawable();
        }
    }
    ...
    public void setTrackDecorationResource(@DrawableRes int i4) {
        setTrackDecorationDrawable(AppCompatResources.getDrawable(getContext(), i4));
    }
