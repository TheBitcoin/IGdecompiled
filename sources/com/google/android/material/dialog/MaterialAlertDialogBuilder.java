...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i4) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes((AttributeSet) null, R.styleable.MaterialAlertDialog, i5, i6);
        int color2 = obtainStyledAttributes.getColor(R.styleable.MaterialAlertDialog_backgroundTint, color);
        obtainStyledAttributes.recycle();
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context2, (AttributeSet) null, i5, i6);
