...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i4, int i5) {
                int i6;
                if (i4 < 0) {
                    i6 = MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition();
                } else {
                    i6 = MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition();
                }
                Month unused = MaterialCalendar.this.current = monthsPagerAdapter.getPageMonth(i6);
                materialButton.setText(monthsPagerAdapter.getPageTitle(i6));
            }
        });
            ...
            public void onDraw(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.State state) {
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (Pair next : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        F f4 = next.first;
                        if (!(f4 == null || next.second == null)) {
                            this.startItem.setTimeInMillis(((Long) f4).longValue());
                            ...
                            for (int i6 = spanCount; i6 <= spanCount2; i6++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    if (i6 != spanCount2 || findViewByPosition2 == null) {
                                        ...
                                        i5 = findViewByPosition2.getLeft() + (findViewByPosition2.getWidth() / 2);
                                    }
                                    Canvas canvas2 = canvas;
                                    canvas2.drawRect((float) i4, (float) top, (float) i5, (float) bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector2, @StyleRes int i4, @NonNull CalendarConstraints calendarConstraints2) {
        return newInstance(dateSelector2, i4, calendarConstraints2, (DayViewDecorator) null);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), i4, false) {
    ...
    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector2, @StyleRes int i4, @NonNull CalendarConstraints calendarConstraints2, @Nullable DayViewDecorator dayViewDecorator2) {
