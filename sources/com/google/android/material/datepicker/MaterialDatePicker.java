...
public final class MaterialDatePicker<S> extends DialogFragment {
        ...
        if (!this.edgeToEdgeEnabled) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(findViewById, new OnApplyWindowInsetsListener() {
                public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                    ...
                    if (i4 >= 0) {
                        findViewById.getLayoutParams().height = i4 + i4;
    ...
    public static /* synthetic */ void g(MaterialDatePicker materialDatePicker, View view) {
        ...
        materialDatePicker.inputMode = i4;
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, (AttributeSet) null, i4, i5);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, R.styleable.MaterialCalendar, i4, i5);
    ...
    public static final class Builder<S> {
        ...
        @NonNull
        public Builder<S> setNegativeButtonContentDescription(@StringRes int i4) {
            this.negativeButtonContentDescriptionResId = i4;
        ...
        @NonNull
        public Builder<S> setPositiveButtonContentDescription(@StringRes int i4) {
            this.positiveButtonContentDescriptionResId = i4;
