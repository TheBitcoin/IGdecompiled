...
public class SideSheetDialog extends SheetDialog<SideSheetCallback> {
    ...
    public /* bridge */ /* synthetic */ void setContentView(@LayoutRes int i4) {
    ...
    public /* bridge */ /* synthetic */ void setSheetEdge(@GravityInt int i4) {
        super.setSheetEdge(i4);
    }

    public SideSheetDialog(@NonNull Context context, @StyleRes int i4) {
        super(context, i4, SIDE_SHEET_DIALOG_THEME_ATTR, SIDE_SHEET_DIALOG_DEFAULT_THEME_RES);
    }
