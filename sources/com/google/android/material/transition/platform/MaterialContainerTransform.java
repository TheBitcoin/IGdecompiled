...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f4) {
            ...
            if (this.entering) {
                f5 = TransitionUtils.lerp(0.0f, 255.0f, f4);
            } else {
                f5 = TransitionUtils.lerp(255.0f, 0.0f, f4);
            }
            paint.setAlpha((int) f5);
            this.motionPathMeasure.getPosTan(this.motionPathLength * f4, this.motionPathPosition, (float[]) null);
            ...
            if (i4 > 0 || f4 < 0.0f) {
                ...
                this.motionPathMeasure.getPosTan(this.motionPathLength * f6, fArr, (float[]) null);
            ...
            float f16 = (float) ((int) (calculateElevationDyMultiplier * f15));
            this.currentElevationDy = f16;
            this.shadowPaint.setShadowLayer(f15, (float) ((int) (calculateElevationDxMultiplier * f15)), f16, SHADOW_COLOR);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i4, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (i4 != -1) {
            ...
            if (view2.getTag(i5) instanceof View) {
                transitionValues.view.setTag(i5, (Object) null);
    ...
    private void maybeApplyThemeValues(Context context, boolean z4) {
        ...
        if (z4) {
            i4 = R.attr.motionDurationLong2;
        } else {
            i4 = R.attr.motionDurationMedium4;
        }
        TransitionUtils.maybeApplyThemeDuration(this, context, i4);
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (!(transitionValues3 == null || transitionValues4 == null)) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                ...
                RectF calculateDrawableBounds = calculateDrawableBounds(view2, view3, f4, f5);
                rectF.offset(f4, f5);
                rectF2.offset(f4, f5);
