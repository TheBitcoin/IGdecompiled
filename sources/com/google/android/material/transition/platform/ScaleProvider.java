...
public final class ScaleProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createScaleAnimator(final View view, float f4, float f5) {
        ...
        ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(view, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat(View.SCALE_X, new float[]{scaleX * f4, scaleX * f5}), PropertyValuesHolder.ofFloat(View.SCALE_Y, new float[]{f4 * scaleY, f5 * scaleY})});
