...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public interface OnCheckedStateChangedListener {
        void onCheckedStateChangedListener(@NonNull MaterialCheckBox materialCheckBox, int i4);
    }
    ...
    static {
        ...
        ERROR_STATE_SET = new int[]{i4};
        CHECKBOX_STATES = new int[][]{new int[]{16842910, i4}, new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};
    }
        ...
        if (this.usingMaterialButtonDrawable) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if ((drawable instanceof AnimatedStateListDrawable) && (animatedVectorDrawableCompat = this.transitionToUnchecked) != null) {
                    int i4 = R.id.checked;
                    int i5 = R.id.unchecked;
                    ((AnimatedStateListDrawable) drawable).addTransition(i4, i5, animatedVectorDrawableCompat, false);
                    ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(R.id.indeterminate, i5, this.transitionToUnchecked, false);
                }
            }
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int width = ((getWidth() - buttonDrawable2.getIntrinsicWidth()) / 2) * i4;
    ...
    public void setButtonIconDrawableResource(@DrawableRes int i4) {
        setButtonIconDrawable(AppCompatResources.getDrawable(getContext(), i4));
    }
