...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        public void onMeasure(int i4, int i5) {
            ...
            if (this.maxWidth > 0 && getMeasuredWidth() > (i6 = this.maxWidth)) {
    ...
    /* access modifiers changed from: private */
    @NonNull
    public static GradientDrawable createGradientDrawableBackground(@ColorInt int i4, @NonNull Resources resources) {
    ...
    /* access modifiers changed from: private */
    @NonNull
    public static MaterialShapeDrawable createMaterialShapeDrawableBackground(@ColorInt int i4, @NonNull ShapeAppearanceModel shapeAppearanceModel) {
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (getAnchorView() != null) {
                i4 = this.extraBottomMarginAnchorView;
            } else {
                i4 = this.extraBottomMarginWindowInset;
            }
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
            int i5 = this.view.originalMargins.bottom + i4;
            ...
            if (marginLayoutParams.bottomMargin == i5 && marginLayoutParams.leftMargin == i6 && marginLayoutParams.rightMargin == i7 && marginLayoutParams.topMargin == i8) {
                z4 = false;
            } else {
                z4 = true;
            }
    ...
    public void onAttachedToWindow() {
        WindowInsets a5;
        if (Build.VERSION.SDK_INT >= 29 && (a5 = this.view.getRootWindowInsets()) != null) {
            this.extraBottomMarginGestureInset = a5.getMandatorySystemGestureInsets().bottom;
            updateMargins();
        }
    }
    ...
    protected BaseTransientBottomBar(@NonNull Context context2, @NonNull ViewGroup viewGroup, @NonNull View view2, @NonNull ContentViewCallback contentViewCallback2) {
        ...
        if (viewGroup == null) {
            ...
            this.animationSlideDuration = MotionUtils.resolveThemeDuration(context2, i4, 250);
            this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context2, i4, DEFAULT_ANIMATION_FADE_IN_DURATION);
            ...
            this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(context2, i5, DEFAULT_ANIMATION_FADE_INTERPOLATOR);
            this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(context2, i5, DEFAULT_ANIMATION_SCALE_INTERPOLATOR);
            this.animationSlideInterpolator = MotionUtils.resolveThemeInterpolator(context2, i5, DEFAULT_ANIMATION_SLIDE_INTERPOLATOR);
        } else {
