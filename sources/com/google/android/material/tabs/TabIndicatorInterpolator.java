...
class TabIndicatorInterpolator {
    ...
    static RectF calculateTabViewContentBounds(@NonNull TabLayout.TabView tabView, @Dimension(unit = 0) int i4) {
        ...
        return new RectF((float) (left - i5), (float) (top - (contentHeight / 2)), (float) (i5 + left), (float) (top + (left / 2)));
    }
    ...
    /* access modifiers changed from: package-private */
    public void updateIndicatorForOffset(TabLayout tabLayout, View view, View view2, @FloatRange(from = 0.0d, to = 1.0d) float f4, @NonNull Drawable drawable) {
        RectF calculateIndicatorWidthForTab = calculateIndicatorWidthForTab(tabLayout, view);
