...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i5) {
    ...
    @NonNull
    public static TooltipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet, @AttrRes int i4, @StyleRes int i5) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context2, attributeSet, i4, i5);
