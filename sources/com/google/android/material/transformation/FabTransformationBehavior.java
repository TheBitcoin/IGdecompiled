...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    @NonNull
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f4, float f5, boolean z4, @NonNull FabTransformationSpec fabTransformationSpec) {
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z4, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z4) {
                ...
                objectAnimator = ObjectAnimator.ofInt(circularRevealWidget, CircularRevealWidget.CircularRevealScrimColorProperty.CIRCULAR_REVEAL_SCRIM_COLOR, new int[]{i4});
            } else {
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z4, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, float f4, float f5, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        Animator animator;
        View view3 = view;
        View view4 = view2;
        ...
        if (view4 instanceof CircularRevealWidget) {
            ...
            if (z4) {
                ...
                View view5 = view2;
                createPreFillRadialExpansion(view5, delay, i5, i4, f6, list);
                ...
                int i7 = i6;
                createPostFillRadialExpansion(view2, delay2, duration, totalDuration, i7, i4, width, list);
    ...
    private void createTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z4, boolean z5, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2, @NonNull RectF rectF) {
        ...
        if (z6) {
            ...
            MotionTiming motionTiming4 = motionTiming2;
            MotionTiming motionTiming5 = motionTiming3;
            calculateChildVisibleBoundsAtEndOfExpansion(view2, fabTransformationSpec2, motionTiming4, motionTiming5, -calculateTranslationX, -calculateTranslationY, 0.0f, 0.0f, rectF);
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull View view2, boolean z4, boolean z5) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            animatorSet.addListener((Animator.AnimatorListener) arrayList6.get(i4));
        }
        return animatorSet;
    }
