...
public class RippleUtils {
    ...
    private static class RippleUtilsLollipop {
        ...
        @DoNotInline
        public static Drawable createOvalRipple(@NonNull Context context, @Px int i4) {
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setColor(-1);
            gradientDrawable.setShape(1);
            return new RippleDrawable(MaterialColors.getColorStateList(context, R.attr.colorControlHighlight, ColorStateList.valueOf(0)), (Drawable) null, new InsetDrawable(gradientDrawable, i4, i4, i4, i4));
        }
    }
    ...
    @RequiresApi(21)
    @NonNull
    public static Drawable createOvalRippleLollipop(@NonNull Context context, @Px int i4) {
        return RippleUtilsLollipop.createOvalRipple(context, i4);
    }
