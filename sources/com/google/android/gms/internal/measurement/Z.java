...
public enum Z {
    ...
    private static final Map f1668B0 = null;
    ...
    static {
        f1668B0 = new HashMap();
        for (Z z4 : values()) {
            f1668B0.put(Integer.valueOf(z4.f1733a), z4);
        }
    }
    ...
    public static Z a(int i4) {
        return (Z) f1668B0.get(Integer.valueOf(i4));
    }

    public final String toString() {
        return Integer.valueOf(this.f1733a).toString();
    }
}
