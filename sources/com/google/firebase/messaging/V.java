...
class V {
    ...
    private final Map f11297b = new ArrayMap();
    ...
    public static /* synthetic */ C0937l a(V v4, String str, C0937l lVar) {
        synchronized (v4) {
            v4.f11297b.remove(str);
        }
        return lVar;
    }
    ...
    public synchronized k0.C0937l b(java.lang.String r4, com.google.firebase.messaging.V.a r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            java.util.Map r0 = r3.f11297b     // Catch:{ all -> 0x002b }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ all -> 0x002b }
            k0.l r0 = (k0.C0937l) r0     // Catch:{ all -> 0x002b }
            r1 = 3
        ...
        L_0x004d:
            ...
            java.util.concurrent.Executor r0 = r3.f11296a     // Catch:{ all -> 0x002b }
