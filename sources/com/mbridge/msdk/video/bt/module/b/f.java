...
public class f {
    ...
    private static final String f15973a = "com.mbridge.msdk.video.bt.module.b.f";
    ...
    public static void a(Context context, String str) {
        if (context != null) {
            try {
                ...
                af.b(f15973a, e5.getMessage());
            }
        }
    }

    public static void a(Context context, CampaignEx campaignEx, String str, int i4) {
        if (context != null && campaignEx != null) {
            try {
                if (!TextUtils.isEmpty(str)) {
                    ...
                    jSONObject.put("templateshowtype", i4 + " offer show success");
                ...
                af.b(f15973a, th.getMessage());
            }
        }
    }

    public static void a(Context context, CampaignEx campaignEx, String str, String str2, int i4) {
        if (context != null && campaignEx != null) {
            try {
                int i5 = 1;
                if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(str2))) {
                    ...
                    jSONObject.put("templateshowtype", i4);
    ...
    public static void a(CampaignEx campaignEx, String str, int i4) {
        try {
            Context c5 = c.m().c();
            if (c5 != null && campaignEx != null && !TextUtils.isEmpty(str)) {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000115");
                jSONObject.put("network_type", ab.m(c5));
                jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str);
                jSONObject.put("cid", campaignEx.getId());
                jSONObject.put("play_cur_time", i4);
