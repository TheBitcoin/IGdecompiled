...
public class a {
    ...
    private static ConcurrentHashMap<String, LinkedHashMap<String, View>> f15723a = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public static LinkedHashMap<String, String> f15724b = new LinkedHashMap<>();

    /* renamed from: c  reason: collision with root package name */
    private static LinkedHashMap<String, CampaignEx> f15725c = new LinkedHashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private static LinkedHashMap<String, c> f15726d = new LinkedHashMap<>();

    /* renamed from: e  reason: collision with root package name */
    private static LinkedHashMap<String, String> f15727e = new LinkedHashMap<>();

    /* renamed from: f  reason: collision with root package name */
    private static LinkedHashMap<String, Integer> f15728f = new LinkedHashMap<>();

    /* renamed from: g  reason: collision with root package name */
    private static LinkedHashMap<String, Activity> f15729g = new LinkedHashMap<>();

    /* renamed from: h  reason: collision with root package name */
    private static volatile int f15730h = 10000;

    /* renamed from: i  reason: collision with root package name */
    private static int f15731i = 0;

    /* renamed from: j  reason: collision with root package name */
    private static int f15732j = 1;

    /* renamed from: k  reason: collision with root package name */
    private static String f15733k = "";

    /* renamed from: l  reason: collision with root package name */
    private static int f15734l;

    /* renamed from: m  reason: collision with root package name */
    private static int f15735m;

    /* renamed from: n  reason: collision with root package name */
    private static int f15736n;

    /* renamed from: o  reason: collision with root package name */
    private static int f15737o;

    /* renamed from: p  reason: collision with root package name */
    private static int f15738p;

    private String h(String str) {
        if (f15724b.containsKey(str)) {
            return f15724b.get(str);
        }
        return "";
    }
    ...
    public final void A(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            String h4 = h(optString2);
            if (TextUtils.isEmpty(h4) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f14150b) != null) {
                h4 = windVaneWebView.getRid();
            }
            if (jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA) == null) {
                c(obj, "data is empty");
                return;
            }
            LinkedHashMap<String, View> b5 = b(optString, h4);
    ...
    public final void I(java.lang.Object r9, org.json.JSONObject r10) {
        /*
            ...
            com.mbridge.msdk.mbsignalcommon.windvane.WindVaneWebView r4 = r4.f14150b     // Catch:{ all -> 0x0024 }
            if (r4 == 0) goto L_0x0027
        ...
        L_0x0066:
            ...
            com.mbridge.msdk.video.bt.a.b unused = com.mbridge.msdk.video.bt.a.b.a.f15756a     // Catch:{ all -> 0x0024 }
        ...
        L_0x0083:
            ...
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.LinkedHashMap<java.lang.String, android.view.View>> r4 = f15723a     // Catch:{ all -> 0x0024 }
            r4.remove(r10)     // Catch:{ all -> 0x0024 }
            r10.clear()     // Catch:{ all -> 0x0024 }
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.LinkedHashMap<java.lang.String, android.view.View>> r10 = f15723a     // Catch:{ all -> 0x0024 }
    ...
    public final void J(Object obj, JSONObject jSONObject) {
        String str;
        try {
            WindVaneWebView windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f14150b;
    ...
    public final void K(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            LinkedHashMap<String, View> b5 = b(optString, str);
            if (b5.size() <= 0 || !f15727e.containsKey(optString2)) {
                c(obj, "unitId not exist");
    ...
    public final String a() {
        f15730h++;
        return String.valueOf(f15730h);
    }

    public final String c(String str) {
        if (f15727e.containsKey(str)) {
            return f15727e.get(str);
        }
        return "";
    }
    ...
    public final int e(String str) {
        if (f15728f.containsKey(str)) {
            return f15728f.get(str).intValue();
        }
        return 2;
    }
    ...
    public final void f(String str) {
        ...
        if (f15726d.containsKey(str)) {
            f15726d.remove(str);
        }
        if (f15725c.containsKey(str)) {
            f15725c.remove(str);
        }
        if (f15724b.containsKey(str)) {
            f15724b.remove(str);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:?, code lost:
        ...
        r6 = (com.mbridge.msdk.video.signal.a.k) ((com.mbridge.msdk.mbsignalcommon.windvane.a) r2).f14150b.getObject();
        r0.setAdEvents(r6.l());
        r0.setAdSession(r6.j());
        r0.setVideoEvents(r6.k());
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void i(java.lang.Object r18, org.json.JSONObject r19) {
        /*
            r17 = this;
            r1 = r17
            r2 = r18
            ...
            java.lang.String r7 = r0.optString(r4)     // Catch:{ all -> 0x002a }
            java.lang.String r8 = r1.h(r7)     // Catch:{ all -> 0x002a }
            boolean r9 = android.text.TextUtils.isEmpty(r8)     // Catch:{ all -> 0x002a }
            if (r9 == 0) goto L_0x002d
            r9 = r2
            com.mbridge.msdk.mbsignalcommon.windvane.a r9 = (com.mbridge.msdk.mbsignalcommon.windvane.a) r9     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.mbsignalcommon.windvane.WindVaneWebView r9 = r9.f14150b     // Catch:{ all -> 0x002a }
            if (r9 == 0) goto L_0x002d
            java.lang.String r8 = r9.getRid()     // Catch:{ all -> 0x002a }
            goto L_0x002d
        L_0x002a:
            r0 = move-exception
            goto L_0x01ce
        L_0x002d:
            ...
            org.json.JSONObject r0 = r0.optJSONObject(r9)     // Catch:{ all -> 0x002a }
            if (r0 != 0) goto L_0x003b
            java.lang.String r0 = "data is empty"
            r1.c((java.lang.Object) r2, (java.lang.String) r0)     // Catch:{ all -> 0x002a }
            return
        L_0x003b:
            java.lang.String r4 = r0.optString(r4)     // Catch:{ all -> 0x002a }
            java.util.LinkedHashMap r6 = r1.b((java.lang.String) r6, (java.lang.String) r8)     // Catch:{ all -> 0x002a }
            boolean r8 = r6.containsKey(r4)     // Catch:{ all -> 0x002a }
            if (r8 == 0) goto L_0x01c3
            boolean r8 = r6.containsKey(r7)     // Catch:{ all -> 0x002a }
            if (r8 == 0) goto L_0x01c3
            java.lang.Object r8 = r6.get(r7)     // Catch:{ all -> 0x002a }
            android.view.ViewGroup r8 = (android.view.ViewGroup) r8     // Catch:{ all -> 0x002a }
            java.lang.Object r9 = r6.get(r4)     // Catch:{ all -> 0x002a }
            android.view.View r9 = (android.view.View) r9     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.foundation.tools.at.a(r9)     // Catch:{ all -> 0x002a }
            if (r8 == 0) goto L_0x01bd
            if (r9 != 0) goto L_0x0064
            goto L_0x01bd
        L_0x0064:
            java.lang.String r10 = "rect"
            org.json.JSONObject r10 = r0.optJSONObject(r10)     // Catch:{ all -> 0x002a }
            boolean r0 = r9 instanceof com.mbridge.msdk.video.bt.module.MBTempContainer     // Catch:{ all -> 0x002a }
            if (r0 == 0) goto L_0x011c
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x002a }
            r0.<init>()     // Catch:{ all -> 0x002a }
            java.lang.String r8 = "OperateViews setNotchString = "
            r0.append(r8)     // Catch:{ all -> 0x002a }
            java.lang.String r8 = "%1$s-%2$s-%3$s-%4$s-%5$s"
            int r11 = f15734l     // Catch:{ all -> 0x002a }
            java.lang.Integer r11 = java.lang.Integer.valueOf(r11)     // Catch:{ all -> 0x002a }
            int r12 = f15735m     // Catch:{ all -> 0x002a }
            java.lang.Integer r12 = java.lang.Integer.valueOf(r12)     // Catch:{ all -> 0x002a }
            int r13 = f15736n     // Catch:{ all -> 0x002a }
            java.lang.Integer r13 = java.lang.Integer.valueOf(r13)     // Catch:{ all -> 0x002a }
            int r14 = f15737o     // Catch:{ all -> 0x002a }
            java.lang.Integer r14 = java.lang.Integer.valueOf(r14)     // Catch:{ all -> 0x002a }
            int r15 = f15738p     // Catch:{ all -> 0x002a }
            ...
            r3[r16] = r11     // Catch:{ all -> 0x002a }
            r11 = 1
            r3[r11] = r12     // Catch:{ all -> 0x002a }
            r11 = 2
            r3[r11] = r13     // Catch:{ all -> 0x002a }
            r11 = 3
            r3[r11] = r14     // Catch:{ all -> 0x002a }
            r11 = 4
            r3[r11] = r15     // Catch:{ all -> 0x002a }
            java.lang.String r3 = java.lang.String.format(r8, r3)     // Catch:{ all -> 0x002a }
            r0.append(r3)     // Catch:{ all -> 0x002a }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.foundation.tools.af.b(r5, r0)     // Catch:{ all -> 0x002a }
            r11 = r9
            com.mbridge.msdk.video.bt.module.MBTempContainer r11 = (com.mbridge.msdk.video.bt.module.MBTempContainer) r11     // Catch:{ all -> 0x002a }
            int r12 = f15734l     // Catch:{ all -> 0x002a }
            int r13 = f15735m     // Catch:{ all -> 0x002a }
            int r14 = f15736n     // Catch:{ all -> 0x002a }
            int r15 = f15737o     // Catch:{ all -> 0x002a }
            int r16 = f15738p     // Catch:{ all -> 0x002a }
            r11.setNotchPadding(r12, r13, r14, r15, r16)     // Catch:{ all -> 0x002a }
            java.util.Collection r0 = r6.values()     // Catch:{ all -> 0x002a }
        ...
        L_0x00d1:
            ...
            android.view.View r3 = (android.view.View) r3     // Catch:{ all -> 0x002a }
            boolean r6 = r3 instanceof com.mbridge.msdk.video.bt.module.MBridgeBTContainer     // Catch:{ all -> 0x002a }
            ...
            r6 = r2
            com.mbridge.msdk.mbsignalcommon.windvane.a r6 = (com.mbridge.msdk.mbsignalcommon.windvane.a) r6     // Catch:{ Exception -> 0x0108 }
            com.mbridge.msdk.mbsignalcommon.windvane.WindVaneWebView r6 = r6.f14150b     // Catch:{ Exception -> 0x0108 }
            java.lang.Object r6 = r6.getObject()     // Catch:{ Exception -> 0x0108 }
            com.mbridge.msdk.video.signal.a.k r6 = (com.mbridge.msdk.video.signal.a.k) r6     // Catch:{ Exception -> 0x0108 }
            q1.a r8 = r6.l()     // Catch:{ Exception -> 0x0108 }
            r0.setAdEvents(r8)     // Catch:{ Exception -> 0x0108 }
            q1.b r8 = r6.j()     // Catch:{ Exception -> 0x0108 }
            r0.setAdSession(r8)     // Catch:{ Exception -> 0x0108 }
            r1.b r6 = r6.k()     // Catch:{ Exception -> 0x0108 }
            r0.setVideoEvents(r6)     // Catch:{ Exception -> 0x0108 }
            goto L_0x0110
        L_0x0108:
            r0 = move-exception
        ...
        L_0x0110:
            ...
            com.mbridge.msdk.video.bt.module.MBridgeBTContainer r3 = (com.mbridge.msdk.video.bt.module.MBridgeBTContainer) r3     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.video.bt.module.MBTempContainer r9 = (com.mbridge.msdk.video.bt.module.MBTempContainer) r9     // Catch:{ all -> 0x002a }
            r0.appendSubView(r3, r9, r10)     // Catch:{ all -> 0x002a }
            goto L_0x0198
        L_0x011c:
            r16 = 0
            if (r10 != 0) goto L_0x013e
            boolean r0 = r9 instanceof com.mbridge.msdk.video.bt.module.BTBaseView     // Catch:{ all -> 0x002a }
            ...
            r3 = r9
            com.mbridge.msdk.video.bt.module.BTBaseView r3 = (com.mbridge.msdk.video.bt.module.BTBaseView) r3     // Catch:{ all -> 0x002a }
            int r3 = r3.getViewWidth()     // Catch:{ all -> 0x002a }
            r6 = r9
            com.mbridge.msdk.video.bt.module.BTBaseView r6 = (com.mbridge.msdk.video.bt.module.BTBaseView) r6     // Catch:{ all -> 0x002a }
            int r6 = r6.getViewHeight()     // Catch:{ all -> 0x002a }
            goto L_0x016b
        L_0x013a:
            r0 = 0
            r3 = 0
        ...
        L_0x013e:
            ...
            int r0 = r10.optInt(r0, r3)     // Catch:{ all -> 0x002a }
            java.lang.String r6 = "top"
            int r6 = r10.optInt(r6, r3)     // Catch:{ all -> 0x002a }
            java.lang.String r11 = "right"
            int r11 = r10.optInt(r11, r3)     // Catch:{ all -> 0x002a }
            java.lang.String r12 = "bottom"
            int r3 = r10.optInt(r12, r3)     // Catch:{ all -> 0x002a }
            android.graphics.Rect r12 = new android.graphics.Rect     // Catch:{ all -> 0x002a }
            r12.<init>(r0, r6, r11, r3)     // Catch:{ all -> 0x002a }
            java.lang.String r0 = "width"
            int r3 = r10.optInt(r0)     // Catch:{ all -> 0x002a }
            java.lang.String r0 = "height"
            int r0 = r10.optInt(r0)     // Catch:{ all -> 0x002a }
            r6 = r0
            r0 = r12
        L_0x016b:
            android.view.ViewGroup$LayoutParams r10 = new android.view.ViewGroup$LayoutParams     // Catch:{ all -> 0x002a }
            r11 = -1
            r10.<init>(r11, r11)     // Catch:{ all -> 0x002a }
            boolean r12 = r8 instanceof android.widget.FrameLayout     // Catch:{ all -> 0x002a }
            if (r12 == 0) goto L_0x017b
            android.widget.FrameLayout$LayoutParams r10 = new android.widget.FrameLayout$LayoutParams     // Catch:{ all -> 0x002a }
            r10.<init>(r11, r11)     // Catch:{ all -> 0x002a }
            goto L_0x018e
        L_0x017b:
            boolean r12 = r8 instanceof android.widget.RelativeLayout     // Catch:{ all -> 0x002a }
            if (r12 == 0) goto L_0x0185
            android.widget.RelativeLayout$LayoutParams r10 = new android.widget.RelativeLayout$LayoutParams     // Catch:{ all -> 0x002a }
            r10.<init>(r11, r11)     // Catch:{ all -> 0x002a }
            goto L_0x018e
        L_0x0185:
            boolean r12 = r8 instanceof android.widget.LinearLayout     // Catch:{ all -> 0x002a }
            if (r12 == 0) goto L_0x018e
            android.widget.LinearLayout$LayoutParams r10 = new android.widget.LinearLayout$LayoutParams     // Catch:{ all -> 0x002a }
            r10.<init>(r11, r11)     // Catch:{ all -> 0x002a }
        L_0x018e:
            android.view.ViewGroup$LayoutParams r0 = r1.a(r10, r0, r3, r6)     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.foundation.tools.at.a(r9)     // Catch:{ all -> 0x002a }
            r8.addView(r9, r0)     // Catch:{ all -> 0x002a }
        L_0x0198:
            r1.a((java.lang.Object) r2, (java.lang.String) r7)     // Catch:{ all -> 0x002a }
            java.lang.String r0 = "onAppendView"
            r1.a((java.lang.Object) r2, (java.lang.String) r0, (java.lang.String) r7)     // Catch:{ all -> 0x002a }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x002a }
            r0.<init>()     // Catch:{ all -> 0x002a }
            java.lang.String r3 = "appendSubView parentId = "
            r0.append(r3)     // Catch:{ all -> 0x002a }
            r0.append(r7)     // Catch:{ all -> 0x002a }
            java.lang.String r3 = " childId = "
            r0.append(r3)     // Catch:{ all -> 0x002a }
            r0.append(r4)     // Catch:{ all -> 0x002a }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.foundation.tools.af.a((java.lang.String) r5, (java.lang.String) r0)     // Catch:{ all -> 0x002a }
            goto L_0x01ed
        L_0x01bd:
        ...
        L_0x01ce:
            ...
            com.mbridge.msdk.foundation.tools.af.a((java.lang.String) r5, (java.lang.String) r0)
        L_0x01ed:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.video.bt.a.a.i(java.lang.Object, org.json.JSONObject):void");
                        ...
                        if (view != null) {
                            ...
                            if (view instanceof MBTempContainer) {
                                ...
                                if (optJSONObject2 != null) {
                                    ...
                                    i4 = ((BTBaseView) view).getViewHeight();
                                } else {
                                    i5 = 0;
                                    rect = null;
                                    i4 = 0;
                                ...
                                ViewGroup.LayoutParams a5 = a(layoutParams, rect, i5, i4);
                                at.a(view);
    ...
    public final void k(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            String h4 = h(optString2);
            if (TextUtils.isEmpty(h4) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj2).f14150b) != null) {
                h4 = windVaneWebView.getRid();
            }
            ...
            if (viewGroup != null) {
                if (view != null) {
                    JSONObject optJSONObject2 = optJSONObject.optJSONObject("rect");
                    if (view instanceof MBTempContainer) {
                        af.b("OperateViews", "OperateViews setNotchString = " + String.format("%1$s-%2$s-%3$s-%4$s-%5$s", new Object[]{Integer.valueOf(f15734l), Integer.valueOf(f15735m), Integer.valueOf(f15736n), Integer.valueOf(f15737o), Integer.valueOf(f15738p)}));
                        ((MBTempContainer) view).setNotchPadding(f15734l, f15735m, f15736n, f15737o, f15738p);
                        Iterator<View> it = b5.values().iterator();
                        while (true) {
                            if (!it.hasNext()) {
                                break;
                        ...
                        viewGroup.addView(view, a(layoutParams, rect, i5, i4));
                    }
                    a(obj2, optString2);
    ...
    public final void s(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            viewGroup.addView(view, indexOfChild + 1, a(layoutParams, rect, i5, i4));
            a(obj, optString2);
    ...
    public final void t(java.lang.Object r19, org.json.JSONObject r20) {
        /*
            ...
            com.mbridge.msdk.mbsignalcommon.windvane.WindVaneWebView r8 = r8.f14150b     // Catch:{ all -> 0x002a }
            if (r8 == 0) goto L_0x002e
    ...
    public final void x(java.lang.Object r6, org.json.JSONObject r7) {
        ...
        L_0x0071:
            ...
            q1.a r1 = r3.getAdEvents()     // Catch:{ all -> 0x0024 }
            r7.setAdEvents(r1)     // Catch:{ all -> 0x0024 }
            q1.b r1 = r3.getAdSession()     // Catch:{ all -> 0x0024 }
            r7.setAdSession(r1)     // Catch:{ all -> 0x0024 }
            r1.b r1 = r3.getVideoEvents()     // Catch:{ all -> 0x0024 }
        ...
        try {
            ...
            if (optJSONObject != null) {
                if (!TextUtils.isEmpty(optString)) {
                    ...
                    if (TextUtils.isEmpty(str) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f14150b) != null) {
                        str = windVaneWebView.getRid();
                    }
                    LinkedHashMap<String, View> b5 = b(optString, str);
                    String a6 = a();
                    ...
                    k kVar = (k) ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f14150b.getObject();
                    ...
                    f15727e.put(a6, optString);
                    f15725c.put(a6, parseCampaignWithBackData);
                    f15726d.put(a6, a5);
                    a(obj, a6);
    ...
    public final synchronized LinkedHashMap<String, View> b(String str, String str2) {
        ConcurrentHashMap<String, LinkedHashMap<String, View>> concurrentHashMap = f15723a;
        if (concurrentHashMap.containsKey(str + "_" + str2)) {
            ConcurrentHashMap<String, LinkedHashMap<String, View>> concurrentHashMap2 = f15723a;
            return concurrentHashMap2.get(str + "_" + str2);
        }
        LinkedHashMap<String, View> linkedHashMap = new LinkedHashMap<>();
        ConcurrentHashMap<String, LinkedHashMap<String, View>> concurrentHashMap3 = f15723a;
    ...
    public final void a(String str, String str2) {
        f15724b.put(str, str2);
    }

    public final void a(String str, Activity activity) {
        f15729g.put(str, activity);
    }

    public final void a(String str, int i4) {
        f15728f.put(str, Integer.valueOf(i4));
    }
                ...
                try {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                        public final void run() {
                            ...
                            int i4 = i4;
                            if (i4 > 0 || i5 > 0) {
                                mBridgeBTWebView.setLayout(i4, i5);
                            }
                ...
                try {
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                        public final void run() {
                            ...
                            int i4 = i4;
                            if (i4 > 0 || i5 > 0) {
                                mBridgeBTLayout.setLayout(i4, i5);
                            }
                            a.this.a(obj2, a5);
    ...
    public final void a(int i4, int i5, int i6, int i7, int i8) {
        af.a("OperateViews", "OperateViews setNotchString = " + String.format("%1$s-%2$s-%3$s-%4$s-%5$s", new Object[]{Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8)}));
        f15733k = s.a(i4, i5, i6, i7, i8);
        f15734l = i4;
        f15735m = i5;
        f15736n = i6;
        f15737o = i7;
