...
public final class k extends l {
    ...
    private int f16603s = 0;
    /* access modifiers changed from: private */

    /* renamed from: t  reason: collision with root package name */
    public CampaignEx f16604t;

    /* renamed from: u  reason: collision with root package name */
    private List<CampaignEx> f16605u;
    ...
    private String f16608x = "";

    /* renamed from: y  reason: collision with root package name */
    private boolean f16609y = false;

    /* renamed from: z  reason: collision with root package name */
    private boolean f16610z = false;

    public k(Activity activity, CampaignEx campaignEx) {
        this.f16600p = activity;
        this.f16604t = campaignEx;
    }
    ...
    private String s() {
        ...
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, this.f16585j);
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("instanceId", this.f16607w);
            jSONObject2.put("rootViewInstanceId", this.f16608x);
            jSONObject2.put("isRootTemplateWebView", this.f16609y);
            jSONObject.put("sdk_info", "MAL_16.8.61,3.0.1");
            jSONObject2.put("playVideoMute", this.f16589n);
            jSONObject.put("sdkSetting", jSONObject2);
            a(jSONObject);
            JSONArray jSONArray = new JSONArray();
            List<CampaignEx> list = this.f16605u;
            if (list == null || list.size() <= 0) {
                jSONArray.put(CampaignEx.campaignToJsonObject(this.f16604t));
            } else {
                for (CampaignEx next : this.f16605u) {
            ...
            if (!TextUtils.isEmpty(g4)) {
                JSONObject jSONObject3 = new JSONObject(g4);
                b(jSONObject3);
                String c5 = h.a().c(this.f16585j);
            ...
            if (!TextUtils.isEmpty(this.f16585j)) {
                jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, this.f16585j);
            }
            if (this.f16610z) {
                str = "1";
    ...
    public final void click(int r6, java.lang.String r7) {
        /*
            ...
            super.click(r6, r7)
            com.mbridge.msdk.foundation.entity.CampaignEx r1 = r5.f16604t
            ...
            goto L_0x003f
        L_0x0015:
            java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r1 = r5.f16605u
        ...
        L_0x0021:
            ...
            java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r1 = r5.f16605u     // Catch:{ JSONException -> 0x003b }
            ...
            r5.f16604t = r0     // Catch:{ JSONException -> 0x003b }
            goto L_0x003f
        L_0x003b:
            r0 = move-exception
            r0.printStackTrace()
        L_0x003f:
            ...
            goto L_0x00f8
        L_0x004c:
            com.mbridge.msdk.video.signal.a$a r6 = r5.f16588m     // Catch:{ all -> 0x0053 }
        ...
        L_0x0053:
            ...
            goto L_0x00f1
        L_0x0056:
            com.mbridge.msdk.foundation.entity.CampaignEx r1 = r5.f16604t     // Catch:{ all -> 0x0053 }
            ...
            goto L_0x0072
        L_0x0068:
            com.mbridge.msdk.videocommon.d.c r1 = r5.f16586k     // Catch:{ all -> 0x0053 }
        ...
        L_0x0072:
            ...
            com.mbridge.msdk.video.signal.a$a r3 = r5.f16588m     // Catch:{ all -> 0x0053 }
            r1.<init>(r5, r3)     // Catch:{ all -> 0x0053 }
            r5.a((com.mbridge.msdk.video.signal.a.C0206a) r1)     // Catch:{ all -> 0x0053 }
        L_0x007f:
            r5.f16603s = r6     // Catch:{ all -> 0x0053 }
            r5.click(r2, r7)     // Catch:{ all -> 0x0053 }
            goto L_0x00f8
        L_0x0086:
            com.mbridge.msdk.foundation.entity.CampaignEx r3 = r5.f16604t     // Catch:{ all -> 0x0053 }
            if (r3 != 0) goto L_0x009f
            java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r3 = r5.f16605u     // Catch:{ all -> 0x0053 }
            if (r3 == 0) goto L_0x009f
            ...
            r5.f16604t = r3     // Catch:{ all -> 0x0053 }
        L_0x009f:
            com.mbridge.msdk.foundation.entity.CampaignEx r3 = r5.f16604t     // Catch:{ all -> 0x0053 }
        ...
        L_0x00a4:
            ...
            int r3 = r5.f16603s     // Catch:{ all -> 0x0053 }
            if (r3 == r1) goto L_0x00ae
            r5.f16603s = r6     // Catch:{ all -> 0x0053 }
        L_0x00ae:
            int r6 = r5.f16603s     // Catch:{ Exception -> 0x00c0 }
            r3 = 2
        ...
        L_0x00eb:
            android.app.Activity r6 = r5.f16600p     // Catch:{ all -> 0x0053 }
    ...
    private void b(JSONObject jSONObject) {
        try {
            ...
            String obj = an.a(c5, "MBridge_ConfirmTitle" + this.f16585j, "").toString();
            String obj2 = an.a(c5, "MBridge_ConfirmContent" + this.f16585j, "").toString();
            String obj3 = an.a(c5, "MBridge_CancelText" + this.f16585j, "").toString();
            String obj4 = an.a(c5, "MBridge_ConfirmText" + this.f16585j, "").toString();
    ...
    public final String c() {
        ...
        if (TextUtils.isEmpty(this.f16601q)) {
            ...
            String str = this.f16601q;
            this.f16601q = ak.b(str, "tun", ab.q() + "");
        }
        return this.f16601q;
    }
    ...
    public final void d() {
        super.d();
        try {
            Activity activity = this.f16600p;
            if (activity != null) {
                activity.finish();
            }
        } catch (Throwable th) {
    ...
    private com.mbridge.msdk.foundation.entity.CampaignEx a(java.lang.String r8, com.mbridge.msdk.foundation.entity.CampaignEx r9) {
        ...
        L_0x0027:
            ...
            java.lang.String r8 = com.mbridge.msdk.foundation.same.a.f13136j     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            org.json.JSONObject r8 = r0.optJSONObject(r8)     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            if (r8 == 0) goto L_0x0076
            android.app.Activity r0 = r7.f16600p     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            java.lang.String r2 = com.mbridge.msdk.foundation.same.a.f13134h     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            ...
            android.app.Activity r2 = r7.f16600p     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            java.lang.String r3 = com.mbridge.msdk.foundation.same.a.f13135i     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
        ...
        L_0x0093:
            ...
            java.lang.String r6 = com.mbridge.msdk.foundation.same.a.f13134h     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            boolean r6 = r6.equals(r4)     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            if (r6 != 0) goto L_0x00b8
            java.lang.String r6 = com.mbridge.msdk.foundation.same.a.f13135i     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            boolean r6 = r6.equals(r4)     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
            if (r6 == 0) goto L_0x00cb
        L_0x00b8:
            android.app.Activity r6 = r7.f16600p     // Catch:{ JSONException -> 0x0073, all -> 0x0070 }
    ...
    private boolean b(com.mbridge.msdk.foundation.entity.CampaignEx r7) {
        /*
            r6 = this;
            com.mbridge.msdk.foundation.controller.c r0 = com.mbridge.msdk.foundation.controller.c.m()     // Catch:{ Exception -> 0x0039 }
            java.lang.String r0 = r0.k()     // Catch:{ Exception -> 0x0039 }
            boolean r1 = android.text.TextUtils.isEmpty(r0)     // Catch:{ Exception -> 0x0039 }
            r2 = 0
            if (r1 != 0) goto L_0x0023
            com.mbridge.msdk.c.h r1 = com.mbridge.msdk.c.h.a()     // Catch:{ Exception -> 0x0039 }
            com.mbridge.msdk.c.g r0 = r1.b(r0)     // Catch:{ Exception -> 0x0039 }
            if (r0 == 0) goto L_0x0023
            long r0 = r0.ad()     // Catch:{ Exception -> 0x0039 }
    ...
    public final void a(int i4, String str) {
        ...
        if (i4 == 2) {
            try {
                ...
                final String optString4 = jSONObject.optString(MBridgeConstans.PROPERTIES_UNIT_ID, this.f16585j);
                final int m4 = ab.m(this.f16600p.getApplication());
                AnonymousClass1 r22 = new Runnable() {
                    public final void run() {
                        o.a((f) g.a((Context) k.this.f16600p.getApplication())).a(new n("2000039", optString, optString2, optString3, optString4, k.this.f16604t.getId(), m4, ab.a((Context) k.this.f16600p.getApplication(), m4)));
                    }
                };
                d.a();
