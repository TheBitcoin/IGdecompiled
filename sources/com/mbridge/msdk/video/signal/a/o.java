...
public final class o extends p {
    ...
    public final String a() {
        ...
        if (this.f16621b == null) {
            ...
            try {
                ...
                arrayList.add(this.f16621b.getCampaign());
                String unitID = this.f16621b.getUnitID();
                if (b.a() == null) {
                    cVar = null;
                } else {
                ...
                af.a("JSRewardVideoV1", "getEndScreenInfo success campaign = " + this.f16621b.getCampaign());
    ...
    public final void b(String str) {
        super.b(str);
        try {
            if (this.f16620a != null && !TextUtils.isEmpty(str)) {
                if (str.equals("landscape")) {
                    this.f16620a.setRequestedOrientation(0);
                } else if (str.equals("portrait")) {
                    this.f16620a.setRequestedOrientation(1);
                }
            }
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public final void c(String str) {
        ...
        super.c(str);
        try {
            if (this.f16620a != null && !TextUtils.isEmpty(str) && (mBridgeContainerView = this.f16621b) != null) {
    ...
    public final void notifyCloseBtn(int i4) {
        super.notifyCloseBtn(i4);
        MBridgeContainerView mBridgeContainerView = this.f16621b;
        if (mBridgeContainerView != null) {
            mBridgeContainerView.notifyCloseBtn(i4);
        }
    }
    ...
    public final void a(String str) {
        ...
        super.a(str);
        try {
            if (this.f16620a != null && !TextUtils.isEmpty(str) && str.equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK) && (mBridgeContainerView = this.f16621b) != null) {
