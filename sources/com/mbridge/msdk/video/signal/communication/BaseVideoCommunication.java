...
public class BaseVideoCommunication extends AbsFeedBackForH5 implements IVideoCommunication {
    ...
    protected IJSFactory f16625a;

    /* renamed from: e  reason: collision with root package name */
    private FastKV f16626e = null;
    ...
    public void cai(java.lang.Object r8, java.lang.String r9) {
        ...
        L_0x004d:
            ...
            int r6 = com.mbridge.msdk.mbsignalcommon.communication.d.f14109b     // Catch:{ Exception -> 0x007c, all -> 0x0037 }
    ...
    public void clearAllCache(Object obj, String str) {
        ...
        if (this.f16626e == null) {
            try {
                this.f16626e = new FastKV.Builder(e.a(c.MBRIDGE_700_CONFIG), "MBridgeH5CacheSP").build();
            } catch (Exception unused) {
                this.f16626e = null;
            }
        }
        FastKV fastKV = this.f16626e;
        if (fastKV != null) {
            try {
                fastKV.clear();
    ...
    public void click(Object obj, String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                IJSFactory iJSFactory = this.f16625a;
                if (iJSFactory != null) {
                    iJSFactory.getJSCommon().click(i4, str2);
                } else if (obj != null) {
                    a aVar = (a) obj;
                    if ((aVar.f14150b.getObject() instanceof k) && (kVar = (k) aVar.f14150b.getObject()) != null) {
                        kVar.click(i4, str2);
                    }
                }
            }
    ...
    public void closeVideoOperte(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                JSONObject jSONObject = new JSONObject(str);
                ...
                this.f16625a.getJSVideoModule().closeVideoOperate(optInt, optInt2);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                    ...
                    this.f16625a.getJSContainerModule().hideAlertWebview();
                    this.f16625a.getJSVideoModule().hideAlertView(optInt);
                }
            }
        } catch (Throwable th) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x0103 A[Catch:{ all -> 0x0101 }] */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x010a A[Catch:{ all -> 0x0101 }] */
    ...
    public void getAllCache(java.lang.Object r9, java.lang.String r10) {
        /*
            r8 = this;
            com.mbridge.msdk.foundation.controller.d.a()
            com.mbridge.msdk.foundation.tools.FastKV r10 = r8.f16626e
            ...
            r8.f16626e = r10     // Catch:{ Exception -> 0x001c }
            goto L_0x001e
        L_0x001c:
            r8.f16626e = r1
        L_0x001e:
            ...
            com.mbridge.msdk.foundation.tools.FastKV r0 = r8.f16626e     // Catch:{ Exception -> 0x003a }
        ...
        L_0x0085:
            ...
            goto L_0x00ea
        L_0x0087:
            com.mbridge.msdk.foundation.controller.c r10 = com.mbridge.msdk.foundation.controller.c.m()     // Catch:{ all -> 0x00c3 }
            android.content.Context r10 = r10.c()     // Catch:{ all -> 0x00c3 }
            android.content.SharedPreferences r10 = r10.getSharedPreferences(r0, r2)     // Catch:{ all -> 0x00c3 }
            org.json.JSONObject r0 = new org.json.JSONObject     // Catch:{ all -> 0x00c3 }
            r0.<init>()     // Catch:{ all -> 0x00c3 }
            java.util.Map r10 = r10.getAll()     // Catch:{ all -> 0x00be }
            java.util.Set r10 = r10.entrySet()     // Catch:{ all -> 0x00be }
            java.util.Iterator r10 = r10.iterator()     // Catch:{ all -> 0x00be }
        L_0x00a4:
            boolean r1 = r10.hasNext()     // Catch:{ all -> 0x00be }
            if (r1 == 0) goto L_0x00c1
            java.lang.Object r1 = r10.next()     // Catch:{ all -> 0x00be }
            java.util.Map$Entry r1 = (java.util.Map.Entry) r1     // Catch:{ all -> 0x00be }
            java.lang.Object r7 = r1.getKey()     // Catch:{ all -> 0x00be }
            java.lang.String r7 = (java.lang.String) r7     // Catch:{ all -> 0x00be }
            java.lang.Object r1 = r1.getValue()     // Catch:{ all -> 0x00be }
            r0.put(r7, r1)     // Catch:{ all -> 0x00be }
            goto L_0x00a4
        L_0x00be:
            r10 = move-exception
            r1 = r0
        ...
        L_0x00c4:
            ...
            goto L_0x0085
        L_0x00ea:
            org.json.JSONObject r0 = new org.json.JSONObject     // Catch:{ all -> 0x0101 }
            r0.<init>()     // Catch:{ all -> 0x0101 }
            java.lang.String r1 = "code"
            r0.put(r1, r2)     // Catch:{ all -> 0x0101 }
            java.lang.String r1 = "message"
            r0.put(r1, r4)     // Catch:{ all -> 0x0101 }
            java.lang.String r1 = "data"
            if (r10 == 0) goto L_0x0103
            r0.put(r1, r10)     // Catch:{ all -> 0x0101 }
            goto L_0x0108
        L_0x0101:
            r9 = move-exception
            goto L_0x011f
        ...
        L_0x0108:
            ...
            com.mbridge.msdk.mbsignalcommon.windvane.g r10 = com.mbridge.msdk.mbsignalcommon.windvane.g.a()     // Catch:{ all -> 0x0101 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x0101 }
            byte[] r0 = r0.getBytes()     // Catch:{ all -> 0x0101 }
            r1 = 2
            java.lang.String r0 = android.util.Base64.encodeToString(r0, r1)     // Catch:{ all -> 0x0101 }
            r10.a(r9, r0)     // Catch:{ all -> 0x0101 }
            goto L_0x0131
        L_0x011f:
            java.lang.StringBuilder r10 = new java.lang.StringBuilder
            r10.<init>()
    ...
    public void getCutout(Object obj, String str) {
        try {
            String i4 = this.f16625a.getJSCommon().i();
            af.b("JS-Video-Brigde", i4);
            if (obj == null || TextUtils.isEmpty(i4)) {
                JSONObject jSONObject = new JSONObject();
            ...
            g.a().a(obj, Base64.encodeToString(i4.getBytes(), 2));
        } catch (Throwable th) {
    ...
    public void getRewardSetting(Object obj, String str) {
        try {
            JSONObject k4 = com.mbridge.msdk.videocommon.d.b.a().b().k();
            JSONObject jSONObject = new JSONObject();
            if (obj == null || k4 == null) {
                jSONObject.put("code", 1);
                ...
                jSONObject.put("code", 0);
                jSONObject.put("message", "Success");
                jSONObject.put(DataSchemeDataSource.SCHEME_DATA, k4);
            }
            g.a().a(obj, Base64.encodeToString(jSONObject.toString().getBytes(), 2));
        } catch (Throwable th) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (this.f16625a != null) {
                    while (i4 < jSONArray.length()) {
                        ...
                        jSONObject.put(a(i5), this.f16625a.getJSCommon().g(i5));
                        i4++;
                    }
                } else if (obj != null) {
                    while (i4 < jSONArray.length()) {
                        ...
                        a aVar = (a) obj;
                        if (aVar.f14150b.getObject() instanceof k) {
                            jSONObject.put(a(i6), ((k) aVar.f14150b.getObject()).g(i6));
                        }
                        i4++;
                    }
                }
    ...
    public void handlerH5Exception(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSCommon().handlerH5Exception(jSONObject.optInt("code", -999), jSONObject.optString("message", "h5 error"));
            }
        } catch (Throwable th) {
    ...
    public void init(Object obj, String str) {
        ...
        try {
            ...
            if (iJSFactory != null) {
                ...
                g.a().a(obj, c5);
                this.f16625a.getJSCommon().b(true);
                if (!TextUtils.isEmpty(str)) {
                    JSONObject jSONObject = new JSONObject(str);
                    ...
                    com.mbridge.msdk.video.signal.d jSCommon = this.f16625a.getJSCommon();
                    if (optInt == 1) {
                        z4 = true;
                    }
                    jSCommon.a(z4);
                    this.f16625a.getJSCommon().b(optInt2);
                    this.f16625a.getJSCommon().c(optInt3);
                    this.f16625a.getJSCommon().d(optInt4);
                    this.f16625a.getJSCommon().e(optInt5);
                    com.mbridge.msdk.video.signal.d jSCommon2 = this.f16625a.getJSCommon();
                    if (optInt6 != 0) {
                        i4 = optInt6;
                    }
                    jSCommon2.h(i4);
                ...
                a aVar = (a) obj;
                if (aVar.f14150b.getObject() instanceof k) {
                    k kVar = (k) aVar.f14150b.getObject();
                    String c6 = kVar.c();
                    if (!TextUtils.isEmpty(str)) {
    ...
    public void isSystemResume(Object obj, String str) {
        try {
            if (this.f16625a != null) {
                ...
                g.a().a(obj, b(this.f16625a.getActivityProxy().h()));
            }
        } catch (Throwable th) {
    ...
    public void ivRewardAdsWithoutVideo(Object obj, String str) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                    this.f16625a.getJSContainerModule().ivRewardAdsWithoutVideo(str);
                }
            }
        } catch (Throwable th) {
            ...
            if (obj != null) {
                ...
                if (l.a(aVar.f14150b)) {
                    ...
                    if (windVaneWebView.getWebViewListener() != null) {
                        ((com.mbridge.msdk.mbsignalcommon.b.a) windVaneWebView.getWebViewListener()).a(windVaneWebView, str3, str2, i5, i4);
                    }
                }
            }
            g.a().a(obj, b(0));
    ...
    public void loadingResourceStatus(Object obj, String str) {
        ...
        if (obj != null) {
            try {
                ...
                WindVaneWebView windVaneWebView = ((a) obj).f14150b;
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSVideoModule().notifyCloseBtn(optInt);
            }
        } catch (Throwable th) {
    ...
    public void openURL(Object obj, String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (optInt == 1) {
                    com.mbridge.msdk.click.c.d(this.f14173b, optString);
                } else if (optInt == 2) {
                    com.mbridge.msdk.click.c.f(this.f14173b, optString);
                }
            } catch (JSONException e5) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                    ...
                    this.f16625a.getJSCommon().f(optInt);
                }
            }
        } catch (Throwable th) {
    ...
    public void progressBarOperate(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                this.f16625a.getJSVideoModule().progressBarOperate(new JSONObject(str).optInt("view_visible"));
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void progressOperate(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSVideoModule().progressOperate(optInt, optInt2);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
            af.b("JS-Video-Brigde", "progressOperate error", th);
    ...
    public void reactDeveloper(Object obj, String str) {
        ...
        try {
            if (this.f16625a == null || TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSBTModule().reactDeveloper(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void readyStatus(Object obj, String str) {
        if (obj != null) {
            try {
                ...
                int optInt = new JSONObject(str).optInt("isReady", 1);
                if (aVar.f14150b.getObject() instanceof k) {
                    ((k) aVar.f14150b.getObject()).i(optInt);
                }
                WindVaneWebView windVaneWebView = aVar.f14150b;
                if (windVaneWebView != null && windVaneWebView.getWebViewListener() != null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x00e0 A[ADDED_TO_REGION, Catch:{ all -> 0x010a }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void removeCacheItem(java.lang.Object r11, java.lang.String r12) {
        /*
            r10 = this;
            com.mbridge.msdk.foundation.controller.d.a()
            com.mbridge.msdk.foundation.tools.FastKV r0 = r10.f16626e
            ...
            r10.f16626e = r0     // Catch:{ Exception -> 0x001b }
            goto L_0x001e
        L_0x001b:
            r0 = 0
            r10.f16626e = r0
        L_0x001e:
            ...
            com.mbridge.msdk.foundation.tools.FastKV r0 = r10.f16626e     // Catch:{ Exception -> 0x004d }
            r0.remove(r12)     // Catch:{ Exception -> 0x004d }
            goto L_0x004d
        L_0x004b:
            r12 = move-exception
            goto L_0x0053
        ...
        L_0x0053:
            ...
            goto L_0x00cc
        L_0x0079:
            com.mbridge.msdk.foundation.controller.c r0 = com.mbridge.msdk.foundation.controller.c.m()     // Catch:{ all -> 0x00a6 }
            android.content.Context r0 = r0.c()     // Catch:{ all -> 0x00a6 }
            android.content.SharedPreferences r0 = r0.getSharedPreferences(r1, r8)     // Catch:{ all -> 0x00a6 }
            boolean r1 = android.text.TextUtils.isEmpty(r12)     // Catch:{ all -> 0x00a6 }
            if (r1 != 0) goto L_0x0050
            org.json.JSONObject r1 = new org.json.JSONObject     // Catch:{ all -> 0x00a6 }
            r1.<init>(r12)     // Catch:{ all -> 0x00a6 }
            java.lang.String r12 = r1.getString(r4)     // Catch:{ all -> 0x00a6 }
            boolean r1 = android.text.TextUtils.isEmpty(r12)     // Catch:{ all -> 0x00a6 }
            if (r1 != 0) goto L_0x004d
            android.content.SharedPreferences$Editor r0 = r0.edit()     // Catch:{ all -> 0x00a6 }
            android.content.SharedPreferences$Editor r12 = r0.remove(r12)     // Catch:{ all -> 0x00a6 }
            r12.apply()     // Catch:{ all -> 0x00a6 }
            goto L_0x004d
        L_0x00a6:
            r12 = move-exception
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            ...
            java.lang.String r3 = r0.toString()
        L_0x00cc:
            org.json.JSONObject r12 = new org.json.JSONObject     // Catch:{ all -> 0x010a }
            r12.<init>()     // Catch:{ all -> 0x010a }
            java.lang.String r0 = "code"
            r1 = r8 ^ 1
            r12.put(r0, r1)     // Catch:{ all -> 0x010a }
            java.lang.String r0 = "message"
            r12.put(r0, r3)     // Catch:{ all -> 0x010a }
            r0 = 2
            if (r11 == 0) goto L_0x00f6
            if (r8 == 0) goto L_0x00f6
            com.mbridge.msdk.mbsignalcommon.windvane.g r1 = com.mbridge.msdk.mbsignalcommon.windvane.g.a()     // Catch:{ all -> 0x010a }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x010a }
            byte[] r12 = r12.getBytes()     // Catch:{ all -> 0x010a }
            java.lang.String r12 = android.util.Base64.encodeToString(r12, r0)     // Catch:{ all -> 0x010a }
            r1.a(r11, r12)     // Catch:{ all -> 0x010a }
            goto L_0x010d
        L_0x00f6:
            com.mbridge.msdk.mbsignalcommon.windvane.g r1 = com.mbridge.msdk.mbsignalcommon.windvane.g.a()     // Catch:{ all -> 0x010a }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x010a }
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (iJSFactory == null || iJSFactory.getJSBTModule() == null) {
                    d.c().b(obj, str);
                } else if (this.f16625a.getJSBTModule() instanceof j) {
                    this.f16625a.getJSBTModule().reportUrls(obj, str);
                } else {
                    d.c().b(obj, str);
                }
            } else {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x00f6 A[ADDED_TO_REGION, Catch:{ all -> 0x0120 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void setCacheItem(java.lang.Object r12, java.lang.String r13) {
        /*
            r11 = this;
            com.mbridge.msdk.foundation.controller.d.a()
            com.mbridge.msdk.foundation.tools.FastKV r0 = r11.f16626e
            java.lang.String r1 = "MBridgeH5CacheSP"
            if (r0 != 0) goto L_0x001e
            com.mbridge.msdk.foundation.tools.FastKV$Builder r0 = new com.mbridge.msdk.foundation.tools.FastKV$Builder     // Catch:{ Exception -> 0x001b }
            com.mbridge.msdk.foundation.same.b.c r2 = com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_CONFIG     // Catch:{ Exception -> 0x001b }
            ...
            r0.<init>(r2, r1)     // Catch:{ Exception -> 0x001b }
            com.mbridge.msdk.foundation.tools.FastKV r0 = r0.build()     // Catch:{ Exception -> 0x001b }
            r11.f16626e = r0     // Catch:{ Exception -> 0x001b }
            goto L_0x001e
        L_0x001b:
            r0 = 0
            r11.f16626e = r0
        L_0x001e:
            ...
            if (r1 != 0) goto L_0x0059
            com.mbridge.msdk.foundation.tools.FastKV r1 = r11.f16626e     // Catch:{ Exception -> 0x0059 }
            r1.putString(r13, r0)     // Catch:{ Exception -> 0x0059 }
            goto L_0x0059
        L_0x0057:
            r13 = move-exception
            goto L_0x005f
        ...
        L_0x005f:
            ...
            goto L_0x00e2
        L_0x0085:
            com.mbridge.msdk.foundation.controller.c r0 = com.mbridge.msdk.foundation.controller.c.m()     // Catch:{ all -> 0x00bc }
            android.content.Context r0 = r0.c()     // Catch:{ all -> 0x00bc }
            android.content.SharedPreferences r0 = r0.getSharedPreferences(r1, r9)     // Catch:{ all -> 0x00bc }
            boolean r1 = android.text.TextUtils.isEmpty(r13)     // Catch:{ all -> 0x00bc }
            if (r1 != 0) goto L_0x005c
            org.json.JSONObject r1 = new org.json.JSONObject     // Catch:{ all -> 0x00bc }
            r1.<init>(r13)     // Catch:{ all -> 0x00bc }
            java.lang.String r13 = r1.getString(r5)     // Catch:{ all -> 0x00bc }
            java.lang.String r1 = r1.getString(r4)     // Catch:{ all -> 0x00bc }
            boolean r4 = android.text.TextUtils.isEmpty(r13)     // Catch:{ all -> 0x00bc }
            if (r4 != 0) goto L_0x0059
            boolean r4 = android.text.TextUtils.isEmpty(r1)     // Catch:{ all -> 0x00bc }
            if (r4 != 0) goto L_0x0059
            android.content.SharedPreferences$Editor r0 = r0.edit()     // Catch:{ all -> 0x00bc }
            android.content.SharedPreferences$Editor r13 = r0.putString(r13, r1)     // Catch:{ all -> 0x00bc }
            r13.apply()     // Catch:{ all -> 0x00bc }
            goto L_0x0059
        L_0x00bc:
            r13 = move-exception
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
            ...
            java.lang.String r3 = r0.toString()
        L_0x00e2:
            org.json.JSONObject r13 = new org.json.JSONObject     // Catch:{ all -> 0x0120 }
            r13.<init>()     // Catch:{ all -> 0x0120 }
            java.lang.String r0 = "code"
            r1 = r9 ^ 1
            r13.put(r0, r1)     // Catch:{ all -> 0x0120 }
            java.lang.String r0 = "message"
            r13.put(r0, r3)     // Catch:{ all -> 0x0120 }
            r0 = 2
            if (r12 == 0) goto L_0x010c
            if (r9 == 0) goto L_0x010c
            com.mbridge.msdk.mbsignalcommon.windvane.g r1 = com.mbridge.msdk.mbsignalcommon.windvane.g.a()     // Catch:{ all -> 0x0120 }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x0120 }
            byte[] r13 = r13.getBytes()     // Catch:{ all -> 0x0120 }
            java.lang.String r13 = android.util.Base64.encodeToString(r13, r0)     // Catch:{ all -> 0x0120 }
            r1.a(r12, r13)     // Catch:{ all -> 0x0120 }
            goto L_0x0123
        L_0x010c:
            com.mbridge.msdk.mbsignalcommon.windvane.g r1 = com.mbridge.msdk.mbsignalcommon.windvane.g.a()     // Catch:{ all -> 0x0120 }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x0120 }
    ...
    public void setScaleFitXY(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSVideoModule().setScaleFitXY(optInt);
            }
        } catch (Throwable th) {
    ...
    public void showAlertView(Object obj, String str) {
        ...
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                this.f16625a.getJSVideoModule().showIVRewardAlertView(str);
    ...
    public void showVideoClickView(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSContainerModule().showVideoClickView(optInt);
            }
        } catch (Throwable th) {
            af.b("JS-Video-Brigde", "showVideoClickView error", th);
        }
    ...
    public void showVideoLocation(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSVideoModule().showVideoLocation(optInt, optInt2, optInt3, optInt4, optInt5, optInt6, optInt7, optInt8, optInt9);
                this.f16625a.getJSCommon().f();
            }
        } catch (Throwable th) {
    ...
    public void soundOperate(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                if (TextUtils.isEmpty(optString)) {
                    this.f16625a.getJSVideoModule().soundOperate(optInt, optInt2);
                } else {
                    this.f16625a.getJSVideoModule().soundOperate(optInt, optInt2, optString);
                }
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void statistics(Object obj, String str) {
        ...
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                JSONObject jSONObject = new JSONObject(str);
                this.f16625a.getJSCommon().a(jSONObject.optInt("type"), jSONObject.optString(DataSchemeDataSource.SCHEME_DATA));
            }
        } catch (Throwable th) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSVideoModule().closeVideoOperate(0, i4);
            }
        } catch (Throwable th) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        ...
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str) && new JSONObject(str).optString(MRAIDCommunicatorUtil.KEY_STATE).equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK)) {
                this.f16625a.getJSVideoModule().closeVideoOperate(1, -1);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
    ...
    public void videoOperate(Object obj, String str) {
        try {
            if (this.f16625a != null && !TextUtils.isEmpty(str)) {
                ...
                this.f16625a.getJSVideoModule().videoOperate(optInt);
                g.a().a(obj, b(0));
            }
        } catch (Throwable th) {
