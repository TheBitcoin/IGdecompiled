...
public class BaseRewardSignal extends BaseRewardSignalDiff {
    ...
    protected BaseIRewardCommunication f16623a;
    ...
    public void cai(java.lang.Object r8, java.lang.String r9) {
        ...
        L_0x0045:
            ...
            int r6 = com.mbridge.msdk.mbsignalcommon.communication.d.f14109b     // Catch:{ Exception -> 0x0074, all -> 0x002f }
    ...
    public void getEndScreenInfo(Object obj, String str) {
        try {
            BaseIRewardCommunication baseIRewardCommunication = this.f16623a;
    ...
    public void handlerPlayableException(Object obj, String str) {
        try {
            if (this.f16623a != null && !TextUtils.isEmpty(str)) {
                this.f16623a.handlerPlayableException(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        ...
        if (z4) {
            ...
            try {
                this.f16623a = cls.newInstance();
                cls.getMethod("initialize", new Class[]{Context.class, WindVaneWebView.class}).invoke(this.f16623a, new Object[]{context, windVaneWebView});
            } catch (Exception e6) {
            ...
            this.f16623a = (BaseIRewardCommunication) windVaneWebView.getObject();
        }
    }
            ...
            if (baseIRewardCommunication != null) {
                ...
                if (obj != null) {
                    ...
                    if (aVar.f14150b.getObject() instanceof k) {
                        ((k) aVar.f14150b.getObject()).click(1, str);
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            if (this.f16623a != null && !TextUtils.isEmpty(str)) {
                this.f16623a.notifyCloseBtn(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void openURL(Object obj, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                if (optInt == 1) {
                    c.d(this.f14173b, optString);
                } else if (optInt == 2) {
                    c.f(this.f14173b, optString);
                }
    ...
    public void setOrientation(Object obj, String str) {
        try {
            if (this.f16623a != null && !TextUtils.isEmpty(str)) {
                this.f16623a.setOrientation(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            if (this.f16623a != null && !TextUtils.isEmpty(str)) {
                this.f16623a.toggleCloseBtn(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        try {
            if (this.f16623a != null && !TextUtils.isEmpty(str)) {
                this.f16623a.triggerCloseBtn(obj, str);
            }
        } catch (Throwable th) {
    ...
    public void initialize(Object obj, WindVaneWebView windVaneWebView) {
        ...
        if (z4) {
            ...
            try {
                this.f16623a = cls.newInstance();
                cls.getMethod("initialize", new Class[]{Object.class, WindVaneWebView.class}).invoke(this.f16623a, new Object[]{obj, windVaneWebView});
            } catch (Exception e6) {
                if (MBridgeConstans.DEBUG) {
                    e6.printStackTrace();
                }
