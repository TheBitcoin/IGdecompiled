...
public final class a {
    ...
    private static boolean f16084j = false;

    /* renamed from: a  reason: collision with root package name */
    public com.mbridge.msdk.video.dynview.d.a f16085a = new com.mbridge.msdk.video.dynview.d.a() {
        public final void a() {
            if (a.this.f16095l && a.this.f16086b != null) {
                a.this.f16086b.a((long) (a.this.f16096m * 1000), a.this.f16094k);
                boolean unused = a.this.f16095l = false;
            }
        }

        public final void b() {
            if (a.this.f16086b != null) {
                a.this.f16086b.b();
                boolean unused = a.this.f16095l = true;
            }
        }
    ...
    public Map<String, Bitmap> f16087c;
    /* access modifiers changed from: private */
    ...
    private String f16089e = "#FFFFFFFF";

    /* renamed from: f  reason: collision with root package name */
    private String f16090f = "#60000000";
    /* access modifiers changed from: private */

    /* renamed from: g  reason: collision with root package name */
    public String f16091g = "#FF5F5F5F";

    /* renamed from: h  reason: collision with root package name */
    private String f16092h = "#90ECECEC";
    /* access modifiers changed from: private */

    /* renamed from: i  reason: collision with root package name */
    public volatile long f16093i = 0;
    /* access modifiers changed from: private */

    /* renamed from: k  reason: collision with root package name */
    public com.mbridge.msdk.video.dynview.i.c.a f16094k = null;
    /* access modifiers changed from: private */

    /* renamed from: l  reason: collision with root package name */
    public boolean f16095l = false;
    /* access modifiers changed from: private */

    /* renamed from: m  reason: collision with root package name */
    public int f16096m = 0;
    ...
    public final void c(c cVar, View view, final Map map, e eVar) {
        try {
            ...
            final List<CampaignEx> g4 = cVar.g();
            if (view.getContext() == null) {
                eVar.a(com.mbridge.msdk.video.dynview.c.a.NOT_FOUND_CONTEXT);
                return;
            }
            if (map != null && map.containsKey("is_dy_success")) {
                f16084j = ((Boolean) map.get("is_dy_success")).booleanValue();
            }
            for (CampaignEx next : g4) {
                if (next != null) {
                    next.setECTemplateRenderSucc(f16084j);
                }
            }
            ListView listView = (ListView) view.findViewById(a(f16084j, "mbridge_order_view_lv"));
            GridView gridView = (GridView) view.findViewById(a(f16084j, "mbridge_order_view_h_lv"));
            ImageView imageView = (ImageView) view.findViewById(a(f16084j, "mbridge_order_view_iv_close"));
            com.mbridge.msdk.video.dynview.ordercamp.a.a aVar = new com.mbridge.msdk.video.dynview.ordercamp.a.a(g4);
            if (cVar.e() == 1) {
                if (listView != null) {
                    try {
                ...
                layoutParams2.width = d5 - (i4 * 2);
                gridView.setLayoutParams(layoutParams2);
                gridView.setColumnWidth((size - i4) - (i5 / 2));
    ...
    public final void b(c cVar, View view, Map map, e eVar) {
        ...
        if (eVar2 != null) {
            ...
            if (map2 != null && map2.containsKey("is_dy_success")) {
                f16084j = ((Boolean) map2.get("is_dy_success")).booleanValue();
            }
            boolean z4 = f16084j;
            LinearLayout linearLayout = z4 ? (LinearLayout) view2.findViewById(a(z4, "mbridge_reward_heat_mllv")) : null;
            ImageView imageView = (ImageView) view2.findViewById(a(f16084j, "mbridge_reward_icon_riv"));
            TextView textView = (TextView) view2.findViewById(a(f16084j, "mbridge_reward_title_tv"));
            LinearLayout linearLayout2 = (LinearLayout) view2.findViewById(a(f16084j, "mbridge_reward_stars_mllv"));
            TextView textView2 = (TextView) view2.findViewById(a(f16084j, "mbridge_reward_click_tv"));
            ImageView imageView2 = (ImageView) view2.findViewById(a(f16084j, "mbridge_videoview_bg"));
            TextView textView3 = (TextView) view2.findViewById(a(f16084j, "mbridge_reward_desc_tv"));
            RelativeLayout relativeLayout = (RelativeLayout) view2.findViewById(a(f16084j, "mbridge_reward_bottom_layout"));
            ...
            CampaignEx campaignEx = g4.get(0);
            if (campaignEx != null) {
                if (imageView != null) {
                    if (!f16084j) {
                ...
                if (i4 == 102 || i4 == 202 || i4 == 302) {
                    ...
                    a(imageView2, campaignEx.getImageUrl(), i4);
                } else if (i4 != 902) {
                    if (i4 != 904) {
                        if (i4 == 5002010) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:103:0x03ea  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:96:0x03b7  */
    /* JADX WARNING: Removed duplicated region for block: B:98:0x03bb  */
    ...
    public final void a(com.mbridge.msdk.video.dynview.c r36, android.view.View r37, java.util.Map r38, com.mbridge.msdk.video.dynview.e.e r39) {
        /*
            ...
            r5 = r38
            r8 = r39
            java.util.Map<java.lang.String, android.graphics.Bitmap> r0 = r1.f16087c
        ...
        L_0x002d:
            ...
            int r4 = com.mbridge.msdk.foundation.same.report.d.a.f13389a
            r3.setShowIndex(r4)
            ...
            int r12 = com.mbridge.msdk.foundation.same.report.d.a.f13390b
            r4.setShowIndex(r12)
            r15 = r3
            goto L_0x0051
        L_0x004f:
        ...
        L_0x02fc:
            ...
            r2.setTextSize(r0)
            java.lang.String r0 = r1.f16089e
            int r0 = android.graphics.Color.parseColor(r0)
            r2.setTextColor(r0)
            java.lang.String r0 = r1.f16090f
            ...
            com.mbridge.msdk.video.dynview.i.c.a r2 = r1.f16094k
    ...
    private void b() {
        ...
        com.mbridge.msdk.video.dynview.b.a.a().f15985a = null;
        if (this.f16085a != null) {
            this.f16085a = null;
        }
        Map<String, Bitmap> map = this.f16087c;
        if (map != null) {
            if (map.entrySet() != null) {
                try {
                    Iterator<Map.Entry<String, Bitmap>> it = this.f16087c.entrySet().iterator();
                    while (it.hasNext()) {
    ...
    private void a(final ImageView imageView, String str, final int i4) {
        if (!TextUtils.isEmpty(str) && imageView != null) {
            com.mbridge.msdk.foundation.same.c.b.a(imageView.getContext()).a(str, new com.mbridge.msdk.foundation.same.c.c() {
                public final void onFailedLoad(String str, String str2) {
                    try {
                        ...
                        imageView.setBackgroundColor(Color.parseColor(a.this.f16091g));
            ...
            public final void onSuccessLoad(Bitmap bitmap, String str) {
                ...
                if (bitmap != null && !bitmap.isRecycled() && (imageView = imageView2) != null) {
                    ...
                    if (a.this.f16087c != null) {
                        a.this.f16087c.put(SameMD5.getMD5(str2), bitmap);
    ...
    private Bitmap a() {
        ...
        try {
            ...
            bitmap.eraseColor(Color.parseColor(this.f16092h));
            return bitmap;
        } catch (Exception e5) {
    ...
    private void a(c cVar, View view) {
        a.C0204a a5 = com.mbridge.msdk.video.dynview.g.a.a();
        a5.a(cVar.e()).a(true);
        if (cVar.e() != 2) {
    ...
    static /* synthetic */ void a(a aVar, Map map, List list, int i4) {
        if (map != null && list != null && list.size() > 1) {
            if (map.containsKey("choice_one_callback") && (map.get("choice_one_callback") instanceof d)) {
                ...
                if (cVar != null) {
                    cVar.a((CampaignEx) list.get(i4), i4);
                }
                aVar.b();
            }
        }
    ...
    static /* synthetic */ void a(a aVar, c cVar, View view) {
        Map<String, Bitmap> map = aVar.f16087c;
        if (map != null && map.size() > 1) {
            new com.mbridge.msdk.video.dynview.h.b();
            Map<String, Bitmap> map2 = aVar.f16087c;
            if (view != null) {
