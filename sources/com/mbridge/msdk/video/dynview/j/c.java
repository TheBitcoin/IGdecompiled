...
public final class c {
    ...
    public final com.mbridge.msdk.video.dynview.c b(View view, CampaignEx campaignEx) {
        ...
        try {
            ...
            return new c.a().a("mbridge_reward_layer_floor_bottom").a(3).a((List<CampaignEx>) arrayList).a(view.getContext()).a(view).c(i4).b(ab.s(view.getContext())).a();
        } catch (Exception e5) {
    ...
    public final com.mbridge.msdk.video.dynview.c b(Context context, List<CampaignEx> list) {
        if (list != null) {
            try {
                if (list.size() != 0) {
                    float f4 = (float) ak.f(com.mbridge.msdk.foundation.controller.c.m().c());
                    ...
                    if (mof_tplid != 0 && !TextUtils.isEmpty(mof_template_url)) {
                        ...
                        arrayList = ad.a(a5, "template_" + mof_tplid + "_" + s4);
                    }
                    return new c.a().a(s4 == 1 ? "mbridge_order_layout_list_portrait" : "mbridge_order_layout_list_landscape").a(5).a(context).a(e5).b(f4).a(list).b(s4).b((List<String>) arrayList).e(dynamicTempCode).d(mof_tplid).a();
                }
            } catch (Exception e6) {
    ...
    public final com.mbridge.msdk.video.dynview.c b(Context context, CampaignEx campaignEx, int i4, String str) {
        if (campaignEx == null) {
            return null;
        }
        try {
            ...
            String str2 = s4 == 1 ? "mbridge_reward_endcard_native_half_portrait" : "mbridge_reward_endcard_native_half_landscape";
            String str3 = "template_" + str + s4 + "_" + ecTemplateId + "_half";
            List arrayList = new ArrayList();
            if (!TextUtils.isEmpty(campaignEx.getendcard_url())) {
                arrayList = ad.a(o.a(2, i4 + "", campaignEx.getendcard_url()), str3);
            }
            return new c.a().a(str2).a(4).a(context).b(ab.s(context)).b((List<String>) arrayList).e(campaignEx.getDynamicTempCode()).d(i4).b(str).g(a5).a();
        } catch (Exception e5) {
            af.b("ViewOptionWrapper", e5.getMessage());
            return null;
        }
    ...
    public final com.mbridge.msdk.video.dynview.c a(Context context, CampaignEx campaignEx, int i4, String str) {
        String str2;
        String str3;
        StringBuilder sb;
        if (campaignEx == null) {
        ...
        try {
            ...
            if (ecTemplateId == 1302) {
                ...
                str2 = sb.toString();
                str3 = "template_" + str + s4 + "_" + ecTemplateId;
            } else {
                str2 = s4 == 1 ? "mbridge_reward_end_card_layout_portrait" : "mbridge_reward_end_card_layout_landscape";
                str3 = "template_" + str + s4;
            }
            List arrayList = new ArrayList();
            if (!TextUtils.isEmpty(campaignEx.getendcard_url())) {
                arrayList = ad.a(o.a(2, i4 + "", campaignEx.getendcard_url()), str3);
    ...
    public final com.mbridge.msdk.video.dynview.c a(View view, CampaignEx campaignEx, boolean z4) {
        ...
        try {
            ...
            if (campaignEx.getRewardTemplateMode() != null) {
                i4 = campaignEx.getRewardTemplateMode().f();
            ...
            if (z4) {
                if (!(i4 == 0 || i4 == 102)) {
                    if (i4 != 202) {
                        str2 = "mbridge_reward_layer_floor_" + i4;
                    }
                }
            ...
            if (!TextUtils.isEmpty(str)) {
                arrayList = ad.a(o.a(1, i4 + "", str), "template_" + i4);
            }
            boolean a6 = a.a(str);
            ...
            return new c.a().a(str2).a(2).a((List<CampaignEx>) arrayList2).a(view.getContext()).a(view).c(i5).f(a5).b(ab.s(view.getContext())).d(i4).a(a6).c(a7).b((List<String>) arrayList).e(campaignEx.getDynamicTempCode()).a();
        } catch (Exception e5) {
            af.b("ViewOptionWrapper", e5.getMessage());
            return null;
        }
