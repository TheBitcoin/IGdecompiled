...
public class MOfferModel implements NoProGuard {
    ...
    private final String f16160E = "e";
    ...
    private final String f16161K = CampaignEx.JSON_KEY_AD_K;
    ...
    private OnItemExposeListener onItemExposeListener = new OnItemExposeListener() {
        ...
        public final void onItemViewVisible(boolean z4, int i4) {
            if (MOfferModel.this.viewMofferLayout != null) {
                if (MOfferModel.this.viewMofferLayout.getVisibility() == 0) {
                    ...
                    try {
                        com.mbridge.msdk.video.dynview.f.a.a(MOfferModel.this.mCampaignUnit, i4, 0, "117361");
                    } catch (Exception e5) {
                        e5.printStackTrace();
                    }
                } else {
                    ...
                    if (!MOfferModel.this.cacheImpressionReportList.contains(Integer.valueOf(i4))) {
                        MOfferModel.this.cacheImpressionReportList.add(Integer.valueOf(i4));
                    }
                }
            }
        }
    ...
    static /* synthetic */ int access$2208(MOfferModel mOfferModel) {
        int i4 = mOfferModel.bitmapSuccessCount;
        mOfferModel.bitmapSuccessCount = i4 + 1;
        return i4;
    }
    ...
    private View buildItemView(final int i4) {
        ...
        setOfferData(this.mCampaignUnit.getAds(), i4, (RoundImageView) inflate.findViewById(a5), (TextView) inflate.findViewById(x.a(this.mContext, "mbridge_reward_end_card_item_title_tv", "id")));
        inflate.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                CampaignEx campaignEx;
                try {
                    if (MOfferModel.this.mCampaignUnit != null && MOfferModel.this.mCampaignUnit.ads != null && MOfferModel.this.mCampaignUnit.ads.size() > 0 && (campaignEx = MOfferModel.this.mCampaignUnit.ads.get(i4)) != null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x018a  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:51:0x0263  */
    ...
    private void buildRequestParams(com.mbridge.msdk.foundation.entity.CampaignEx r28) {
        ...
        L_0x01ac:
            ...
            r2.put(r0, r3)     // Catch:{ Exception -> 0x01ee }
            java.lang.String r0 = "crt_rid"
            r2.put(r0, r4)     // Catch:{ Exception -> 0x01ee }
            r2.put(r13, r12)     // Catch:{ Exception -> 0x01ee }
            r0 = r16
            r2.put(r0, r14)     // Catch:{ Exception -> 0x01ee }
            r4 = r19
            r0 = r23
            r2.put(r0, r4)     // Catch:{ Exception -> 0x01ee }
            r0 = r20
    ...
    private void buildScrollViewGroup() {
        if (this.mContext != null && this.viewMofferLayout != null && this.mMainOfferCampaignEx != null) {
            ...
            for (int i4 = 0; i4 < this.mCampaignUnit.ads.size(); i4++) {
                View buildItemView = buildItemView(i4);
        ...
        if (campaignUnit != null) {
            try {
                ...
                if (this.mCampaignUnit.getAds() != null) {
                    ...
                    for (int i4 = 0; i4 < this.admf; i4++) {
                        if (!this.mImpressionId.contains(Integer.valueOf(i4))) {
                            com.mbridge.msdk.video.dynview.f.a.a(this.mCampaignUnit, i4, 0, "117361");
                            this.mImpressionId.add(Integer.valueOf(i4));
                        }
                    }
                }
            } catch (Exception e5) {
    ...
    private void doControllableImpOnShow(int i4) {
        CampaignUnit campaignUnit = this.mCampaignUnit;
        if (campaignUnit != null && campaignUnit.getAds() != null) {
            try {
                int size = this.mCampaignUnit.getAds().size();
                if (this.mControlShowSize == 0) {
                    this.mControlShowSize = this.admf + i4;
                }
                if (this.mControlShowSize >= size) {
                    this.mControlShowSize = size;
                }
                while (i4 < this.mControlShowSize) {
                    if (!this.mImpressionId.contains(Integer.valueOf(i4))) {
                        com.mbridge.msdk.video.dynview.f.a.a(this.mCampaignUnit, i4, 0, "117361");
                        this.mImpressionId.add(Integer.valueOf(i4));
                    }
    ...
    private void initData() {
        ...
        if (campaignEx != null && this.mContext != null) {
            ...
            if (this.mParam != null) {
                    ...
                    public final void a(int i4, String str) {
                        ...
                        try {
                            ...
                            if (!MOfferModel.this.hasReportMoreOfferLoad) {
                                ...
                                Context c5 = c.m().c();
                                com.mbridge.msdk.video.dynview.f.a.a(access$200, c5, "more offer load failed errorCode:" + i4 + "errorMsg:" + str, MOfferModel.this.mUnitId, MOfferModel.this.mRid);
                ...
                String str = com.mbridge.msdk.foundation.same.net.e.d.f().f13297M;
                if (!TextUtils.isEmpty(this.mMainOfferCampaignEx.getReq_ext_data())) {
                    try {
                        ...
                        af.b(TAG, e5.getMessage());
                        str = com.mbridge.msdk.foundation.same.net.e.d.f().f13297M;
                    }
                }
                String str2 = str;
                com.mbridge.msdk.foundation.same.report.d.e eVar = new com.mbridge.msdk.foundation.same.report.d.e();
    ...
    private void setCallbackForLogicVisibleView(View view, int i4) {
        boolean z4;
        if (view != null) {
            try {
                Rect rect = new Rect();
                ...
                if (globalVisibleRect && z4) {
                    ...
                    if (list != null && this.onItemExposeListener != null) {
                        if (!list.contains(Integer.valueOf(i4))) {
                            this.mImpressionId.add(Integer.valueOf(i4));
                            this.onItemExposeListener.onItemViewVisible(true, i4);
                        }
                    }
                } else if (this.admf != 0) {
                    doControllableImpOnShow(i4);
                }
            } catch (Exception e5) {
                af.b(TAG, e5.getMessage());
            }
        ...
        if (mBridgeRelativeLayout != null) {
            mBridgeRelativeLayout.setMoreOfferCacheReportCallBack(new b() {
                public final void a() {
                    try {
                        if (MOfferModel.this.cacheImpressionReportList != null) {
                            for (int i4 = 0; i4 < MOfferModel.this.cacheImpressionReportList.size(); i4++) {
                                if (!MOfferModel.this.hasReportMoreOfferShow) {
                                ...
                                com.mbridge.msdk.video.dynview.f.a.a(MOfferModel.this.mCampaignUnit, ((Integer) MOfferModel.this.cacheImpressionReportList.get(i4)).intValue(), 0, "117361");
                            }
                        }
                        if (!MOfferModel.this.isOnlyImpShow && MOfferModel.this.cacheOnlyImpressionReportList != null) {
                            for (int i5 = 0; i5 < MOfferModel.this.cacheOnlyImpressionReportList.size(); i5++) {
                                com.mbridge.msdk.video.dynview.f.a.a(MOfferModel.this.mCampaignUnit, ((Integer) MOfferModel.this.cacheOnlyImpressionReportList.get(i5)).intValue(), 1, "117361");
                            }
                        }
    ...
    private void setOfferData(List<CampaignEx> list, int i4, final RoundImageView roundImageView, TextView textView) {
        CampaignEx campaignEx;
        if (roundImageView != null && textView != null && list != null && this.mContext != null && this.mMainOfferCampaignEx != null && list.size() > 0 && (campaignEx = list.get(i4)) != null) {
    ...
    public void checkViewVisiableState() {
        if (this.mLinearLayout != null) {
            int i4 = 0;
            while (i4 < this.mLinearLayout.getChildCount()) {
                try {
                    setCallbackForLogicVisibleView(this.mLinearLayout.getChildAt(i4), i4);
                    i4++;
                } catch (Exception e5) {
                    af.b(TAG, e5.getMessage());
                    return;
