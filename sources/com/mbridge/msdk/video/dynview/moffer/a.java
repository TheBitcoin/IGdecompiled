...
public class a {
    ...
    private static volatile a f16174a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, SoftReference<MOfferModel>> f16175b = new ConcurrentHashMap();

    /* renamed from: c  reason: collision with root package name */
    private int f16176c = 500;
    ...
    public final void b() {
        ...
        try {
            Map<String, SoftReference<MOfferModel>> map = this.f16175b;
            if (map != null) {
    ...
    public final void a(final ViewGroup viewGroup, String str, com.mbridge.msdk.video.module.a.a aVar) {
        if (viewGroup != null && aVar != null && this.f16175b != null && !TextUtils.isEmpty(str) && this.f16175b.containsKey(str)) {
            SoftReference softReference = this.f16175b.get(str);
    ...
    public final void a(CampaignEx campaignEx, final ViewGroup viewGroup, com.mbridge.msdk.video.module.a.a aVar, int i4) {
        if (campaignEx != null) {
            String str = campaignEx.getRequestId() + "_" + campaignEx.getId();
            if (this.f16175b == null) {
                this.f16175b = new ConcurrentHashMap();
    ...
    public final boolean a(String str) {
        if (this.f16175b == null || TextUtils.isEmpty(str)) {
            return false;
        }
        return this.f16175b.containsKey(str);
    }
            ...
            if (mOfferModel2.getECParentTemplateCode() == 1302) {
                try {
                    if (mOfferModel2.getmMainOfferCampaignEx() == null || mOfferModel2.getmMainOfferCampaignEx().getRewardTemplateMode() == null) {
                        ...
                        i4 = mOfferModel2.getmMainOfferCampaignEx().getRewardTemplateMode().b();
                        if (i4 == 0) {
                            i4 = ab.s(c.m().c());
                        }
                    }
                    if (i4 != 1 && (viewGroup3 instanceof MBridgeNativeEndCardView)) {
                        ...
                        int g4 = ak.g(c.m().c()) - ak.a(c.m().c(), 220.0f);
                        RelativeLayout.LayoutParams layoutParams3 = (RelativeLayout.LayoutParams) imageView2.getLayoutParams();
                        layoutParams3.height = g4;
                        layoutParams3.width = (g4 * 16) / 9;
                    ...
                    if (viewGroup3 instanceof MBridgeNativeEndCardView) {
                        ...
                        new b().a(arrayList, 0, ak.a(c.m().c(), 100.0f), (long) aVar2.f16176c);
                    } else {
                ...
                try {
                    if (viewGroup3 instanceof MBridgeNativeEndCardView) {
                        ...
                        new b().a(arrayList2, 0, ak.a(c.m().c(), 100.0f), (long) aVar2.f16176c);
                    }
