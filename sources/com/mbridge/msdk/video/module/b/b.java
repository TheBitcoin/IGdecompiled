...
public final class b {
    ...
    public static HashMap<String, ArrayList<String>> f16575a = new HashMap<>();
    ...
    public static void d(Context context, CampaignEx campaignEx) {
        if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && campaignEx.getNativeVideoTracking().l() != null) {
            ...
            ArrayList arrayList = f16575a.get(campaignUnitId);
            if (arrayList == null) {
                arrayList = new ArrayList();
                f16575a.put(campaignUnitId, arrayList);
            }
    ...
    public static void a(Context context, CampaignEx campaignEx, int i4, int i5, int i6) {
        ...
        if (i5 != 0 && context != null && campaignEx != null) {
            try {
                List<Map<Integer, String>> i8 = campaignEx.getNativeVideoTracking().i();
                int i9 = ((i4 + 1) * 100) / i5;
                if (i8 != null) {
                    int i10 = 0;
                    int i11 = 0;
                        ...
                        if (map != null && map.size() > 0) {
                            ...
                            while (it.hasNext()) {
                                ...
                                if (campaignEx.getSpareOfferFlag() == 1) {
                                    str = str2 + "&to=1&cbt=" + campaignEx.getCbt() + "&tmorl=" + i7;
                                } else {
                                    str = str2 + "&to=0&cbt=" + campaignEx.getCbt() + "&tmorl=" + i7;
                                }
                                if (intValue <= i9 && !TextUtils.isEmpty(str)) {
                                    String[] strArr = {str};
                                    if (i11 < 1) {
                                        i11++;
                                        try {
            ...
            try {
                if (map.size() > 0) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (i4 != ((Integer) next.getKey()).intValue() || TextUtils.isEmpty(str3)) {
