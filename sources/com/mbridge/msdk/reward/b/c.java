...
public final class c implements Runnable {
    ...
    public final void run() {
        ...
        if (this.f15353a != null && !TextUtils.isEmpty(this.f15354b)) {
            try {
                ...
                b.a().c(this.f15354b);
                if (!ah.a().a("c_d_v_w_i", false) && !TextUtils.isEmpty(this.f15354b) && (a5 = a.a().a(this.f15354b, 1)) != null && a5.size() > 0) {
                    com.mbridge.msdk.videocommon.download.b.getInstance().createUnitCache(this.f15353a, this.f15354b, a5, 94, (com.mbridge.msdk.videocommon.listener.a) null);
                }
            } catch (Exception e6) {
