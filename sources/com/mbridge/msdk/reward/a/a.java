...
public final class a {
    ...
    private static String f14963a = "RewardCandidateController";
    ...
    public a(String str, boolean z4) {
        try {
            this.f14964b = b.a().a(str, com.mbridge.msdk.videocommon.d.b.a().a(c.m().k(), str, z4).G());
        } catch (Exception e5) {
            e5.printStackTrace();
        }
    }
    ...
    public final void a(List<CampaignEx> list, String str, com.mbridge.msdk.reward.adapter.c cVar, String str2) {
        String str3 = str;
        try {
            if (this.f14964b != null && !TextUtils.isEmpty(str3)) {
                List<CampaignEx> list2 = list;
                this.f14964b.a(com.mbridge.msdk.foundation.b.a.f12716b, 2, list2, this.f14964b.a(list2, str3) > 0, "", "", -1, str2);
                d dVar = this.f14964b;
                JSONObject a5 = dVar.a(dVar.b(str3));
                if (a5 != null && this.f14964b.d(str3) > 0.0d) {
                    int optInt = a5.optInt("max_usage_limit", 10);
                    int optInt2 = a5.optInt("max_cache_num", 20);
                    a(this.f14964b.a(optInt, 0), a5, optInt2, -1.0d, cVar, new com.mbridge.msdk.foundation.same.report.d.c(), str3, false, 0);
                }
            }
        } catch (Exception e5) {
            e5.printStackTrace();
    ...
    public final com.mbridge.msdk.foundation.b.c a(String str, com.mbridge.msdk.foundation.same.report.d.c cVar, CampaignEx campaignEx, com.mbridge.msdk.foundation.c.b bVar, int i4, com.mbridge.msdk.reward.adapter.c cVar2) {
        String str2;
        String str3;
        int i5;
        String str4 = str;
        ...
        if (campaignEx == null) {
            ...
            try {
                ...
                try {
                    ...
                    cVar3.a(com.mbridge.msdk.foundation.b.c.f12737c);
                    return cVar3;
        ...
        if (dVar == null) {
            ...
            cVar4.a(com.mbridge.msdk.foundation.b.c.f12737c);
            return cVar4;
        }
        com.mbridge.msdk.foundation.b.c c5 = dVar.c(str4);
        if (c5.g() <= com.mbridge.msdk.foundation.b.c.f12736b) {
            ...
            c5 = a(d5, str7, cVar2, cVar, str4, i4);
            this.f14964b.a(c5.a(), cVar, str2, i5, str6, i4, d5);
        }
        return c5;
    }

    private com.mbridge.msdk.foundation.b.c a(double d5, String str, com.mbridge.msdk.reward.adapter.c cVar, com.mbridge.msdk.foundation.same.report.d.c cVar2, String str2, int i4) {
        com.mbridge.msdk.foundation.b.c cVar3;
        com.mbridge.msdk.foundation.b.c a5 = this.f14964b.a();
        try {
            if (a5.g() > 0) {
                return a5;
            }
            JSONObject a6 = this.f14964b.a(str);
            if (a6 != null) {
                ...
                if (optInt2 > 0) {
                    ...
                    List<com.mbridge.msdk.foundation.b.b> a7 = this.f14964b.a(optInt, System.currentTimeMillis() - (j4 * 1000));
                    if (a7 != null && a7.size() > 0) {
                        return a(a7, a6, optInt2, d5, cVar, cVar2, str2, true, i4);
                    }
                    a5.d("no cache");
                    a5.a(com.mbridge.msdk.foundation.b.c.f12737c);
                    cVar3 = a5;
                    try {
                        a(cVar2, str2, cVar3, (List<a.C0178a>) null, a6, 2);
                        return cVar3;
                    } catch (Exception unused) {
    ...
    private com.mbridge.msdk.foundation.b.c a(List<com.mbridge.msdk.foundation.b.b> list, JSONObject jSONObject, int i4, double d5, com.mbridge.msdk.reward.adapter.c cVar, com.mbridge.msdk.foundation.same.report.d.c cVar2, String str, boolean z4, int i5) {
        ...
        if (jSONObject2 == null) {
            ...
            for (int i7 = 0; i7 < list3.size(); i7++) {
                com.mbridge.msdk.foundation.b.b bVar = list3.get(i7);
                if (bVar != null) {
                    cVar3.a(bVar.e());
                }
            }
            ...
            if (list3 != null && list3.size() > 0) {
                ...
                int i8 = 0;
                while (i8 < size) {
                    com.mbridge.msdk.foundation.b.b bVar3 = list3.get(i8);
                    if (bVar3 != null) {
                        i6 = i8;
                        ...
                        list2 = list3;
                        arrayList2.add(new a.C0178a(pow, bVar3));
                ...
                d dVar = this.f14964b;
                if (dVar != null) {
                    dVar.a((List<a.C0178a>) arrayList2, i4);
                }
                if (bVar2 != null) {
                    cVar3.a(bVar2.b());
                    cVar3.a(com.mbridge.msdk.foundation.b.c.f12738d);
                } else {
            ...
            if (z4) {
                a(cVar2, str, cVar3, (List<a.C0178a>) arrayList, jSONObject, 2);
            }
            return cVar3;
        }
    }
    ...
    private List<com.mbridge.msdk.foundation.b.b> a(List<com.mbridge.msdk.foundation.b.b> list, com.mbridge.msdk.foundation.b.c cVar) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            com.mbridge.msdk.foundation.b.b bVar = list.get(i4);
            if (!(bVar == null || (b5 = bVar.b()) == null || b5.size() == 0)) {
                ...
                while (true) {
                    ...
                    CampaignEx campaignEx = b5.get(i5);
    ...
    private java.util.List<com.mbridge.msdk.foundation.b.b> a(java.util.List<com.mbridge.msdk.foundation.b.b> r11, com.mbridge.msdk.reward.adapter.c r12, com.mbridge.msdk.foundation.b.c r13) {
        ...
        L_0x002f:
            ...
            r13.b(r4)
            com.mbridge.msdk.foundation.b.d r4 = r10.f14964b
    ...
    public final void a(String str, String str2, int i4, String str3) {
        d dVar = this.f14964b;
        if (dVar != null) {
            dVar.a(str, str2, i4, str3);
        }
    }

    public final void a(com.mbridge.msdk.foundation.same.report.d.c cVar, String str, com.mbridge.msdk.foundation.b.c cVar2, List<a.C0178a> list, JSONObject jSONObject, int i4) {
        String str2;
        try {
            e eVar = new e();
            if (i4 == 1) {
            ...
            if (cVar2 != null) {
                if (cVar2.g() == com.mbridge.msdk.foundation.b.c.f12738d) {
                    eVar.a("result", 1);
                } else {
                    eVar.a("result", 2);
            ...
            if (list != null && list.size() > 0) {
                ...
                for (int i5 = 0; i5 < list.size(); i5++) {
                    com.mbridge.msdk.foundation.b.b a6 = list.get(i5).a();
                    if (a6 != null) {
