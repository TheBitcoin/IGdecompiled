...
public abstract class SegmentDownloadAction<K extends Comparable<K>> extends DownloadAction {
    ...
    protected static abstract class SegmentDownloadActionDeserializer<K> extends DownloadAction.Deserializer {
        public SegmentDownloadActionDeserializer(String str, int i4) {
            super(str, i4);
        }
        ...
        public final DownloadAction readFromStream(int i4, DataInputStream dataInputStream) throws IOException {
    ...
    protected SegmentDownloadAction(String str, int i4, Uri uri, boolean z4, @Nullable byte[] bArr, List<K> list) {
        super(str, i4, uri, z4, bArr);
        if (z4) {
    ...
    /* access modifiers changed from: protected */
    public abstract void writeKey(DataOutputStream dataOutputStream, K k4) throws IOException;
    ...
    public final void writeToStream(DataOutputStream dataOutputStream) throws IOException {
        ...
        for (int i4 = 0; i4 < this.keys.size(); i4++) {
            writeKey(dataOutputStream, (Comparable) this.keys.get(i4));
        }
    }
}
