...
public abstract class DownloadAction {
    ...
    public static abstract class Deserializer {
        ...
        public abstract DownloadAction readFromStream(int i4, DataInputStream dataInputStream) throws IOException;
    }

    protected DownloadAction(String str, int i4, Uri uri2, boolean z4, @Nullable byte[] bArr) {
        this.type = str;
        this.version = i4;
        this.uri = uri2;
