...
public final class Util {
    ...
    public static long addWithOverflowDefault(long j4, long j5, long j6) {
        long j7 = j4 + j5;
        return ((j4 ^ j7) & (j5 ^ j7)) < 0 ? j6 : j7;
    }
    ...
    public static int constrainValue(int i4, int i5, int i6) {
    ...
    public static int crc(byte[] bArr, int i4, int i5, int i6) {
        while (i4 < i5) {
            i6 = CRC32_BYTES_MSBF[((i6 >>> 24) ^ (bArr[i4] & 255)) & 255] ^ (i6 << 8);
            i4++;
        }
        return i6;
    }
    ...
    public static String escapeFileName(String str) {
        ...
        StringBuilder sb = new StringBuilder((i5 * 2) + length);
        while (i5 > 0) {
            int i7 = i4 + 1;
    ...
    public static int getAudioContentTypeForStreamType(int i4) {
        if (i4 != 0) {
    ...
    public static int getAudioUsageForStreamType(int i4) {
        if (i4 == 0) {
            return 2;
        }
        if (i4 == 1) {
    ...
    public static String getCodecsOfType(String str, int i4) {
        ...
        for (String str2 : split) {
            if (i4 == MimeTypes.getTrackTypeOfCodec(str2)) {
                if (sb.length() > 0) {
                    sb.append(",");
                }
                sb.append(str2);
    ...
    public static int getDefaultBufferSize(int i4) {
        if (i4 == 0) {
            return 16777216;
        }
        if (i4 == 1) {
    ...
    private static void getDisplaySizeV23(Display display, Point point) {
        Display.Mode a5 = display.getMode();
        point.x = a5.getPhysicalWidth();
        point.y = a5.getPhysicalHeight();
    }
    ...
    public static int getIntegerCodeForString(String str) {
        ...
        char c5 = 0;
        for (int i4 = 0; i4 < length; i4++) {
            c5 = (c5 << 8) | str.charAt(i4);
        }
        return c5;
    }

    public static long getMediaDurationForPlayoutDuration(long j4, float f4) {
        if (f4 == 1.0f) {
            return j4;
        }
        return Math.round(((double) j4) * ((double) f4));
    }

    public static int getPcmEncoding(int i4) {
        if (i4 == 8) {
            return 3;
        }
        if (i4 == 16) {
    ...
    public static long getPlayoutDurationForMediaDuration(long j4, float f4) {
        if (f4 == 1.0f) {
            return j4;
        }
        return Math.round(((double) j4) / ((double) f4));
    ...
    public static int getStreamTypeForAudioUsage(int i4) {
        if (i4 == 13) {
            return 1;
        }
        switch (i4) {
    ...
    public static String getStringForTime(StringBuilder sb, Formatter formatter, long j4) {
        if (j4 == C.TIME_UNSET) {
            j4 = 0;
        }
        long j5 = (j4 + 500) / 1000;
        ...
        sb.setLength(0);
        if (j8 > 0) {
            return formatter.format("%d:%02d:%02d", new Object[]{Long.valueOf(j8), Long.valueOf(j7), Long.valueOf(j6)}).toString();
        }
        return formatter.format("%02d:%02d", new Object[]{Long.valueOf(j7), Long.valueOf(j6)}).toString();
    }
    ...
    public static boolean isEncodingHighResolutionIntegerPcm(int i4) {
        return i4 == Integer.MIN_VALUE || i4 == 1073741824;
    }

    public static boolean isEncodingPcm(int i4) {
        return i4 == 3 || i4 == 2 || i4 == Integer.MIN_VALUE || i4 == 1073741824 || i4 == 4;
    }

    public static boolean isLinebreak(int i4) {
        return i4 == 10 || i4 == 13;
    }
    ...
    public static <T> T[] nullSafeArrayCopy(T[] tArr, int i4) {
        boolean z4;
        if (i4 <= tArr.length) {
            z4 = true;
        } else {
    ...
    public static long parseXsDateTime(String str) throws ParserException {
        ...
        if (matcher.matches()) {
            ...
            if (i4 != 0) {
                return timeInMillis - ((long) (i4 * MBridgeCommon.DEFAULT_LOAD_TIMEOUT));
            }
            return timeInMillis;
        }
    ...
    public static <T> void removeRange(List<T> list, int i4, int i5) {
    ...
    public static long scaleLargeTimestamp(long j4, long j5, long j6) {
        ...
        return (long) (((double) j4) * (((double) j5) / ((double) j6)));
    }

    public static long[] scaleLargeTimestamps(List<Long> list, long j4, long j5) {
        int size = list.size();
        long[] jArr = new long[size];
        int i4 = 0;
        int i5 = (j5 > j4 ? 1 : (j5 == j4 ? 0 : -1));
        if (i5 >= 0 && j5 % j4 == 0) {
            long j6 = j5 / j4;
            while (i4 < size) {
                jArr[i4] = list.get(i4).longValue() / j6;
                i4++;
            }
        } else if (i5 >= 0 || j4 % j5 != 0) {
            double d5 = ((double) j4) / ((double) j5);
            while (i4 < size) {
                jArr[i4] = (long) (((double) list.get(i4).longValue()) * d5);
                i4++;
            }
        } else {
            long j7 = j4 / j5;
            while (i4 < size) {
                jArr[i4] = list.get(i4).longValue() * j7;
                i4++;
            }
        }
        return jArr;
    ...
    public static void scaleLargeTimestampsInPlace(long[] jArr, long j4, long j5) {
        int i4 = 0;
        int i5 = (j5 > j4 ? 1 : (j5 == j4 ? 0 : -1));
        if (i5 >= 0 && j5 % j4 == 0) {
            long j6 = j5 / j4;
            ...
            double d5 = ((double) j4) / ((double) j5);
            while (i4 < jArr.length) {
                jArr[i4] = (long) (((double) jArr[i4]) * d5);
                i4++;
            }
        } else {
            long j7 = j4 / j5;
    ...
    public static long subtractWithOverflowDefault(long j4, long j5, long j6) {
        long j7 = j4 - j5;
        return ((j4 ^ j7) & (j5 ^ j4)) < 0 ? j6 : j7;
    }
    ...
    public static String unescapeFileName(String str) {
        ...
        while (i5 > 0 && matcher.find()) {
            sb.append(str, i4, matcher.start());
    ...
    public static long ceilDivide(long j4, long j5) {
        return ((j4 + j5) - 1) / j5;
    }
    ...
    public static long constrainValue(long j4, long j5, long j6) {
        return Math.max(j5, Math.min(j4, j6));
    }

    public static String fromUtf8Bytes(byte[] bArr, int i4, int i5) {
        return new String(bArr, i4, i5, Charset.forName(C.UTF8_NAME));
    }

    public static float constrainValue(float f4, float f5, float f6) {
    ...
    public static android.graphics.Point getPhysicalDisplaySize(android.content.Context r6, android.view.Display r7) {
        /*
            ...
            java.lang.String r5 = "BRAVIA"
            boolean r4 = r4.startsWith(r5)
            if (r4 == 0) goto L_0x003a
            android.content.pm.PackageManager r6 = r6.getPackageManager()
            java.lang.String r4 = "com.sony.dtv.hardware.panel.qfhd"
            boolean r6 = r6.hasSystemFeature(r4)
        ...
        L_0x004c:
            ...
            java.lang.String r3 = toLowerInvariant(r3)
            boolean r6 = r6.equals(r3)
        ...
        L_0x0072:
            ...
            java.lang.Class r6 = java.lang.Class.forName(r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r3 = "get"
            java.lang.Class[] r4 = new java.lang.Class[r1]     // Catch:{ Exception -> 0x0091 }
            java.lang.Class<java.lang.String> r5 = java.lang.String.class
            r4[r0] = r5     // Catch:{ Exception -> 0x0091 }
            java.lang.reflect.Method r3 = r6.getMethod(r3, r4)     // Catch:{ Exception -> 0x0091 }
            java.lang.Object[] r4 = new java.lang.Object[r1]     // Catch:{ Exception -> 0x0091 }
            java.lang.String r5 = "sys.display-size"
            r4[r0] = r5     // Catch:{ Exception -> 0x0091 }
            java.lang.Object r6 = r3.invoke(r6, r4)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = (java.lang.String) r6     // Catch:{ Exception -> 0x0091 }
            goto L_0x0098
        L_0x0091:
            r6 = move-exception
        ...
        L_0x0098:
            ...
            if (r3 != 0) goto L_0x00d6
            java.lang.String r3 = r6.trim()     // Catch:{ NumberFormatException -> 0x00c2 }
            ...
            r3.<init>(r0, r1)     // Catch:{ NumberFormatException -> 0x00c2 }
            return r3
        L_0x00c2:
