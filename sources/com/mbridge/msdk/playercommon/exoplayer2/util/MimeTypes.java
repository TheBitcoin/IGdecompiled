...
public final class MimeTypes {
    ...
    private static final class CustomMimeType {
        ...
        public CustomMimeType(String str, String str2, int i4) {
            this.mimeType = str;
    ...
    private static String getCustomMimeTypeForCodec(String str) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            CustomMimeType customMimeType = customMimeTypes.get(i4);
    ...
    @Nullable
    public static String getMimeTypeFromMp4ObjectType(int i4) {
        if (i4 == 32) {
            return VIDEO_MP4V;
        }
        if (i4 == 33) {
    ...
    public static void registerCustomMimeType(String str, String str2, int i4) {
        CustomMimeType customMimeType = new CustomMimeType(str, str2, i4);
        int size = customMimeTypes.size();
        int i5 = 0;
        while (true) {
            if (i5 >= size) {
            ...
            if (str.equals(arrayList.get(i5).mimeType)) {
                arrayList.remove(i5);
                break;
            }
            i5++;
