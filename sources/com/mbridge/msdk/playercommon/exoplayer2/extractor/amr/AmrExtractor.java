...
public final class AmrExtractor implements Extractor {
    ...
    static int frameSizeBytesByTypeNb(int i4) {
        return frameSizeBytesByTypeNb[i4];
    }

    static int frameSizeBytesByTypeWb(int i4) {
    ...
    private boolean isValidFrameType(int i4) {
        ...
        if (isWideBandValidFrameType(i4) || isNarrowBandValidFrameType(i4)) {
            return true;
        }
        return false;
    }
    ...
    private void maybeOutputFormat() {
        ...
        if (!this.hasOutputFormat) {
            ...
            this.trackOutput.format(Format.createAudioSampleFormat((String) null, str2, (String) null, -1, MAX_FRAME_SIZE_BYTES, 1, i4, -1, (List<byte[]>) null, (DrmInitData) null, 0, (String) null));
        }
    }
