...
final class SeiReader {
    ...
    public final void consume(long j4, ParsableByteArray parsableByteArray) {
        CeaUtil.consume(j4, parsableByteArray, this.outputs);
    }
    ...
    public final void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator trackIdGenerator) {
        ...
        for (int i4 = 0; i4 < this.outputs.length; i4++) {
            ...
            Format format = this.closedCaptionFormats.get(i4);
