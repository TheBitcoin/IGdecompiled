...
public final class H264Reader implements ElementaryStreamReader {
    ...
    private static final class SampleReader {
        ...
        private static final class SliceHeaderData {
            ...
            public final void setAll(NalUnitUtil.SpsData spsData2, int i4, int i5, int i6, int i7, boolean z4, boolean z5, boolean z6, boolean z7, int i8, int i9, int i10, int i11, int i12) {
            ...
            public final void setSliceType(int i4) {
                this.sliceType = i4;
                this.hasSliceType = true;
            }
        }
        ...
        public final void endNalUnit(long j4, int i4) {
            ...
            int i5 = this.nalUnitType;
            if (i5 == 5 || (this.allowNonIdrKeyframes && i5 == 1 && this.sliceHeader.isISlice())) {
                z4 = true;
            }
        ...
        public final void startNalUnit(long j4, int i4, long j5) {
            this.nalUnitType = i4;
            this.nalUnitTimeUs = j5;
            this.nalUnitStartPosition = j4;
            if (!this.allowNonIdrKeyframes || i4 != 1) {
    ...
    public final void consume(ParsableByteArray parsableByteArray) {
        ...
        while (true) {
            ...
            endNalUnit(j4, i6, i4, this.pesTimeUs);
