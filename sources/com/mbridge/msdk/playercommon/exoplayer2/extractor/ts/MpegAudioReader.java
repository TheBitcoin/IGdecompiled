    ...
    private void readHeaderRemainder(ParsableByteArray parsableByteArray) {
        ...
        if (i4 >= 4) {
            ...
            if (!this.hasOutputFormat) {
                ...
                this.frameDurationUs = (((long) mpegAudioHeader.samplesPerFrame) * 1000000) / ((long) i5);
                this.output.format(Format.createAudioSampleFormat(this.formatId, mpegAudioHeader.mimeType, (String) null, -1, 4096, mpegAudioHeader.channels, i5, (List<byte[]>) null, (DrmInitData) null, 0, this.language));
