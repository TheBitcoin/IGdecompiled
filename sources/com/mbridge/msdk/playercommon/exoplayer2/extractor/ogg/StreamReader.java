...
abstract class StreamReader {
    ...
    private int readPayload(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        if (this.lengthOfReadPacket > 0 || this.oggPacket.populate(extractorInput2)) {
            ...
            if (preparePayload >= 0) {
                ...
                if (j4 + preparePayload >= this.targetGranule) {
                    long convertGranuleToTime = convertGranuleToTime(j4);
    ...
    public long convertGranuleToTime(long j4) {
        return (j4 * 1000000) / ((long) this.sampleRate);
    }

    /* access modifiers changed from: protected */
    public long convertTimeToGranule(long j4) {
        return (((long) this.sampleRate) * j4) / 1000000;
    }
    ...
    /* access modifiers changed from: protected */
    public abstract boolean readHeaders(ParsableByteArray parsableByteArray, long j4, SetupData setupData2) throws IOException, InterruptedException;
    ...
    public final void seek(long j4, long j5) {
        ...
        if (j4 == 0) {
            ...
            this.targetGranule = this.oggSeeker.startSeek(j5);
            this.state = 2;
        }
    }
}
