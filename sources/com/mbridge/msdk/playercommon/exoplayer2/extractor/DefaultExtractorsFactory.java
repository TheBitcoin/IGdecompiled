...
public final class DefaultExtractorsFactory implements ExtractorsFactory {
    ...
    public final synchronized DefaultExtractorsFactory setFragmentedMp4ExtractorFlags(int i4) {
        this.fragmentedMp4Flags = i4;
        return this;
    }

    public final synchronized DefaultExtractorsFactory setMatroskaExtractorFlags(int i4) {
        this.matroskaFlags = i4;
        return this;
    }

    public final synchronized DefaultExtractorsFactory setMp3ExtractorFlags(int i4) {
        this.mp3Flags = i4;
        return this;
    }

    public final synchronized DefaultExtractorsFactory setMp4ExtractorFlags(int i4) {
        this.mp4Flags = i4;
        return this;
    }

    public final synchronized DefaultExtractorsFactory setTsExtractorFlags(int i4) {
        this.tsFlags = i4;
        return this;
    }

    public final synchronized DefaultExtractorsFactory setTsExtractorMode(int i4) {
        this.tsMode = i4;
        return this;
    }
}
