...
abstract class Atom {
    ...
    static final class ContainerAtom extends Atom {
        ...
        public final int getChildAtomOfTypeCount(int i4) {
        ...
        public final ContainerAtom getContainerAtomOfType(int i4) {
            int size = this.containerChildren.size();
            for (int i5 = 0; i5 < size; i5++) {
                ContainerAtom containerAtom = this.containerChildren.get(i5);
                if (containerAtom.type == i4) {
        ...
        public final LeafAtom getLeafAtomOfType(int i4) {
            int size = this.leafChildren.size();
            for (int i5 = 0; i5 < size; i5++) {
                LeafAtom leafAtom = this.leafChildren.get(i5);
                if (leafAtom.type == i4) {
                    return leafAtom;
                }
            }
    ...
    public static String getAtomTypeString(int i4) {
        return "" + ((char) ((i4 >> 24) & 255)) + ((char) ((i4 >> 16) & 255)) + ((char) ((i4 >> 8) & 255)) + ((char) (i4 & 255));
    }

    public static int parseFullAtomFlags(int i4) {
        return i4 & ViewCompat.MEASURED_SIZE_MASK;
    }

    public static int parseFullAtomVersion(int i4) {
        return (i4 >> 24) & 255;
    }
