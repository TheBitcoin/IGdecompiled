...
public final class TrackEncryptionBox {
    ...
    public TrackEncryptionBox(boolean z4, @Nullable String str, int i4, byte[] bArr, int i5, int i6, @Nullable byte[] bArr2) {
        boolean z5;
        boolean z6 = false;
        if (i4 == 0) {
            z5 = true;
        ...
        this.cryptoData = new TrackOutput.CryptoData(schemeToCryptoMode(str), bArr, i5, i6);
    }
