...
final class MetadataUtil {
    ...
    private static CommentFrame parseCommentAttribute(int i4, ParsableByteArray parsableByteArray) {
        ...
        Log.w(TAG, "Failed to parse comment attribute: " + Atom.getAtomTypeString(i4));
        return null;
    }
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        if (i4 == 169 || i4 == 65533) {
            ...
            if (i5 != SHORT_TYPE_NAME_1) {
                if (i5 != SHORT_TYPE_NAME_2) {
                    if (i5 != SHORT_TYPE_COMPOSER_1) {
                        if (i5 != SHORT_TYPE_COMPOSER_2) {
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i4, String str, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        ...
        Log.w(TAG, "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i4));
        return null;
    }

    private static Id3Frame parseInternalAttribute(ParsableByteArray parsableByteArray, int i4) {
        String str = null;
        String str2 = null;
        int i5 = -1;
        int i6 = -1;
        ...
        return new InternalFrame(str, str2, parsableByteArray.readNullTerminatedString(i6 - 16));
    }
    ...
    private static TextInformationFrame parseTextAttribute(int i4, String str, ParsableByteArray parsableByteArray) {
        int readInt = parsableByteArray.readInt();
        if (parsableByteArray.readInt() == Atom.TYPE_data) {
            parsableByteArray.skipBytes(8);
            return new TextInformationFrame(str, (String) null, parsableByteArray.readNullTerminatedString(readInt - 16));
        }
        Log.w(TAG, "Failed to parse text attribute: " + Atom.getAtomTypeString(i4));
        return null;
    }

    private static Id3Frame parseUint8Attribute(int i4, String str, ParsableByteArray parsableByteArray, boolean z4, boolean z5) {
        ...
        if (parseUint8AttributeValue < 0) {
            Log.w(TAG, "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i4));
            return null;
        } else if (z4) {
