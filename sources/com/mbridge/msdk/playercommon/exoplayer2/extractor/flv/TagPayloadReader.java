...
abstract class TagPayloadReader {
    ...
    public final void consume(ParsableByteArray parsableByteArray, long j4) throws ParserException {
        if (parseHeader(parsableByteArray)) {
            parsePayload(parsableByteArray, j4);
        }
    }
    ...
    /* access modifiers changed from: protected */
    public abstract void parsePayload(ParsableByteArray parsableByteArray, long j4) throws ParserException;
