...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    public final void parsePayload(ParsableByteArray parsableByteArray, long j4) throws ParserException {
        int i4;
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        long readInt24 = j4 + (((long) parsableByteArray.readInt24()) * 1000);
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            while (parsableByteArray.bytesLeft() > 0) {
                parsableByteArray.readBytes(this.nalLength.data, i5, this.nalUnitLengthFieldLength);
            ...
            trackOutput.sampleMetadata(readInt24, i4, i6, 0, (TrackOutput.CryptoData) null);
        }
    }
