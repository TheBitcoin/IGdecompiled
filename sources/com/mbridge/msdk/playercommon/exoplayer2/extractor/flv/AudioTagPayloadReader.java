...
final class AudioTagPayloadReader extends TagPayloadReader {
    ...
    public final boolean parseHeader(ParsableByteArray parsableByteArray) throws TagPayloadReader.UnsupportedFormatException {
        ...
        if (!this.hasParsedAudioDataHeader) {
            ...
            if (i5 == 2) {
                ...
                this.output.format(Format.createAudioSampleFormat((String) null, str2, (String) null, -1, -1, 1, 8000, i4, (List<byte[]>) null, (DrmInitData) null, 0, (String) null));
                this.hasOutputFormat = true;
            } else if (i5 != 10) {
    ...
    public final void parsePayload(ParsableByteArray parsableByteArray, long j4) throws ParserException {
        ...
        if (this.audioFormat == 2) {
            ...
            this.output.sampleMetadata(j4, 1, bytesLeft, 0, (TrackOutput.CryptoData) null);
            return;
        }
        ...
        if (readUnsignedByte == 0 && !this.hasOutputFormat) {
            ...
            this.output.sampleMetadata(j4, 1, bytesLeft3, 0, (TrackOutput.CryptoData) null);
        }
    }
