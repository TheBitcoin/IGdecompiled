...
final class ExoPlayerImplInternal implements Handler.Callback, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender, MediaPeriod.Callback, MediaSource.SourceInfoRefreshListener, TrackSelector.InvalidationListener {
    ...
    private static final class PendingMessageInfo implements Comparable<PendingMessageInfo> {
        ...
        public final void setResolvedPosition(int i4, long j4, Object obj) {
    ...
    private static final class PlaybackInfoUpdate {
        ...
        public final void incrementPendingOperationAcks(int i4) {
        ...
        public final void setPositionDiscontinuity(int i4) {
            boolean z4 = true;
    ...
    private static final class SeekPosition {
        ...
        public SeekPosition(Timeline timeline2, int i4, long j4) {
            this.timeline = timeline2;
            this.windowIndex = i4;
    ...
    public ExoPlayerImplInternal(Renderer[] rendererArr, TrackSelector trackSelector2, TrackSelectorResult trackSelectorResult, LoadControl loadControl2, boolean z4, int i4, boolean z5, Handler handler2, ExoPlayer exoPlayer, Clock clock2) {
        Clock clock3 = clock2;
    ...
    private void doSomeWork() throws ExoPlaybackException, IOException {
        ...
        if (z6 && ((j4 == C.TIME_UNSET || j4 <= this.playbackInfo.positionUs) && playingPeriod.info.isFinal)) {
            setState(4);
            stopRenderers();
        ...
        if ((this.playWhenReady && this.playbackInfo.playbackState == 3) || (i4 = this.playbackInfo.playbackState) == 2) {
            scheduleNextWork(uptimeMillis, 10);
        } else if (this.enabledRenderers.length == 0 || i4 == 4) {
    ...
    private void enableRenderer(int i4, boolean z4, int i5) throws ExoPlaybackException {
        boolean z5;
        boolean z6;
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        ...
        if (renderer.getState() == 0) {
            ...
            Format[] formats = getFormats(trackSelectorResult.selections.get(i4));
            ...
            renderer.enable(rendererConfiguration, formats, playingPeriod.sampleStreams[i4], this.rendererPositionUs, z6, playingPeriod.getRendererOffset());
    ...
    private void enableRenderers(boolean[] zArr, int i4) throws ExoPlaybackException {
        this.enabledRenderers = new Renderer[i4];
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        int i5 = 0;
        for (int i6 = 0; i6 < this.renderers.length; i6++) {
            if (playingPeriod.trackSelectorResult.isRendererEnabled(i6)) {
                enableRenderer(i6, zArr[i6], i5);
                i5++;
            }
        }
    }
    ...
    private Pair<Integer, Long> getPeriodPosition(Timeline timeline, int i4, long j4) {
        return timeline.getPeriodPosition(this.window, this.period, i4, j4);
    }
        ...
        if (mediaSourceRefreshInfo2.source == this.mediaSource) {
            ...
            if (i4 > 0) {
                ...
                if (seekPosition != null) {
                    ...
                    this.playbackInfo = playbackInfo2.fromNewPosition(resolveMediaPeriodIdForAds, j6, longValue);
                    ...
                    this.playbackInfo = playbackInfo3.fromNewPosition(resolveMediaPeriodIdForAds2, j5, longValue2);
                }
            } else {
                PlaybackInfo playbackInfo4 = this.playbackInfo;
                int i5 = playbackInfo4.periodId.periodIndex;
                long j8 = playbackInfo4.contentPositionUs;
                if (!timeline.isEmpty()) {
                    MediaPeriodHolder frontPeriod = this.queue.getFrontPeriod();
                    if (frontPeriod == null) {
                        obj = timeline.getPeriod(i5, this.period, true).uid;
                    } else {
                        obj = frontPeriod.uid;
                    }
                    int indexOfPeriod = timeline2.getIndexOfPeriod(obj);
                    if (indexOfPeriod == -1) {
                        int resolveSubsequentPeriod = resolveSubsequentPeriod(i5, timeline, timeline2);
                        ...
                        this.playbackInfo = this.playbackInfo.fromNewPosition(resolveMediaPeriodIdForAds3, seekToPeriodPosition(resolveMediaPeriodIdForAds3, j7), longValue3);
                        return;
                    }
                    if (indexOfPeriod != i5) {
                    ...
                    if (mediaPeriodId.isAd()) {
                        MediaSource.MediaPeriodId resolveMediaPeriodIdForAds4 = this.queue.resolveMediaPeriodIdForAds(indexOfPeriod, j8);
                        if (!resolveMediaPeriodIdForAds4.equals(mediaPeriodId)) {
                            if (!resolveMediaPeriodIdForAds4.isAd()) {
                                j7 = j8;
                            }
                            this.playbackInfo = this.playbackInfo.fromNewPosition(resolveMediaPeriodIdForAds4, seekToPeriodPosition(resolveMediaPeriodIdForAds4, j7), j8);
                            return;
                        }
                    }
                    ...
                    MediaSource.MediaPeriodId resolveMediaPeriodIdForAds5 = this.queue.resolveMediaPeriodIdForAds(i5, j8);
                    long j9 = j8;
                    ...
                    this.playbackInfo = playbackInfo5.fromNewPosition(resolveMediaPeriodIdForAds5, j4, j9);
                }
            }
        }
    }
    ...
    private boolean isTimelineReady() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j4 = playingPeriod.info.durationUs;
        if (j4 == C.TIME_UNSET || this.playbackInfo.positionUs < j4) {
            return true;
        }
    ...
    private void maybeNotifyPlaybackInfoChanged() {
        ...
        if (this.playbackInfoUpdate.hasPendingUpdate(this.playbackInfo)) {
            ...
            if (this.playbackInfoUpdate.positionDiscontinuity) {
                i4 = this.playbackInfoUpdate.discontinuityReason;
            } else {
                i4 = -1;
            }
            handler2.obtainMessage(0, access$100, i4, this.playbackInfo).sendToTarget();
    ...
    private void maybeThrowPeriodPrepareError() throws IOException {
        ...
        if (loadingPeriod != null && !loadingPeriod.prepared) {
            if (readingPeriod == null || readingPeriod.next == loadingPeriod) {
                ...
                int i4 = 0;
                while (i4 < length) {
                    if (rendererArr[i4].hasReadStreamToEnd()) {
                        i4++;
                    } else {
                        return;
                    }
    ...
    private void resetInternal(boolean z4, boolean z5, boolean z6) {
        ...
        if (z6) {
            ...
            int i4 = 0;
            while (i4 < size) {
                PendingMessageInfo pendingMessageInfo = arrayList.get(i4);
                i4++;
        ...
        if (z5) {
            ...
            j4 = this.playbackInfo.positionUs;
        }
        if (!z5) {
            j5 = this.playbackInfo.contentPositionUs;
        }
        long j6 = j5;
        PlaybackInfo playbackInfo2 = this.playbackInfo;
        int i5 = playbackInfo2.playbackState;
        if (z6) {
        ...
        this.playbackInfo = new PlaybackInfo(timeline2, obj, mediaPeriodId2, j4, j6, i5, false, trackGroupArray2, trackSelectorResult);
    ...
    private void resetRendererPosition(long j4) throws ExoPlaybackException {
        if (this.queue.hasPlayingPeriod()) {
            j4 = this.queue.getPlayingPeriod().toRendererTime(j4);
        }
    ...
    private int resolveSubsequentPeriod(int i4, Timeline timeline, Timeline timeline2) {
        int periodCount = timeline.getPeriodCount();
        int i5 = 0;
        int i6 = i4;
        int i7 = -1;
        while (i5 < periodCount && i7 == -1) {
            Timeline timeline3 = timeline;
            i6 = timeline3.getNextPeriodIndex(i6, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (i6 == -1) {
                break;
            }
            i7 = timeline2.getIndexOfPeriod(timeline3.getPeriod(i6, this.period, true).uid);
            i5++;
            timeline = timeline3;
        }
        return i7;
    ...
    private void scheduleNextWork(long j4, long j5) {
        this.handler.removeMessages(2);
        this.handler.sendEmptyMessageAtTime(2, j4 + j5);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x0061 A[Catch:{ all -> 0x0072 }] */
    ...
    private void seekToInternal(com.mbridge.msdk.playercommon.exoplayer2.ExoPlayerImplInternal.SeekPosition r21) throws com.mbridge.msdk.playercommon.exoplayer2.ExoPlaybackException {
        ...
        L_0x005c:
            r9 = 2
            com.mbridge.msdk.playercommon.exoplayer2.source.MediaSource r10 = r1.mediaSource     // Catch:{ all -> 0x0072 }
            if (r10 == 0) goto L_0x00c9
            int r10 = r1.pendingPrepareCount     // Catch:{ all -> 0x0072 }
        ...
        L_0x0066:
            ...
            r0 = 4
            r1.setState(r0)     // Catch:{ all -> 0x0072 }
            r1.resetInternal(r6, r3, r6)     // Catch:{ all -> 0x0072 }
            goto L_0x00cb
        L_0x0072:
            r0 = move-exception
            goto L_0x00d9
        L_0x0074:
            com.mbridge.msdk.playercommon.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x0072 }
            com.mbridge.msdk.playercommon.exoplayer2.source.MediaSource$MediaPeriodId r0 = r0.periodId     // Catch:{ all -> 0x0072 }
            boolean r0 = r15.equals(r0)     // Catch:{ all -> 0x0072 }
            if (r0 == 0) goto L_0x00ba
            com.mbridge.msdk.playercommon.exoplayer2.MediaPeriodQueue r0 = r1.queue     // Catch:{ all -> 0x0072 }
            com.mbridge.msdk.playercommon.exoplayer2.MediaPeriodHolder r0 = r0.getPlayingPeriod()     // Catch:{ all -> 0x0072 }
            if (r0 == 0) goto L_0x0093
            int r7 = (r12 > r4 ? 1 : (r12 == r4 ? 0 : -1))
            if (r7 == 0) goto L_0x0093
            com.mbridge.msdk.playercommon.exoplayer2.source.MediaPeriod r0 = r0.mediaPeriod     // Catch:{ all -> 0x0072 }
            com.mbridge.msdk.playercommon.exoplayer2.SeekParameters r4 = r1.seekParameters     // Catch:{ all -> 0x0072 }
            long r4 = r0.getAdjustedSeekPositionUs(r12, r4)     // Catch:{ all -> 0x0072 }
            goto L_0x0094
        L_0x0093:
            r4 = r12
        L_0x0094:
            long r7 = com.mbridge.msdk.playercommon.exoplayer2.C.usToMs(r4)     // Catch:{ all -> 0x0072 }
            com.mbridge.msdk.playercommon.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x0072 }
            long r10 = r0.positionUs     // Catch:{ all -> 0x0072 }
            long r10 = com.mbridge.msdk.playercommon.exoplayer2.C.usToMs(r10)     // Catch:{ all -> 0x0072 }
            int r0 = (r7 > r10 ? 1 : (r7 == r10 ? 0 : -1))
            if (r0 != 0) goto L_0x00bb
            com.mbridge.msdk.playercommon.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x0072 }
            long r3 = r0.positionUs     // Catch:{ all -> 0x0072 }
        ...
        L_0x00ba:
            r4 = r12
        L_0x00bb:
            long r4 = r1.seekToPeriodPosition(r15, r4)     // Catch:{ all -> 0x0072 }
        ...
        L_0x00c5:
            ...
            goto L_0x00cd
        L_0x00c9:
            r1.pendingInitialSeekPosition = r0     // Catch:{ all -> 0x0072 }
        L_0x00cb:
            r16 = r12
        L_0x00cd:
            com.mbridge.msdk.playercommon.exoplayer2.PlaybackInfo r14 = r1.playbackInfo
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j4) throws ExoPlaybackException {
        return seekToPeriodPosition(mediaPeriodId, j4, this.queue.getPlayingPeriod() != this.queue.getReadingPeriod());
    }
    ...
    private void setRepeatModeInternal(int i4) throws ExoPlaybackException {
        this.repeatMode = i4;
        if (!this.queue.updateRepeatMode(i4)) {
    ...
    private void setState(int i4) {
        PlaybackInfo playbackInfo2 = this.playbackInfo;
        if (playbackInfo2.playbackState != i4) {
            this.playbackInfo = playbackInfo2.copyWithPlaybackState(i4);
        }
    }

    private boolean shouldKeepPeriodHolder(MediaSource.MediaPeriodId mediaPeriodId, long j4, MediaPeriodHolder mediaPeriodHolder) {
        ...
        if (mediaSource2 != null) {
            ...
            if (this.queue.hasPlayingPeriod()) {
                ...
                while (this.playWhenReady && playingPeriod != readingPeriod && this.rendererPositionUs >= playingPeriod.next.rendererPositionOffsetUs) {
                    ...
                    this.playbackInfoUpdate.setPositionDiscontinuity(i4);
                    updatePlaybackPositions();
                    ...
                    if (mediaPeriodHolder != null && mediaPeriodHolder.prepared) {
                        ...
                        while (true) {
                            ...
                            if (i6 < rendererArr2.length) {
                                ...
                                SampleStream sampleStream2 = readingPeriod.sampleStreams[i6];
                                        ...
                                        if (trackSelectorResult.isRendererEnabled(i7)) {
                                            if (!z4) {
                                                if (!renderer3.isCurrentStreamFinal()) {
                                                    ...
                                                    if (this.rendererCapabilities[i7].getTrackType() == 5) {
                                                        z5 = true;
                                                    } else {
                                                        z5 = false;
                                                    }
                                                    ...
                                                    if (isRendererEnabled && rendererConfiguration2.equals(rendererConfiguration) && !z5) {
                                                        renderer3.replaceStream(getFormats(trackSelection), advanceReadingPeriod.sampleStreams[i7], advanceReadingPeriod.getRendererOffset());
                                                    }
                                                }
                                            }
    ...
    private void updatePlaybackPositions() throws ExoPlaybackException {
        ...
        if (this.queue.hasPlayingPeriod()) {
            ...
            PlaybackInfo playbackInfo3 = this.playbackInfo;
            if (this.enabledRenderers.length == 0) {
                j4 = playingPeriod.info.durationUs;
            } else {
                j4 = playingPeriod.getBufferedPositionUs(true);
            }
            playbackInfo3.bufferedPositionUs = j4;
        }
    }
        ...
        if (playingPeriod != null && mediaPeriodHolder != playingPeriod) {
            ...
            while (true) {
                ...
                if (i4 < rendererArr.length) {
                    ...
                    if (zArr[i4] && (!playingPeriod.trackSelectorResult.isRendererEnabled(i4) || (renderer.isCurrentStreamFinal() && renderer.getStream() == mediaPeriodHolder.sampleStreams[i4]))) {
                        disableRenderer(renderer);
                    }
                    i4++;
                } else {
                    this.playbackInfo = this.playbackInfo.copyWithTrackInfo(playingPeriod.trackGroups, playingPeriod.trackSelectorResult);
                    enableRenderers(zArr, i5);
                    return;
                }
            }
        }
    ...
    public final synchronized void release() {
        /*
            r8 = this;
            monitor-enter(r8)
            boolean r0 = r8.released     // Catch:{ all -> 0x002c }
            if (r0 != 0) goto L_0x0044
            android.os.HandlerThread r0 = r8.internalPlaybackThread     // Catch:{ all -> 0x002c }
            boolean r0 = r0.isAlive()     // Catch:{ all -> 0x002c }
            if (r0 != 0) goto L_0x000e
            goto L_0x0044
        L_0x000e:
            com.mbridge.msdk.playercommon.exoplayer2.util.HandlerWrapper r0 = r8.handler     // Catch:{ all -> 0x002c }
            r1 = 7
            r0.sendEmptyMessage(r1)     // Catch:{ all -> 0x002c }
            com.mbridge.msdk.playercommon.exoplayer2.util.Clock r0 = r8.clock     // Catch:{ all -> 0x002c }
            long r0 = r0.elapsedRealtime()     // Catch:{ all -> 0x002c }
            r2 = 500(0x1f4, double:2.47E-321)
            long r0 = r0 + r2
            r4 = 0
        L_0x001e:
            boolean r5 = r8.released     // Catch:{ all -> 0x002c }
            if (r5 != 0) goto L_0x0039
            r5 = 0
            int r7 = (r2 > r5 ? 1 : (r2 == r5 ? 0 : -1))
            if (r7 <= 0) goto L_0x0039
            r8.wait(r2)     // Catch:{ InterruptedException -> 0x002e }
            goto L_0x0030
        L_0x002c:
            r0 = move-exception
            goto L_0x0046
        L_0x002e:
            ...
            r4 = 1
        L_0x0030:
            com.mbridge.msdk.playercommon.exoplayer2.util.Clock r2 = r8.clock     // Catch:{ all -> 0x002c }
    ...
    public final void seekTo(Timeline timeline, int i4, long j4) {
        this.handler.obtainMessage(3, new SeekPosition(timeline, i4, j4)).sendToTarget();
    }
    ...
    public final void setRepeatMode(int i4) {
        this.handler.obtainMessage(12, i4, 0).sendToTarget();
    }
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j4, boolean z4) throws ExoPlaybackException {
        stopRenderers();
        this.rebuffering = false;
        setState(2);
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        ...
        while (true) {
            if (mediaPeriodHolder == null) {
                break;
            } else if (shouldKeepPeriodHolder(mediaPeriodId, j4, mediaPeriodHolder)) {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (mediaPeriodHolder.hasEnabledTracks) {
                ...
                mediaPeriodHolder.mediaPeriod.discardBuffer(j4 - this.backBufferDurationUs, this.retainBackBufferFromKeyframe);
            }
