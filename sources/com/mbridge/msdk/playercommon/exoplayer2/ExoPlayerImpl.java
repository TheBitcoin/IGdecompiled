...
final class ExoPlayerImpl implements ExoPlayer {
    ...
    private static final class PlaybackInfoUpdate {
        ...
        public PlaybackInfoUpdate(PlaybackInfo playbackInfo2, PlaybackInfo playbackInfo3, Set<Player.EventListener> set, TrackSelector trackSelector2, boolean z4, int i4, int i5, boolean z5, boolean z6, boolean z7) {
            boolean z8;
            boolean z9;
            boolean z10;
    ...
    public ExoPlayerImpl(Renderer[] rendererArr, TrackSelector trackSelector2, LoadControl loadControl, Clock clock) {
        ...
        ExoPlayerImplInternal exoPlayerImplInternal = new ExoPlayerImplInternal(rendererArr2, trackSelector3, trackSelectorResult2, loadControl, this.playWhenReady, this.repeatMode, this.shuffleModeEnabled, r8, this, clock);
        this.internalPlayer = exoPlayerImplInternal;
        this.internalPlayerHandler = new Handler(exoPlayerImplInternal.getPlaybackLooper());
    }

    private PlaybackInfo getResetPlaybackInfo(boolean z4, boolean z5, int i4) {
        Timeline timeline;
        Object obj;
        ...
        long j4 = playbackInfo2.startPositionUs;
        long j5 = playbackInfo2.contentPositionUs;
        if (z5) {
        ...
        return new PlaybackInfo(timeline2, obj2, mediaPeriodId, j4, j5, i4, false, trackGroupArray2, trackSelectorResult);
    }

    private void handlePlaybackInfo(PlaybackInfo playbackInfo2, int i4, boolean z4, int i5) {
        PlaybackInfo playbackInfo3;
        int i6;
        int i7 = this.pendingOperationAcks - i4;
        ...
        if (i7 == 0) {
            ...
            updatePlaybackInfo(playbackInfo3, z4, i5, i6, z5, false);
        }
    }

    private long playbackInfoPositionUsToWindowPositionMs(long j4) {
    ...
    private void updatePlaybackInfo(PlaybackInfo playbackInfo2, boolean z4, int i4, int i5, boolean z5, boolean z6) {
        boolean isEmpty = this.pendingPlaybackInfoUpdates.isEmpty();
        this.pendingPlaybackInfoUpdates.addLast(new PlaybackInfoUpdate(playbackInfo2, this.playbackInfo, this.listeners, this.trackSelector, z4, i4, i5, z5, this.playWhenReady, z6));
        this.playbackInfo = playbackInfo2;
        if (isEmpty) {
    ...
    public final int getRendererType(int i4) {
        return this.renderers[i4].getTrackType();
    }
    ...
    public final void handleEvent(Message message) {
        ...
        if (i4 == 0) {
            ...
            handlePlaybackInfo(playbackInfo2, i5, z4, i6);
        } else if (i4 == 1) {
    ...
    public final void seekTo(long j4) {
        seekTo(getCurrentWindowIndex(), j4);
    }
    ...
    public final void setRepeatMode(int i4) {
        if (this.repeatMode != i4) {
            this.repeatMode = i4;
            this.internalPlayer.setRepeatMode(i4);
            Iterator<Player.EventListener> it = this.listeners.iterator();
            while (it.hasNext()) {
