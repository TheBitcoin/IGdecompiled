...
public abstract class BaseRenderer implements Renderer, RendererCapabilities {
    ...
    public final void enable(RendererConfiguration rendererConfiguration, Format[] formatArr, SampleStream sampleStream, long j4, boolean z4, long j5) throws ExoPlaybackException {
        boolean z5;
        if (this.state == 0) {
            z5 = true;
        } else {
        ...
        this.state = 1;
        onEnabled(z4);
        replaceStream(formatArr, sampleStream, j5);
        ...
        if (readData != -4) {
            if (readData == -5) {
                ...
                if (j4 != Long.MAX_VALUE) {
                    formatHolder.format = format.copyWithSubsampleOffsetUs(j4 + this.streamOffsetUs);
                }
            }
            return readData;
    ...
    public int skipSource(long j4) {
        return this.stream.skipData(j4 - this.streamOffsetUs);
    }
