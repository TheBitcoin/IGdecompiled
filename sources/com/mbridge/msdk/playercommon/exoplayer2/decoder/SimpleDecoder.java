...
public abstract class SimpleDecoder<I extends DecoderInputBuffer, O extends OutputBuffer, E extends Exception> implements Decoder<I, O, E> {
    ...
    private void releaseInputBufferInternal(I i4) {
        i4.clear();
    ...
    private void releaseOutputBufferInternal(O o4) {
        o4.clear();
    ...
    public void releaseOutputBuffer(O o4) {
        synchronized (this.lock) {
            releaseOutputBufferInternal(o4);
    ...
    public final void setInitialInputBufferSize(int i4) {
        ...
        for (I ensureSpaceForWrite : this.availableInputBuffers) {
            ensureSpaceForWrite.ensureSpaceForWrite(i4);
        }
    }
    ...
    public final O dequeueOutputBuffer() throws Exception {
        synchronized (this.lock) {
            try {
                ...
                O o4 = (OutputBuffer) this.queuedOutputBuffers.removeFirst();
                return o4;
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final void queueInputBuffer(I i4) throws Exception {
        synchronized (this.lock) {
            maybeThrowException();
            Assertions.checkArgument(i4 == this.dequeuedInputBuffer);
            this.queuedInputBuffers.addLast(i4);
            maybeNotifyDecodeLoop();
            this.dequeuedInputBuffer = null;
        }
    }
