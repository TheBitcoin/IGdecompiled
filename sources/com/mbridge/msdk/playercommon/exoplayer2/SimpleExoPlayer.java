...
public class SimpleExoPlayer implements ExoPlayer, Player.TextComponent, Player.VideoComponent {
    ...
    private final class ComponentListener implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener, AudioRendererEventListener, MetadataOutput, TextOutput, VideoRendererEventListener {
        ...
        public final void onAudioDecoderInitialized(String str, long j4, long j5) {
            ...
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioDecoderInitialized(str, j4, j5);
            }
        }
        ...
        public final void onAudioSessionId(int i4) {
            int unused = SimpleExoPlayer.this.audioSessionId = i4;
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSessionId(i4);
            }
        }
        ...
        public final void onAudioSinkUnderrun(int i4, long j4, long j5) {
            Iterator it = SimpleExoPlayer.this.audioDebugListeners.iterator();
            while (it.hasNext()) {
                ((AudioRendererEventListener) it.next()).onAudioSinkUnderrun(i4, j4, j5);
            }
        }
        ...
        public final void onDroppedFrames(int i4, long j4) {
            ...
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onDroppedFrames(i4, j4);
            }
        }
        ...
        public final void onVideoDecoderInitialized(String str, long j4, long j5) {
            Iterator it = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it.hasNext()) {
                ((VideoRendererEventListener) it.next()).onVideoDecoderInitialized(str, j4, j5);
            }
        }
        ...
        public final void onVideoSizeChanged(int i4, int i5, int i6, float f4) {
            Iterator it = SimpleExoPlayer.this.videoListeners.iterator();
            while (it.hasNext()) {
                ((com.mbridge.msdk.playercommon.exoplayer2.video.VideoListener) it.next()).onVideoSizeChanged(i4, i5, i6, f4);
            }
            Iterator it2 = SimpleExoPlayer.this.videoDebugListeners.iterator();
            while (it2.hasNext()) {
                ((VideoRendererEventListener) it2.next()).onVideoSizeChanged(i4, i5, i6, f4);
            }
        }
    ...
    public void setAudioStreamType(int i4) {
        int audioUsageForStreamType = Util.getAudioUsageForStreamType(i4);
        setAudioAttributes(new AudioAttributes.Builder().setUsage(audioUsageForStreamType).setContentType(Util.getAudioContentTypeForStreamType(i4)).build());
    }
    ...
    public void setPlaybackParams(@Nullable PlaybackParams playbackParams) {
        ...
        if (playbackParams != null) {
            PlaybackParams unused = playbackParams.allowDefaults();
    ...
    public void setVideoScalingMode(int i4) {
        ...
        for (Renderer renderer : this.renderers) {
            if (renderer.getTrackType() == 2) {
                this.player.createMessage(renderer).setType(4).setPayload(Integer.valueOf(i4)).send();
            }
        }
    }
    ...
    public void setVolume(float f4) {
        ...
        for (Renderer renderer : this.renderers) {
            if (renderer.getTrackType() == 1) {
                this.player.createMessage(renderer).setType(2).setPayload(Float.valueOf(f4)).send();
            }
        }
    }
