...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static byte[] copyOfRangeIfValid(byte[] bArr, int i4, int i5) {
        if (i5 <= i4) {
            return new byte[0];
        }
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i4, int i5) throws UnsupportedEncodingException {
        int i6;
        String str;
        ...
        if (i5 == 2) {
            ...
            i6 = indexOfZeroByte(bArr, 0);
            str = Util.toLowerInvariant(new String(bArr, 0, i6, "ISO-8859-1"));
            if (str.indexOf(47) == -1) {
                str = "image/" + str;
            }
        }
        int i8 = i6 + 2;
        int indexOfEos = indexOfEos(bArr, i8, readUnsignedByte);
        return new ApicFrame(str, new String(bArr, i8, indexOfEos - i8, charsetName), bArr[i6 + 1] & 255, copyOfRangeIfValid(bArr, indexOfEos + delimiterLength(readUnsignedByte), i7));
    }

    private static BinaryFrame decodeBinaryFrame(ParsableByteArray parsableByteArray, int i4, String str) {
        byte[] bArr = new byte[i4];
        parsableByteArray.readBytes(bArr, 0, i4);
        return new BinaryFrame(str, bArr);
    }

    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i4, int i5, boolean z4, int i6, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        long j4;
        ...
        while (parsableByteArray.getPosition() < i7) {
            Id3Frame decodeFrame = decodeFrame(i5, parsableByteArray, z4, i6, framePredicate2);
            if (decodeFrame != null) {
        ...
        return new ChapterFrame(str, readInt, readInt2, readUnsignedInt, j4, id3FrameArr);
    }

    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i4, int i5, boolean z4, int i6, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        boolean z5;
        boolean z6;
        int position = parsableByteArray.getPosition();
        int indexOfZeroByte = indexOfZeroByte(parsableByteArray.data, position);
        ...
        for (int i7 = 0; i7 < readUnsignedByte2; i7++) {
            ...
            strArr[i7] = new String(parsableByteArray.data, position2, indexOfZeroByte2 - position2, "ISO-8859-1");
    ...
    private static CommentFrame decodeCommentFrame(ParsableByteArray parsableByteArray, int i4) throws UnsupportedEncodingException {
        if (i4 < 4) {
            return null;
        }
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
    ...
    private static GeobFrame decodeGeobFrame(ParsableByteArray parsableByteArray, int i4) throws UnsupportedEncodingException {
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        String charsetName = getCharsetName(readUnsignedByte);
        int i5 = i4 - 1;
        ...
        int i6 = indexOfZeroByte + 1;
        int indexOfEos = indexOfEos(bArr, i6, readUnsignedByte);
        String decodeStringIfValid = decodeStringIfValid(bArr, i6, indexOfEos, charsetName);
        int delimiterLength = indexOfEos + delimiterLength(readUnsignedByte);
        int indexOfEos2 = indexOfEos(bArr, delimiterLength, readUnsignedByte);
        return new GeobFrame(str, decodeStringIfValid, decodeStringIfValid(bArr, delimiterLength, indexOfEos2, charsetName), copyOfRangeIfValid(bArr, indexOfEos2 + delimiterLength(readUnsignedByte), i5));
    }
    ...
    private static PrivFrame decodePrivFrame(ParsableByteArray parsableByteArray, int i4) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i4];
        parsableByteArray.readBytes(bArr, 0, i4);
        int indexOfZeroByte = indexOfZeroByte(bArr, 0);
        return new PrivFrame(new String(bArr, 0, indexOfZeroByte, "ISO-8859-1"), copyOfRangeIfValid(bArr, indexOfZeroByte + 1, i4));
    }

    private static String decodeStringIfValid(byte[] bArr, int i4, int i5, String str) throws UnsupportedEncodingException {
    ...
    private static TextInformationFrame decodeTextInformationFrame(ParsableByteArray parsableByteArray, int i4, String str) throws UnsupportedEncodingException {
        if (i4 < 1) {
            return null;
        }
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
    ...
    private static TextInformationFrame decodeTxxxFrame(ParsableByteArray parsableByteArray, int i4) throws UnsupportedEncodingException {
        if (i4 < 1) {
            return null;
        }
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
    ...
    private static UrlLinkFrame decodeUrlLinkFrame(ParsableByteArray parsableByteArray, int i4, String str) throws UnsupportedEncodingException {
        byte[] bArr = new byte[i4];
        parsableByteArray.readBytes(bArr, 0, i4);
        return new UrlLinkFrame(str, (String) null, new String(bArr, 0, indexOfZeroByte(bArr, 0), "ISO-8859-1"));
    }

    private static UrlLinkFrame decodeWxxxFrame(ParsableByteArray parsableByteArray, int i4) throws UnsupportedEncodingException {
        if (i4 < 1) {
            return null;
        }
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
    ...
    private static int delimiterLength(int i4) {
        return (i4 == 0 || i4 == 3) ? 1 : 2;
    }

    private static String getCharsetName(int i4) {
        if (i4 == 1) {
            return C.UTF16_NAME;
        }
        if (i4 == 2) {
    ...
    private static String getFrameId(int i4, int i5, int i6, int i7, int i8) {
        if (i4 == 2) {
            return String.format(Locale.US, "%c%c%c", new Object[]{Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7)});
        }
        return String.format(Locale.US, "%c%c%c%c", new Object[]{Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8)});
    }

    private static int indexOfEos(byte[] bArr, int i4, int i5) {
        int indexOfZeroByte = indexOfZeroByte(bArr, i4);
        if (i5 == 0 || i5 == 3) {
    ...
    private static int indexOfZeroByte(byte[] bArr, int i4) {
    ...
    private static int removeUnsynchronization(ParsableByteArray parsableByteArray, int i4) {
        ...
        while (true) {
            ...
            if ((bArr[position] & 255) == 255 && bArr[i5] == 0) {
                System.arraycopy(bArr, position + 2, bArr, i5, (i4 - position) - 2);
                i4--;
            }
            position = i5;
        }
    ...
    public final Metadata decode(byte[] bArr, int i4) {
        ArrayList arrayList = new ArrayList();
        ...
        int position = parsableByteArray.getPosition();
        int i5 = decodeHeader.majorVersion == 2 ? 6 : 10;
        ...
        boolean z4 = false;
        if (!validateFrames(parsableByteArray, decodeHeader.majorVersion, i5, false)) {
            if (decodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i5, true)) {
                Log.w(TAG, "Failed to validate ID3 tag with majorVersion=" + decodeHeader.majorVersion);
                return null;
            }
            z4 = true;
        }
        while (parsableByteArray.bytesLeft() >= i5) {
            Id3Frame decodeFrame = decodeFrame(decodeHeader.majorVersion, parsableByteArray, z4, i5, this.framePredicate);
            if (decodeFrame != null) {
                arrayList.add(decodeFrame);
            }
        }
