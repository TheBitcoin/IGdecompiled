...
public final class ExoPlaybackException extends Exception {
    ...
    private ExoPlaybackException(int i4, String str, Throwable th, int i5) {
        super(str, th);
        this.type = i4;
        this.rendererIndex = i5;
    }

    public static ExoPlaybackException createForRenderer(Exception exc, int i4) {
        return new ExoPlaybackException(1, (String) null, exc, i4);
    }
