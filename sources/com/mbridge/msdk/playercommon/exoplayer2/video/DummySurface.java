...
public final class DummySurface extends Surface {
    ...
    private static int getSecureModeV24(Context context) {
        ...
        int i4 = Util.SDK_INT;
        if (i4 < 26 && ("samsung".equals(Util.MANUFACTURER) || "XT1650".equals(Util.MODEL))) {
            return 0;
        }
        if ((i4 < 26 && !context.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance")) || (eglQueryString = EGL14.eglQueryString(EGL14.eglGetDisplay(0), 12373)) == null || !eglQueryString.contains(EXTENSION_PROTECTED_CONTENT)) {
            return 0;
        }
    ...
    public static DummySurface newInstanceV17(Context context, boolean z4) {
        ...
        return dummySurfaceThread.init(i4);
    }
