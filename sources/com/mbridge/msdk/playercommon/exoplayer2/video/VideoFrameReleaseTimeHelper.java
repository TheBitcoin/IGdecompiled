...
public final class VideoFrameReleaseTimeHelper {
    ...
    private static long closestVsync(long j4, long j5, long j6) {
        long j7;
    ...
    private boolean isDriftTooLarge(long j4, long j5) {
        if (Math.abs((j5 - this.syncUnadjustedReleaseTimeNs) - (j4 - this.syncFramePresentationTimeNs)) > MAX_ALLOWED_DRIFT_NS) {
            return true;
        }
        return false;
    }
