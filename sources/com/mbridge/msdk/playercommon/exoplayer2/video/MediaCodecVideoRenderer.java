...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    private static Point getCodecMaxSize(MediaCodecInfo mediaCodecInfo, Format format) throws MediaCodecUtil.DecoderQueryException {
        ...
        for (int i9 : STANDARD_LONG_EDGE_VIDEO_PX) {
            ...
            if (Util.SDK_INT >= 21) {
                ...
                Point alignVideoSizeV21 = mediaCodecInfo.alignVideoSizeV21(i6, i9);
                ...
                if (ceilDivide * ceilDivide2 <= MediaCodecUtil.maxH264DecodableFrameSize()) {
                    ...
                    return new Point(i5, ceilDivide);
                }
            }
        }
        return null;
    ...
    private static boolean isBufferLate(long j4) {
        return j4 < -30000;
    }

    private static boolean isBufferVeryLate(long j4) {
        return j4 < -500000;
    }
    ...
    private void maybeNotifyVideoSizeChanged() {
        ...
        if (i4 != -1 || this.currentHeight != -1) {
            if (this.reportedWidth != i4 || this.reportedHeight != this.currentHeight || this.reportedUnappliedRotationDegrees != this.currentUnappliedRotationDegrees || this.reportedPixelWidthHeightRatio != this.currentPixelWidthHeightRatio) {
                this.eventDispatcher.videoSizeChanged(i4, this.currentHeight, this.currentUnappliedRotationDegrees, this.currentPixelWidthHeightRatio);
    ...
    private void maybeRenotifyVideoSizeChanged() {
        ...
        if (i4 != -1 || this.reportedHeight != -1) {
            this.eventDispatcher.videoSizeChanged(i4, this.reportedHeight, this.reportedUnappliedRotationDegrees, this.reportedPixelWidthHeightRatio);
        }
    }
    ...
    public int canKeepCodec(MediaCodec mediaCodec, MediaCodecInfo mediaCodecInfo, Format format, Format format2) {
        ...
        if (i4 > codecMaxValues2.width || format2.height > codecMaxValues2.height || getMaxInputSize(mediaCodecInfo, format2) > this.codecMaxValues.inputSize) {
            return 0;
        }
    ...
    /* access modifiers changed from: protected */
    public void dropOutputBuffer(MediaCodec mediaCodec, int i4, long j4) {
    ...
    public CodecMaxValues getCodecMaxValues(MediaCodecInfo mediaCodecInfo, Format format, Format[] formatArr) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (z5) {
            Log.w(TAG, "Resolutions unknown. Codec max resolution: " + i4 + "x" + i5);
            Point codecMaxSize = getCodecMaxSize(mediaCodecInfo, format);
            if (codecMaxSize != null) {
                i4 = Math.max(i4, codecMaxSize.x);
                i5 = Math.max(i5, codecMaxSize.y);
                maxInputSize = Math.max(maxInputSize, getMaxInputSize(mediaCodecInfo, format.sampleMimeType, i4, i5));
                Log.w(TAG, "Codec max resolution adjusted to: " + i4 + "x" + i5);
            }
        }
        return new CodecMaxValues(i4, i5, maxInputSize);
    }
    ...
    public MediaFormat getMediaFormat(Format format, CodecMaxValues codecMaxValues2, boolean z4, int i4) {
    ...
    /* access modifiers changed from: protected */
    public boolean maybeDropBuffersToKeyframe(MediaCodec mediaCodec, int i4, long j4, long j5) throws ExoPlaybackException {
    ...
    public void onCodecInitialized(String str, long j4, long j5) {
        String str2 = str;
        this.eventDispatcher.decoderInitialized(str2, j4, j5);
    ...
    public void onOutputFormatChanged(MediaCodec mediaCodec, MediaFormat mediaFormat) {
        ...
        if (z4) {
            i4 = (mediaFormat.getInteger(KEY_CROP_RIGHT) - mediaFormat.getInteger(KEY_CROP_LEFT)) + 1;
        } else {
            i4 = mediaFormat.getInteger("width");
        }
        this.currentWidth = i4;
        if (z4) {
            i5 = (mediaFormat.getInteger(KEY_CROP_BOTTOM) - mediaFormat.getInteger(KEY_CROP_TOP)) + 1;
        } else {
            i5 = mediaFormat.getInteger("height");
        }
        this.currentHeight = i5;
        float f4 = this.pendingPixelWidthHeightRatio;
        this.currentPixelWidthHeightRatio = f4;
        if (Util.SDK_INT >= 21) {
            ...
            if (i6 == 90 || i6 == 270) {
                ...
                this.currentPixelWidthHeightRatio = 1.0f / f4;
            }
        } else {
    ...
    public void onStreamChanged(Format[] formatArr, long j4) throws ExoPlaybackException {
        if (this.outputStreamOffsetUs == C.TIME_UNSET) {
            ...
            jArr[i5 - 1] = j4;
            this.pendingOutputStreamSwitchTimesUs[i5 - 1] = this.lastInputTimeUs;
        }
    ...
    public boolean processOutputBuffer(long j4, long j5, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i4, int i5, long j6, boolean z4) throws ExoPlaybackException {
        ...
        if (z4) {
            skipOutputBuffer(mediaCodec3, i6, j11);
            return true;
        }
        long j12 = j10 - j8;
        if (this.surface != this.dummySurface) {
            ...
            long j13 = j11;
            if (!this.renderedFirstFrame || (z5 && shouldForceRenderOutputBuffer(j12, elapsedRealtime - this.lastRenderTimeUs))) {
                MediaCodec mediaCodec4 = mediaCodec;
                long j14 = j13;
                if (Util.SDK_INT >= 21) {
                    renderOutputBufferV21(mediaCodec4, i6, j14, System.nanoTime());
                } else {
                    renderOutputBuffer(mediaCodec4, i6, j14);
                }
                return true;
            }
            if (z5 && j8 != this.initialPositionUs) {
                ...
                if (shouldDropBuffersToKeyframe(j15, j9)) {
                    mediaCodec2 = mediaCodec;
                    j7 = j13;
                    if (maybeDropBuffersToKeyframe(mediaCodec2, i6, j7, j8)) {
                        return false;
                    }
                } else {
                    mediaCodec2 = mediaCodec;
                ...
                if (shouldDropOutputBuffer(j15, j9)) {
                    dropOutputBuffer(mediaCodec2, i6, j7);
                    return true;
                } else if (Util.SDK_INT >= 21) {
                    if (j15 < 50000) {
                        renderOutputBufferV21(mediaCodec2, i6, j7, adjustReleaseTime);
                        return true;
                    }
                    ...
                    renderOutputBuffer(mediaCodec2, i6, j7);
                    return true;
                }
            }
            return false;
        } else if (!isBufferLate(j12)) {
            return false;
        } else {
            skipOutputBuffer(mediaCodec3, i6, j11);
            return true;
    ...
    /* access modifiers changed from: protected */
    public void renderOutputBuffer(MediaCodec mediaCodec, int i4, long j4) {
    ...
    /* access modifiers changed from: protected */
    @TargetApi(21)
    public void renderOutputBufferV21(MediaCodec mediaCodec, int i4, long j4, long j5) {
        maybeNotifyVideoSizeChanged();
        TraceUtil.beginSection("releaseOutputBuffer");
    ...
    /* access modifiers changed from: protected */
    public boolean shouldDropBuffersToKeyframe(long j4, long j5) {
        return isBufferVeryLate(j4);
    }

    /* access modifiers changed from: protected */
    public boolean shouldDropOutputBuffer(long j4, long j5) {
        return isBufferLate(j4);
    }

    /* access modifiers changed from: protected */
    public boolean shouldForceRenderOutputBuffer(long j4, long j5) {
        if (!isBufferLate(j4) || j5 <= 100000) {
            return false;
        }
        return true;
    }
    ...
    /* access modifiers changed from: protected */
    public void skipOutputBuffer(MediaCodec mediaCodec, int i4, long j4) {
    ...
    public int supportsFormat(MediaCodecSelector mediaCodecSelector, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, Format format) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfo == null) {
            ...
            if (isCodecSupported && (i6 = format.width) > 0 && (i7 = format.height) > 0) {
                if (Util.SDK_INT >= 21) {
                    isCodecSupported = decoderInfo.isVideoSizeAndRateSupportedV21(i6, i7, (double) format.frameRate);
                } else {
                    if (i6 * i7 > MediaCodecUtil.maxH264DecodableFrameSize()) {
                        z5 = false;
                    }
                    if (!z5) {
    ...
    /* access modifiers changed from: protected */
    public void updateDroppedBufferCounters(int i4) {
    ...
    public MediaCodecVideoRenderer(Context context2, MediaCodecSelector mediaCodecSelector, long j4) {
        this(context2, mediaCodecSelector, j4, (Handler) null, (VideoRendererEventListener) null, -1);
    }

    public MediaCodecVideoRenderer(Context context2, MediaCodecSelector mediaCodecSelector, long j4, @Nullable Handler handler, @Nullable VideoRendererEventListener videoRendererEventListener, int i4) {
        this(context2, mediaCodecSelector, j4, (DrmSessionManager<FrameworkMediaCrypto>) null, false, handler, videoRendererEventListener, i4);
    }

    public MediaCodecVideoRenderer(Context context2, MediaCodecSelector mediaCodecSelector, long j4, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, boolean z4, @Nullable Handler handler, @Nullable VideoRendererEventListener videoRendererEventListener, int i4) {
        super(2, mediaCodecSelector, drmSessionManager, z4);
        this.allowedJoiningTimeMs = j4;
        this.maxDroppedFramesToNotify = i4;
