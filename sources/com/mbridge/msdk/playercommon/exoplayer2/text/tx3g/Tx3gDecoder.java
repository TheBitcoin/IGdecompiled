...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    private static void attachColor(SpannableStringBuilder spannableStringBuilder, int i4, int i5, int i6, int i7, int i8) {
        if (i4 != i5) {
            spannableStringBuilder.setSpan(new ForegroundColorSpan((i4 >>> 8) | ((i4 & 255) << 24)), i6, i7, i8 | 33);
        }
    }

    private static void attachFontFace(SpannableStringBuilder spannableStringBuilder, int i4, int i5, int i6, int i7, int i8) {
        boolean z4;
        boolean z5;
        if (i4 != i5) {
            int i9 = i8 | 33;
    ...
    private static void attachFontFamily(SpannableStringBuilder spannableStringBuilder, String str, String str2, int i4, int i5, int i6) {
        if (str != str2) {
    ...
    private void decodeInitializationData(List<byte[]> list) {
        ...
        if (list != null && list.size() == 1 && (list.get(0).length == 48 || list.get(0).length == 53)) {
            ...
            int i4 = bArr[25] * 20;
            this.calculatedVideoTrackHeight = i4;
            if ((bArr[0] & 32) != 0) {
                z4 = true;
            }
            this.customVerticalPlacement = z4;
            if (z4) {
                float f4 = ((float) ((bArr[11] & 255) | ((bArr[10] & 255) << 8))) / ((float) i4);
                this.defaultVerticalPlacement = f4;
                this.defaultVerticalPlacement = Util.constrainValue(f4, 0.0f, 0.95f);
                return;
            }
