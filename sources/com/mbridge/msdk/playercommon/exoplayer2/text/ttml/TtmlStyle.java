...
final class TtmlStyle {
    ...
    public final TtmlStyle setBackgroundColor(int i4) {
    ...
    public final TtmlStyle setFontColor(int i4) {
        boolean z4;
        if (this.inheritableStyle == null) {
            z4 = true;
        } else {
    ...
    public final TtmlStyle setFontSize(float f4) {
        this.fontSize = f4;
        return this;
    }

    public final TtmlStyle setFontSizeUnit(int i4) {
