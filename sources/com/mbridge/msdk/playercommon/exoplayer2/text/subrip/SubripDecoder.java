...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    private static long parseTimecode(Matcher matcher, int i4) {
        return ((Long.parseLong(matcher.group(i4 + 1)) * 3600000) + (Long.parseLong(matcher.group(i4 + 2)) * ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS) + (Long.parseLong(matcher.group(i4 + 3)) * 1000) + Long.parseLong(matcher.group(i4 + 4))) * 1000;
    }

    /* access modifiers changed from: protected */
    public final SubripSubtitle decode(byte[] bArr, int i4, boolean z4) {
