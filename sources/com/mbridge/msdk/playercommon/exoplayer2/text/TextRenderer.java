...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private long getNextEventTime() {
        int i4 = this.nextSubtitleEventIndex;
        if (i4 == -1 || i4 >= this.subtitle.getEventTimeCount()) {
    ...
    /* access modifiers changed from: protected */
    public final void onStreamChanged(Format[] formatArr, long j4) throws ExoPlaybackException {
        ...
        if (!this.outputStreamEnded) {
            ...
            if (getState() == 2) {
                ...
                if (subtitleOutputBuffer != null) {
                    if (subtitleOutputBuffer.isEndOfStream()) {
                    ...
                    } else if (this.nextSubtitle.timeUs <= j4) {
                        ...
                        this.nextSubtitle = null;
                        this.nextSubtitleEventIndex = subtitleOutputBuffer3.getNextEventTimeIndex(j4);
                        z4 = true;
                    }
                }
                if (z4) {
                    updateOutput(this.subtitle.getCues(j4));
                }
                if (this.decoderReplacementState != 2) {
