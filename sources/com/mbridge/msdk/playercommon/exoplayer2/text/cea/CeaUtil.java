...
public final class CeaUtil {
    ...
    public static void consume(long j4, ParsableByteArray parsableByteArray, TrackOutput[] trackOutputArr) {
        int i4;
        boolean z4;
        boolean z5;
        ...
        while (parsableByteArray2.bytesLeft() > 1) {
            ...
            if (readNon255TerminatedValue2 == -1 || readNon255TerminatedValue2 > parsableByteArray2.bytesLeft()) {
                ...
                if (readUnsignedShort == 49) {
                    if (i4 == USER_ID_GA94 || i4 == USER_ID_DTG1) {
                        z5 = true;
                    } else {
                        z5 = false;
                    }
                ...
                if (z4) {
                    ...
                    for (TrackOutput trackOutput : trackOutputArr2) {
                        ...
                        trackOutput.sampleMetadata(j4, 1, readUnsignedByte3, 0, (TrackOutput.CryptoData) null);
                    }
                }
            }
