...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private static final class CueBuilder {
        ...
        static {
            ...
            WINDOW_STYLE_FILL = new int[]{argbColorFromCeaColor, argbColorFromCeaColor2, i4, i5, argbColorFromCeaColor2, argbColorFromCeaColor, argbColorFromCeaColor};
            int i6 = argbColorFromCeaColor2;
            PEN_STYLE_BACKGROUND = new int[]{argbColorFromCeaColor, argbColorFromCeaColor, i4, i5, argbColorFromCeaColor, i6, i6};
        }
        ...
        public static int getArgbColorFromCeaColor(int i4, int i5, int i6) {
            return getArgbColorFromCeaColor(i4, i5, i6, 0);
        }
        ...
        public final void defineWindow(boolean z4, boolean z5, boolean z6, int i4, boolean z7, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
            int i12 = i10;
            int i13 = i11;
            this.defined = true;
            this.visible = z4;
        ...
        public final void setPenAttributes(int i4, int i5, int i6, boolean z4, boolean z5, int i7, int i8) {
            if (this.italicsStartPosition != -1) {
                if (!z4) {
        ...
        public final void setPenColor(int i4, int i5, int i6) {
            if (!(this.foregroundColorStartPosition == -1 || this.foregroundColor == i4)) {
                this.captionStringBuilder.setSpan(new ForegroundColorSpan(this.foregroundColor), this.foregroundColorStartPosition, this.captionStringBuilder.length(), 33);
            }
            if (i4 != COLOR_SOLID_WHITE) {
                this.foregroundColorStartPosition = this.captionStringBuilder.length();
                this.foregroundColor = i4;
            }
            if (!(this.backgroundColorStartPosition == -1 || this.backgroundColor == i5)) {
                this.captionStringBuilder.setSpan(new BackgroundColorSpan(this.backgroundColor), this.backgroundColorStartPosition, this.captionStringBuilder.length(), 33);
            }
            if (i5 != COLOR_SOLID_BLACK) {
                this.backgroundColorStartPosition = this.captionStringBuilder.length();
                this.backgroundColor = i5;
            }
        }

        public final void setPenLocation(int i4, int i5) {
            if (this.row != i4) {
                append(10);
            }
            this.row = i4;
        ...
        public final void setWindowAttributes(int i4, int i5, boolean z4, int i6, int i7, int i8, int i9) {
            this.windowFillColor = i4;
    ...
    public Cea708Decoder(int i4) {
        this.selectedServiceNumber = i4 == -1 ? 1 : i4;
    ...
    private List<Cue> getDisplayCues() {
        ...
        for (int i4 = 0; i4 < 8; i4++) {
            if (!this.cueBuilders[i4].isEmpty() && this.cueBuilders[i4].isVisible()) {
                arrayList.add(this.cueBuilders[i4].build());
            }
        }
    ...
    private void handleC0Command(int i4) {
        ...
        if (i4 == 3) {
            ...
            switch (i4) {
                ...
                default:
                    if (i4 >= 17 && i4 <= 23) {
                        Log.w(TAG, "Currently unsupported COMMAND_EXT1 Command: " + i4);
                        this.serviceBlockPacket.skipBits(8);
                        return;
                    } else if (i4 < 24 || i4 > 31) {
                        Log.w(TAG, "Invalid C0 command: " + i4);
                        return;
                    } else {
                        Log.w(TAG, "Currently unsupported COMMAND_P16 Command: " + i4);
    ...
    private void handleDefineWindow(int i4) {
        CueBuilder cueBuilder = this.cueBuilders[i4];
        this.serviceBlockPacket.skipBits(2);
    ...
    private void handleG0Character(int i4) {
        if (i4 == 127) {
            ...
            this.currentCueBuilder.append((char) (i4 & 255));
        }
    }
                ...
                default:
                    switch (i4) {
                        ...
                        case ModuleDescriptor.MODULE_VERSION:
                            ...
                            return;
                        default:
                            Log.w(TAG, "Invalid G2 character: " + i4);
                            return;
                    }
            }
        } else {
    ...
    private void handleG3Character(int i4) {
        ...
        Log.w(TAG, "Invalid G3 character: " + i4);
    ...
    private void processCurrentPacket() {
        ...
        if (i4 != (dtvCcPacket.packetSize * 2) - 1) {
        ...
        this.serviceBlockPacket.reset(dtvCcPacket.packetData, i4);
        int readBits = this.serviceBlockPacket.readBits(3);
        ...
        while (this.ccData.bytesLeft() >= 3) {
            ...
            if ((i4 == 2 || i4 == 3) && z4) {
                if (i4 == 3) {
                    ...
                    DtvCcPacket dtvCcPacket = new DtvCcPacket(i5, b5);
