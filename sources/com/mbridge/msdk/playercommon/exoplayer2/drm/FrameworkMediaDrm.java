        ...
        if (onEventListener == null) {
            ...
            r32 = new MediaDrm.OnEventListener() {
                public void onEvent(@NonNull MediaDrm mediaDrm, @Nullable byte[] bArr, int i4, int i5, byte[] bArr2) {
                    onEventListener.onEvent(FrameworkMediaDrm.this, bArr, i4, i5, bArr2);
                }
            };
        }
            ...
            if (onKeyStatusChangeListener == null) {
                ...
                r22 = new MediaDrm.OnKeyStatusChangeListener() {
                    public void onKeyStatusChange(@NonNull MediaDrm mediaDrm, @NonNull byte[] bArr, @NonNull List<MediaDrm.KeyStatus> list, boolean z4) {
                        ...
                        for (MediaDrm.KeyStatus a5 : list) {
                            MediaDrm.KeyStatus a6 = b.a(a5);
                            arrayList.add(new ExoMediaDrm.DefaultKeyStatus(a6.getStatusCode(), a6.getKeyId()));
                        }
