...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    private byte[] blockingKeyRequest(int i4, byte[] bArr, DrmInitData drmInitData) throws DrmSession.DrmSessionException {
        DrmSession openBlockingKeyRequest = openBlockingKeyRequest(i4, bArr, drmInitData);
    ...
    private DrmSession<T> openBlockingKeyRequest(int i4, byte[] bArr, DrmInitData drmInitData) {
        this.drmSessionManager.setMode(i4, bArr);
