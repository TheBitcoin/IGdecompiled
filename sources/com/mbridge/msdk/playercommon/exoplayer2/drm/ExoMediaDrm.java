...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    public static final class DefaultKeyStatus implements KeyStatus {
        ...
        DefaultKeyStatus(int i4, byte[] bArr) {
            this.statusCode = i4;
            this.keyId = bArr;
        }
    ...
    public interface OnEventListener<T extends ExoMediaCrypto> {
        void onEvent(ExoMediaDrm<? extends T> exoMediaDrm, byte[] bArr, int i4, int i5, @Nullable byte[] bArr2);
    }
    ...
    KeyRequest getKeyRequest(byte[] bArr, byte[] bArr2, String str, int i4, HashMap<String, String> hashMap) throws NotProvisionedException;
