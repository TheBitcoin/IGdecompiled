...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public final int hashCode() {
            ...
            if (this.hashCode == 0) {
                ...
                this.hashCode = ((((hashCode2 + i4) * 31) + this.mimeType.hashCode()) * 31) + Arrays.hashCode(this.data);
            }
    ...
    public final int hashCode() {
        ...
        if (this.hashCode == 0) {
            ...
            this.hashCode = (i4 * 31) + Arrays.hashCode(this.schemeDatas);
        }
        return this.hashCode;
    }
    ...
    public final SchemeData get(int i4) {
