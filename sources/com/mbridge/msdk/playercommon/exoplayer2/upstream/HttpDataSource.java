...
public interface HttpDataSource extends DataSource {
    ...
    public static final class InvalidResponseCodeException extends HttpDataSourceException {
        ...
        public InvalidResponseCodeException(int i4, Map<String, List<String>> map, DataSpec dataSpec) {
            super("Response code: " + i4, dataSpec, 1);
    ...
    int read(byte[] bArr, int i4, int i5) throws HttpDataSourceException;
    ...
    public static class HttpDataSourceException extends IOException {
        ...
        public HttpDataSourceException(DataSpec dataSpec2, int i4) {
            this.dataSpec = dataSpec2;
            this.type = i4;
        }

        public HttpDataSourceException(String str, DataSpec dataSpec2, int i4) {
            super(str);
            this.dataSpec = dataSpec2;
            this.type = i4;
        }

        public HttpDataSourceException(IOException iOException, DataSpec dataSpec2, int i4) {
            super(iOException);
            this.dataSpec = dataSpec2;
            this.type = i4;
        }

        public HttpDataSourceException(String str, IOException iOException, DataSpec dataSpec2, int i4) {
