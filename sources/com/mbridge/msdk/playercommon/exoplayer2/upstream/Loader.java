...
public final class Loader implements LoaderErrorThrower {
    ...
    public interface Callback<T extends Loadable> {
        ...
        int onLoadError(T t4, long j4, long j5, IOException iOException);
    }
    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public LoadTask(Looper looper, T t4, Callback<T> callback2, int i4, long j4) {
            super(looper);
            this.loadable = t4;
        ...
        public final void handleMessage(Message message) {
            if (!this.released) {
                ...
                if (i4 == 0) {
                    ...
                    if (this.canceled) {
                        this.callback.onLoadCanceled(this.loadable, elapsedRealtime, j4, false);
                        return;
                    }
                    int i5 = message.what;
                    int i6 = 1;
                    if (i5 == 1) {
                        ...
                        try {
                            this.callback.onLoadCompleted(this.loadable, elapsedRealtime, j4);
                        ...
                        int onLoadError = this.callback.onLoadError(this.loadable, elapsedRealtime, j4, iOException);
                        if (onLoadError == 3) {
                            IOException unused2 = Loader.this.fatalError = this.currentError;
                        } else if (onLoadError != 2) {
                            if (onLoadError != 1) {
                                i6 = 1 + this.errorCount;
                            }
                            this.errorCount = i6;
        ...
        public final void maybeThrowError(int i4) throws IOException {
    ...
    public final <T extends Loadable> long startLoading(T t4, Callback<T> callback, int i4) {
        boolean z4;
        ...
        long elapsedRealtime = SystemClock.elapsedRealtime();
        new LoadTask(myLooper, t4, callback, i4, elapsedRealtime).start(0);
