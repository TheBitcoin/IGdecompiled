...
public final class SimpleCache implements Cache {
    ...
    private SimpleCacheSpan getSpan(String str, long j4) throws Cache.CacheException {
        SimpleCacheSpan span;
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent == null) {
            return SimpleCacheSpan.createOpenHole(str, j4);
        }
        while (true) {
            span = cachedContent.getSpan(j4);
    ...
    private void removeStaleSpansAndCachedContents() throws Cache.CacheException {
        ...
        for (int i4 = 0; i4 < arrayList.size(); i4++) {
            removeSpan((CacheSpan) arrayList.get(i4), false);
        }
        this.index.removeEmpty();
        this.index.store();
    }
    ...
    public final synchronized long getCachedLength(String str, long j4, long j5) {
        long j6;
        Assertions.checkState(!this.released);
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent != null) {
            j6 = cachedContent.getCachedBytesLength(j4, j5);
        } else {
            j6 = -j5;
        }
        return j6;
    ...
    public final synchronized boolean isCached(String str, long j4, long j5) {
        boolean z4;
        z4 = false;
        Assertions.checkState(!this.released);
        CachedContent cachedContent = this.index.get(str);
        if (cachedContent != null && cachedContent.getCachedBytesLength(j4, j5) >= j5) {
            z4 = true;
        }
        return z4;
    }
    ...
    public final synchronized void setContentLength(String str, long j4) throws Cache.CacheException {
        ContentMetadataMutations contentMetadataMutations = new ContentMetadataMutations();
        ContentMetadataInternal.setContentLength(contentMetadataMutations, j4);
        applyContentMetadataMutations(str, contentMetadataMutations);
    }

    public final synchronized File startFile(String str, long j4, long j5) throws Cache.CacheException {
        Throwable th;
        try {
            Assertions.checkState(!this.released);
            CachedContent cachedContent = this.index.get(str);
            ...
            long j6 = j4;
            try {
                this.evictor.onStartFile(this, str, j6, j5);
                long j7 = j6;
    ...
    public final synchronized SimpleCacheSpan startReadWrite(String str, long j4) throws InterruptedException, Cache.CacheException {
    ...
    public final synchronized SimpleCacheSpan startReadWriteNonBlocking(String str, long j4) throws Cache.CacheException {
        Assertions.checkState(!this.released);
        SimpleCacheSpan span = getSpan(str, j4);
        if (span.isCached) {
