...
public final class DefaultContentMetadata implements ContentMetadata {
    ...
    public final int hashCode() {
        if (this.hashCode == 0) {
            int i4 = 0;
            for (Map.Entry next : this.metadata.entrySet()) {
                i4 += Arrays.hashCode((byte[]) next.getValue()) ^ ((String) next.getKey()).hashCode();
            }
            this.hashCode = i4;
        }
    ...
    public final long get(String str, long j4) {
        return this.metadata.containsKey(str) ? ByteBuffer.wrap(this.metadata.get(str)).getLong() : j4;
    }
}
