...
public final class CacheDataSource implements DataSource {
    ...
    private void notifyCacheIgnored(int i4) {
        ...
        if (eventListener2 != null) {
            eventListener2.onCacheIgnored(i4);
        }
    }
    ...
    public final int read(byte[] bArr, int i4, int i5) throws IOException {
        ...
        try {
            ...
            int read = this.currentDataSource.read(bArr, i4, i5);
            if (read != -1) {
    ...
    public CacheDataSource(Cache cache2, DataSource dataSource, int i4) {
        this(cache2, dataSource, i4, DEFAULT_MAX_CACHE_FILE_SIZE);
    }

    public CacheDataSource(Cache cache2, DataSource dataSource, int i4, long j4) {
        this(cache2, dataSource, new FileDataSource(), new CacheDataSink(cache2, j4), i4, (EventListener) null);
    }

    public CacheDataSource(Cache cache2, DataSource dataSource, DataSource dataSource2, DataSink dataSink, int i4, @Nullable EventListener eventListener2) {
        this.cache = cache2;
        this.cacheReadDataSource = dataSource2;
        boolean z4 = false;
        this.blockOnCache = (i4 & 1) != 0;
        this.ignoreCacheOnError = (i4 & 2) != 0;
        this.ignoreCacheForUnsetLengthRequests = (i4 & 4) != 0 ? true : z4;
