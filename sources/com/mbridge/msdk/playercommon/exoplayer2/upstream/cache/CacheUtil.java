...
public final class CacheUtil {
    ...
    public static void getCached(DataSpec dataSpec, Cache cache, CachingCounters cachingCounters) {
        ...
        cachingCounters2.contentLength = j6;
        cachingCounters2.alreadyCachedBytes = 0;
        cachingCounters2.newlyCachedBytes = 0;
        long j7 = j6;
        while (j7 != 0) {
            int i4 = (j7 > -1 ? 1 : (j7 == -1 ? 0 : -1));
            if (i4 != 0) {
                j4 = j7;
            } else {
                j4 = Long.MAX_VALUE;
            }
            long cachedLength = cache2.getCachedLength(key, j5, j4);
            if (cachedLength > 0) {
    ...
    private static long readAndDiscard(com.mbridge.msdk.playercommon.exoplayer2.upstream.DataSpec r16, long r17, long r19, com.mbridge.msdk.playercommon.exoplayer2.upstream.DataSource r21, byte[] r22, com.mbridge.msdk.playercommon.exoplayer2.util.PriorityTaskManager r23, int r24, com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CacheUtil.CachingCounters r25) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x004a:
            ...
            int r7 = (int) r6     // Catch:{ PriorityTooLowException -> 0x0046, all -> 0x0044 }
            goto L_0x0063
        L_0x0062:
            int r7 = r0.length     // Catch:{ PriorityTooLowException -> 0x0046, all -> 0x0044 }
        L_0x0063:
            r6 = 0
            int r6 = r1.read(r0, r6, r7)     // Catch:{ PriorityTooLowException -> 0x0046, all -> 0x0044 }
            r7 = -1
    ...
    public static void cache(DataSpec dataSpec, Cache cache, CacheDataSource cacheDataSource, byte[] bArr, PriorityTaskManager priorityTaskManager, int i4, @Nullable CachingCounters cachingCounters, @Nullable AtomicBoolean atomicBoolean, boolean z4) throws IOException, InterruptedException {
        DataSpec dataSpec2 = dataSpec;
        Cache cache2 = cache;
        CachingCounters cachingCounters2 = cachingCounters;
        ...
        String key = getKey(dataSpec2);
        long j4 = dataSpec2.absoluteStreamPosition;
        long j5 = dataSpec2.length;
        if (j5 == -1) {
            j5 = cache2.getContentLength(key);
        }
        long j6 = j5;
        while (true) {
            long j7 = 0;
            ...
            if (atomicBoolean == null || !atomicBoolean.get()) {
                ...
                long cachedLength = cache2.getCachedLength(key, j4, i5 != 0 ? j6 : Long.MAX_VALUE);
                String str = key;
                long j8 = j4;
                if (cachedLength <= 0) {
                    long j9 = -cachedLength;
                    if (readAndDiscard(dataSpec2, j8, j9, cacheDataSource, bArr, priorityTaskManager, i4, cachingCounters3) >= j9) {
                        cachedLength = j9;
                    } else if (z4 && i5 != 0) {
