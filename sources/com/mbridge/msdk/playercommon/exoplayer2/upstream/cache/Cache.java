...
public interface Cache {
    ...
    boolean isCached(String str, long j4, long j5);
    ...
    void setContentLength(String str, long j4) throws CacheException;

    File startFile(String str, long j4, long j5) throws CacheException;

    CacheSpan startReadWrite(String str, long j4) throws InterruptedException, CacheException;

    @Nullable
    CacheSpan startReadWriteNonBlocking(String str, long j4) throws CacheException;
}
