...
public final class ParsingLoadable<T> implements Loader.Loadable {
    ...
    public ParsingLoadable(DataSource dataSource2, Uri uri, int i4, Parser<? extends T> parser2) {
        this(dataSource2, new DataSpec(uri, 3), i4, parser2);
    }
    ...
    public ParsingLoadable(DataSource dataSource2, DataSpec dataSpec2, int i4, Parser<? extends T> parser2) {
