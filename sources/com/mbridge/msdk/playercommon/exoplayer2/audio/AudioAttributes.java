...
public final class AudioAttributes {
    ...
    public static final class Builder {
        ...
        public final Builder setContentType(int i4) {
            this.contentType = i4;
            return this;
        }

        public final Builder setFlags(int i4) {
            this.flags = i4;
            return this;
        }

        public final Builder setUsage(int i4) {
            this.usage = i4;
            return this;
        }
    }
    ...
    private AudioAttributes(int i4, int i5, int i6) {
        this.contentType = i4;
        this.flags = i5;
        this.usage = i6;
    }
