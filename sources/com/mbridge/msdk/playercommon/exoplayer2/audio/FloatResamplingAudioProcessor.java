...
final class FloatResamplingAudioProcessor implements AudioProcessor {
    ...
    private static void writePcm32BitFloat(int i4, ByteBuffer byteBuffer) {
        int floatToIntBits = Float.floatToIntBits((float) (((double) i4) * PCM_32_BIT_INT_TO_PCM_32_BIT_FLOAT_FACTOR));
    ...
    public final boolean configure(int i4, int i5, int i6) throws AudioProcessor.UnhandledFormatException {
        if (!Util.isEncodingHighResolutionIntegerPcm(i6)) {
            throw new AudioProcessor.UnhandledFormatException(i4, i5, i6);
        } else if (this.sampleRateHz == i4 && this.channelCount == i5 && this.sourceEncoding == i6) {
            return false;
        } else {
            this.sampleRateHz = i4;
            this.channelCount = i5;
            this.sourceEncoding = i6;
            return true;
        }
    }
