...
public abstract class SimpleDecoderAudioRenderer extends BaseRenderer implements MediaClock {
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public final void onAudioSessionId(int i4) {
            SimpleDecoderAudioRenderer.this.eventDispatcher.audioSessionId(i4);
        ...
        public final void onUnderrun(int i4, long j4, long j5) {
            ...
            long j6 = j4;
            long j7 = j5;
            SimpleDecoderAudioRenderer.this.eventDispatcher.audioTrackUnderrun(i5, j6, j7);
            long j8 = j6;
            int i6 = i5;
            SimpleDecoderAudioRenderer.this.onAudioTrackUnderrun(i6, j8, j7);
        }
    }
    ...
    private boolean feedInputBuffer() throws AudioDecoderException, ExoPlaybackException {
        ...
        if (this.waitingForKeys) {
            ...
            i4 = readSource(this.formatHolder, this.inputBuffer, false);
        }
        if (i4 == -3) {
            return false;
        }
    ...
    public final int supportsFormat(Format format) {
        ...
        return supportsFormatInternal | i4 | 8;
    }
    ...
    /* access modifiers changed from: protected */
    public final boolean supportsOutputEncoding(int i4) {
        return this.audioSink.isEncodingSupported(i4);
    }
