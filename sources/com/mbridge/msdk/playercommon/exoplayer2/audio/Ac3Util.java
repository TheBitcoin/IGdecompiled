...
public final class Ac3Util {
    ...
    public static final class SyncFrameInfo {
        ...
        private SyncFrameInfo(String str, int i4, int i5, int i6, int i7, int i8) {
            this.mimeType = str;
            this.streamType = i4;
    ...
    private static int getAc3SyncframeSize(int i4, int i5) {
        int i6 = i5 / 2;
        if (i4 < 0) {
            return -1;
        }
    ...
    public static Format parseAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        int i4 = SAMPLE_RATE_BY_FSCOD[(parsableByteArray.readUnsignedByte() & PsExtractor.AUDIO_STREAM) >> 6];
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        int i5 = CHANNEL_COUNT_BY_ACMOD[(readUnsignedByte & 56) >> 3];
        if ((readUnsignedByte & 4) != 0) {
            i5++;
        }
        return Format.createAudioSampleFormat(str, MimeTypes.AUDIO_AC3, (String) null, -1, -1, i5, i4, (List<byte[]>) null, drmInitData, 0, str2);
    }
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z4) {
            ...
            i4 = SAMPLE_RATE_BY_FSCOD[readBits6];
            i5 = CHANNEL_COUNT_BY_ACMOD[readBits7] + (parsableBitArray2.readBit() ? 1 : 0);
            str = MimeTypes.AUDIO_AC3;
            i6 = -1;
            i7 = AC3_SYNCFRAME_AUDIO_SAMPLE_COUNT;
        }
        return new SyncFrameInfo(str, i6, i5, i4, ac3SyncframeSize, i7);
    }
    ...
    public static Format parseEAc3AnnexFFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        int i4 = SAMPLE_RATE_BY_FSCOD[(parsableByteArray.readUnsignedByte() & PsExtractor.AUDIO_STREAM) >> 6];
        int readUnsignedByte = parsableByteArray.readUnsignedByte();
        int i5 = CHANNEL_COUNT_BY_ACMOD[(readUnsignedByte & 14) >> 1];
        ...
        return Format.createAudioSampleFormat(str, str3, (String) null, -1, -1, i6, i4, (List<byte[]>) null, drmInitData, 0, str2);
    }

    public static int parseEAc3SyncframeAudioSampleCount(ByteBuffer byteBuffer) {
        int i4 = 6;
        if (((byteBuffer.get(byteBuffer.position() + 4) & 192) >> 6) != 3) {
            i4 = BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[(byteBuffer.get(byteBuffer.position() + 4) & 48) >> 4];
        }
        return i4 * 256;
    }
    ...
    public static int parseTrueHdSyncframeAudioSampleCount(ByteBuffer byteBuffer, int i4) {
