...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public MediaCodecRenderer(int i4, MediaCodecSelector mediaCodecSelector2, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager2, boolean z4) {
        super(i4);
        boolean z5;
        if (Util.SDK_INT >= 16) {
            z5 = true;
    ...
    private static boolean codecNeedsEosFlushWorkaround(String str) {
        ...
        if (i4 > 19 || !"hb2000".equals(Util.DEVICE)) {
            return false;
        }
    ...
    private static boolean codecNeedsFlushWorkaround(String str) {
        ...
        if (i4 != 19 || !Util.MODEL.startsWith("SM-G800")) {
            return false;
        }
    ...
    private boolean drainOutputBuffer(long j4, long j5) throws ExoPlaybackException {
        boolean z4;
        boolean z5;
        int i4;
        if (!hasOutputBuffer()) {
            if (!this.codecNeedsEosOutputExceptionWorkaround || !this.codecReceivedEos) {
                i4 = this.codec.dequeueOutputBuffer(this.outputBufferInfo, getDequeueOutputBufferTimeoutUs());
            } else {
                try {
                    i4 = this.codec.dequeueOutputBuffer(this.outputBufferInfo, getDequeueOutputBufferTimeoutUs());
            ...
            if (i4 >= 0) {
                ...
                if (bufferInfo.size != 0 || (bufferInfo.flags & 4) == 0) {
                    this.outputIndex = i4;
                    ByteBuffer outputBuffer2 = getOutputBuffer(i4);
        ...
        if (!this.codecNeedsEosOutputExceptionWorkaround || !this.codecReceivedEos) {
            ...
            z4 = processOutputBuffer(j4, j5, mediaCodec, byteBuffer2, i5, bufferInfo3.flags, bufferInfo3.presentationTimeUs, this.shouldSkipOutputBuffer);
        } else {
            try {
                ...
                z4 = processOutputBuffer(j4, j5, mediaCodec2, byteBuffer3, i6, bufferInfo4.flags, bufferInfo4.presentationTimeUs, this.shouldSkipOutputBuffer);
        ...
        if (this.codecReinitializationState == 1) {
            ...
            if (this.waitingForKeys) {
                ...
                if (this.codecReconfigurationState == 1) {
                    for (int i6 = 0; i6 < this.format.initializationData.size(); i6++) {
                        this.buffer.data.put(this.format.initializationData.get(i6));
                    }
                    this.codecReconfigurationState = 2;
                }
                i4 = this.buffer.data.position();
                i5 = readSource(this.formatHolder, this.buffer, false);
            }
            if (i5 == -3) {
                return false;
            }
            if (i5 == -5) {
                ...
                try {
                    ...
                    if (isEncrypted) {
                        this.codec.queueSecureInputBuffer(this.inputIndex, 0, getFrameworkCryptoInfo(this.buffer, i4), j4, 0);
                    } else {
                        this.codec.queueInputBuffer(this.inputIndex, 0, this.buffer.data.limit(), j4, 0);
                    }
                    resetInputBuffer();
                    this.codecReceivedBuffers = true;
                    this.codecReconfigurationState = 0;
    ...
    private static MediaCodec.CryptoInfo getFrameworkCryptoInfo(DecoderInputBuffer decoderInputBuffer, int i4) {
    ...
    private ByteBuffer getInputBuffer(int i4) {
        if (Util.SDK_INT >= 21) {
            return this.codec.getInputBuffer(i4);
        }
        return this.inputBuffers[i4];
    }

    private ByteBuffer getOutputBuffer(int i4) {
        if (Util.SDK_INT >= 21) {
            return this.codec.getOutputBuffer(i4);
        }
        return this.outputBuffers[i4];
    }
    ...
    private boolean shouldSkipOutputBuffer(long j4) {
    ...
    /* access modifiers changed from: protected */
    public abstract boolean processOutputBuffer(long j4, long j5, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i4, int i5, long j6, boolean z4) throws ExoPlaybackException;
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z4, int i4) {
            ...
            this.diagnosticInfo = buildCustomDiagnosticInfo(i4);
        }
        ...
        private static String buildCustomDiagnosticInfo(int i4) {
            ...
            return "com.google.android.exoplayer.MediaCodecTrackRenderer_" + str + Math.abs(i4);
        }
