...
public final class MediaCodecUtil {
    ...
    private static final class MediaCodecListCompatV16 implements MediaCodecListCompat {
        ...
        public final MediaCodecInfo getCodecInfoAt(int i4) {
        ...
        if (Util.SDK_INT < 26) {
            if (list.size() > 1 && MTK_RAW_DECODER_NAME.equals(list.get(0).name)) {
                for (int i4 = 1; i4 < list.size(); i4++) {
                    MediaCodecInfo mediaCodecInfo = list.get(i4);
    ...
    private static int avcLevelToMaxFrameSize(int i4) {
        if (i4 == 1 || i4 == 2) {
            return 25344;
        }
        switch (i4) {
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        try {
            ...
            int i4 = AVC_PROFILE_NUMBER_TO_CONST.get(num2.intValue(), -1);
            if (i4 == -1) {
                Log.w(TAG, "Unknown AVC profile: " + num2);
                return null;
            }
            int i5 = AVC_LEVEL_NUMBER_TO_CONST.get(num.intValue(), -1);
            if (i5 != -1) {
    ...
    public static synchronized List<MediaCodecInfo> getDecoderInfos(String str, boolean z4) throws DecoderQueryException {
        ...
        synchronized (MediaCodecUtil.class) {
            try {
                ...
                if (z4 && decoderInfosInternal.isEmpty() && 21 <= i4 && i4 <= 23) {
                    mediaCodecListCompat = new MediaCodecListCompatV16();
    ...
    private static boolean isCodecUsableDecoder(MediaCodecInfo mediaCodecInfo, String str, boolean z4, String str2) {
        ...
        if (i4 < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(Util.MANUFACTURER))) {
            String str6 = Util.DEVICE;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i4 <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(Util.MANUFACTURER)) {
            String str7 = Util.DEVICE;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i4 <= 19 && Util.DEVICE.startsWith("jflte") && "OMX.qcom.video.decoder.vp8".equals(str)) {
            return false;
        }
