...
public final class MediaCodecInfo {
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i4) {
        int i5;
        if (i4 > 1 || ((Util.SDK_INT >= 26 && i4 > 0) || MimeTypes.AUDIO_MPEG.equals(str2) || MimeTypes.AUDIO_AMR_NB.equals(str2) || MimeTypes.AUDIO_AMR_WB.equals(str2) || MimeTypes.AUDIO_AAC.equals(str2) || MimeTypes.AUDIO_VORBIS.equals(str2) || MimeTypes.AUDIO_OPUS.equals(str2) || MimeTypes.AUDIO_RAW.equals(str2) || MimeTypes.AUDIO_FLAC.equals(str2) || MimeTypes.AUDIO_ALAW.equals(str2) || MimeTypes.AUDIO_MLAW.equals(str2) || MimeTypes.AUDIO_MSGSM.equals(str2))) {
            return i4;
        }
        ...
        Log.w(TAG, "AssumedMaxChannelAdjustment: " + str + ", [" + i4 + " to " + i5 + "]");
        return i5;
    }

    @TargetApi(21)
    private static boolean areSizeAndRateSupportedV21(MediaCodecInfo.VideoCapabilities videoCapabilities, int i4, int i5, double d5) {
        if (d5 == -1.0d || d5 <= 0.0d) {
            return videoCapabilities.isSizeSupported(i4, i5);
        }
        return videoCapabilities.areSizeAndRateSupported(i4, i5, d5);
    }
    ...
    @TargetApi(21)
    public final Point alignVideoSizeV21(int i4, int i5) {
        ...
        return new Point(Util.ceilDivide(i4, widthAlignment) * widthAlignment, Util.ceilDivide(i5, heightAlignment) * heightAlignment);
    }
    ...
    @TargetApi(21)
    public final boolean isAudioChannelCountSupportedV21(int i4) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.capabilities;
        if (codecCapabilities == null) {
        ...
        if (audioCapabilities == null) {
            ...
            return false;
        } else if (adjustMaxInputChannelCount(this.name, this.mimeType, audioCapabilities.getMaxInputChannelCount()) >= i4) {
            return true;
        } else {
    ...
    @TargetApi(21)
    public final boolean isAudioSampleRateSupportedV21(int i4) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.capabilities;
        if (codecCapabilities == null) {
    ...
    @TargetApi(21)
    public final boolean isVideoSizeAndRateSupportedV21(int i4, int i5, double d5) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.capabilities;
        if (codecCapabilities == null) {
        ...
        if (videoCapabilities == null) {
            ...
            return false;
        } else if (areSizeAndRateSupportedV21(videoCapabilities, i4, i5, d5)) {
            return true;
        } else {
            if (i4 >= i5 || !areSizeAndRateSupportedV21(videoCapabilities, i5, i4, d5)) {
                logNoSupport("sizeAndRate.support, " + i4 + "x" + i5 + "x" + d5);
                return false;
            }
            logAssumedSupport("sizeAndRate.rotated, " + i4 + "x" + i5 + "x" + d5);
            return true;
        }
    }
