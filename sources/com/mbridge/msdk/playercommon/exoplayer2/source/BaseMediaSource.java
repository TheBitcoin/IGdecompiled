...
public abstract class BaseMediaSource implements MediaSource {
    ...
    /* access modifiers changed from: protected */
    public final MediaSourceEventListener.EventDispatcher createEventDispatcher(MediaSource.MediaPeriodId mediaPeriodId, long j4) {
        Assertions.checkArgument(mediaPeriodId != null);
        return this.eventDispatcher.withParameters(0, mediaPeriodId, j4);
    }

    /* access modifiers changed from: protected */
    public final MediaSourceEventListener.EventDispatcher createEventDispatcher(int i4, @Nullable MediaSource.MediaPeriodId mediaPeriodId, long j4) {
        return this.eventDispatcher.withParameters(i4, mediaPeriodId, j4);
    }
}
