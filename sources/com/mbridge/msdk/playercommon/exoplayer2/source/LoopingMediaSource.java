...
public final class LoopingMediaSource extends CompositeMediaSource<Void> {
    ...
    private static final class InfinitelyLoopingTimeline extends ForwardingTimeline {
        ...
        public final int getNextWindowIndex(int i4, int i5, boolean z4) {
        ...
        public final int getPreviousWindowIndex(int i4, int i5, boolean z4) {
    ...
    private static final class LoopingTimeline extends AbstractConcatenatedTimeline {
        ...
        public final int getChildIndexByPeriodIndex(int i4) {
            return i4 / this.childPeriodCount;
        }

        /* access modifiers changed from: protected */
        public final int getChildIndexByWindowIndex(int i4) {
            return i4 / this.childWindowCount;
        }
