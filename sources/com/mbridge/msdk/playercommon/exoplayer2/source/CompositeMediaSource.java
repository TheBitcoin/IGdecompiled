...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i4, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.id, i4);
        ...
        public final void onDownstreamFormatChanged(int i4, @Nullable MediaSource.MediaPeriodId mediaPeriodId, MediaSourceEventListener.MediaLoadData mediaLoadData) {
            if (maybeUpdateEventDispatcher(i4, mediaPeriodId)) {
    ...
    @Nullable
    public MediaSource.MediaPeriodId getMediaPeriodIdForChildMediaPeriodId(@Nullable T t4, MediaSource.MediaPeriodId mediaPeriodId) {
    ...
    /* access modifiers changed from: protected */
    public int getWindowIndexForChildWindowIndex(@Nullable T t4, int i4) {
        return i4;
    }
    ...
    /* access modifiers changed from: protected */
    public abstract void onChildSourceInfoRefreshed(@Nullable T t4, MediaSource mediaSource, Timeline timeline, @Nullable Object obj);

    /* access modifiers changed from: protected */
    public final void prepareChildSource(@Nullable final T t4, MediaSource mediaSource) {
        ...
        AnonymousClass1 r02 = new MediaSource.SourceInfoRefreshListener() {
            public void onSourceInfoRefreshed(MediaSource mediaSource, Timeline timeline, @Nullable Object obj) {
                CompositeMediaSource.this.onChildSourceInfoRefreshed(t4, mediaSource, timeline, obj);
            }
        };
        ForwardingEventListener forwardingEventListener = new ForwardingEventListener(t4);
        this.childSources.put(t4, new MediaSourceAndListener(mediaSource, r02, forwardingEventListener));
    ...
    /* access modifiers changed from: protected */
    public final void releaseChildSource(@Nullable T t4) {
        MediaSourceAndListener remove = this.childSources.remove(t4);
