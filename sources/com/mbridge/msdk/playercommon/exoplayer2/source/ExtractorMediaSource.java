...
public final class ExtractorMediaSource extends BaseMediaSource implements ExtractorMediaPeriod.Listener {
    ...
    public static final class Factory implements AdsMediaSource.MediaSourceFactory {
        ...
        public final Factory setContinueLoadingCheckIntervalBytes(int i4) {
    ...
    private void notifySourceInfoRefreshed(long j4, boolean z4) {
    ...
    public final void onSourceInfoRefreshed(long j4, boolean z4) {
        if (j4 == C.TIME_UNSET) {
            j4 = this.timelineDurationUs;
        }
        if (this.timelineDurationUs != j4 || this.timelineIsSeekable != z4) {
            notifySourceInfoRefreshed(j4, z4);
        }
    }
    ...
    @Deprecated
    public ExtractorMediaSource(Uri uri2, DataSource.Factory factory, ExtractorsFactory extractorsFactory2, int i4, Handler handler, EventListener eventListener, String str, int i5) {
        this(uri2, factory, extractorsFactory2, i4, str, i5, (Object) null);
        if (eventListener != null && handler != null) {
            addEventListener(handler, new EventListenerWrapper(eventListener));
        }
    }

    private ExtractorMediaSource(Uri uri2, DataSource.Factory factory, ExtractorsFactory extractorsFactory2, int i4, @Nullable String str, int i5, @Nullable Object obj) {
        this.uri = uri2;
        this.dataSourceFactory = factory;
        this.extractorsFactory = extractorsFactory2;
        this.minLoadableRetryCount = i4;
