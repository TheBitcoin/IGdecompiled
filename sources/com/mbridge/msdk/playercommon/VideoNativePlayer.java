...
public class VideoNativePlayer implements Player.EventListener {
            ...
            try {
                if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                    ...
                    if (VideoNativePlayer.this.exoPlayer == null || VideoNativePlayer.this.exoPlayer.getDuration() <= 0) {
                        ...
                        j4 = VideoNativePlayer.this.exoPlayer.getDuration() / 100;
                    }
                    if (access$100 >= 0 && j4 > 0 && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                        VideoNativePlayer videoNativePlayer2 = VideoNativePlayer.this;
                        videoNativePlayer2.postOnPlayProgressMSOnMainThread(videoNativePlayer2.mCurrentPosition / 100, j4);
                    }
            ...
            try {
                if (VideoNativePlayer.this.exoPlayer != null && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                    ...
                    if (VideoNativePlayer.this.exoPlayer == null || VideoNativePlayer.this.exoPlayer.getDuration() <= 0) {
                        ...
                        i4 = (int) (VideoNativePlayer.this.exoPlayer.getDuration() / 1000);
                    }
                    if (VideoNativePlayer.this.mIsStartPlay) {
                        VideoNativePlayer.this.postOnPlayStartOnMainThread(i4);
                        af.c(VideoNativePlayer.TAG, "onPlayStarted()");
                        boolean unused2 = VideoNativePlayer.this.mIsStartPlay = false;
                    }
                    if (access$100 >= 0 && i4 > 0 && VideoNativePlayer.this.exoPlayerIsPlaying()) {
                        VideoNativePlayer.this.postOnPlayProgressOnMainThread(access$100, i4);
                    }
    ...
    /* access modifiers changed from: private */
    public void postOnPlayProgressMSOnMainThread(long j4, long j5) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                final long j6 = j4;
                ...
                handler.post(new Runnable() {
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayProgressMS((int) j6, (int) j7);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayProgressMS((int) j6, (int) j7);
                        }
                    }
                });
            }
    ...
    /* access modifiers changed from: private */
    public void postOnPlayProgressOnMainThread(final int i4, final int i5) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() {
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayProgress(i4, i5);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayProgress(i4, i5);
                        }
                    }
                });
            }
    ...
    /* access modifiers changed from: private */
    public void postOnPlayStartOnMainThread(final int i4) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() {
                    public void run() {
                        if (VideoNativePlayer.this.mOutterVFListener != null) {
                            VideoNativePlayer.this.mOutterVFListener.onPlayStarted(i4);
                        }
                        if (VideoNativePlayer.this.mInnerVFPLisener != null) {
                            VideoNativePlayer.this.mInnerVFPLisener.onPlayStarted(i4);
                        }
                    }
                });
            }
    ...
    public boolean onError(int i4, String str) {
        try {
            af.b(TAG, "onError what:" + i4 + " extra:" + str);
            hideLoading();
    ...
    public void onPlayerStateChanged(boolean z4, int i4) {
        af.b(TAG, "onPlaybackStateChanged : " + i4);
        if (i4 == 1) {
    ...
    public void onPositionDiscontinuity(int i4) {
        af.b(TAG, "onPositionDiscontinuity : " + i4);
        if (i4 == 0) {
            onCompletion();
        }
    }
    ...
    public void play(Context context, String str, int i4) {
        try {
            af.b(TAG, "进来播放 currentionPosition:" + this.mCurrentPosition);
            this.mCurrentPosition = (long) i4;
            if (TextUtils.isEmpty(str)) {
