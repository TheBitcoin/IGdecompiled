...
public class VideoFeedsPlayer implements Player.EventListener {
            ...
            try {
                if (VideoFeedsPlayer.this.exoPlayer != null && VideoFeedsPlayer.this.exoPlayerIsPlaying()) {
                    ...
                    if (VideoFeedsPlayer.this.exoPlayer == null || VideoFeedsPlayer.this.exoPlayer.getDuration() <= 0) {
                        ...
                        j4 = VideoFeedsPlayer.this.exoPlayer.getDuration() / 1000;
                        if (access$100 > 0.0f && access$100 < 500.0f) {
                            round++;
                        }
                    }
                    if (round >= 0 && j4 > 0 && ((long) round) < 1 + j4) {
                        VideoFeedsPlayer.this.postOnPlayProgressOnMainThread(round, (int) j4);
                    }
            ...
            if (handler != null) {
                handler.post(new Runnable() {
                    public void run() {
                        if (VideoFeedsPlayer.this.mOutterVFListener != null) {
                            try {
                                VideoFeedsPlayer.this.mOutterVFListener.onPlayProgress(i4, i5);
                            } catch (Exception e5) {
                                af.b(VideoFeedsPlayer.TAG, e5.getMessage());
                            }
                        }
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                VideoFeedsPlayer.this.mInnerVFPLisener.onPlayProgress(i4, i5);
                            } catch (Exception e6) {
                                af.b(VideoFeedsPlayer.TAG, e6.getMessage());
                            }
                        }
    ...
    private void postOnPlayStartOnMainThread(final long j4) {
        try {
            Handler handler = this.mHandler;
            if (handler != null) {
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        if (VideoFeedsPlayer.this.mOutterVFListener != null) {
                            try {
                                VideoFeedsPlayer.this.mOutterVFListener.onPlayStarted(i4);
                            } catch (Exception e5) {
                                af.b(VideoFeedsPlayer.TAG, e5.getMessage());
                            }
                        }
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                VideoFeedsPlayer.this.mInnerVFPLisener.onPlayStarted(i4);
                            } catch (Exception e6) {
                                af.b(VideoFeedsPlayer.TAG, e6.getMessage());
                            }
                        }
    ...
    public void setPlaybackParams(float f4) {
        try {
            if (exoPlayerIsPlaying()) {
                this.exoPlayer.setPlaybackParameters(new PlaybackParameters(f4));
                return;
            }
            this.exoPlayer.setPlaybackParameters(new PlaybackParameters(f4));
            this.exoPlayer.stop();
