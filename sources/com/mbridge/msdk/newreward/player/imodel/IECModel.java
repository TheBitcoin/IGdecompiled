...
public interface IECModel extends IModel {
    ...
    void eventTrackingForEndCardShow(RedirectModel redirectModel, int i4);
    ...
    boolean onAdClose(MBridgeIds mBridgeIds, RewardInfo rewardInfo, int i4);

    void onAdCloseWithIVReward(MBridgeIds mBridgeIds, boolean z4, int i4);
    ...
    void onEndCardShow(MBridgeIds mBridgeIds, int i4);

    @ReportAnnotation.MethodInfo(isParameter = true, key = "2000131", reportType = "1")
    boolean onShowFail(MBridgeIds mBridgeIds, String str, int i4);

    void setRenderStatus(int i4);
}
