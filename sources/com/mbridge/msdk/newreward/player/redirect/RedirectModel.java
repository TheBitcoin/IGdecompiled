...
public class RedirectModel {
    ...
    public void setClickSenario(int i4) {
        this.clickSenario = i4;
    }
    ...
    public void setCurrPercentAge(int i4) {
        this.currPercentAge = i4;
    }
    ...
    public void setEndScreenType(int i4) {
        this.endScreenType = i4;
    }

    public void setPercentRate(int i4) {
        this.percentRate = i4;
    }
    ...
    public void setVideoSourceCompleteTime(int i4) {
        this.videoSourceCompleteTime = i4;
    }
