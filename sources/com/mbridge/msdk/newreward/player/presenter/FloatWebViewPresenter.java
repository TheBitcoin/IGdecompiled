...
public class FloatWebViewPresenter extends AbsPresenter implements b {
    ...
    public FloatWebViewPresenter(IBaseWebView iBaseWebView, int i4) {
        super(iBaseWebView);
        int i5 = 4;
        ...
        this.TEMPLATE_MARK_TYPE = i4 != 273 ? 5 : i5;
    }
    ...
    public void reqSuccessful(java.lang.Object r9) {
        /*
            ...
            r1 = 0
            r2 = 2
            boolean r3 = r9 instanceof org.json.JSONObject     // Catch:{ all -> 0x002a }
            if (r3 == 0) goto L_0x00d1
            org.json.JSONObject r9 = (org.json.JSONObject) r9     // Catch:{ all -> 0x002a }
            int r3 = r9.length()     // Catch:{ all -> 0x002a }
            if (r3 <= 0) goto L_0x00d1
            java.lang.String r3 = "action"
            java.lang.String r3 = r9.getString(r3)     // Catch:{ all -> 0x002a }
            int r4 = r3.hashCode()     // Catch:{ all -> 0x002a }
            r5 = 5
            r6 = 4
            r7 = 3
            switch(r4) {
        ...
        L_0x0020:
            ...
            boolean r3 = r3.equals(r4)     // Catch:{ all -> 0x002a }
        ...
        L_0x006f:
            ...
            com.mbridge.msdk.newreward.player.redirect.RedirectModel r3 = r8.redirectModel     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.newreward.player.redirect.RedirectType r4 = com.mbridge.msdk.newreward.player.redirect.RedirectType.AD_TRACKING_CLICK_URL     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.newreward.player.redirect.RedirectModel r3 = r3.setRedirectType(r4)     // Catch:{ all -> 0x002a }
            java.lang.Object[] r2 = new java.lang.Object[r2]     // Catch:{ all -> 0x002a }
            java.lang.String r4 = "campaign_redirect"
            r2[r1] = r4     // Catch:{ all -> 0x002a }
            r2[r0] = r3     // Catch:{ all -> 0x002a }
            java.util.Map r0 = r9.a((java.lang.Object[]) r2)     // Catch:{ all -> 0x002a }
        ...
        L_0x0098:
            ...
            r9.onCloseViewClick(r7)     // Catch:{ all -> 0x002a }
            return
        L_0x009e:
            int r9 = r9.optInt(r4, r0)     // Catch:{ all -> 0x002a }
            r8.webCloseViewStatus = r9     // Catch:{ all -> 0x002a }
            com.mbridge.msdk.newreward.player.iview.IBaseWebView r2 = r8.mWebContentView     // Catch:{ all -> 0x002a }
            if (r9 != r0) goto L_0x00a9
            goto L_0x00aa
        L_0x00a9:
            r1 = 4
        L_0x00aa:
            r2.setNativeCloseButtonVisibility(r1)     // Catch:{ all -> 0x002a }
            return
        L_0x00ae:
            int r9 = r9.optInt(r4, r0)     // Catch:{ all -> 0x002a }
