...
public class MoreOfferPresenter extends AbsPresenter {
    ...
    public MoreOfferPresenter(IMoreOfferTemplateView iMoreOfferTemplateView2) {
        ...
        if (!(this.adapterModel.E() == null || this.adapterModel.E().f14899a == null)) {
            this.moreOfferModel.mImpressionId.addAll(this.adapterModel.E().f14899a);
        }
    ...
    public void calculateCanShowCount() {
        ...
        if (linearLayout2 != null && linearLayout2.getChildCount() > 5) {
            try {
                ...
                if (this.linearLayout.getChildCount() >= this.initCanShowMaxCount) {
                    for (int i4 = 0; i4 < this.initCanShowMaxCount; i4++) {
                        View childAt = this.linearLayout.getChildAt(i4);
                        if (childAt != null) {
                            loadIconImageUrl(childAt, i4);
                        }
                    }
                }
            } catch (Exception e5) {
    ...
    public void checkItemVisibleState() {
        if (this.linearLayout != null) {
            ...
            while (i4 < this.linearLayout.getChildCount()) {
                try {
                    this.moreOfferRedirectModel.setItemPositionId(i4);
                    if (!this.moreOfferModel.mImpressionId.contains(Integer.valueOf(i4))) {
                        View childAt = this.linearLayout.getChildAt(i4);
                        if (childAt != null) {
                            setItemRedirectModel(i4);
                            setMoreOfferItemClickListener(childAt);
                            doMoreOfferImpression(childAt, i4);
                        }
                    }
                    i4++;
                } catch (Exception e5) {
    ...
    private void doMoreOfferImpression(View view, int i4) {
        boolean z4;
        List<Integer> list;
        if (this.moreOfferModel != null) {
            try {
                ...
                if (!globalVisibleRect || !z4) {
                    if (this.iconBufferCount <= 2 && (list = this.ImageLoadReadyCountList) != null && !list.contains(Integer.valueOf(i4))) {
                        loadIconImageUrl(view, i4);
                    }
    ...
    private CampaignEx getCampaignEx(int i4) {
        try {
            if (this.adapterModel.E() == null) {
                return null;
            }
            int i5 = this.moreOfferType;
            if (i5 != 1) {
                if (i5 != 2) {
                    return null;
                }
        ...
        if (bVar != null) {
            try {
                ...
                if (E4 != null && E4.size() > i4) {
                    ...
                    com.mbridge.msdk.foundation.same.c.b.a(com.mbridge.msdk.foundation.controller.c.m().c()).a(E4.get(i4).getIconUrl(), new com.mbridge.msdk.foundation.same.c.c() {
    ...
    public void reportAdmfImpression() {
        int i4 = 0;
        while (i4 < this.initCanShowMaxCount) {
            try {
                if (!this.moreOfferModel.mImpressionId.contains(Integer.valueOf(i4))) {
                    this.moreOfferRedirectModel.setItemPositionId(i4);
                    setItemRedirectModel(i4);
    ...
    /* access modifiers changed from: private */
    public void setItemRedirectModel(int i4) {
        if (this.adapterModel != null && this.moreOfferRedirectModel != null) {
            String str = "117361";
            try {
                CampaignEx campaignEx = getCampaignEx(i4);
                String str2 = "";
                if (campaignEx != null) {
    ...
    public void getAdMFTmValue(int i4) {
