        ...
        try {
            if (this.campaignEx.getVideoUrlEncode() != null) {
                ...
                if (g4 == null || !g4.exists()) {
                    ...
                    this.iView.play(g4.getAbsolutePath(), getBufferTimeout());
                }
            }
        } catch (Exception e5) {
                            ...
                            public void onNoDoubleClick(View view) {
                                ...
                                if (campaignEx != null) {
                                    ...
                                    if (view instanceof TextView) {
                                        PlayTemplePresenter.this.campaignEx.setTriggerClickSource(com.mbridge.msdk.foundation.same.report.d.a.f13401m);
                                    } else {
                                        PlayTemplePresenter.this.campaignEx.setTriggerClickSource(com.mbridge.msdk.foundation.same.report.d.a.f13402n);
                                    }
                                }
    ...
    public void windowFocusChanged() {
        ...
        try {
            if (isHalfScreenOffer()) {
                ...
                this.iView.setPlayerSize(17, i5, i6);
                return;
            }
            c cVar = this.commandManager;
            Object d5 = cVar.d((Object) cVar.a("fullScreenWidth", Float.valueOf(ak.j(this.context)), "fullScreenHeight", Float.valueOf(ak.i(this.context)), "campaign", this.campaignEx, "orientation", Integer.valueOf(this.context.getResources().getConfiguration().orientation)), f.TEMP_PLAYER_INIT);
