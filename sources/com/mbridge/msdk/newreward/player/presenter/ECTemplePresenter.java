...
public class ECTemplePresenter extends AbsPresenter {
        ...
        try {
            ...
            if (timeInMillis - this.lastClickTime >= AdaptiveTrackSelection.DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS) {
                ...
                if (campaignEx != null) {
                    ...
                    this.campaignEx.setTriggerClickSource(a.f13401m);
                }
                ...
                public void onSuccessLoad(Bitmap bitmap, String str) {
                    if (bitmap != null && !bitmap.isRecycled()) {
                        try {
                            ...
                            com.mbridge.msdk.newreward.function.h.a.a(bitmap, new a.C0198a() {
    ...
    public void adShowFail(String str, int i4) {
        if (!this.adapterModel.Y()) {
            ...
            this.ecTempleModel.onShowFail(this.mBridgeIds, str, i4);
            finish(true);
        }
    }
                        ...
                        if (this.alacRunnable == null) {
                            this.alacRunnable = new Runnable() {
                                public void run() {
                                    ...
                                    if (campaignEx != null) {
                                        campaignEx.setClickTempSource(com.mbridge.msdk.foundation.same.report.d.a.f13396h);
                                        ECTemplePresenter.this.campaignEx.setTriggerClickSource(com.mbridge.msdk.foundation.same.report.d.a.f13402n);
                                        ECTemplePresenter.this.campaignEx.setClickType(com.mbridge.msdk.foundation.same.report.d.a.f13397i);
                                    }
                                    ECTemplePresenter eCTemplePresenter = ECTemplePresenter.this;
