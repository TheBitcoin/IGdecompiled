...
public class PlayWebPresenter extends BaseTemplatePresenter implements b {
    ...
    public void firePrivacyFeedbackEvent(int i4) {
        String str;
        try {
    ...
    private void showCTAOrMiniEndCard(int i4) {
        if (i4 == -1) {
    ...
    public void initDataForView(com.mbridge.msdk.video.dynview.a aVar) {
        ...
        if (this.campaignEx.getVideoUrlEncode() != null) {
            File g4 = this.adapterModel.g(this.campaignEx.getRequestIdNotice());
            ...
            if (g4 == null || !g4.exists()) {
                ...
                this.mWebTemplateView.play(g4.getAbsolutePath(), getBufferTimeout());
            }
        }
    ...
    public void onClick(int i4) {
        ...
        if ((i4 == 1 || i4 == 3) && this.mNativeHandleClick) {
            CampaignEx campaignEx = this.campaignEx;
            if (campaignEx != null) {
                campaignEx.setClickTempSource(com.mbridge.msdk.foundation.same.report.d.a.f13395g);
                if (i4 == 1) {
                    this.campaignEx.setTriggerClickSource(com.mbridge.msdk.foundation.same.report.d.a.f13402n);
                } else {
                    this.campaignEx.setTriggerClickSource(com.mbridge.msdk.foundation.same.report.d.a.f13401m);
                }
            }
        ...
        MBCommunicatorUtil.notifyClick(this.mWebTemplateView.getWebView(), i4, com.mbridge.msdk.newreward.function.h.b.a(this.mTouchX, this.mTouchY, 0));
    }
    ...
    public void onPlayProgress(int i4, int i5) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            if (i5 == 0) {
                i5 = this.campaignEx.getVideoLength();
            }
            if (i5 == 0) {
                i5 = 1;
            }
            jSONObject.put("progress", (int) (((float) i4) / ((float) i5)));
            ...
            MBCommunicatorUtil.notifyVideoProgress(this.mWebTemplateView.getWebView(), i4, i5);
        } catch (Throwable th) {
            af.b("PlayWebPresenter", th.getMessage());
        }
    }
    ...
    public void reqSuccessful(java.lang.Object r23) {
        /*
            ...
            r0 = r23
            java.lang.String r2 = ""
            boolean r3 = r0 instanceof org.json.JSONObject     // Catch:{ all -> 0x0034 }
            if (r3 == 0) goto L_0x0252
            org.json.JSONObject r0 = (org.json.JSONObject) r0     // Catch:{ all -> 0x0034 }
            int r3 = r0.length()     // Catch:{ all -> 0x0034 }
            if (r3 <= 0) goto L_0x0252
            java.lang.String r3 = "action"
            java.lang.String r3 = r0.getString(r3)     // Catch:{ all -> 0x0034 }
            int r4 = r3.hashCode()     // Catch:{ all -> 0x0034 }
            r5 = 4
            r6 = 8
            r7 = 0
            r8 = 2
            ...
            switch(r4) {
                ...
                case 1691567443: goto L_0x004f;
                case 1779467262: goto L_0x0043;
                case 1843897919: goto L_0x0037;
        ...
        L_0x0028:
            ...
            boolean r3 = r3.equals(r4)     // Catch:{ all -> 0x0034 }
        ...
        L_0x00c1:
            goto L_0x0252
        L_0x00c3:
            java.lang.String r3 = r0.optString(r11, r2)     // Catch:{ all -> 0x0034 }
            java.lang.String r0 = r0.optString(r13, r2)     // Catch:{ all -> 0x0034 }
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ all -> 0x0034 }
            if (r4 == 0) goto L_0x00d3
            goto L_0x0252
        L_0x00d3:
            org.json.JSONObject r4 = new org.json.JSONObject     // Catch:{ all -> 0x0034 }
            r4.<init>(r0)     // Catch:{ all -> 0x0034 }
            java.lang.String r0 = "popup"
            boolean r0 = r3.equals(r0)     // Catch:{ all -> 0x0034 }
            java.lang.String r5 = "key"
            if (r0 == 0) goto L_0x00f3
            java.lang.String r0 = r4.optString(r5, r2)     // Catch:{ all -> 0x0034 }
            int r8 = r4.optInt(r12, r10)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.foundation.d.b r11 = com.mbridge.msdk.foundation.d.b.a()     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.foundation.d.a r13 = r1.feedbackDialogEventListener     // Catch:{ all -> 0x0034 }
            r11.a((java.lang.String) r0, (int) r8, (com.mbridge.msdk.foundation.d.a) r13)     // Catch:{ all -> 0x0034 }
        L_0x00f3:
            java.lang.String r0 = "visibility"
            boolean r0 = r3.equals(r0)     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0114
            int r0 = r4.optInt(r12, r10)     // Catch:{ all -> 0x0034 }
            java.lang.String r8 = r4.optString(r5, r2)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.foundation.d.b r11 = com.mbridge.msdk.foundation.d.b.a()     // Catch:{ all -> 0x0034 }
        ...
        L_0x010a:
            r6 = 0
        L_0x010b:
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r0 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.view.hybrid.MBWebView r0 = r0.getWebView()     // Catch:{ all -> 0x0034 }
            r11.a((java.lang.String) r8, (int) r6, (android.view.ViewGroup) r0)     // Catch:{ all -> 0x0034 }
        L_0x0114:
            java.lang.String r0 = "layout"
            boolean r0 = r3.equals(r0)     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0252
            java.lang.String r0 = "width"
            int r12 = r4.optInt(r0, r9)     // Catch:{ all -> 0x0034 }
            java.lang.String r0 = "height"
            int r13 = r4.optInt(r0, r9)     // Catch:{ all -> 0x0034 }
            java.lang.String r0 = "left"
            int r0 = r4.optInt(r0, r9)     // Catch:{ all -> 0x0034 }
            java.lang.String r3 = "top"
            int r3 = r4.optInt(r3, r9)     // Catch:{ all -> 0x0034 }
            java.lang.String r6 = "opacity"
            r7 = 4607182418800017408(0x3ff0000000000000, double:1.0)
            double r6 = r4.optDouble(r6, r7)     // Catch:{ all -> 0x0034 }
            java.lang.String r8 = "radius"
            r9 = 20
            int r14 = r4.optInt(r8, r9)     // Catch:{ all -> 0x0034 }
            java.lang.String r8 = "fontColor"
            java.lang.String r18 = r4.optString(r8, r2)     // Catch:{ all -> 0x0034 }
            java.lang.String r8 = "bgColor"
            java.lang.String r19 = r4.optString(r8, r2)     // Catch:{ all -> 0x0034 }
            java.lang.String r11 = r4.optString(r5, r2)     // Catch:{ all -> 0x0034 }
            java.lang.String r2 = "fontSize"
            r8 = -4616189618054758400(0xbff0000000000000, double:-1.0)
            double r8 = r4.optDouble(r2, r8)     // Catch:{ all -> 0x0034 }
            java.lang.String r2 = "padding"
            org.json.JSONArray r21 = r4.optJSONArray(r2)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.foundation.d.b r10 = com.mbridge.msdk.foundation.d.b.a()     // Catch:{ all -> 0x0034 }
            float r15 = (float) r0     // Catch:{ all -> 0x0034 }
            float r0 = (float) r3     // Catch:{ all -> 0x0034 }
            float r2 = (float) r6     // Catch:{ all -> 0x0034 }
            float r3 = (float) r8     // Catch:{ all -> 0x0034 }
            r16 = r0
            r17 = r2
            r20 = r3
            r10.a(r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21)     // Catch:{ all -> 0x0034 }
            return
        L_0x0174:
            int r0 = r0.optInt(r11, r4)     // Catch:{ all -> 0x0034 }
            r1.showCTAOrMiniEndCard(r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x017c:
            com.mbridge.msdk.foundation.entity.CampaignEx r0 = r1.campaignEx     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0185
            int r2 = com.mbridge.msdk.foundation.same.report.d.a.f13395g     // Catch:{ all -> 0x0034 }
            r0.setClickTempSource(r2)     // Catch:{ all -> 0x0034 }
        L_0x0185:
            com.mbridge.msdk.newreward.player.imodel.IPlayModel r0 = r1.playTempleModel     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.out.MBridgeIds r2 = r1.mBridgeIds     // Catch:{ all -> 0x0034 }
            r0.onAdClick(r2)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.imodel.IPlayModel r0 = r1.playTempleModel     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.redirect.RedirectModel r2 = r1.redirectModel     // Catch:{ all -> 0x0034 }
            r0.eventTrackingForClick(r2)     // Catch:{ all -> 0x0034 }
            return
        L_0x0194:
            org.json.JSONObject r0 = r0.optJSONObject(r13)     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0252
            int r0 = r0.optInt(r12, r8)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r2 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            if (r0 != r10) goto L_0x01a3
            goto L_0x01a4
        L_0x01a3:
            r6 = 0
        L_0x01a4:
            r2.setSegmentsProgressBar(r6)     // Catch:{ all -> 0x0034 }
            return
        L_0x01a8:
            org.json.JSONObject r0 = r0.optJSONObject(r13)     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0252
            java.lang.String r2 = "progress"
            int r2 = r0.optInt(r2, r9)     // Catch:{ all -> 0x0034 }
            int r0 = r0.optInt(r12, r8)     // Catch:{ all -> 0x0034 }
            if (r2 == r9) goto L_0x01bf
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r3 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            r3.seekToPlay(r2)     // Catch:{ all -> 0x0034 }
        L_0x01bf:
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r2 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            android.view.View r2 = r2.getCountDownView()     // Catch:{ all -> 0x0034 }
            if (r0 != r8) goto L_0x01c8
            r5 = 0
        L_0x01c8:
            r2.setVisibility(r5)     // Catch:{ all -> 0x0034 }
            return
        L_0x01cc:
            org.json.JSONObject r0 = r0.optJSONObject(r13)     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0252
            java.lang.String r2 = "mute"
            int r2 = r0.optInt(r2, r8)     // Catch:{ all -> 0x0034 }
            int r0 = r0.optInt(r12, r8)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r3 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            r3.setMuteState(r2, r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x01e2:
            int r0 = r0.optInt(r13, r4)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r2 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            r2.playOrPauseVideo(r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x01ec:
            java.lang.String r0 = r0.optString(r13)     // Catch:{ all -> 0x0034 }
            boolean r2 = android.text.TextUtils.isEmpty(r0)     // Catch:{ all -> 0x0034 }
            if (r2 != 0) goto L_0x0252
            org.json.JSONObject r2 = new org.json.JSONObject     // Catch:{ all -> 0x0034 }
            r2.<init>(r0)     // Catch:{ all -> 0x0034 }
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r0 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            r0.changeVideoViewPosition(r2)     // Catch:{ all -> 0x0034 }
            return
        L_0x0201:
            r1.onWebContentError()     // Catch:{ all -> 0x0034 }
            return
        L_0x0205:
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r0 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            r0.onCloseViewClick(r8)     // Catch:{ all -> 0x0034 }
            return
        L_0x020b:
            int r0 = r0.optInt(r13, r9)     // Catch:{ all -> 0x0034 }
            r1.webCloseViewStatus = r0     // Catch:{ all -> 0x0034 }
            if (r0 == 0) goto L_0x0215
            if (r0 != r10) goto L_0x021c
        L_0x0215:
            android.os.Handler r2 = r1.mHandler     // Catch:{ all -> 0x0034 }
            java.lang.Runnable r3 = r1.nativeCloseBtnVisibleRunnable     // Catch:{ all -> 0x0034 }
            r2.removeCallbacks(r3)     // Catch:{ all -> 0x0034 }
        L_0x021c:
            if (r0 != r10) goto L_0x0252
            r1.mCanResponseBackPress = r10     // Catch:{ all -> 0x0034 }
            return
        L_0x0221:
            int r0 = r0.optInt(r13, r10)     // Catch:{ all -> 0x0034 }
            r1.webCloseViewStatus = r0     // Catch:{ all -> 0x0034 }
            android.os.Handler r2 = r1.mHandler     // Catch:{ all -> 0x0034 }
            java.lang.Runnable r3 = r1.nativeCloseBtnVisibleRunnable     // Catch:{ all -> 0x0034 }
            r2.removeCallbacks(r3)     // Catch:{ all -> 0x0034 }
            ...
            r5 = 0
        L_0x0233:
            r2.setNativeCloseButtonVisibility(r5)     // Catch:{ all -> 0x0034 }
            return
        L_0x0237:
            int r0 = r0.optInt(r13, r10)     // Catch:{ all -> 0x0034 }
            if (r0 != r10) goto L_0x0245
            com.mbridge.msdk.newreward.player.iview.IWebTemplateView r0 = r1.mWebTemplateView     // Catch:{ all -> 0x0034 }
            int r2 = r1.TEMPLATE_MARK_TYPE     // Catch:{ all -> 0x0034 }
            r0.onWebViewShow(r2)     // Catch:{ all -> 0x0034 }
            return
        L_0x0245:
            r1.onWebContentError()     // Catch:{ all -> 0x0034 }
            return
