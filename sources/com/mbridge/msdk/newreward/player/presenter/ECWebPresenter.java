    ...
    public void onWebContentError() {
        ...
        if (!this.isLoadResourceError) {
            ...
            if (this.isShown) {
                ...
                if (campaignEx != null) {
                    j4 = campaignEx.getEcTemplateId();
                } else {
                    j4 = 404;
                }
                com.mbridge.msdk.newreward.function.command.c cVar = this.commandManager;
                cVar.g(cVar.a("add_temple", Long.valueOf(j4), "template_type", 18, "adapter_model", this.adapterModel, "parent_temple", this.data.getRootViewGroup()), f.SHOW_ADD_TEMPLE);
                d.a().d(f.SHOW_OR_PRELOAD_WEB_EC);
            } else {
    ...
    public void reqSuccessful(java.lang.Object r26) {
        /*
            ...
            switch(r3) {
                ...
                case 94750088: goto L_0x0054;
                case 94756344: goto L_0x004a;
                case 96046965: goto L_0x0040;
        ...
        L_0x0175:
            ...
            int r2 = com.mbridge.msdk.foundation.same.report.d.a.f13396h     // Catch:{ all -> 0x0033 }
        ...
        L_0x0191:
            ...
            int r2 = com.mbridge.msdk.foundation.same.a.f13108F     // Catch:{ all -> 0x0033 }
            goto L_0x01a7
        L_0x01a2:
            int r2 = com.mbridge.msdk.foundation.same.a.f13107E     // Catch:{ all -> 0x0033 }
            goto L_0x01a7
        L_0x01a5:
            int r2 = com.mbridge.msdk.foundation.same.a.f13106D     // Catch:{ all -> 0x0033 }
        L_0x01a7:
