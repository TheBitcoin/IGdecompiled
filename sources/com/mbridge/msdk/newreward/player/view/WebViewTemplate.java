...
public class WebViewTemplate extends FrameLayout implements View.OnClickListener, IWebTemplateView {
    ...
    private final Runnable getNotchDataRunnable = new Runnable() {
        /* JADX WARNING: Removed duplicated region for block: B:24:0x0064 A[Catch:{ all -> 0x0089 }] */
        /* JADX WARNING: Removed duplicated region for block: B:25:0x0066 A[Catch:{ all -> 0x0089 }] */
        /* JADX WARNING: Removed duplicated region for block: B:28:0x006b A[Catch:{ all -> 0x0089 }] */
        /* JADX WARNING: Removed duplicated region for block: B:29:0x006d A[Catch:{ all -> 0x0089 }] */
        /* JADX WARNING: Removed duplicated region for block: B:32:0x0072 A[Catch:{ all -> 0x0089 }] */
        /* JADX WARNING: Removed duplicated region for block: B:33:0x0073 A[Catch:{ all -> 0x0089 }] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void run() {
            /*
                r8 = this;
                int r0 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x0089 }
                r1 = 23
                if (r0 < r1) goto L_0x0093
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r1 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                android.view.WindowInsets r1 = r1.getRootWindowInsets()     // Catch:{ all -> 0x0089 }
                r2 = 28
                if (r0 < r2) goto L_0x0093
                android.view.DisplayCutout r0 = r1.getDisplayCutout()     // Catch:{ all -> 0x0089 }
                if (r0 == 0) goto L_0x0093
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r1 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                android.widget.RelativeLayout r1 = r1.mTopControllerView     // Catch:{ all -> 0x0089 }
                if (r1 == 0) goto L_0x0093
                int r1 = r0.getSafeInsetLeft()     // Catch:{ all -> 0x0089 }
                int r2 = r0.getSafeInsetTop()     // Catch:{ all -> 0x0089 }
                int r3 = r0.getSafeInsetRight()     // Catch:{ all -> 0x0089 }
                int r0 = r0.getSafeInsetBottom()     // Catch:{ all -> 0x0089 }
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r4 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                android.view.Display r4 = r4.getDisplay()     // Catch:{ all -> 0x0089 }
                int r4 = r4.getRotation()     // Catch:{ all -> 0x0089 }
            ...
            L_0x004b:
                r4 = 0
            L_0x004c:
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r5 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                android.widget.RelativeLayout r5 = r5.mTopControllerView     // Catch:{ all -> 0x0089 }
                android.view.ViewGroup$LayoutParams r5 = r5.getLayoutParams()     // Catch:{ all -> 0x0089 }
                android.widget.FrameLayout$LayoutParams r5 = (android.widget.FrameLayout.LayoutParams) r5     // Catch:{ all -> 0x0089 }
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r6 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                android.content.Context r6 = r6.getContext()     // Catch:{ all -> 0x0089 }
                r7 = 1092616192(0x41200000, float:10.0)
                int r6 = com.mbridge.msdk.foundation.tools.ak.a((android.content.Context) r6, (float) r7)     // Catch:{ all -> 0x0089 }
            ...
            L_0x0066:
                r7 = r1
            L_0x0067:
                r5.leftMargin = r7     // Catch:{ all -> 0x0089 }
            ...
            L_0x006d:
                r7 = r2
            L_0x006e:
                r5.topMargin = r7     // Catch:{ all -> 0x0089 }
                if (r3 != 0) goto L_0x0073
                goto L_0x0074
            L_0x0073:
                r6 = r3
            L_0x0074:
                r5.rightMargin = r6     // Catch:{ all -> 0x0089 }
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r6 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                android.widget.RelativeLayout r6 = r6.mTopControllerView     // Catch:{ all -> 0x0089 }
                r6.setLayoutParams(r5)     // Catch:{ all -> 0x0089 }
                com.mbridge.msdk.newreward.player.view.WebViewTemplate r5 = com.mbridge.msdk.newreward.player.view.WebViewTemplate.this     // Catch:{ all -> 0x0089 }
                com.mbridge.msdk.newreward.player.presenter.PlayWebPresenter r5 = r5.mWebTemplatePresenter     // Catch:{ all -> 0x0089 }
                java.lang.String r0 = com.mbridge.msdk.foundation.tools.s.a(r4, r1, r3, r2, r0)     // Catch:{ all -> 0x0089 }
                r5.setNotchData(r0)     // Catch:{ all -> 0x0089 }
                return
            L_0x0089:
                r0 = move-exception
    ...
    public void addWebView(MBWebView mBWebView, int i4) {
        if (mBWebView != null) {
    ...
    public void play(String str, int i4) {
        this.mPlayerView.initBufferIngParam(i4);
        this.mPlayerView.initVFPData(str, str, this.mWebTemplatePresenter);
        this.mPlayerView.playVideo();
    }

    public void playOrPauseVideo(int i4) {
        ...
        if (i4 != -999) {
            ...
            } else if (i4 == 6 && (playerView = this.mPlayerView) != null) {
                playerView.release();
            }
        }
    }
    ...
    public void seekToPlay(int i4) {
        PlayerView playerView = this.mPlayerView;
        if (playerView != null && i4 != -1) {
            playerView.seekTo(i4);
        }
    }
    ...
    public void setAlertViewType(String str, int i4, int i5) {
        AlertTempleView alertTempleView = this.mAlertTempleView;
        if (alertTempleView != null) {
            alertTempleView.setAlertType(i4, str, i5);
        }
    }
    ...
    public void setCountDown(String str, int i4, int i5, ViewGroup.LayoutParams layoutParams) {
        TextView textView = this.mCountDownTextView;
        if (textView != null && textView.getVisibility() != 4) {
            this.mCountDownTextView.setText(str);
            if (i4 != 0) {
                this.mCountDownTextView.setPadding(i4, 0, i4, 0);
            }
            if (layoutParams != null) {
                this.mCountDownTextView.setLayoutParams(layoutParams);
            }
            if (i5 != 0) {
                this.mCountDownTextView.setBackgroundResource(i5);
            }
        }
    }
    ...
    public void setNativeCloseButtonVisibility(int i4) {
        ...
        if (imageView != null) {
            ...
            if (i4 == 0 && (playWebPresenter = this.mWebTemplatePresenter) != null) {
                playWebPresenter.setCanResponseBack(true);
            }
        }
    }

    public void setPlayerSize(int i4, int i5, int i6) {
    }

    public void setSegmentsProgressBar(int i4) {
        ...
        if (mBridgeSegmentsProgressBar != null) {
            ...
            this.mSegmentsProgressBar.setVisibility(i4);
        }
    }

    public void setTemplateWidthAndHeight(int i4) {
    }
    ...
    public void webViewShow() {
        if (!this.isWebViewShowed) {
            ...
            MBCommunicatorUtil.notifyShowDataInfo(this.mWebView, i4, this.mWebTemplatePresenter.getCampaignOrientation());
    ...
    public void setMuteState(int i4, int i5) {
        SoundImageView soundImageView = this.mSoundImageView;
        if (soundImageView != null) {
            soundImageView.setVisibility(i5 == 1 ? 4 : 0);
            if (i4 == 1) {
    ...
    public WebViewTemplate(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        super(context, attributeSet, i4);
        initPresenter();
    }

    @RequiresApi(api = 21)
    public WebViewTemplate(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
