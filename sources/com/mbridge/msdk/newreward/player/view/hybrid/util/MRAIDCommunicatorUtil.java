...
public class MRAIDCommunicatorUtil {
    ...
    public static void fireSetCurrentPosition(WebView webView, float f4, float f5, float f6, float f7) {
        call(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setCurrentPosition(%.1f, %.1f, %.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5), Float.valueOf(f6), Float.valueOf(f7)}));
    }

    public static void fireSetDefaultPosition(WebView webView, float f4, float f5, float f6, float f7) {
        call(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setDefaultPosition(%.1f, %.1f, %.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5), Float.valueOf(f6), Float.valueOf(f7)}));
    }
    ...
    public static void fireSetMaxSize(WebView webView, float f4, float f5) {
        call(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setMaxSize(%.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5)}));
    }
    ...
    public static void fireSetScreenSize(WebView webView, float f4, float f5) {
        call(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setScreenSize(%.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5)}));
    }

    public static void fireSizeChangeEvent(WebView webView, float f4, float f5) {
        call(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.notifySizeChangeEvent(%.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5)}));
    }
