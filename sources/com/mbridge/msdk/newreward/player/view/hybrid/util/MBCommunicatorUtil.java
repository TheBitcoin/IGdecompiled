...
public class MBCommunicatorUtil {
    ...
    public static void notifyClick(WebView webView, int i4, String str) {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void notifyShowDataInfo(WebView webView, int i4, int i5) {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void notifyVideoProgress(WebView webView, int i4, int i5) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("progress", (int) (((float) i4) / ((float) i5)));
            jSONObject.put("time", String.valueOf(i4));
            jSONObject.put(TypedValues.TransitionType.S_DURATION, String.valueOf(i5));
    ...
    public static void notifyVideoStatus(WebView webView, int i4) {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    public static void notifyWebViewShowed(WebView webView, String str, String str2) {
        ...
        try {
            ...
            jSONObject2.put(a.f13138l, (double) ak.d(webView.getContext()));
            if (TextUtils.isEmpty(str2)) {
