...
public abstract class BaseECTemplate extends RelativeLayout implements View.OnClickListener, IECTempleView {
    ...
    public boolean initViews(boolean z4) {
        boolean z5 = z4;
        try {
            this.mDyXmlSuccess = z5;
            this.nativeECLayout = (RelativeLayout) findViewById(this.ecPresenter.filterFindViewId(z5, "mbridge_native_ec_layout"));
    ...
    public void setCloseViewBtnDelayShow(int i4) {
        View view = this.closeView;
        if (view != null) {
    ...
    public void setHeatCount(int i4) {
        LinearLayout linearLayout = this.mLevelHeatCount;
        if (linearLayout instanceof MBHeatLevelLayoutView) {
            ((MBHeatLevelLayoutView) linearLayout).setHeatCount(i4);
        }
    }

    public void setImageBitMap(int i4, Bitmap bitmap) {
        ((ImageView) findViewById(i4)).setImageBitmap(bitmap);
    }

    public void setNLogo(int i4, String str, Drawable drawable) {
        if (i4 == 0) {
        ...
        try {
            if (!this.ecPresenter.isHalfScreenOffer()) {
                ...
                if (i6 >= 23) {
                    ...
                    if (i6 >= 28 && (a5 = a6.getDisplayCutout()) != null) {
    ...
    public void setRatingAndUser(double d5, int i4) {
        try {
            ...
            if (linearLayout instanceof MBridgeLevelLayoutView) {
                ...
                ((MBridgeLevelLayoutView) this.levelSlv).setRatingAndUser(d5, i4);
            }
    ...
    public void setTextByID(int i4, String str) {
