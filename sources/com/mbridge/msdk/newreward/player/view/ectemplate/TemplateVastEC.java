...
public class TemplateVastEC extends FrameLayout implements IBaseView {
    ...
    public TemplateVastEC(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        super(context, attributeSet, i4);
        initPresenter();
    }

    @RequiresApi(api = 21)
    public TemplateVastEC(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
