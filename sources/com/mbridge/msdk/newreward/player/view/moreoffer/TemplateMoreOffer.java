...
public class TemplateMoreOffer extends BaseMoreOfferTemplate implements View.OnClickListener, IMoreOfferTemplateView {
    ...
    public TemplateMoreOffer(Context context, b bVar, int i4) {
        super(context);
        this.mContext = context;
        setVisibility(8);
        this.moreOfferType = i4;
        ...
        this.moreOfferPresenter.syncLoad(i4);
    }
    ...
    public void addMoreOfferLikeText(final String str, final int i4) {
        if (this.likeTv != null) {
            post(new Runnable() {
                public void run() {
                    ...
                    if (textView != null) {
                        ...
                        if (i4 != 0) {
                            TemplateMoreOffer.this.likeTv.getLayoutParams().width = i4;
                        }
