...
public abstract class BaseTemplate extends RelativeLayout implements View.OnClickListener, IPlayTempleView {
        ...
        public void run() {
            ...
            try {
                ...
                if (playTemplePresenter == null || !playTemplePresenter.isHalfScreenOffer()) {
                    ...
                    if (i4 >= 23) {
                        WindowInsets a6 = BaseTemplate.this.getRootWindowInsets();
                        if (i4 >= 28 && a6 != null && (a5 = a6.getDisplayCutout()) != null && BaseTemplate.this.mTopControllerView != null) {
                            ...
                            int a10 = ak.a(BaseTemplate.this.getContext(), 9.0f);
                            if (a7 == 0) {
                                a7 = a10;
                            }
    ...
    public void play(String str, int i4) {
        PlayerView playerView = this.mPlayerView;
        if (playerView != null) {
            playerView.initBufferIngParam(i4);
    ...
    public void setAlertViewType(String str, int i4, int i5) {
        ...
        if (alertTempleView2 != null) {
            alertTempleView2.setAlertType(i4, str, i5);
        }
    }
    ...
    public void setCountDown(String str, int i4, int i5, ViewGroup.LayoutParams layoutParams) {
        ...
        if (textView != null) {
            ...
            if (i4 != 0) {
                this.mTvCountDown.setPadding(i4, 0, i4, 0);
            }
            if (layoutParams != null) {
                this.mTvCountDown.setLayoutParams(layoutParams);
            }
            if (i5 != 0) {
                this.mTvCountDown.setBackgroundResource(i5);
            }
        }
    }
    ...
    public void setTemplateWidthAndHeight(final int i4) {
        post(new Runnable() {
            public void run() {
                try {
