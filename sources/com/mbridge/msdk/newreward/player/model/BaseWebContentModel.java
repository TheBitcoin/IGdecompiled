...
public class BaseWebContentModel extends HybridCommunicatorImpl implements WebViewEventListener {
        ...
        if (communicatorParameter != null) {
            try {
                if (!TextUtils.isEmpty(communicatorParameter.getQuery()) && this.mAdapterModel != null) {
                    ...
                    a5.setClickTempSource(i4);
                    a5.setTriggerClickSource(a.f13401m);
            ...
            try {
                ...
                if (!TextUtils.isEmpty(optString) && !TextUtils.isEmpty(optString2)) {
                    ...
                    if (this.mReqCallBack != null) {
                        ...
                        jSONObject2.put("shouldUseCustomClose", i4);
    ...
    public void loadingResourceStatus(WebView webView, int i4) {
    }
                ...
                if (!TextUtils.isEmpty(optString)) {
                    if (this.mAdapterModel.D().b().u().size() > 1) {
                        ...
                        if (campaignToJsonObject != null) {
                            ...
                            parseCampaignWithBackData.setClickTempSource(a.f13396h);
                            parseCampaignWithBackData.setTriggerClickSource(a.f13402n);
    ...
    public void setRenderStatus(int i4) {
        this.renderStatus = i4;
    }
    ...
    public void statistics(CommunicatorParameter communicatorParameter) {
        ...
        if (communicatorParameter != null && !TextUtils.isEmpty(communicatorParameter.getQuery())) {
            ...
            try {
                ...
                final int m4 = ab.m(com.mbridge.msdk.foundation.controller.c.m().c());
                com.mbridge.msdk.foundation.same.f.a.b().execute(new Runnable() {
                    public void run() {
                        o.a((f) g.a(com.mbridge.msdk.foundation.controller.c.m().c())).a(new n("2000039", optString, optString2, optString3, optString4, BaseWebContentModel.this.mAdapterModel.U().getId(), m4, ab.a(com.mbridge.msdk.foundation.controller.c.m().c(), m4)));
                    }
                });
            } catch (Throwable th) {
                af.b("BaseWebContentModel", th.getMessage());
