...
public class WebViewECModel extends BaseWebContentModel implements IECModel {
    ...
    public void eventTrackingForEndCardShow(RedirectModel redirectModel, @BridgeParameter(key = "type") int i4) {
    ...
    public void onEndCardShow(MBridgeIds mBridgeIds, @BridgeParameter(key = "type") int i4) {
        RewardVideoListener rewardVideoListener2 = this.rewardVideoListener;
    ...
    public boolean onShowFail(MBridgeIds mBridgeIds, String str, int i4) {
        if (this.adShownState) {
            return true;
        }
        this.adShownState = true;
