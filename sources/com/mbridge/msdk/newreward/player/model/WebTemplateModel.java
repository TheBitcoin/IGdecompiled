...
public class WebTemplateModel extends BaseWebContentModel implements IPlayModel {
    ...
    public void checkOMSdkProgress(int i4, int i5) {
    }
    ...
    public void eventNoticeUrl(RedirectModel redirectModel, int i4) {
        if (this.mCommandManager != null) {
            redirectModel.setRedirectType(RedirectType.NOTICE_URL);
            c cVar = this.mCommandManager;
            cVar.f(cVar.a("campaign_redirect", redirectModel, "click_scenario", Integer.valueOf(i4)), f.CAMPAIGN_REDIRECT);
        }
    }
    ...
    public void eventTrackingForPlayPercentage(RedirectModel redirectModel, @BridgeParameter(key = "percent") int i4) {
    ...
    public boolean onAdClose(MBridgeIds mBridgeIds, RewardInfo rewardInfo, @BridgeParameter(key = "type") int i4) {
    ...
    public void onAdCloseWithIVReward(MBridgeIds mBridgeIds, boolean z4, int i4) {
        RewardVideoListener rewardVideoListener2 = this.rewardVideoListener;
        if (rewardVideoListener2 != null) {
            rewardVideoListener2.onAdCloseWithIVReward(mBridgeIds, z4, i4);
        }
    }
    ...
    public boolean onShowFail(MBridgeIds mBridgeIds, String str, @BridgeParameter(key = "code") int i4) {
        if (this.adShownState) {
            return true;
        }
        this.adShownState = true;
