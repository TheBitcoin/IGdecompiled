...
public interface IPlayTempleView extends IBaseView {
    ...
    void setAlertViewType(String str, int i4, int i5);

    void setBackGroundImage(Bitmap bitmap);

    void setCountDown(String str, int i4, int i5, ViewGroup.LayoutParams layoutParams);

    void setMuteState(boolean z4);

    void setPlayerSize(int i4, int i5, int i6);

    void setSegmentsProgressBar(int i4);

    void setTemplateWidthAndHeight(int i4);
