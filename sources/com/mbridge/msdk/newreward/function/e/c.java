...
public final class c {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f14898a     // Catch:{ NoSuchFieldError -> 0x00c0 }
    ...
    public final void a(com.mbridge.msdk.newreward.a.e r23, java.util.Map r24, com.mbridge.msdk.newreward.function.command.f r25) {
        ...
        L_0x0125:
            ...
            r15 = 0
        L_0x0127:
            int[] r19 = com.mbridge.msdk.newreward.function.e.c.AnonymousClass1.f14898a     // Catch:{ Exception -> 0x0050 }
            ...
            if (!TextUtils.isEmpty(str) && str.equals("2000130")) {
                ...
                if (eVar.D() == null || eVar.D().b() == null || (b5 = eVar.D().b()) == null) {
                    ...
                    if (b5.E() == null || b5.E().isEmpty()) {
                        ...
                        i4 = b5.E().get(0).getFilterCallBackState();
                        i6 = a7;
                    }
                }
    ...
    public final void a(com.mbridge.msdk.newreward.b.b bVar, Map map, f fVar) {
        if (bVar != null) {
            try {
                ...
                int i4 = AnonymousClass1.f14898a[fVar.ordinal()];
                if (i4 == 9) {
                    cVar.a("2000128");
                } else if (i4 == 15) {
