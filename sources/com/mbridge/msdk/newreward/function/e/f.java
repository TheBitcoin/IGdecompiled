...
public final class f {
    ...
    public com.mbridge.msdk.videocommon.d.c f14917f;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0097, code lost:
        if ((r8.f14916e.i() + r10.d()) <= java.lang.System.currentTimeMillis()) goto L_0x0099;
     */
    ...
    public final void a(java.lang.Object r9, com.mbridge.msdk.newreward.a.b.b r10) {
        /*
            ...
            java.lang.String r1 = r8.f14913b     // Catch:{ all -> 0x0018 }
            ...
            r8.f14913b = r1     // Catch:{ all -> 0x0018 }
            goto L_0x0020
        L_0x0018:
            r1 = move-exception
        ...
        L_0x0020:
            ...
            java.lang.String r2 = r8.f14912a     // Catch:{ all -> 0x0043 }
            com.mbridge.msdk.c.g r1 = r1.a(r2)     // Catch:{ all -> 0x0043 }
            r8.f14915d = r1     // Catch:{ all -> 0x0043 }
            ...
            r8.f14916e = r1     // Catch:{ all -> 0x0043 }
        ...
        L_0x0046:
            ...
            java.lang.String r2 = r8.f14912a     // Catch:{ Exception -> 0x0054 }
            java.lang.String r3 = r8.f14913b     // Catch:{ Exception -> 0x0054 }
            com.mbridge.msdk.videocommon.d.c r1 = r1.f(r2, r3)     // Catch:{ Exception -> 0x0054 }
            r8.f14917f = r1     // Catch:{ Exception -> 0x0054 }
        L_0x0054:
            com.mbridge.msdk.videocommon.d.c r1 = r8.f14917f     // Catch:{ all -> 0x0043 }
            if (r1 != 0) goto L_0x006c
            com.mbridge.msdk.videocommon.d.b r1 = com.mbridge.msdk.videocommon.d.b.a()     // Catch:{ all -> 0x0043 }
            int r2 = r8.f14914c     // Catch:{ all -> 0x0043 }
        ...
        L_0x0065:
            ...
            r8.f14917f = r1     // Catch:{ all -> 0x0043 }
            goto L_0x0077
        L_0x006c:
            com.mbridge.msdk.videocommon.d.b r1 = com.mbridge.msdk.videocommon.d.b.a()     // Catch:{ all -> 0x0043 }
            java.lang.String r2 = r8.f14913b     // Catch:{ all -> 0x0043 }
            java.lang.String r3 = com.mbridge.msdk.videocommon.d.c.f16988a     // Catch:{ all -> 0x0043 }
        ...
        L_0x0077:
            ...
            com.mbridge.msdk.videocommon.d.a r10 = r8.f14916e
            java.lang.String r1 = ""
        ...
        L_0x00b5:
            ...
            com.mbridge.msdk.videocommon.d.c r2 = r8.f14917f
            if (r2 == 0) goto L_0x00d0
            long r2 = r10.e()
            long r4 = java.lang.System.currentTimeMillis()
            com.mbridge.msdk.videocommon.d.c r10 = r8.f14917f
            long r6 = r10.x()
            long r6 = r6 + r2
            int r10 = (r6 > r4 ? 1 : (r6 == r4 ? 0 : -1))
            if (r10 > 0) goto L_0x00ec
    ...
    /* access modifiers changed from: private */
    public void a(com.mbridge.msdk.newreward.function.command.f fVar, int i4, String str) {
        int i5;
        try {
            ...
            if (fVar == com.mbridge.msdk.newreward.function.command.f.REPORT_SETTING_REQUEST_START) {
                ...
                i5 = fVar == com.mbridge.msdk.newreward.function.command.f.REPORT_SETTING_REQUEST_FAIL ? 2 : 0;
            }
            eVar.a("result", Integer.valueOf(i5));
            eVar.a("type", Integer.valueOf(i4));
            eVar.a("url", d.f().f13328r ? d.f().f13294J : d.f().f13293I);
            eVar.a("reason", str);
            cVar.a("2000112", eVar);
