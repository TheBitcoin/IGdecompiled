...
public class MBridgeDailyPlayModel {
    ...
    public MBridgeDailyPlayModel(int i4, String str, String str2) {
        this.mAdType = i4;
        str = TextUtils.isEmpty(str) ? "null" : str;
        this.mPlacementID = str;
        str2 = TextUtils.isEmpty(str2) ? "null" : str2;
        this.mUnitID = str2;
        String str3 = i4 + "_" + str + "_" + str2;
        this.mCountKey = str3 + "_count";
        this.mTimeKey = str3 + "_time";
    }

    public void insertDailyCap() {
        long j4 = MBridgeSharedPreferenceModel.getInstance().getLong(this.mTimeKey, 0);
    ...
    public void setMaxPlayCount(int i4) {
        this.mMaxDailyCap = i4;
    }
}
