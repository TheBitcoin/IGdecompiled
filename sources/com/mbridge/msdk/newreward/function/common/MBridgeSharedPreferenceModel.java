...
public final class MBridgeSharedPreferenceModel {
    ...
    private int getIntegerValue(String str, int i4) {
        ...
        try {
            int i5 = this.mFastKV.getInt(str, i4);
    ...
    private long getLongValue(String str, long j4) {
        if (this.mFastKV == null) {
            initFastKV();
        }
        try {
            long j5 = this.mFastKV.getLong(str, j4);
    ...
    public final int getInteger(String str, int i4) {
        Integer num;
    ...
    public final long getLong(String str, long j4) {
        ...
        if (!concurrentHashMap.containsKey(str) || (l4 = concurrentHashMap.get(str)) == null) {
            return getLongValue(str, j4);
        }
        return l4.longValue();
    }
    ...
    public final void putInteger(String str, int i4) {
        if (!TextUtils.isEmpty(str)) {
            ConcurrentHashMap<String, Integer> concurrentHashMap = mIntegerCache;
            if (concurrentHashMap.containsKey(str)) {
