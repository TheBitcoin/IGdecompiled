...
public final class g implements b {
    ...
    private final String f14800a = "RedirectReceiver";
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f14801a     // Catch:{ NoSuchFieldError -> 0x00d8 }
    ...
    public final void a(Object obj) {
        ...
        if (redirectModel != null) {
            ...
            switch (AnonymousClass1.f14801a[redirectModel.getRedirectType().ordinal()]) {
                case 1:
                    ...
                    try {
                        if (!TextUtils.isEmpty(noticeUrl)) {
                            if (!noticeUrl.contains(a.f13139m)) {
                                noticeUrl = noticeUrl + "&" + a.f13139m + "=" + intValue;
                            } else {
                                noticeUrl = noticeUrl.replace(a.f13139m + "=" + Uri.parse(noticeUrl).getQueryParameter(a.f13139m), a.f13139m + "=" + intValue);
                            }
                        }
                    } catch (Throwable th) {
                ...
                case 2:
                    ...
                    return;
                case 3:
                    com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), a(campaignEx.getImpressionURL(), campaignEx, settingModel), false, true, com.mbridge.msdk.click.a.a.f12014g);
                    return;
                case 4:
                    com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), a(campaignEx.getOnlyImpressionURL(), campaignEx, settingModel), false, true, com.mbridge.msdk.click.a.a.f12015h);
                    return;
                case 5:
                    ...
                    return;
                case 6:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (l4 = campaignEx.getNativeVideoTracking().l()) != null && l4.length > 0) {
                        com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), l4, true, false);
                        return;
                    }
                    return;
                case 7:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (r4 = campaignEx.getNativeVideoTracking().r()) != null && r4.length > 0) {
                        try {
                            String[] strArr = new String[r4.length];
                            for (int i4 = 0; i4 < r4.length; i4++) {
                                String a6 = a(r4[i4], campaignEx, settingModel);
                ...
                case 8:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (s4 = campaignEx.getNativeVideoTracking().s()) != null && s4.length > 0) {
                        com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), s4, false, false);
                        return;
                    }
                    return;
                case 9:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (j4 = campaignEx.getNativeVideoTracking().j()) != null && j4.length > 0) {
                        com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), j4, false, false);
                        return;
                    }
                    return;
                case 10:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (k4 = campaignEx.getNativeVideoTracking().k()) != null && k4.length > 0) {
                        com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), k4, false, false);
                        return;
                    }
                    return;
                case 11:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (p4 = campaignEx.getNativeVideoTracking().p()) != null && p4.length > 0) {
                        com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), p4, false, true);
                        return;
                    }
                    return;
                case 12:
                    if (campaignEx != null && campaignEx.getNativeVideoTracking() != null && (o4 = campaignEx.getNativeVideoTracking().o()) != null && o4.length > 0) {
                        com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), o4, false, true);
                        return;
                    }
                    return;
                case 13:
                    try {
                        ...
                        if (campaignEx != null && campaignEx.getNativeVideoTracking() != null) {
                            ...
                            if (!i5.isEmpty()) {
                                for (Map<Integer, String> entrySet : i5) {
                ...
                case 14:
                    if (campaignEx != null) {
                        try {
                            if (campaignEx.getNativeVideoTracking() != null && (m4 = campaignEx.getNativeVideoTracking().m()) != null && m4.length > 0) {
                                com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), m4, false, false);
                                return;
                            }
                            return;
                        } catch (Exception e7) {
                ...
                case 15:
                    if (campaignEx != null) {
                        try {
                            if (campaignEx.getNativeVideoTracking() != null && (n4 = campaignEx.getNativeVideoTracking().n()) != null && n4.length > 0) {
                                com.mbridge.msdk.click.a.a(c.m().c(), campaignEx, redirectModel.getUnitId(), n4, false, false);
                                return;
                            }
                            return;
                        } catch (Exception e8) {
    ...
    private JSONObject a(RedirectModel redirectModel) {
        ...
        try {
            jSONObject2.put(a.f13134h, redirectModel.getxInScreen());
            jSONObject2.put(a.f13135i, redirectModel.getyInScreen());
            jSONObject2.put(a.f13139m, redirectModel.getClickSenario());
            try {
                i4 = c.m().c().getResources().getConfiguration().orientation;
            } catch (Exception e5) {
                e5.printStackTrace();
                i4 = 1;
            }
            jSONObject2.put(a.f13137k, i4);
