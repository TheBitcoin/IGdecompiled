...
public class NewShowReceiver implements b {
    ...
    public final void a(Object obj) {
        ...
        if (eVar != null) {
            ...
            intent.putExtra(CampaignEx.JSON_KEY_LOCAL_REQUEST_ID, this.f14813a.G());
            if (!(this.f14813a.D() == null || this.f14813a.D().a() == null || this.f14813a.D().a().size() != 1)) {
                e eVar2 = this.f14813a;
                eVar2.a(eVar2.D().a().get(0));
            }
            try {
                this.f14813a.p(a.b(c.m().c()));
            } catch (Throwable th) {
