...
public final class a {
    ...
    public com.mbridge.msdk.newreward.function.command.a.a f14688a;
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public volatile boolean f14689b = false;
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14698a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public final void b(final e eVar, final b bVar) {
        if (eVar != null) {
                ...
                public final void run() {
                    ...
                    a.this.f14688a.a(bVar, new b() {
                        public final void reqFailed(com.mbridge.msdk.foundation.c.b bVar) {
                            ...
                            boolean unused = a.this.f14689b = true;
            ...
            af.a("CampaignRetryStrategy", "retryReqCampaign，retryReqCampaign: " + this.f14690c);
            MBridgeTaskManager.directorExecute(r02, this.f14690c);
        }
    }
    ...
    public void a(f fVar, e eVar, String str, boolean z4) {
        ...
        if (eVar != null) {
            ...
            if (d5 != null && b5 != null) {
                try {
                    Map a5 = d5.a("retry_count", Integer.valueOf(this.f14691d), "type", 1);
                    int i5 = AnonymousClass2.f14698a[fVar.ordinal()];
                    if (i5 == 1) {
                        d5.a((Object) b5, f.REPORT_V3_RETRY_START, (Object) a5);
                    } else if (i5 == 2) {
                        a5.put(TypedValues.TransitionType.S_DURATION, Long.valueOf(System.currentTimeMillis() - this.f14692e));
                        if (z4) {
                            a5.put("reason", str);
                        }
                        if (z4) {
