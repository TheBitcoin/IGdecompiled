...
public final class e implements a {
    ...
    com.mbridge.msdk.newreward.a.e f14759a;
    ...
    public final void a(b bVar, com.mbridge.msdk.newreward.a.b.b bVar2) {
        ...
        try {
            Map map = (Map) bVar.b();
            this.f14759a = (com.mbridge.msdk.newreward.a.e) map.get("adapter_model");
            this.f14760b = (c) map.get("command_manager");
            try {
                Map<String, Long> map2 = com.mbridge.msdk.foundation.same.a.b.f13166k;
            ...
            try {
                i.a((f) g.a(com.mbridge.msdk.foundation.controller.c.m().c())).a(this.f14759a.H());
            } catch (Exception e6) {
                if (MBridgeConstans.DEBUG) {
                    e6.printStackTrace();
                }
            ...
            try {
                com.mbridge.msdk.newreward.a.e eVar = this.f14759a;
                if (eVar.A() == 2) {
                ...
                } else if (((MBridgeDailyPlayModel) this.f14760b.a((Object) new HashMap(), com.mbridge.msdk.newreward.function.command.f.CREATE_DAILY)).isOverDailyCap()) {
                    bVar2.reqFailed(new com.mbridge.msdk.foundation.c.b(880019));
                } else {
                    com.mbridge.msdk.newreward.a.e eVar2 = this.f14759a;
                    if (eVar2 != null) {
