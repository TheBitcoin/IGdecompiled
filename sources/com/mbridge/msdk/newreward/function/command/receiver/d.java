...
public class d {
    ...
    private static volatile d f14769a;

    /* renamed from: b  reason: collision with root package name */
    private ConcurrentHashMap<f, Object> f14770b;

    /* renamed from: c  reason: collision with root package name */
    private ConcurrentHashMap<String, Object> f14771c;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f14772a     // Catch:{ NoSuchFieldError -> 0x00e4 }
    ...
    public final <T extends a> T b(f fVar) {
        int i4 = AnonymousClass1.f14772a[fVar.ordinal()];
        if (i4 == 1) {
            return new g();
        }
        if (i4 == 2) {
    ...
    public final <T extends e> T c(f fVar) {
        T t4 = null;
        switch (AnonymousClass1.f14772a[fVar.ordinal()]) {
            case 11:
            ...
            case 14:
                if (this.f14770b == null) {
                    this.f14770b = new ConcurrentHashMap<>();
                }
                ConcurrentHashMap<f, Object> concurrentHashMap = this.f14770b;
                f fVar2 = f.CANDIDATE_LOAD_ACTION;
                if (concurrentHashMap.containsKey(fVar2)) {
                    t4 = (e) this.f14770b.get(fVar2);
                }
                if (t4 != null) {
                    return t4;
                }
                T aVar = new a();
                this.f14770b.put(fVar2, aVar);
                return aVar;
            case 15:
            case 16:
            case 17:
    ...
    public final void d(f fVar) {
        ...
        if (fVar != null && (concurrentHashMap = this.f14770b) != null) {
    ...
    public final <T extends b> T a(f fVar) {
        ...
        if (concurrentHashMap.containsKey(fVar2)) {
            t4 = (h) this.f14770b.get(fVar2);
        }
        if (t4 != null) {
            return t4;
        }
        T hVar = new h();
        this.f14770b.put(fVar2, hVar);
        return hVar;
    }
    ...
    public final <T extends b> T a(f fVar, String str) {
        ...
        if (fVar == f.SHOW_OR_PRELOAD_WEB_TEMPLATE) {
            if (this.f14771c == null) {
                this.f14771c = new ConcurrentHashMap<>();
            }
            if (this.f14771c.containsKey(str)) {
                t4 = (com.mbridge.msdk.newreward.function.command.receiver.showreceiver.i) this.f14771c.get(str);
            }
            if (t4 == null) {
                T iVar = new com.mbridge.msdk.newreward.function.command.receiver.showreceiver.i();
                this.f14771c.put(str, iVar);
                return iVar;
            }
        }
        return t4;
    ...
    public final void a(String str) {
        ...
        if (!TextUtils.isEmpty(str) && (concurrentHashMap = this.f14771c) != null) {
