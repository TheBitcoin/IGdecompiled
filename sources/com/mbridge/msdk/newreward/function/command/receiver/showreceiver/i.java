...
public final class i implements b {
    ...
    MBWebView f14803a = null;

    /* renamed from: b  reason: collision with root package name */
    WebTemplateModel f14804b = null;

    /* renamed from: c  reason: collision with root package name */
    Handler f14805c = new Handler(Looper.getMainLooper());

    /* renamed from: d  reason: collision with root package name */
    private final String f14806d = "WebTemplateReceiver";
    ...
    public final void a(java.lang.Object r11) {
        ...
        L_0x00c9:
            ...
            android.os.Handler r2 = r10.f14805c     // Catch:{ all -> 0x0020 }
        ...
        L_0x00d5:
            if (r1 != r6) goto L_0x010d
            com.mbridge.msdk.newreward.player.view.hybrid.MBWebView r1 = r10.f14803a     // Catch:{ all -> 0x0020 }
            if (r1 == 0) goto L_0x0100
            com.mbridge.msdk.newreward.player.model.WebTemplateModel r1 = r10.f14804b     // Catch:{ all -> 0x0020 }
            if (r1 != 0) goto L_0x00e0
            goto L_0x0100
        L_0x00e0:
            int r1 = r1.getRenderStatus()     // Catch:{ all -> 0x0020 }
            com.mbridge.msdk.newreward.player.model.WebTemplateModel r2 = r10.f14804b     // Catch:{ all -> 0x0020 }
        ...
        L_0x00ef:
            ...
            android.os.Handler r11 = r10.f14805c     // Catch:{ all -> 0x0020 }
    ...
    private void a(int i4, c cVar, e eVar, ViewGroup viewGroup) {
        if (cVar != null) {
            try {
                cVar.g(cVar.a("add_temple", Integer.valueOf(i4), "template_type", 17, "adapter_model", eVar, "parent_temple", viewGroup), f.SHOW_ADD_TEMPLE);
            } catch (Throwable th) {
