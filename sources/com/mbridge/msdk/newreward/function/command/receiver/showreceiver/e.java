...
public final class e implements a {
    ...
    public final void a(b bVar, com.mbridge.msdk.newreward.a.b.b bVar2) {
        Map map = (Map) bVar.b();
        this.f14795a = ((com.mbridge.msdk.newreward.function.c.a.b) map.get("more_offer_campaign")).E();
        CampaignEx campaignEx = (CampaignEx) map.get("campaign");
        this.f14796b = campaignEx;
        if (campaignEx != null) {
            this.f14797c = aq.a(campaignEx.getendcard_url(), "mof_textmod");
        }
        List<CampaignEx> list = this.f14795a;
        if (list == null || list.isEmpty()) {
            bVar2.reqFailed(new com.mbridge.msdk.foundation.c.b(-1, ""));
            return;
        }
        List<CampaignEx> list2 = this.f14795a;
        ...
        for (CampaignEx next : list2) {
            ...
            if (inflate != null) {
                ...
                if (!TextUtils.isEmpty(next.getAppName())) {
                    if (TextUtils.isEmpty(this.f14797c) || !this.f14797c.equals("1")) {
