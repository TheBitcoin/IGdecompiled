...
public final class b {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (jSONObject != null) {
                ...
                if (!str.contains("notice")) {
                    JSONObject optJSONObject = jSONObject2.optJSONObject(a.f13136j);
                    if (optJSONObject != null) {
                        str3 = String.valueOf(ak.a(c.m().c(), (float) Integer.parseInt(optJSONObject.getString(a.f13134h))));
                        str2 = String.valueOf(ak.a(c.m().c(), (float) Integer.parseInt(optJSONObject.getString(a.f13135i))));
                    } else {
                        str3 = "-999";
                        str2 = str3;
                    }
                    if (optJSONObject != null) {
                        if (optJSONObject.length() > 0) {
                            ...
                            while (keys.hasNext()) {
                                ...
                                if (a.f13134h.equals(next) || a.f13135i.equals(next)) {
    ...
    public static String a(String str, List<CampaignEx> list, boolean z4, int i4) {
        ...
        try {
            ...
            jSONObject2.put("playVideoMute", i4);
    ...
    private static boolean a(com.mbridge.msdk.foundation.entity.CampaignEx r6) {
        ...
        L_0x0032:
            ...
            boolean r6 = r6.isSpareOffer(r2, r0)     // Catch:{ Exception -> 0x0039 }
            return r6
        L_0x0039:
            r6 = move-exception
    ...
    public static String a(float f4, float f5, int i4) {
        JSONObject jSONObject;
        int i5;
        JSONObject jSONObject2 = new JSONObject();
        try {
            jSONObject = new JSONObject();
            jSONObject.put(a.f13134h, ak.b(c.m().c(), f4));
            jSONObject.put(a.f13135i, ak.b(c.m().c(), f5));
            jSONObject.put(a.f13139m, i4);
            i5 = c.m().c().getResources().getConfiguration().orientation;
        } catch (Throwable th) {
            af.b("HybridCommunicatorUtil", th.getMessage());
        }
        jSONObject.put(a.f13137k, i5);
        jSONObject.put(a.f13138l, (double) ak.d(c.m().c()));
        jSONObject2.put(a.f13136j, jSONObject);
