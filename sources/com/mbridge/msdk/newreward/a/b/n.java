...
public final class n implements a {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14353a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.i().H() != null) {
            if (aVar.i().H().containsKey("command_manager")) {
                this.f14347a = (c) aVar.i().H().get("command_manager");
            }
            if (aVar.i().H().containsKey("adapter_model")) {
                this.f14348b = (e) aVar.i().H().get("adapter_model");
            }
        }
        if (d5 == null) {
    ...
    public void a(f fVar, int i4, a aVar, MBridgeError mBridgeError) {
        c cVar = this.f14347a;
        if (cVar != null && this.f14348b != null) {
            try {
                ...
                int i5 = AnonymousClass2.f14353a[fVar.ordinal()];
                if (i5 == 1) {
                    a5.put("cache", Integer.valueOf(this.f14349c));
                    this.f14347a.a((Object) this.f14348b, fVar, (Object) a5);
                } else if (i5 == 2) {
                    if (this.f14349c == 2) {
