...
public final class j implements a {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14331a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.i().H() != null) {
            if (aVar.i().H().containsKey("command_manager")) {
                this.f14326a = (c) aVar.i().H().get("command_manager");
            }
            if (aVar.i().H().containsKey("adapter_model")) {
                this.f14327b = (e) aVar.i().H().get("adapter_model");
            }
        }
        if (e5 == null) {
    ...
    public void a(f fVar, int i4, a aVar, MBridgeError mBridgeError) {
        c cVar = this.f14326a;
        if (cVar != null && this.f14327b != null) {
            try {
                Map a5 = cVar.a("resource_type", 7, "url", aVar.e().j(), "mraid_type", Integer.valueOf(aVar.j() ? 1 : 0));
                int i5 = AnonymousClass2.f14331a[fVar.ordinal()];
                if (i5 == 1) {
                    a5.put("cache", Integer.valueOf(this.f14328c));
                    this.f14326a.a((Object) this.f14327b, fVar, (Object) a5);
                } else if (i5 == 2) {
                    if (this.f14328c == 2) {
