...
public final class g implements a {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14321a     // Catch:{ NoSuchFieldError -> 0x001d }
        ...
        if (aVar == null || aVar.h() == null || !aVar.h().isDynamicView()) {
            ...
            if (!(aVar == null || aVar.i().H() == null)) {
                if (aVar.i().H().containsKey("command_manager")) {
                    this.f14316a = (c) aVar.i().H().get("command_manager");
                }
                if (aVar.i().H().containsKey("adapter_model")) {
                    this.f14317b = (e) aVar.i().H().get("adapter_model");
                }
            }
            if (b5 == null) {
    ...
    public void a(f fVar, int i4, a aVar, MBridgeError mBridgeError) {
        c cVar = this.f14316a;
        if (cVar != null && this.f14317b != null) {
            try {
                Map a5 = cVar.a("resource_type", 6, "scenes", 1, "url", aVar.b().j(), "mraid_type", Integer.valueOf(aVar.j() ? 1 : 0));
                int i5 = AnonymousClass2.f14321a[fVar.ordinal()];
                if (i5 == 1) {
                    a5.put("cache", Integer.valueOf(this.f14318c));
                    this.f14316a.a((Object) this.f14317b, fVar, (Object) a5);
                } else if (i5 == 2) {
                    if (this.f14318c == 2) {
