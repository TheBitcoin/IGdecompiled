...
public final class d implements a {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14301a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (bVar2.H() != null) {
            if (bVar2.H().containsKey("command_manager")) {
                this.f14295a = (c) bVar2.H().get("command_manager");
            }
            if (bVar2.H().containsKey("adapter_model")) {
                this.f14296b = (e) bVar2.H().get("adapter_model");
            }
        }
        if (w4 == null) {
        ...
        w4.l().a(0, new x() {
            ...
            private void a(b bVar, b bVar2, MBridgeError mBridgeError, String str) {
                ...
                if (bVar.y()) {
                    ...
                    if (!w4.d()) {
                        bVar2.reqFailed(com.mbridge.msdk.foundation.c.a.a(i4, 880005, str + str2));
                    }
                }
            }
        });
    ...
    public void a(f fVar, b bVar, int i4, String str) {
        c cVar = this.f14295a;
        if (cVar != null && this.f14296b != null) {
            try {
                Map a5 = cVar.a("resource_type", 1, "url", bVar.w().j());
                int i5 = AnonymousClass2.f14301a[fVar.ordinal()];
                if (i5 == 1) {
                    a5.put("cache", Integer.valueOf(this.f14297c));
                    this.f14295a.a((Object) this.f14296b, fVar, (Object) a5);
                } else if (i5 == 2) {
                    if (this.f14297c == 2) {
