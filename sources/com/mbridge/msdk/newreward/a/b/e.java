...
public final class e implements a {
    ...
    public com.mbridge.msdk.newreward.a.e f14303b;
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f14308a     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.i().H() != null) {
            if (aVar.i().H().containsKey("command_manager")) {
                this.f14302a = (c) aVar.i().H().get("command_manager");
            }
            if (aVar.i().H().containsKey("adapter_model")) {
                this.f14303b = (com.mbridge.msdk.newreward.a.e) aVar.i().H().get("adapter_model");
            }
        }
        if (c5 == null) {
        ...
        c5.l().a(0, new x() {
            ...
            public final void b(b bVar, a aVar, q qVar) {
                ...
                if (!(e.this.f14302a == null || aVar == null || aVar.c() == null)) {
                    if (!aVar.c().g()) {
                        e.this.f14302a.i(e.this.f14302a.a("web_resource_action", 1, "parent_temple", null, "adapter_model", e.this.f14303b, CampaignEx.JSON_KEY_LOCAL_REQUEST_ID, e.this.f14303b.G(), "bridge_ids", aVar.g()), f.SHOW_OR_PRELOAD_WEB_TEMPLATE);
                    } else {
                        return;
                    }
                }
    ...
    /* access modifiers changed from: private */
    public void a(f fVar, int i4, a aVar, MBridgeError mBridgeError) {
        c cVar = this.f14302a;
        if (cVar != null && this.f14303b != null) {
            try {
                ...
                int i5 = AnonymousClass2.f14308a[fVar.ordinal()];
                if (i5 == 1) {
                    a5.put("cache", Integer.valueOf(this.f14304c));
                    this.f14302a.a((Object) this.f14303b, fVar, (Object) a5);
                } else if (i5 == 2) {
                    if (this.f14304c == 2) {
