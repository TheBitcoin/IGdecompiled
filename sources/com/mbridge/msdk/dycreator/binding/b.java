...
public final class b {
    ...
    private static volatile b f12543a;

    /* renamed from: b  reason: collision with root package name */
    private d f12544b = ((d) a.a().a(a.C0177a.VIEW_OBSERVER));

    /* renamed from: c  reason: collision with root package name */
    private c f12545c = ((c) a.a().a(a.C0177a.CLICK_OBSERVER));

    /* renamed from: d  reason: collision with root package name */
    private f f12546d = ((f) a.a().a(a.C0177a.EFFECT_OBSERVER));

    /* renamed from: e  reason: collision with root package name */
    private h f12547e = ((h) a.a().a(a.C0177a.REPORT_OBSERVER));

    /* renamed from: f  reason: collision with root package name */
    private BaseViewModel f12548f;
    /* access modifiers changed from: private */

    /* renamed from: g  reason: collision with root package name */
    public com.mbridge.msdk.shake.b f12549g;
                                                    ...
                                                    try {
                                                        if (!bitmap.isRecycled()) {
                                                            ...
                                                            if (aVar2.getEffectData().getOrientation() == 1) {
                                                                i4 = view.getResources().getConfiguration().orientation;
                                                            } else {
                                                                i4 = aVar2.getEffectData().getOrientation();
                                                            }
                                                            if (i4 == 1) {
                                                                if (z4) {
                                                                    View view = view;
    ...
    public final void a(BaseViewModel baseViewModel) {
        this.f12548f = baseViewModel;
        if (baseViewModel != null) {
            baseViewModel.setClickSubject(this.f12545c);
            this.f12548f.setConcreteSubject(this.f12544b);
            this.f12548f.setEffectSubject(this.f12546d);
            this.f12548f.setReportSubject(this.f12547e);
        }
    }
    ...
    private com.mbridge.msdk.shake.b a(View view, MBSplashData mBSplashData) {
        ...
        if (mBSplashData != null) {
            try {
                ...
                if (dyOption != null && dyOption.isShakeVisible() && this.f12549g == null) {
                    bVar = this;
                    final View view2 = view;
                    final MBSplashData mBSplashData2 = mBSplashData;
                    try {
                        bVar.f12549g = new com.mbridge.msdk.shake.b(dyOption.getShakeStrenght(), dyOption.getShakeTime() * 1000) {
                            public final void a() {
                                View view = view2;
                                if (view != null) {
                                    try {
                                        if (view.getGlobalVisibleRect(new Rect())) {
                                            ...
                                            com.mbridge.msdk.shake.a.a().b(b.this.f12549g);
                                        }
                                    } catch (Exception e5) {
                                        af.b("MBDataBinding", e5.getMessage());
                                    }
                    ...
                    if (interBase instanceof ViewGroup) {
                        ...
                        if (effectDes != null) {
                            if (effectDes.equals("wobble") && (viewGroup instanceof MBSplashShakeView)) {
                                if (aVar.getEffectData().isShakeVisible()) {
                                    if (bVar.f12549g != null) {
                                        com.mbridge.msdk.shake.a.a().b(bVar.f12549g);
                                    }
                                    com.mbridge.msdk.shake.a.a().a(bVar.a(viewGroup, (MBSplashData) aVar));
                                } else if (bVar.f12549g != null) {
                                    com.mbridge.msdk.shake.a.a().b(bVar.f12549g);
                                }
                            }
                        ...
                        if (effectDes != null) {
                            ...
                            if (effectDes.equals("countdown") && (view instanceof TextView)) {
                                ...
                                final String t4 = ab.t(view.getContext());
                                DyOption effectData = aVar2.getEffectData();
                                if (effectData != null) {
                                    boolean isCanSkip = effectData.isCanSkip();
                                    i4 = effectData.getCountDownTime();
                                    z4 = isCanSkip;
                                } else {
                                    i4 = 5;
                                    z4 = false;
                                }
                                ((TextView) view).setText(com.mbridge.msdk.dycreator.e.d.a(z4, i4, str, t4));
