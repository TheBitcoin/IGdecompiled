...
class SubscriberMethodFinder {
    ...
    private static final Map<String, List<SubscriberMethod>> f12624a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f12625b = new ConcurrentHashMap();
    ...
    public final List<SubscriberMethod> a(Class<?> cls, String str) {
        ...
        Map<String, List<SubscriberMethod>> map = f12624a;
        synchronized (map) {
            list = map.get(str3);
        }
        if (list != null) {
            ...
            for (Method method : cls2.getDeclaredMethods()) {
                ...
                if (name2.startsWith(str2)) {
                    ...
                    if (parameterTypes.length == 1) {
                        ...
                        } else if (!f12625b.containsKey(cls2)) {
        ...
        if (!arrayList.isEmpty()) {
            Map<String, List<SubscriberMethod>> map2 = f12624a;
            synchronized (map2) {
