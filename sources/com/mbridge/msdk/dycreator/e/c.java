...
public final class c {
    public static double a(double d5, double d6, int i4) {
        if (i4 < 0) {
            return 1.0d;
        }
        try {
            return new BigDecimal(Double.toString(d5)).divide(new BigDecimal(Double.toString(d6)), i4, 4).doubleValue();
        } catch (Exception e5) {
            ...
            for (int i4 = 0; i4 < attributeCount; i4++) {
                ...
                if (!TextUtils.isEmpty(attributeName)) {
                    if (attributeName.equals("mbridge_data")) {
                        try {
                            hashMap.put("mbridgeData", b.f12637a.get(attributeSet.getAttributeValue(i4).substring(8)));
                        } catch (Exception e5) {
                            e5.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_click")) {
                        try {
                            hashMap.put("mbridgeAction", b.f12637a.get(attributeSet.getAttributeValue(i4).substring(8)));
                        } catch (Exception e6) {
                            e6.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_strategy")) {
                        try {
                            hashMap.put("mbridgeStrategy", b.f12637a.get(attributeSet.getAttributeValue(i4).substring(8)));
                        } catch (Exception e7) {
                            e7.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_effect")) {
                        try {
                            hashMap.put("mbridgeEffect", b.f12637a.get(attributeSet.getAttributeValue(i4).substring(8)));
                        } catch (Exception e8) {
                            e8.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_report")) {
                        try {
                            hashMap.put("mbridgeReport", attributeSet.getAttributeValue(i4));
                        } catch (Exception e9) {
                            e9.printStackTrace();
                        }
                    }
