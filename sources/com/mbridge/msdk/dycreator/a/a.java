...
public final class a {
    ...
    private static final Class[] f12176f = {Context.class, AttributeSet.class};

    /* renamed from: g  reason: collision with root package name */
    private static final HashMap<String, Constructor> f12177g = new HashMap<>();

    /* renamed from: j  reason: collision with root package name */
    private static String f12178j = "com.mbridge.msdk.dycreator.baseview.MB";

    /* renamed from: a  reason: collision with root package name */
    protected final Context f12179a;

    /* renamed from: b  reason: collision with root package name */
    private final boolean f12180b = true;

    /* renamed from: c  reason: collision with root package name */
    private C0176a f12181c;

    /* renamed from: d  reason: collision with root package name */
    private b f12182d;

    /* renamed from: e  reason: collision with root package name */
    private final Object[] f12183e = new Object[2];

    /* renamed from: h  reason: collision with root package name */
    private HashMap<String, Boolean> f12184h;
    ...
    private void b(org.xmlpull.v1.XmlPullParser r6, android.view.View r7, android.util.AttributeSet r8) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x001c:
            ...
            throw r7
        L_0x0038:
            android.content.Context r1 = r5.f12179a
    ...
    private android.view.View a(org.xmlpull.v1.XmlPullParser r7, android.view.ViewGroup r8, boolean r9) {
        /*
            r6 = this;
            java.lang.Object[] r0 = r6.f12183e
            monitor-enter(r0)
            android.util.AttributeSet r1 = android.util.Xml.asAttributeSet(r7)     // Catch:{ all -> 0x0053 }
            java.lang.Object[] r2 = r6.f12183e     // Catch:{ all -> 0x0053 }
            android.content.Context r3 = r6.f12179a     // Catch:{ all -> 0x0053 }
            r4 = 0
    ...
    private View a(String str, String str2, AttributeSet attributeSet) throws ClassNotFoundException, InflateException {
        ...
        String str4;
        String str5;
        HashMap<String, Constructor> hashMap = f12177g;
        Constructor<?> constructor = hashMap.get(str);
        Class cls = null;
        if (constructor == null) {
            try {
                ClassLoader classLoader = this.f12179a.getClassLoader();
                if (str2 != null) {
                    str5 = str2 + str;
                } else {
                    str5 = str;
                ...
                constructor = loadClass.getConstructor(f12176f);
        ...
        } else if (this.f12182d != null) {
            Boolean bool = this.f12184h.get(str);
            if (bool == null) {
                ClassLoader classLoader2 = this.f12179a.getClassLoader();
                if (str2 != null) {
                    str3 = str2 + str;
                } else {
                    str3 = str;
                ...
                boolean z4 = loadClass2 != null && this.f12182d.a(loadClass2);
                this.f12184h.put(str, Boolean.valueOf(z4));
                if (!z4) {
                    b(str, str2, attributeSet);
                }
    ...
    private View a(String str, AttributeSet attributeSet) {
        ...
        try {
            C0176a aVar = this.f12181c;
            View a5 = aVar == null ? null : aVar.a(str, this.f12179a, attributeSet);
            if (a5 == null) {
                if (-1 == str.indexOf(46)) {
                    if (!str.equals("MBStarLevelLayoutView")) {
                        if (!str.equals("LuckPan")) {
                            a5 = a(str, f12178j, attributeSet);
                        }
                    }
    ...
    public final View a(String str, ViewGroup viewGroup) {
        ...
        this.f12185i = System.currentTimeMillis();
        PrintStream printStream = System.out;
