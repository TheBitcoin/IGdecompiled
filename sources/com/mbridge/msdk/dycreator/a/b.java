...
public class b {
    ...
    private static volatile b f12186g;

    /* renamed from: a  reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f12187a;

    /* renamed from: b  reason: collision with root package name */
    private SoftReference<HashMap<String, String>> f12188b;

    /* renamed from: c  reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f12189c;
    ...
    public final HashMap b() {
        SoftReference<HashMap<String, c>> softReference = this.f12187a;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f12187a = new SoftReference<>(hashMap);
        }
        return this.f12187a.get();
    }

    public final HashMap<String, c> c() {
        SoftReference<HashMap<String, c>> softReference = this.f12189c;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f12189c = new SoftReference<>(hashMap);
        }
        return this.f12189c.get();
    }
    ...
    public final int d(String str) {
        ...
        if (TextUtils.isEmpty(g4)) {
            g4 = this.f12192f.getPackageName();
        }
    ...
    public final String e(String str) {
        ...
        SoftReference<HashMap<String, String>> softReference = this.f12188b;
        if (softReference == null || softReference.get() == null) {
            this.f12188b = new SoftReference<>(d());
        }
        String substring = str.substring(8);
        if (this.f12188b.get() == null || this.f12188b.get().size() <= 0) {
            return null;
        }
        String str2 = (String) this.f12188b.get().get(substring);
    ...
    public final void a(Context context, String str) {
        try {
            if (g.f12640a) {
                this.f12190d = context.getFilesDir().toString();
            } else {
                this.f12190d = str;
            }
            if (e.a(context).heightPixels > 320) {
                if (!g.f12640a) {
                    this.f12191e = "/drawable-hdpi/";
                    this.f12192f = context;
                    com.mbridge.msdk.dycreator.e.b.f12637a = a().d();
                }
            }
            this.f12191e = "/drawable-mdpi/";
            this.f12192f = context;
            com.mbridge.msdk.dycreator.e.b.f12637a = a().d();
        } catch (Exception e5) {
            af.b("MBResource", e5.getMessage());
    ...
    private HashMap<String, String> d() {
        ...
        try {
            inputStream = this.f12192f.getAssets().open("rv_binddatas.xml");
    ...
    public final int a(String str) {
        ...
        if (str.startsWith("#")) {
            ...
            return Build.VERSION.SDK_INT >= 23 ? c.m().c().getColor(x.a(c.m().c(), str.substring(7), "color")) : ViewCompat.MEASURED_STATE_MASK;
        }
    }
    ...
    public final int b(String str) {
        try {
            ...
            if (str.contains("d")) {
                return (int) TypedValue.applyDimension(1, (float) parseInt, this.f12192f.getResources().getDisplayMetrics());
            }
            str.contains("s");
            return parseInt;
        }
    ...
    public final void a(String str, ImageView imageView) {
        Context context;
        if (str != null && str.startsWith("@drawable/") && (context = this.f12192f) != null) {
            try {
                ...
                imageView.setImageResource(resources.getIdentifier(str, "drawable", g4));
            } catch (Exception e5) {
                af.b("MBResource", e5.getMessage());
            }
        }
    ...
    public final int c(String str) {
        ...
        try {
            ...
            for (String field : split) {
                i4 = cls.getField(field).getInt((Object) null);
            }
            return i4;
        } catch (Exception e5) {
            e5.printStackTrace();
