...
public class MBHorizontalScrollView extends HorizontalScrollView implements InterBase {
    ...
    private Map<String, String> f12275a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f12276b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12278a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12278a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12278a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f12278a     // Catch:{ NoSuchFieldError -> 0x003e }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12275a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12275a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12275a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12275a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12275a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12275a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12276b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12276b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12277c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12276b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12276b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12277c);
        }
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12276b = c.a(str);
        if (campaignEx != null) {
            this.f12277c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12278a[cVar.ordinal()];
                if (i5 == 1) {
    ...
    public MBHorizontalScrollView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12275a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f12275a, (View) this);
        } catch (Exception e5) {
            af.b("MBHorizontalScrollView", e5.getMessage());
        }
    }

    public MBHorizontalScrollView(Context context, AttributeSet attributeSet, int i4) {
