...
public class MBPlayerView extends PlayerView implements InterBase {
    ...
    private float f12297a;

    /* renamed from: b  reason: collision with root package name */
    private float f12298b;

    /* renamed from: c  reason: collision with root package name */
    private Map<String, String> f12299c;

    /* renamed from: d  reason: collision with root package name */
    private Map<String, Boolean> f12300d;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x0054:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f12302a     // Catch:{ NoSuchFieldError -> 0x0090 }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12299c;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12299c.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12299c.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12299c.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12299c.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12299c.get("mbridgeStrategy");
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f12300d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12300d.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12301e);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12300d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12300d.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12301e);
        }
    }

    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        this.f12297a = motionEvent.getRawX();
        this.f12298b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12300d = c.a(str);
        if (campaignEx != null) {
            this.f12301e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public LinearLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f12302a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        layoutParams.weight = attributeSet.getAttributeFloatValue(i4, 0.0f);
                        break;
                    case 6:
    ...
    public MBPlayerView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12299c = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f12299c, (View) this);
        } catch (Exception e5) {
