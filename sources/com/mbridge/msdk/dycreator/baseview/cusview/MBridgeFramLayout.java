...
public class MBridgeFramLayout extends FrameLayout {
    ...
    public void onAttachedToWindow() {
        ...
        AnimatorSet animatorSet = this.f12421a;
        if (animatorSet != null) {
            try {
                animatorSet.start();
            } catch (Exception e5) {
    ...
    public MBridgeFramLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
