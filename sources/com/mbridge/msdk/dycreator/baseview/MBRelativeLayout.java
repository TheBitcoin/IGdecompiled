...
public class MBRelativeLayout extends RelativeLayout implements InterBase {
    ...
    private Map<String, String> f12305c;

    /* renamed from: d  reason: collision with root package name */
    private Map<String, Boolean> f12306d;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00e4 }
            ...
            L_0x00e4:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00f0 }
            ...
            L_0x00f0:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f12308a     // Catch:{ NoSuchFieldError -> 0x0120 }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12305c;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12305c.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12305c.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12305c.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12305c.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12305c.get("mbridgeStrategy");
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f12306d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12306d.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12307e);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12306d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12306d.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12307e);
        }
    }

    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        this.f12303a = motionEvent.getRawX();
        this.f12304b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12306d = c.a(str);
        if (campaignEx != null) {
            this.f12307e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public RelativeLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f12308a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        layoutParams.rightMargin = b.a().b(attributeSet.getAttributeValue(i4));
                        break;
                    case 15:
                        layoutParams.topMargin = b.a().b(attributeSet.getAttributeValue(i4));
                        break;
                    case 16:
                        layoutParams.bottomMargin = b.a().b(attributeSet.getAttributeValue(i4));
                        break;
                    case 17:
                        if (!attributeSet.getAttributeBooleanValue(i4, false)) {
                            break;
                    ...
                    case 20:
                        String attributeValue9 = attributeSet.getAttributeValue(i4);
                    ...
                    case 21:
                        String attributeValue10 = attributeSet.getAttributeValue(i4);
                    ...
                    case 22:
                        String attributeValue11 = attributeSet.getAttributeValue(i4);
    ...
    public MBRelativeLayout(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12305c = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f12305c, (View) this);
        } catch (Exception e5) {
            af.b("MBRelativeLayouts", e5.getMessage());
        }
    }
