...
public class MBExtMBridgeTextView extends MBridgeTextView implements InterBase {
    ...
    private Map<String, String> f12483a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f12484b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0049:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x0090:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x00f0:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0138 }
            ...
            L_0x0138:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0144 }
            ...
            L_0x0144:
                int[] r0 = f12486a     // Catch:{ NoSuchFieldError -> 0x0150 }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12486a[cVar.ordinal()];
                if (i5 == 27) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12483a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12483a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12483a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12483a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12483a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12483a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12484b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12484b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12485c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12484b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12484b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12485c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            c cVar = c5.get(attributeSet2.getAttributeName(i8));
            if (cVar != null) {
                Log.d("setupview", cVar.toString());
                String[] strArr = null;
                switch (AnonymousClass1.f12486a[cVar.ordinal()]) {
                    case 1:
                        String attributeValue = attributeSet2.getAttributeValue(i8);
                    ...
                    case 2:
                        String attributeValue2 = attributeSet2.getAttributeValue(i8);
                        if (!TextUtils.isEmpty(attributeValue2)) {
                            if (!attributeValue2.startsWith("@string/")) {
                                setText(attributeValue2);
                                break;
                            } else {
                                setText(b.a().e(attributeSet2.getAttributeValue(i8)));
                                break;
                            }
                        } else {
                            break;
                    ...
                    case 3:
                        String attributeValue3 = attributeSet2.getAttributeValue(i8);
                    ...
                    case 4:
                        setSingleLine(attributeSet2.getAttributeBooleanValue(i8, false));
                        break;
                    case 5:
                        setLines(attributeSet2.getAttributeIntValue(i8, 1));
                        break;
                    case 6:
                        String attributeValue4 = attributeSet2.getAttributeValue(i8);
                    ...
                    case 7:
                        setCompoundDrawablePadding(b.a().b(attributeSet2.getAttributeValue(i8)));
                        break;
                    case 8:
                        setHorizontalFadingEdgeEnabled(attributeSet2.getAttributeBooleanValue(i8, false));
                        break;
                    case 9:
                        setHorizontallyScrolling(attributeSet2.getAttributeBooleanValue(i8, false));
                        break;
                    case 10:
                        setTextColor(b.a().a(attributeSet2.getAttributeValue(i8)));
                        break;
                    case 11:
                        String attributeValue5 = attributeSet2.getAttributeValue(i8);
                    ...
                    case 12:
                        String attributeValue6 = attributeSet2.getAttributeValue(i8);
                    ...
                    case 13:
                        String attributeValue7 = attributeSet2.getAttributeValue(i8);
                        if (!attributeValue7.startsWith("#")) {
                            ...
                            if (strArr != null && strArr.length <= 2) {
                                setBackgroundColor(b.a().a(attributeSet2.getAttributeValue(i8)));
                                break;
                            } else {
                        ...
                        break;
                    case 14:
                        if (!TtmlNode.BOLD.equalsIgnoreCase(attributeSet2.getAttributeValue(i8))) {
                            break;
                        } else {
                    ...
                    case 15:
                        String attributeValue8 = attributeSet2.getAttributeValue(i8);
                        String substring = attributeValue8.substring(attributeValue8.indexOf("/") + 1);
                        b a5 = b.a();
                        setTextAppearance(getContext(), a5.d("R.style." + substring));
                        break;
                    case 16:
                        String attributeValue9 = attributeSet2.getAttributeValue(i8);
                        if (TextUtils.isEmpty(attributeValue9)) {
                            break;
                        } else {
                            String str2 = com.mbridge.msdk.dycreator.e.b.f12637a.get(attributeValue9.substring(8));
                    ...
                    case 17:
                        String attributeValue10 = attributeSet2.getAttributeValue(i8);
                        if (!TextUtils.isEmpty(attributeValue10)) {
                            String str3 = com.mbridge.msdk.dycreator.e.b.f12637a.get(attributeValue10.substring(8));
                    ...
                    case 18:
                        setGravity(b.a().c(attributeSet2.getAttributeValue(i8)));
                        break;
                    case 19:
                        int b5 = b.a().b(attributeSet2.getAttributeValue(i8));
                        setPadding(b5, b5, b5, b5);
                        break;
                    case 20:
                        i7 = b.a().b(attributeSet2.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 21:
                        i6 = b.a().b(attributeSet2.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 22:
                        i4 = b.a().b(attributeSet2.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 23:
                        i5 = b.a().b(attributeSet2.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 24:
                        setPadding(b.a().b(attributeSet2.getAttributeValue(i8)), i7, i5, i6);
                        break;
                    case 25:
                        setPadding(i4, i7, b.a().b(attributeSet2.getAttributeValue(i8)), i6);
                        break;
                    case 26:
                        setFilters(new InputFilter[]{new InputFilter.LengthFilter(b.a().b(attributeSet2.getAttributeValue(i8)))});
                        break;
                }
            }
        }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12484b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12485c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBExtMBridgeTextView(Context context, @Nullable AttributeSet attributeSet) {
        super(context);
        try {
            this.f12483a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f12483a, (View) this);
        } catch (Exception e5) {
            af.b("MBExtMBridgeTextView", e5.getMessage());
        }
    }

    public MBExtMBridgeTextView(Context context, @Nullable AttributeSet attributeSet, int i4) {
