...
public class MBExtFeedBackView extends FeedBackButton implements InterBase {
    ...
    private Map<String, String> f12457a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f12458b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0049:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x0090:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x00f0:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0138 }
            ...
            L_0x0138:
                int[] r0 = f12460a     // Catch:{ NoSuchFieldError -> 0x0144 }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12460a[cVar.ordinal()];
                if (i5 == 26) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12457a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12457a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12457a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12457a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12457a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12457a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12458b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12458b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12459c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12458b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12458b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12459c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            c cVar = c5.get(attributeSet.getAttributeName(i8));
            if (cVar != null) {
                Log.d("setupview", cVar.toString());
                switch (AnonymousClass1.f12460a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 2:
                        ...
                        if (!TextUtils.isEmpty(attributeValue2)) {
                            if (!attributeValue2.startsWith("@string/")) {
                                ...
                                setText(b.a().e(attributeSet.getAttributeValue(i8)));
                                break;
                            }
                        } else {
                            break;
                    ...
                    case 4:
                        setSingleLine(attributeSet.getAttributeBooleanValue(i8, false));
                        break;
                    case 5:
                        setLines(attributeSet.getAttributeIntValue(i8, 1));
                        break;
                    case 6:
                    ...
                    case 7:
                        setCompoundDrawablePadding(b.a().b(attributeSet.getAttributeValue(i8)));
                        break;
                    case 8:
                        setHorizontalFadingEdgeEnabled(attributeSet.getAttributeBooleanValue(i8, false));
                        break;
                    case 9:
                        setHorizontallyScrolling(attributeSet.getAttributeBooleanValue(i8, false));
                        break;
                    case 10:
                        setTextColor(b.a().a(attributeSet.getAttributeValue(i8)));
                        break;
                    case 11:
                    ...
                    case 14:
                        if (!TtmlNode.BOLD.equalsIgnoreCase(attributeSet.getAttributeValue(i8))) {
                            break;
                        } else {
                    ...
                    case 18:
                        ...
                        break;
                    case 19:
                        int b5 = b.a().b(attributeSet.getAttributeValue(i8));
                        setPadding(b5, b5, b5, b5);
                        break;
                    case 20:
                        i7 = b.a().b(attributeSet.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 21:
                        i6 = b.a().b(attributeSet.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 22:
                        i4 = b.a().b(attributeSet.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 23:
                        i5 = b.a().b(attributeSet.getAttributeValue(i8));
                        setPadding(i4, i7, i5, i6);
                        break;
                    case 24:
                        setPadding(b.a().b(attributeSet.getAttributeValue(i8)), i7, i5, i6);
                        break;
                    case 25:
                        setPadding(i4, i7, b.a().b(attributeSet.getAttributeValue(i8)), i6);
                        break;
                }
            }
        }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12458b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12459c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBExtFeedBackView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12457a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f12457a, (View) this);
        } catch (Exception e5) {
            af.b("MBExtFeedBackView", e5.getMessage());
        }
    }

    public MBExtFeedBackView(Context context, AttributeSet attributeSet, int i4) {
