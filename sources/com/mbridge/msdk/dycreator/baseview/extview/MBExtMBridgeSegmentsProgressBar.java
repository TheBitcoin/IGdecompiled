...
public class MBExtMBridgeSegmentsProgressBar extends MBridgeSegmentsProgressBar implements InterBase {
    ...
    private Map<String, String> f12479a;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0049:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0090:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f12482a     // Catch:{ NoSuchFieldError -> 0x00cc }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12479a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12479a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12479a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12479a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12479a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12479a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12480b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12480b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12481c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12480b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12480b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12481c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12482a[cVar.ordinal()];
                if (i5 == 1) {
    ...
    public LinearLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f12482a[cVar.ordinal()]) {
                    case 6:
                        String attributeValue = attributeSet.getAttributeValue(i4);
    ...
    public MBExtMBridgeSegmentsProgressBar(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12479a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f12479a, (View) this);
        } catch (Exception e5) {
            e5.printStackTrace();
        }
    }

    public MBExtMBridgeSegmentsProgressBar(Context context, AttributeSet attributeSet, int i4) {
