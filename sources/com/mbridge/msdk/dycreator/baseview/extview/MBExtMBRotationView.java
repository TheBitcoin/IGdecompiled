...
public class MBExtMBRotationView extends MBRotationView implements InterBase {
    ...
    private Map<String, String> f12465b;

    /* renamed from: c  reason: collision with root package name */
    private Map<String, Boolean> f12466c;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f12468a     // Catch:{ NoSuchFieldError -> 0x006c }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12465b;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12465b.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12465b.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12465b.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12465b.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12465b.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12466c;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12466c.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12467d);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12466c;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12466c.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12467d);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12468a[cVar.ordinal()];
                if (i5 == 1) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12466c = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f12467d = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f12468a[cVar.ordinal()]) {
                    case 5:
                        String attributeValue = attributeSet.getAttributeValue(i4);
    ...
    public MBExtMBRotationView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12465b = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f12465b, (View) this);
        } catch (Exception e5) {
            af.b("MBExtMBRotationView", e5.getMessage());
        }
    }

    public MBExtMBRotationView(Context context, AttributeSet attributeSet, int i4) {
