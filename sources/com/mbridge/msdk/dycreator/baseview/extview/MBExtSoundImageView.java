...
public class MBExtSoundImageView extends SoundImageView {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0028:
                int[] r0 = f12491a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x006c:
                int[] r0 = f12491a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f12491a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f12491a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f12491a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f12491a     // Catch:{ NoSuchFieldError -> 0x00a8 }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(Context context, AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12491a[cVar.ordinal()];
                if (i5 == 6) {
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            c cVar = c5.get(attributeSet.getAttributeName(i4));
            if (cVar != null) {
                switch (AnonymousClass1.f12491a[cVar.ordinal()]) {
                    case 1:
                        String attributeValue = attributeSet.getAttributeValue(i4);
                    ...
                    case 9:
                        ...
                        this.f12488b = b6;
                        setPadding(this.f12487a, b6, this.f12489c, this.f12490d);
                        break;
                    case 10:
                        int b7 = b.a().b(attributeSet.getAttributeValue(i4));
                        this.f12490d = b7;
                        setPadding(this.f12487a, this.f12488b, this.f12489c, b7);
                        break;
                    case 11:
                        int b8 = b.a().b(attributeSet.getAttributeValue(i4));
                        this.f12487a = b8;
                        setPadding(b8, this.f12488b, this.f12489c, this.f12490d);
                        break;
                    case 12:
                        int b9 = b.a().b(attributeSet.getAttributeValue(i4));
                        this.f12489c = b9;
                        setPadding(this.f12487a, this.f12488b, b9, this.f12490d);
                        break;
                }
            }
        }
    ...
    public MBExtSoundImageView(Context context, AttributeSet attributeSet, int i4) {
