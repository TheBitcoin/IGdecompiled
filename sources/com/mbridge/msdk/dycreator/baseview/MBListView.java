...
public class MBListView extends ListView implements InterBase {
    ...
    private Map<String, String> f12293a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f12294b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12296a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12296a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12296a     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    public MBListView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f12293a = c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            c.a(this.f12293a, (View) this);
        } catch (Exception e5) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12293a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12293a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12293a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12293a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12293a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12293a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12294b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12294b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12295c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12294b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12294b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12295c);
        }
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12294b = c.a(str);
        if (campaignEx != null) {
            this.f12295c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public AbsListView.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12296a[cVar.ordinal()];
                if (i5 == 1) {
