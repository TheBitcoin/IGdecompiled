...
public class MBInduceClickView extends FrameLayout implements InterBase, InterEffect {
    ...
    private Map<String, String> f12283a;

    /* renamed from: b  reason: collision with root package name */
    private Map<String, Boolean> f12284b;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f12286a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f12286a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f12286a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f12286a     // Catch:{ NoSuchFieldError -> 0x003e }
    ...
    public String getActionDes() {
        Map<String, String> map = this.f12283a;
        if (map == null || !map.containsKey("mbridgeAction")) {
            return "";
        }
        return this.f12283a.get("mbridgeAction");
    }
    ...
    public String getBindDataDes() {
        ...
        return this.f12283a.get("mbridgeData");
    }
    ...
    public String getEffectDes() {
        ...
        return this.f12283a.get("mbridgeEffect");
    }
    ...
    public String getReportDes() {
        ...
        return this.f12283a.get("mbridgeReport");
    }
    ...
    public String getStrategyDes() {
        ...
        return this.f12283a.get("mbridgeStrategy");
    }

    /* access modifiers changed from: protected */
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f12284b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f12284b.get("mbridgeAttached").booleanValue()) {
            new k.a("mbridgeAttached").a().a(this.f12285c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f12284b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f12284b.get("mbridgeDetached").booleanValue()) {
            new k.a("mbridgeDetached").a().a(this.f12285c);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f12284b = c.a(str);
        if (campaignEx != null) {
            this.f12285c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i4 = 0; i4 < attributeCount; i4++) {
            ...
            if (cVar != null) {
                int i5 = AnonymousClass1.f12286a[cVar.ordinal()];
                if (i5 == 1) {
    ...
    public MBInduceClickView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (!(context == null || attributeSet == null)) {
            try {
                this.f12283a = c.a(context, attributeSet);
            } catch (Exception e5) {
        ...
        c.a(this.f12283a, (View) this);
    }

    public MBInduceClickView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
