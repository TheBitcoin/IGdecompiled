...
public class MBRoundRectImageViewC extends MBImageView {
    ...
    private Paint f12309a = new Paint();
                ...
                if (!a5.isRecycled()) {
                    ...
                    if (a6 != null) {
                        if (!a6.isRecycled()) {
                            ...
                            this.f12309a.reset();
                            canvas.drawBitmap(a6, rect, rect, this.f12309a);
                            return;
                        }
                    }
                    super.onDraw(canvas);
    ...
    private Bitmap a(Bitmap bitmap, int i4) {
        if (bitmap != null && !bitmap.isRecycled()) {
            try {
                ...
                float f4 = (float) i4;
                canvas.drawRoundRect(new RectF(0.0f, 0.0f, (float) bitmap.getWidth(), (float) bitmap.getHeight()), f4, f4, paint);
                return createBitmap;
            } catch (Exception e5) {
                af.b("MBRoundRectImageViewC", e5.getMessage());
            }
