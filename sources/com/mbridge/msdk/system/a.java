...
public abstract class a implements MBridgeSDK {
    ...
    private final Application.ActivityLifecycleCallbacks activityLifecycleCallbacks = new Application.ActivityLifecycleCallbacks() {
        ...
        public final void onActivityPaused(@NonNull Activity activity) {
            int f4 = c.m().f();
            af.b("com.mbridge.msdk", "onActivityPaused currentActivityNum:" + f4);
        }
        ...
        public final void onActivityStarted(@NonNull Activity activity) {
            int f4 = c.m().f();
            af.b("com.mbridge.msdk", "onActivityStarted currentActivityNum:" + f4);
            af.b("com.mbridge.msdk", "onActivityStarted isCoolStart:" + a.this.isCoolStart);
            if (!a.this.isCoolStart && f4 == 0) {
                i.a("1");
            }
        ...
        public final void onActivityStopped(@NonNull Activity activity) {
            int f4 = c.m().f();
            af.b("com.mbridge.msdk", "onActivityStopped currentActivityNum:" + f4);
            if (f4 == 1 || f4 == 0) {
                i.a("2");
            }
            c.m().a(f4 - 1);
    ...
    public void setConsentStatus(Context context, int i4) {
        checkAliveContext(context);
        com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().a(i4);
    }
    ...
    public void setCoppaStatus(Context context, boolean z4) {
        ...
        com.mbridge.msdk.foundation.a.a.a.a().b(MBridgeConstans.AUTHORITY_COPPA, i4);
    }
    ...
    public void setPlayVideoMute(int i4, int i5) {
        if (i4 == 94) {
            com.mbridge.msdk.foundation.same.a.f13125W = i5;
        } else if (i4 == 287) {
            com.mbridge.msdk.foundation.same.a.f13126X = i5;
        }
    }
    ...
    public void setUserPrivateInfoType(Context context, String str, int i4) {
        checkAliveContext(context);
        com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().a(str, i4);
    }
