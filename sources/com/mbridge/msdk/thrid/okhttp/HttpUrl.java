...
public final class HttpUrl {
    ...
    static String canonicalize(String str, int i4, int i5, String str2, boolean z4, boolean z5, boolean z6, boolean z7, Charset charset) {
        ...
        while (i6 < i5) {
            ...
            if (codePointAt < 32 || codePointAt == 127 || ((codePointAt >= 128 && z7) || str2.indexOf(codePointAt) != -1 || ((codePointAt == 37 && (!z4 || (z5 && !percentEncoded(str, i6, i5)))) || (codePointAt == 43 && z6)))) {
    ...
    static boolean percentEncoded(String str, int i4, int i5) {
        int i6 = i4 + 2;
        if (i6 >= i5 || str.charAt(i4) != '%' || Util.decodeHexDigit(str.charAt(i4 + 1)) == -1 || Util.decodeHexDigit(str.charAt(i6)) == -1) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder {
        ...
        private static int parsePort(String str, int i4, int i5) {
            try {
                int parseInt = Integer.parseInt(HttpUrl.canonicalize(str, i4, i5, "", false, false, false, true, (Charset) null));
        ...
        private void push(String str, int i4, int i5, boolean z4, boolean z5) {
            String canonicalize = HttpUrl.canonicalize(str, i4, i5, HttpUrl.PATH_SEGMENT_ENCODE_SET, z5, false, false, true, (Charset) null);
        ...
        private void resolvePath(String str, int i4, int i5) {
            boolean z4;
            if (i4 != i5) {
                char charAt = str.charAt(i4);
                if (charAt == '/' || charAt == '\\') {
                ...
                while (i6 < i5) {
                    ...
                    if (delimiterOffset < i5) {
                        z4 = true;
                    } else {
                        z4 = false;
                    }
                    String str2 = str;
                    push(str2, i6, delimiterOffset, z4, true);
                    if (z4) {
                        delimiterOffset++;
                    }
                    i6 = delimiterOffset;
        ...
        public Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl2 == null || !httpUrl2.scheme.equals(this.scheme)) {
                ...
                boolean z5 = false;
                while (true) {
                    delimiterOffset = Util.delimiterOffset(str4, i5, skipTrailingAsciiWhitespace, "@/\\?#");
                    ...
                    if (c5 == 65535 || c5 == c6 || c5 == '/' || c5 == '\\' || c5 == '?') {
                        ...
                        str2 = str4;
                        int i7 = i5;
                        int portColonOffset = portColonOffset(str2, i7, i6);
                        ...
                        if (c5 != '@') {
                            ...
                            if (!z4) {
                                ...
                                String str5 = "%40";
                                String canonicalize = HttpUrl.canonicalize(str, i5, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                if (z5) {
                                ...
                                if (delimiterOffset2 != i9) {
                                    ...
                                    i4 = i9;
                                    this.encodedPassword = HttpUrl.canonicalize(str, i10, i4, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                    z4 = true;
                                } else {
                                    i4 = i9;
                                }
                                ...
                                sb.append("%40");
                                str3 = str;
                                sb.append(HttpUrl.canonicalize(str3, i5, i4, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null));
                ...
                str2 = str4;
                int i72 = i5;
                int portColonOffset2 = portColonOffset(str2, i72, i62);
                int i82 = portColonOffset2 + 1;
                if (i82 < i62) {
                    this.host = canonicalizeHost(str2, i72, portColonOffset2);
                    int parsePort = parsePort(str2, i82, i62);
                    this.port = parsePort;
                    if (parsePort == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i82, i62) + '\"');
                    }
                } else {
                    this.host = canonicalizeHost(str2, i72, portColonOffset2);
                ...
                if (this.host != null) {
                    skipLeadingAsciiWhitespace = i62;
                } else {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i72, portColonOffset2) + '\"');
                }
            } else {
        ...
        private Builder addPathSegments(String str, boolean z4) {
            ...
            while (true) {
                ...
                String str2 = str;
                boolean z5 = z4;
                push(str2, i4, delimiterOffset, delimiterOffset < str.length(), z5);
