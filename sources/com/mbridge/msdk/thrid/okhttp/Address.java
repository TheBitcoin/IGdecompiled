...
public final class Address {
    ...
    public Address(String str, int i4, Dns dns2, SocketFactory socketFactory2, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier2, CertificatePinner certificatePinner2, Authenticator authenticator, Proxy proxy2, List<Protocol> list, List<ConnectionSpec> list2, ProxySelector proxySelector2) {
        String str2;
        ...
        this.url = builder.scheme(str2).host(str).port(i4).build();
        if (dns2 != null) {
            this.dns = dns2;
    ...
    public int hashCode() {
        ...
        if (certificatePinner2 != null) {
            i7 = certificatePinner2.hashCode();
        }
        return i10 + i7;
    }
