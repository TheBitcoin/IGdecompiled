...
public final class Http2 {
    ...
    static String frameLog(boolean z4, int i4, int i5, byte b5, byte b6) {
        String str;
        String str2;
        ...
        return Util.format("%s 0x%08x %5d %-13s %s", str2, Integer.valueOf(i4), Integer.valueOf(i5), str, formatFlags);
    }
