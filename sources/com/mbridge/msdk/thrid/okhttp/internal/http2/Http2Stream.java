...
public final class Http2Stream {
    ...
    final class FramingSink implements Sink, AutoCloseable {
        static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    private final class FramingSource implements Source, AutoCloseable {
        static final /* synthetic */ boolean $assertionsDisabled = false;
        boolean closed;
        boolean finished;
        ...
        public void receive(BufferedSource bufferedSource, long j4) throws IOException {
            boolean z4;
            boolean z5;
            boolean z6;
            long j5;
            while (j4 > 0) {
                synchronized (Http2Stream.this) {
                    z4 = this.finished;
                    z5 = false;
                    if (this.readBuffer.size() + j4 > this.maxByteCount) {
                        z6 = true;
                    } else {
                        z6 = false;
                    }
    ...
    Http2Stream(int i4, Http2Connection http2Connection, boolean z4, boolean z5, Headers headers) {
    ...
    public void receiveData(BufferedSource bufferedSource, int i4) throws IOException {
        this.source.receive(bufferedSource, (long) i4);
    }
