...
public final class RouteSelector {
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (i4 < 1 || i4 > 65535) {
            ...
            this.inetSocketAddresses.add(InetSocketAddress.createUnresolved(str, i4));
        } else {
            ...
            if (!lookup.isEmpty()) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    this.inetSocketAddresses.add(new InetSocketAddress(lookup.get(i5), i4));
                }
                return;
            }
