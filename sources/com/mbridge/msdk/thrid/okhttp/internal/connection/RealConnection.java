...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private Request createTunnel(int i4, int i5, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            this.source.timeout().timeout((long) i4, timeUnit);
            this.sink.timeout().timeout((long) i5, timeUnit);
    ...
    public static RealConnection testConnection(ConnectionPool connectionPool2, Route route2, Socket socket2, long j4) {
