...
public final class CacheStrategy {
    ...
    public static class Factory {
        ...
        public Factory(long j4, Request request2, Response response) {
            this.nowMillis = j4;
        ...
        private long cacheResponseAge() {
            ...
            long j4 = 0;
            if (date != null) {
                j4 = Math.max(0, this.receivedResponseMillis - date.getTime());
            }
            ...
            return j4 + (j5 - this.sentRequestMillis) + (this.nowMillis - j5);
        }
        ...
        private CacheStrategy getCandidate() {
            ...
            if (cacheControl.minFreshSeconds() != -1) {
                j4 = TimeUnit.SECONDS.toMillis((long) cacheControl.minFreshSeconds());
            } else {
                j4 = 0;
            }
            if (!cacheControl2.mustRevalidate() && cacheControl.maxStaleSeconds() != -1) {
                j5 = TimeUnit.SECONDS.toMillis((long) cacheControl.maxStaleSeconds());
            }
            if (!cacheControl2.noCache()) {
                long j6 = j4 + cacheResponseAge;
