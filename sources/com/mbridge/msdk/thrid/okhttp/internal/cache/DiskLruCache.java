...
public final class DiskLruCache implements Closeable, Flushable, AutoCloseable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            /*
                ...
                monitor-enter(r0)
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0011 }
            ...
            L_0x002d:
                ...
                com.mbridge.msdk.thrid.okio.Sink r2 = com.mbridge.msdk.thrid.okio.Okio.blackhole()     // Catch:{ all -> 0x0011 }
                com.mbridge.msdk.thrid.okio.BufferedSink r2 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Sink) r2)     // Catch:{ all -> 0x0011 }
            ...
            synchronized (DiskLruCache.this) {
                try {
                    if (!this.done) {
                        ...
                        AnonymousClass1 r12 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(entry2.dirtyFiles[i4])) {
                ...
                while (true) {
                    try {
                        ...
                        while (true) {
                            ...
                            if (i4 >= diskLruCache2.valueCount || (source = sourceArr[i4]) == null) {
                                try {
    ...
    DiskLruCache(FileSystem fileSystem2, File file, int i4, int i5, long j4, Executor executor2) {
    ...
    public static DiskLruCache create(FileSystem fileSystem2, File file, int i4, int i5, long j4) {
        if (j4 <= 0) {
            throw new IllegalArgumentException("maxSize <= 0");
        } else if (i5 > 0) {
            return new DiskLruCache(fileSystem2, file, i4, i5, j4, new ThreadPoolExecutor(0, 1, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), Util.threadFactory("OkHttp DiskLruCache", true)));
        } else {
    ...
    public synchronized boolean remove(java.lang.String r7) throws java.io.IOException {
        /*
            r6 = this;
            monitor-enter(r6)
            r6.initialize()     // Catch:{ all -> 0x0028 }
            r6.checkNotClosed()     // Catch:{ all -> 0x0028 }
            r6.validateKey(r7)     // Catch:{ all -> 0x0028 }
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r0 = r6.lruEntries     // Catch:{ all -> 0x0028 }
            java.lang.Object r7 = r0.get(r7)     // Catch:{ all -> 0x0028 }
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r7 = (com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Entry) r7     // Catch:{ all -> 0x0028 }
            r0 = 0
            if (r7 != 0) goto L_0x0017
            monitor-exit(r6)
            return r0
        L_0x0017:
            boolean r7 = r6.removeEntry(r7)     // Catch:{ all -> 0x0028 }
            if (r7 == 0) goto L_0x002a
            long r1 = r6.size     // Catch:{ all -> 0x0028 }
            long r3 = r6.maxSize     // Catch:{ all -> 0x0028 }
            int r5 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r5 > 0) goto L_0x002a
            r6.mostRecentTrimFailed = r0     // Catch:{ all -> 0x0028 }
            goto L_0x002a
        L_0x0028:
            r7 = move-exception
            goto L_0x002c
    ...
    public synchronized com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            ...
            long r1 = r0.sequenceNumber     // Catch:{ all -> 0x0022 }
