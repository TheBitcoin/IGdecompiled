...
final class WebSocketWriter {
    ...
    final class FrameSink implements Sink, AutoCloseable {
        boolean closed;
        long contentLength;
        int formatOpcode;
    ...
    public Sink newMessageSink(int i4, long j4) {
        if (!this.activeWriter) {
            ...
            frameSink2.formatOpcode = i4;
            frameSink2.contentLength = j4;
    ...
    public void writeMessageFrame(int i4, long j4, boolean z4, boolean z5) throws IOException {
        if (!this.writerClosed) {
            ...
            if (j4 <= 125) {
                ...
                this.sinkBuffer.writeByte(i5 | ModuleDescriptor.MODULE_VERSION);
