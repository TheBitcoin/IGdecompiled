...
final class Relay {
    ...
    class RelaySource implements Source, AutoCloseable {
    ...
    public static Relay edit(File file2, Source source, ByteString byteString, long j4) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file2, "rw");
        Relay relay = new Relay(randomAccessFile, source, 0, byteString, j4);
    ...
    private void writeMetadata(long j4) throws IOException {
        ...
        new FileOperator(this.file.getChannel()).write(FILE_HEADER_SIZE + j4, buffer2, (long) this.metadata.size());
    }

    /* access modifiers changed from: package-private */
    public void commit(long j4) throws IOException {
        writeMetadata(j4);
        this.file.getChannel().force(false);
        writeHeader(PREFIX_CLEAN, j4, (long) this.metadata.size());
        this.file.getChannel().force(false);
        synchronized (this) {
            try {
                this.complete = true;
