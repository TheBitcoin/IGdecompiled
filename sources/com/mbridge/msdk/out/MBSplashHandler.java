...
public class MBSplashHandler implements BaseExtraInterfaceForHandler {
    ...
    public MBSplashHandler(Activity activity, String str, String str2, boolean z4, int i4) {
        this(activity, str, str2, z4, i4, orientation, logoSizeH, logoSizeW);
    }
    ...
    public MBSplashHandler(Activity activity, String str, String str2, boolean z4, int i4, int i5, int i6, int i7) {
        String e5 = ak.e(str2);
        if (!TextUtils.isEmpty(e5)) {
            ak.b(str2, e5);
        }
