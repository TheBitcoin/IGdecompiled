...
public class Campaign extends BaseCampaign {
    ...
    public /* bridge */ /* synthetic */ void setAdchoiceSizeHeight(int i4) {
        super.setAdchoiceSizeHeight(i4);
    }

    public /* bridge */ /* synthetic */ void setAdchoiceSizeWidth(int i4) {
        super.setAdchoiceSizeWidth(i4);
    }
    ...
    public /* bridge */ /* synthetic */ void setCreativeId(long j4) {
        super.setCreativeId(j4);
    }
    ...
    public /* bridge */ /* synthetic */ void setNumberRating(int i4) {
        super.setNumberRating(i4);
    }
    ...
    public /* bridge */ /* synthetic */ void setRating(double d5) {
        super.setRating(d5);
    }
    ...
    public /* bridge */ /* synthetic */ void setTimestamp(long j4) {
        super.setTimestamp(j4);
    }

    public /* bridge */ /* synthetic */ void setType(int i4) {
        super.setType(i4);
    }

    public /* bridge */ /* synthetic */ void setVideoLength(int i4) {
        super.setVideoLength(i4);
    }
}
