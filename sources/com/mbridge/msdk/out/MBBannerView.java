...
public class MBBannerView extends RelativeLayout implements BaseExtraInterfaceForHandler {
    ...
    private void delayedNotify() {
        postDelayed(new Runnable() {
            public void run() {
                if (MBBannerView.this.controller != null && !com.mbridge.msdk.foundation.d.b.f12876c) {
    ...
    public void onResume() {
        if (this.controller != null && TextUtils.isEmpty(this.bidToken) && !com.mbridge.msdk.foundation.d.b.f12876c) {
            this.controller.f();
        }
    }
    ...
    public void onWindowVisibilityChanged(int i4) {
        ...
        if (i4 == 0) {
            delayedNotify();
        } else if (!com.mbridge.msdk.foundation.d.b.f12876c) {
