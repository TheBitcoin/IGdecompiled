        ...
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    ...
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, APPLETS_API_VALUE);
                    jSONObject.put("network_type", ab.m(context));
                    jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str2);
                    if (!TextUtils.isEmpty(a.f13124V)) {
                        jSONObject.put(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, a.f13124V);
                    }
                    if (!TextUtils.isEmpty(a.f13133g)) {
                        jSONObject.put("c", a.f13133g);
                    }
