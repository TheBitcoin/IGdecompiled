...
public class AppletsModel implements Serializable {
    ...
    private static final class DefaultAppletSchemeResponse extends AppletSchemeResponse {
        ...
        public final void onSuccess(d<JSONObject> dVar) {
            ...
            if (appletsModel2 != null) {
                appletsModel2.changeRequestingState(false);
                if (dVar == null || dVar.f13256c == null) {
    ...
    /* access modifiers changed from: private */
    public void handlerSchemeRequestFailed(int i4, String str) {
        if (this.appletSchemeCallBack != null) {
            if (MBridgeConstans.DEBUG) {
                af.a(TAG, String.format("handlerSchemeRequestFailed network error by code %s and %s", new Object[]{String.valueOf(i4), str}));
            }
            try {
            ...
            AppletsReport.reportAppletsLoadState(c.m().c(), String.format("network error by code %s and %s", new Object[]{String.valueOf(i4), str}), this.unitID, this.requestId);
        }
    }
    ...
    public void handlerSchemeRequestNetworkError(a aVar) {
        ...
        if (this.appletSchemeCallBack != null) {
            ...
            if (MBridgeConstans.DEBUG) {
                af.a(TAG, String.format("handlerSchemeRequestNetworkError network error by code %s and %s", new Object[]{String.valueOf(i4), str}));
            }
            try {
                IAppletSchemeCallBack iAppletSchemeCallBack = this.appletSchemeCallBack;
                iAppletSchemeCallBack.onNetworkError(i4, "network error: " + str, this.reBuildClickUrl);
            } catch (Exception e5) {
                if (MBridgeConstans.DEBUG) {
    ...
    private String reCreateClickUrl(String str) {
        return com.mbridge.msdk.foundation.same.net.e.d.f().f13311a + "?" + str;
    }

    public boolean can(int i4) {
        if (isRequesting() || !canRequestWxScheme(i4)) {
            return false;
        }
    ...
    public void requestWxAppletsScheme(int i4, IAppletSchemeCallBack iAppletSchemeCallBack) {
        if (this.campaignEx != null && !TextUtils.isEmpty(this.unitID)) {
            ...
            if (this.params != null) {
                ...
                appletSchemeRequest.get(1, com.mbridge.msdk.foundation.same.net.e.d.f().f13311a, this.params, (b) new DefaultAppletSchemeResponse(this), "applets_model", (long) ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            }
        }
    }
