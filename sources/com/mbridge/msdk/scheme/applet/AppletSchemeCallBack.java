...
public abstract class AppletSchemeCallBack implements IAppletSchemeCallBack {
    ...
    public void onAppletSchemeRequestFailed(int i4, String str, String str2) {
        try {
            onRequestFailed(i4, str, str2);
        } catch (Exception e5) {
    ...
    public void onNetworkError(int i4, String str, String str2) {
        try {
            onRequestFailed(i4, str, str2);
        } catch (Exception e5) {
            if (MBridgeConstans.DEBUG) {
    ...
    public abstract void onRequestFailed(int i4, String str, String str2);
