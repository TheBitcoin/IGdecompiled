...
public final class e {
    ...
    private static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static e f17100a = new e((AnonymousClass1) null);
    }
    ...
    public final String b(String str) {
        try {
            ...
            File file = new File(this.f17098a + "/" + md5 + ".html");
            if (file.exists()) {
                return ad.b(file);
            }
            return null;
    ...
    private e() {
        this.f17098a = com.mbridge.msdk.foundation.same.b.e.a(c.MBRIDGE_700_HTML);
    }
    ...
    public final String a(String str) {
        try {
            String str2 = this.f17098a + "/" + SameMD5.getMD5(aq.b(str)) + ".html";
