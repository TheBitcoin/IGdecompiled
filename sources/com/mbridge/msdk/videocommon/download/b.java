...
public class b {
    ...
    private static volatile b f17084a;

    /* renamed from: b  reason: collision with root package name */
    private boolean f17085b = false;

    /* renamed from: c  reason: collision with root package name */
    private ConcurrentHashMap<String, j> f17086c = new ConcurrentHashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<Map<String, a>>> f17087d;

    /* renamed from: e  reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> f17088e;

    /* renamed from: f  reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<a>> f17089f;
    ...
    public final CopyOnWriteArrayList<a> b(String str) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<a>> concurrentHashMap = this.f17089f;
        if (concurrentHashMap == null || !concurrentHashMap.containsKey(str)) {
            return null;
        }
        return this.f17089f.get(str);
    }

    public final j c(String str) {
        ConcurrentHashMap<String, j> concurrentHashMap = this.f17086c;
        if (concurrentHashMap == null || !concurrentHashMap.containsKey(str)) {
            return null;
        }
        return this.f17086c.get(str);
    }

    public j createUnitCache(Context context, String str, CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList, int i4, a aVar) {
        if (TextUtils.isEmpty(str) || copyOnWriteArrayList == null || copyOnWriteArrayList.size() == 0) {
            return null;
        }
        if (this.f17086c.containsKey(str)) {
            j jVar = this.f17086c.get(str);
            if (jVar == null) {
                jVar = new j(context, (List<CampaignEx>) copyOnWriteArrayList, str, i4);
                this.f17086c.put(str, jVar);
            }
            if (i4 == 94 || i4 == 287) {
        ...
        j jVar2 = new j(context, (List<CampaignEx>) copyOnWriteArrayList, str, i4);
        if (aVar != null) {
            jVar2.a(aVar);
        }
        this.f17086c.put(str, jVar2);
        return jVar2;
    }
    ...
    public final CopyOnWriteArrayList<CampaignEx> a(String str) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> concurrentHashMap = this.f17088e;
        if (concurrentHashMap == null || !concurrentHashMap.containsKey(str)) {
            return null;
        }
        return this.f17088e.get(str);
    }

    public final void b(String str, CopyOnWriteArrayList<a> copyOnWriteArrayList) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<a>> concurrentHashMap = this.f17089f;
        if (concurrentHashMap == null) {
            this.f17089f = new ConcurrentHashMap<>();
        } else {
            concurrentHashMap.clear();
        }
        this.f17089f.put(str, copyOnWriteArrayList);
    }

    public final void a(String str, CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> concurrentHashMap = this.f17088e;
        if (concurrentHashMap == null) {
            this.f17088e = new ConcurrentHashMap<>();
        } else {
            concurrentHashMap.clear();
        }
        this.f17088e.put(str, copyOnWriteArrayList);
    }
                ...
                if (!(jVar == null || (c5 = jVar.c()) == null)) {
                    ...
                    for (int i4 = 0; i4 < size; i4++) {
                        ...
                        if (map != null) {
                            ...
                            if (!(!it.hasNext() || (aVar = (a) ((Map.Entry) it.next()).getValue()) == null || (l4 = aVar.l()) == null)) {
                                String videoUrlEncode = l4.getVideoUrlEncode();
    ...
    public final boolean a(int i4, String str, boolean z4) {
        try {
            j c5 = c(str);
            if (c5 == null || c5.a(i4, z4) == null) {
                return false;
            }
            return true;
        } catch (Exception e5) {
    ...
    public j createUnitCache(Context context, String str, CampaignEx campaignEx, int i4, a aVar) {
        ...
        if (this.f17086c.containsKey(str)) {
            j jVar = this.f17086c.get(str);
            if (jVar == null) {
                jVar = new j(context, campaignEx, str, i4);
                this.f17086c.put(str, jVar);
            }
            if (i4 == 94 || i4 == 287) {
        ...
        j jVar2 = new j(context, campaignEx, str, i4);
        if (aVar != null) {
            jVar2.a(aVar);
        }
        this.f17086c.put(str, jVar2);
    ...
    public final boolean a(int i4, String str, boolean z4, int i5, boolean z5, int i6, List<CampaignEx> list) {
        return a(i4, str, z4, i5, z5, i6, list, false, (e) null);
    }
    ...
    public final boolean a(int r13, java.lang.String r14, boolean r15, int r16, boolean r17, int r18, java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r19, boolean r20, com.mbridge.msdk.foundation.same.report.d.e r21) {
        ...
        L_0x018c:
            ...
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.concurrent.CopyOnWriteArrayList<java.util.Map<java.lang.String, com.mbridge.msdk.videocommon.download.a>>> r0 = r12.f17087d     // Catch:{ Exception -> 0x0060 }
            ...
            r12.f17087d = r0     // Catch:{ Exception -> 0x0060 }
            goto L_0x01a5
        L_0x019a:
        ...
        L_0x01a5:
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.videocommon.download.a>> r0 = r12.f17089f     // Catch:{ Exception -> 0x0060 }
            if (r0 != 0) goto L_0x01b1
            j$.util.concurrent.ConcurrentHashMap r0 = new j$.util.concurrent.ConcurrentHashMap     // Catch:{ Exception -> 0x0060 }
            r0.<init>()     // Catch:{ Exception -> 0x0060 }
            r12.f17089f = r0     // Catch:{ Exception -> 0x0060 }
            goto L_0x01bc
        L_0x01b1:
            boolean r0 = r0.containsKey(r14)     // Catch:{ Exception -> 0x0060 }
            ...
            r0.remove(r14)     // Catch:{ Exception -> 0x0060 }
        L_0x01bc:
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.foundation.entity.CampaignEx>> r0 = r12.f17088e     // Catch:{ Exception -> 0x0060 }
            if (r0 != 0) goto L_0x01c8
            j$.util.concurrent.ConcurrentHashMap r0 = new j$.util.concurrent.ConcurrentHashMap     // Catch:{ Exception -> 0x0060 }
            r0.<init>()     // Catch:{ Exception -> 0x0060 }
            r12.f17088e = r0     // Catch:{ Exception -> 0x0060 }
            goto L_0x01d3
        L_0x01c8:
            boolean r0 = r0.containsKey(r14)     // Catch:{ Exception -> 0x0060 }
        ...
        L_0x01ee:
            ...
            goto L_0x01ee
        L_0x022e:
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.concurrent.CopyOnWriteArrayList<java.util.Map<java.lang.String, com.mbridge.msdk.videocommon.download.a>>> r13 = r12.f17087d     // Catch:{ Exception -> 0x0060 }
            r13.put(r14, r0)     // Catch:{ Exception -> 0x0060 }
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.foundation.entity.CampaignEx>> r13 = r12.f17088e     // Catch:{ Exception -> 0x0060 }
            r13.put(r14, r2)     // Catch:{ Exception -> 0x0060 }
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.videocommon.download.a>> r13 = r12.f17089f     // Catch:{ Exception -> 0x0060 }
