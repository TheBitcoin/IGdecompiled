...
public class a {
    ...
    public static final String f16959a = "com.mbridge.msdk.videocommon.c.a";
    ...
    public final void a(Context context, final String str, String str2) {
        ...
        try {
            ...
            af.b(f16959a, th.getMessage());
        }
        new b(context).get(1, d.f().f13293I, eVar, (com.mbridge.msdk.foundation.same.net.b) new com.mbridge.msdk.foundation.same.net.f.d() {
                ...
                try {
                    if (ak.a(jSONObject)) {
                        ...
                        try {
                            ...
                            af.b(a.f16959a, e5.getMessage());
                        }
                    } else {
                        b.a().f(str);
                    }
                } catch (Exception e6) {
                    af.b(a.f16959a, e6.getMessage());
                } catch (Throwable th) {
                    af.b(a.f16959a, th.getMessage());
                    return;
                }
                a.this.a(1, 2, "");
            }
    ...
    public final void a(Context context, final String str, String str2, String str3, final c cVar) {
        ...
        r6.setUnitId(str3);
        new b(context).get(1, d.f().f13293I, eVar, (com.mbridge.msdk.foundation.same.net.b) r6, "setting", (long) ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
        a(3, 3, "");
    }
