...
final class c {
    ...
    private final Object f15439c = new Object();
    ...
    public final void b(java.util.List<com.mbridge.msdk.tracker.i> r7) {
        /*
            r6 = this;
            java.lang.Object r0 = r6.f15439c
            monitor-enter(r0)
            com.mbridge.msdk.tracker.b r1 = r6.f15437a     // Catch:{ all -> 0x001a }
            ...
            goto L_0x00a7
        L_0x0013:
            com.mbridge.msdk.tracker.b r1 = r6.f15437a     // Catch:{ Exception -> 0x001d }
        ...
        L_0x001d:
            r1 = move-exception
            boolean r2 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x001a }
        ...
        L_0x004c:
            ...
            java.lang.String r5 = r6.f15438b     // Catch:{ Exception -> 0x0079 }
        ...
        L_0x007e:
            ...
            goto L_0x00a1
        L_0x0082:
            boolean r2 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x0077 }
    ...
    public final void c(java.util.List<com.mbridge.msdk.tracker.i> r7) {
        ...
        L_0x004c:
            ...
            java.lang.String r5 = r6.f15438b     // Catch:{ Exception -> 0x0089 }
        ...
        L_0x008e:
            ...
            goto L_0x00b1
        L_0x0092:
            boolean r2 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x0087 }
    ...
    public final long a(i iVar) {
        ...
        synchronized (this.f15439c) {
            long j4 = -1;
            if (y.a((Object) this.f15437a)) {
                return -1;
            }
            try {
                sQLiteDatabase = this.f15437a.getWritableDatabase();
            } catch (Exception e5) {
                if (a.f15435a) {
            ...
            try {
                ...
                contentValues.put("type", Integer.valueOf(c5.b()));
                ...
                j4 = sQLiteDatabase.insert(this.f15438b, (String) null, contentValues);
                c(sQLiteDatabase);
            } catch (Exception e6) {
                if (a.f15435a) {
    ...
    public final int b() {
        ...
        synchronized (this.f15439c) {
            ...
            try {
                d(sQLiteDatabase);
                i4 = sQLiteDatabase.delete(this.f15438b, "state = ? OR state = ?", new String[]{String.valueOf(-1), String.valueOf(2)});
                c(sQLiteDatabase);
            } catch (Exception e6) {
                if (a.f15435a) {
    ...
    public final void c() {
        /*
            ...
            java.lang.Object r0 = r6.f15439c
            monitor-enter(r0)
            com.mbridge.msdk.tracker.b r1 = r6.f15437a     // Catch:{ all -> 0x000d }
        ...
        L_0x000d:
            ...
            goto L_0x0090
        L_0x0010:
            com.mbridge.msdk.tracker.b r1 = r6.f15437a     // Catch:{ Exception -> 0x0017 }
            android.database.sqlite.SQLiteDatabase r1 = r1.getWritableDatabase()     // Catch:{ Exception -> 0x0017 }
            goto L_0x0037
        L_0x0017:
            r1 = move-exception
            boolean r2 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x000d }
        ...
        L_0x003f:
            ...
            java.lang.String r5 = r6.f15438b     // Catch:{ Exception -> 0x006a }
        ...
        L_0x006a:
            r2 = move-exception
            boolean r3 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x0068 }
    ...
    public final java.util.List<com.mbridge.msdk.tracker.i> a(int r14) {
        /*
            r13 = this;
            java.lang.Object r1 = r13.f15439c
            monitor-enter(r1)
            com.mbridge.msdk.tracker.b r0 = r13.f15437a     // Catch:{ all -> 0x000e }
        ...
        L_0x000e:
            ...
            goto L_0x00ac
        L_0x0012:
            com.mbridge.msdk.tracker.b r0 = r13.f15437a     // Catch:{ Exception -> 0x001a }
            android.database.sqlite.SQLiteDatabase r0 = r0.getWritableDatabase()     // Catch:{ Exception -> 0x001a }
            r3 = r0
            goto L_0x003a
        L_0x001a:
            r0 = move-exception
            boolean r3 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x000e }
        ...
        L_0x0042:
            ...
            java.lang.String r4 = r13.f15438b     // Catch:{ Exception -> 0x007c }
        ...
        L_0x007c:
            ...
            r14 = r2
        L_0x007e:
            boolean r4 = com.mbridge.msdk.tracker.a.f15435a     // Catch:{ all -> 0x007a }
    ...
    public final int a() {
        ...
        synchronized (this.f15439c) {
            ...
            try {
                d(sQLiteDatabase);
                cursor = sQLiteDatabase.query(this.f15438b, (String[]) null, "state = ? OR state = ?", new String[]{String.valueOf(3), String.valueOf(0)}, (String) null, (String) null, (String) null, (String) null);
                if (cursor != null && cursor.moveToNext()) {
                    i4 = Math.max(cursor.getCount(), 0);
                }
                c(sQLiteDatabase);
                b(sQLiteDatabase);
            } catch (Exception e6) {
