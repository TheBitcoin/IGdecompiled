...
public final class h extends a {
    ...
    private final SSLSocketFactory f15619b;

    static class a extends FilterInputStream implements AutoCloseable {

        /* renamed from: a  reason: collision with root package name */
        private final HttpURLConnection f15620a;

        a(HttpURLConnection httpURLConnection) {
            super(h.b(httpURLConnection));
            this.f15620a = httpURLConnection;
        }

        public final void close() throws IOException {
            super.close();
            this.f15620a.disconnect();
        }
    }
    ...
    public final com.mbridge.msdk.tracker.network.toolbox.g a(com.mbridge.msdk.tracker.network.u<?> r7, java.util.Map<java.lang.String, java.lang.String> r8) throws java.io.IOException {
        ...
        L_0x0013:
            ...
            r1.putAll(r8)
            com.mbridge.msdk.tracker.network.toolbox.h$b r8 = r6.f15618a
        ...
        L_0x0045:
            ...
            javax.net.ssl.SSLSocketFactory r8 = r6.f15619b
            if (r8 == 0) goto L_0x007f
            r4 = r0
