...
public final class c {
    ...
    static Handler f12048a = new Handler(Looper.getMainLooper()) {
        public final void handleMessage(Message message) {
            ...
            try {
                if (message.what == 1000) {
                    ...
                    new h(com.mbridge.msdk.foundation.controller.c.m().c()).a(i4, i5, str3, str2, str);
                }
            } catch (Throwable th) {
                Throwable th2 = th;
    ...
    public static String a(String str, String str2, String str3) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (b5 != null && (s4 = b5.s()) != null && !TextUtils.isEmpty(host)) {
                    Iterator<Map.Entry<String, b.a>> it = s4.entrySet().iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            break;
                        }
    ...
    public static void a(final Context context, int i4, final String str) {
        if (i4 != 0) {
            try {
