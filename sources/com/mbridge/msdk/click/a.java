...
public final class a {
    ...
    public static Map<String, Long> f11976b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    public static Set<String> f11977c = new HashSet();
    ...
    public g f11980f = null;

    /* renamed from: g  reason: collision with root package name */
    private Context f11981g = null;
    ...
    public NativeListener.NativeTrackingListener f11983i = null;

    /* renamed from: j  reason: collision with root package name */
    private h f11984j;

    /* renamed from: k  reason: collision with root package name */
    private com.mbridge.msdk.c.g f11985k;
    ...
    public a(Context context, String str) {
        ...
        this.f11986l = this.f11985k.aK();
        Context applicationContext = context.getApplicationContext();
        this.f11981g = applicationContext;
        this.f11978d = str;
        if (this.f11980f == null) {
            this.f11980f = g.a(applicationContext);
        }
        this.f11984j = new h(this.f11981g);
    }
    ...
    static /* synthetic */ void f(a aVar) {
        try {
            ...
            aVar.f11981g.sendBroadcast(intent);
        } catch (Exception e5) {
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String str2, boolean z4, boolean z5) {
        if (context != null) {
            String str3 = str;
            new d(context.getApplicationContext()).a(str3, campaignEx, (f) null, str2, z4, z5, com.mbridge.msdk.click.a.a.f12013f);
        }
    }
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String[] strArr, boolean z4, boolean z5) {
        if (context != null && campaignEx != null && !TextUtils.isEmpty(str) && strArr != null) {
            ...
            for (String a5 : strArr) {
                ...
                }, a5, z4, z5, com.mbridge.msdk.click.a.a.f12013f);
            }
        }
    }
    ...
    private boolean b(CampaignEx campaignEx) {
        ...
        try {
            ...
            Map<String, Long> map = f11976b;
            if (map == null) {
                return true;
            }
            if (map.containsKey(id) && (l4 = f11976b.get(id)) != null) {
                if (l4.longValue() > System.currentTimeMillis() || f11977c.contains(campaignEx.getId())) {
                    return false;
                }
            }
            f11976b.put(campaignEx.getId(), Long.valueOf(System.currentTimeMillis() + ((long) (campaignEx.getClickTimeOutInterval() * 1000))));
            return true;
        } catch (Exception e5) {
            if (!MBridgeConstans.DEBUG) {
                return true;
    ...
    public final void a(NativeListener.NativeTrackingListener nativeTrackingListener) {
        this.f11983i = nativeTrackingListener;
    }
    ...
    private int b() {
        try {
            com.mbridge.msdk.c.g gVar = this.f11985k;
            if (gVar != null) {
                return gVar.Y();
            }
            return 1;
    ...
    public final void a(com.mbridge.msdk.foundation.entity.CampaignEx r19) {
        ...
        L_0x0012:
            ...
            com.mbridge.msdk.foundation.db.g r3 = r1.f11980f     // Catch:{ all -> 0x003f }
            ...
            java.lang.String r5 = r1.f11978d     // Catch:{ all -> 0x003f }
        ...
        L_0x004a:
            ...
            android.content.Context r6 = r1.f11981g     // Catch:{ all -> 0x003f }
            java.lang.String r14 = r2.getDeepLinkURL()     // Catch:{ all -> 0x003f }
            boolean r6 = com.mbridge.msdk.click.c.e(r6, r14)     // Catch:{ all -> 0x003f }
            if (r6 == 0) goto L_0x00ac
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r3 = r1.f11983i     // Catch:{ all -> 0x003f }
        ...
        L_0x0087:
            ...
            android.content.Context r3 = r1.f11981g     // Catch:{ all -> 0x003f }
            java.lang.String r4 = r1.f11978d     // Catch:{ all -> 0x003f }
            com.mbridge.msdk.click.b.a(r3, r4, r2, r0, r12)     // Catch:{ all -> 0x003f }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r0 = r1.f11983i     // Catch:{ all -> 0x003f }
        ...
        L_0x00d6:
            android.content.Context r0 = r1.f11981g     // Catch:{ all -> 0x003f }
            java.lang.String r3 = r1.f11978d     // Catch:{ all -> 0x003f }
        ...
        L_0x0113:
            ...
            android.content.Context r3 = r1.f11981g     // Catch:{ Exception -> 0x0127 }
        ...
        L_0x01c1:
            ...
            android.content.Context r0 = r1.f11981g     // Catch:{ all -> 0x003f }
            java.lang.String r3 = r1.f11978d     // Catch:{ all -> 0x003f }
            int r8 = com.mbridge.msdk.foundation.same.a.f13116N     // Catch:{ all -> 0x003f }
        ...
        L_0x0216:
            ...
            android.content.Context r9 = r1.f11981g     // Catch:{ all -> 0x003f }
            java.lang.String r10 = r1.f11978d     // Catch:{ all -> 0x003f }
        ...
        L_0x0267:
            android.content.Context r0 = r1.f11981g     // Catch:{ all -> 0x003f }
            java.lang.String r4 = r2.getClickURL()     // Catch:{ all -> 0x003f }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r6 = r1.f11983i     // Catch:{ all -> 0x003f }
        ...
        L_0x0287:
            ...
            r6 = r5
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r5 = r1.f11983i     // Catch:{ all -> 0x003f }
            r4 = r19
        ...
        L_0x02a4:
            ...
            java.lang.String r4 = r2.getClickURL()     // Catch:{ all -> 0x003f }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r14 = r1.f11983i     // Catch:{ all -> 0x003f }
        ...
        L_0x02c3:
            ...
            com.mbridge.msdk.click.i r0 = r1.f11990p     // Catch:{ all -> 0x003f }
            if (r0 == 0) goto L_0x02e0
            r0.onStartRedirection(r2, r4)     // Catch:{ all -> 0x003f }
        L_0x02e0:
            android.content.Context r3 = r1.f11981g     // Catch:{ all -> 0x003f }
        ...
        L_0x0386:
            android.content.Context r3 = r1.f11981g     // Catch:{ all -> 0x003f }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r4 = r1.f11983i     // Catch:{ all -> 0x003f }
    ...
    private void a(Context context, CampaignEx campaignEx, List<String> list) {
        if (context == null) {
            com.mbridge.msdk.foundation.same.report.i.a(c.m().c(), campaignEx, 2, "context is null", this.f11978d);
            return;
        }
        boolean z4 = ab.z() == 1;
        boolean z5 = ab.v(context) == 1;
        if (!z4 || !z5) {
            com.mbridge.msdk.foundation.same.report.i.a(context, campaignEx, 2, "integrated:" + z4 + "-hasWx:" + z5, this.f11978d);
            a(campaignEx, list);
            return;
        }
        ...
        if (!TextUtils.isEmpty(ghId)) {
            try {
                ...
                com.mbridge.msdk.foundation.same.report.i.a(context, campaignEx, 1, "", this.f11978d);
            } catch (Throwable th) {
                com.mbridge.msdk.foundation.same.report.i.a(context, campaignEx, 2, th.getMessage(), this.f11978d);
                a(campaignEx, list);
            }
        } else {
            a(campaignEx, list);
            com.mbridge.msdk.foundation.same.report.i.a(context, campaignEx, 2, "ghid is empty", this.f11978d);
        }
    }

    private void a(CampaignEx campaignEx, List<String> list) {
        if (b() == 2) {
            aj.a(this.f11981g, campaignEx.getClickURL(), campaignEx, this.f11983i, list);
        } else {
            aj.a(this.f11981g, campaignEx.getClickURL(), (BaseTrackingListener) this.f11983i, campaignEx, list);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:55:0x011c A[Catch:{ Exception -> 0x001d }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void a(final com.mbridge.msdk.foundation.entity.CampaignEx r12, final boolean r13, java.lang.Boolean r14, java.util.List<java.lang.String> r15) {
        /*
            ...
            r11.f11979e = r3     // Catch:{ Exception -> 0x001d }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r3 = r11.f11983i     // Catch:{ Exception -> 0x001d }
            r8 = 1
        ...
        L_0x003a:
            r11.f11989o = r8     // Catch:{ Exception -> 0x001d }
            r11.f11987m = r10     // Catch:{ Exception -> 0x001d }
            r4 = 0
        L_0x003f:
            com.mbridge.msdk.foundation.db.g r3 = r11.f11980f     // Catch:{ Exception -> 0x001d }
            ...
            java.lang.String r6 = r11.f11978d     // Catch:{ Exception -> 0x001d }
        ...
        L_0x0084:
            ...
            android.content.Context r3 = r11.f11981g     // Catch:{ Exception -> 0x001d }
            ...
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r6 = r11.f11983i     // Catch:{ Exception -> 0x001d }
        ...
        L_0x00e5:
            ...
            com.mbridge.msdk.click.d r0 = r11.f11982h     // Catch:{ Exception -> 0x001d }
            if (r0 == 0) goto L_0x00fd
            r0.a()     // Catch:{ Exception -> 0x001d }
        L_0x00fd:
            java.util.Set<java.lang.String> r0 = f11977c     // Catch:{ Exception -> 0x001d }
            if (r0 == 0) goto L_0x011c
            java.lang.String r4 = r12.getId()     // Catch:{ Exception -> 0x001d }
            boolean r0 = r0.contains(r4)     // Catch:{ Exception -> 0x001d }
            if (r0 == 0) goto L_0x011c
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r0 = r11.f11983i     // Catch:{ Exception -> 0x001d }
        ...
        L_0x0127:
            ...
            android.content.Context r0 = r11.f11981g     // Catch:{ Exception -> 0x001d }
            r8.<init>(r0)     // Catch:{ Exception -> 0x001d }
            r11.f11982h = r8     // Catch:{ Exception -> 0x001d }
            java.lang.String r10 = r11.f11978d     // Catch:{ Exception -> 0x001d }
    ...
    public final void a(JumpLoaderResult jumpLoaderResult, CampaignEx campaignEx, int i4, boolean z4) {
        if (campaignEx != null && jumpLoaderResult != null) {
            try {
                long currentTimeMillis = System.currentTimeMillis() - this.f11979e;
                e eVar = new e();
                int m4 = ab.m(this.f11981g);
                eVar.a(m4);
                eVar.c(ab.a(this.f11981g, m4));
                ...
                if (a6 != null && !a6.isEmpty()) {
                    ...
                    int i5 = 0;
                    while (i5 < size) {
                        JSONObject jSONObject = a6.get(i5);
                        i5++;
                        d.a().a(jSONObject);
                    }
                }
    ...
    public final void a(Campaign campaign, String str) {
        try {
            ...
            if (campaign != null) {
                ...
                if (!aj.a.a(this.f11981g, str, this.f11983i) && campaignEx != null) {
                    if (!TextUtils.isEmpty(campaignEx.getPackageName())) {
                        Context context = this.f11981g;
                        aj.a.a(context, "market://details?id=" + campaignEx.getPackageName(), this.f11983i);
                    } else if (b() == 2) {
                        aj.a(this.f11981g, campaignEx.getClickURL(), campaignEx, this.f11983i, (List<String>) new ArrayList());
                    } else {
                        aj.a(this.f11981g, campaignEx.getClickURL(), (BaseTrackingListener) this.f11983i, campaignEx, (List<String>) new ArrayList());
                    }
                }
            }
        } catch (Exception e5) {
    ...
    private void a(int i4, String str, CampaignEx campaignEx, NativeListener.NativeTrackingListener nativeTrackingListener, List<String> list) {
        try {
            if (TextUtils.isEmpty(str)) {
                return;
            }
            if (i4 == 2) {
                aj.a(this.f11981g, str, campaignEx, nativeTrackingListener, list);
            } else {
                aj.a(this.f11981g, str, (BaseTrackingListener) nativeTrackingListener, campaignEx, list);
            }
        } catch (Throwable th) {
            if (MBridgeConstans.DEBUG) {
    ...
    private boolean a(com.mbridge.msdk.foundation.entity.CampaignEx r10, com.mbridge.msdk.click.entity.JumpLoaderResult r11, boolean r12, int r13, java.util.List<java.lang.String> r14) {
        /*
            ...
            android.content.Context r2 = r9.f11981g     // Catch:{ all -> 0x001c }
            java.lang.String r3 = r11.getUrl()     // Catch:{ all -> 0x001c }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r5 = r9.f11983i     // Catch:{ all -> 0x001c }
        ...
        L_0x007d:
            ...
            r9.a((com.mbridge.msdk.click.entity.JumpLoaderResult) r11, (com.mbridge.msdk.foundation.entity.CampaignEx) r10, (boolean) r7)     // Catch:{ all -> 0x008e }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r2 = r9.f11983i     // Catch:{ all -> 0x008e }
            if (r2 == 0) goto L_0x00a1
            java.lang.String r0 = r11.getUrl()     // Catch:{ all -> 0x008e }
            r2.onFinishRedirection(r10, r0)     // Catch:{ all -> 0x008e }
            return r8
        L_0x008e:
            r0 = move-exception
            r7 = r8
        ...
        L_0x0091:
            ...
            java.lang.String r0 = r11.getUrl()     // Catch:{ all -> 0x008e }
            r2.onRedirectionFailed(r10, r0)     // Catch:{ all -> 0x008e }
        L_0x00a1:
            return r8
        L_0x00a2:
            boolean r2 = com.mbridge.msdk.MBridgeConstans.DEBUG
    ...
    private boolean a(CampaignEx campaignEx, JumpLoaderResult jumpLoaderResult, boolean z4, List<String> list) {
        ...
        if (z4) {
            try {
                if (b.a()) {
                    b.a(this.f11981g, this.f11978d, campaignEx, campaignEx.getNoticeUrl(), com.mbridge.msdk.foundation.same.a.f13115M);
                }
                aj.a(this.f11981g, campaignEx.getClickURL(), (BaseTrackingListener) this.f11983i, campaignEx, list);
                z5 = true;
            } catch (Throwable th) {
        ...
        if (z5) {
            NativeListener.NativeTrackingListener nativeTrackingListener = this.f11983i;
            ...
            NativeListener.NativeTrackingListener nativeTrackingListener2 = this.f11983i;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00c2, code lost:
        if (com.mbridge.msdk.foundation.tools.aj.a.a(r0, "market://details?id=" + r9.getPackageName(), r8.f11983i) == false) goto L_0x00c4;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void a(com.mbridge.msdk.foundation.entity.CampaignEx r9, com.mbridge.msdk.click.entity.JumpLoaderResult r10, boolean r11, boolean r12, java.lang.Boolean r13, java.util.List<java.lang.String> r14) {
        /*
            r8 = this;
            boolean r0 = r8.f11988n     // Catch:{ Exception -> 0x001e }
        ...
        L_0x0042:
            ...
            return
        L_0x0049:
            android.content.Context r0 = r8.f11981g     // Catch:{ Exception -> 0x001e }
            java.lang.String r2 = r9.getClickURL()     // Catch:{ Exception -> 0x001e }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r4 = r8.f11983i     // Catch:{ Exception -> 0x001e }
            ...
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r0 = r8.f11983i     // Catch:{ Exception -> 0x001e }
        ...
        L_0x0063:
            ...
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r5 = r8.f11983i     // Catch:{ Exception -> 0x001e }
        ...
        L_0x00dd:
            ...
            android.content.Context r0 = r8.f11981g     // Catch:{ Exception -> 0x001e }
            java.lang.String r2 = r8.f11978d     // Catch:{ Exception -> 0x001e }
            com.mbridge.msdk.out.NativeListener$NativeTrackingListener r5 = r8.f11983i     // Catch:{ Exception -> 0x001e }
            r1 = r9
            r3 = r10
            r4 = r13
    ...
    private void a(CampaignEx campaignEx, int i4, int i5, List<String> list) {
        try {
    ...
    public static void a(Context context, final CampaignEx campaignEx, String str, final String str2, boolean z4, boolean z5, final int i4) {
        if (context != null) {
            if (campaignEx != null) {
                try {
                    String b5 = b(i4);
            ...
            final int i5 = TextUtils.isEmpty(str2) ? -1 : str2.startsWith("tcp") ? 1 : 0;
            new d(context.getApplicationContext()).a(str, campaignEx, new f() {
                ...
                public final void b(Object obj) {
                    try {
                        com.mbridge.msdk.foundation.same.report.d.e eVar = new com.mbridge.msdk.foundation.same.report.d.e();
                        eVar.a("result", 2);
                        eVar.a("net_ty", String.valueOf(i5));
    ...
    static /* synthetic */ void a(a aVar, CampaignEx campaignEx) {
        try {
            Intent intent = new Intent(aVar.f11981g, LoadingActivity.class);
            intent.setFlags(268435456);
            intent.putExtra(CampaignEx.JSON_KEY_ICON_URL, campaignEx.getIconUrl());
            aVar.f11981g.startActivity(intent);
        } catch (Exception e5) {
            if (MBridgeConstans.DEBUG) {
                af.b("CommonClickControl", "Exception", e5);
            }
