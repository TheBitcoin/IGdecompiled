...
public class h {
    ...
    private static final String f12082a = "h";
    ...
    private final int f12086e = 3145728;
    ...
    public final com.mbridge.msdk.click.entity.a a(java.lang.String r5, boolean r6, boolean r7, com.mbridge.msdk.foundation.entity.CampaignEx r8) {
        ...
        L_0x0060:
            ...
            com.mbridge.msdk.c.g r6 = r4.f12083b     // Catch:{ all -> 0x0039 }
            boolean r6 = r6.aJ()     // Catch:{ all -> 0x0039 }
            if (r6 == 0) goto L_0x007c
            java.lang.String r6 = r4.f12084c     // Catch:{ all -> 0x0039 }
            boolean r6 = android.text.TextUtils.isEmpty(r6)     // Catch:{ all -> 0x0039 }
            if (r6 != 0) goto L_0x007c
            java.lang.String r6 = "referer"
            java.lang.String r7 = r4.f12084c     // Catch:{ all -> 0x0039 }
        ...
        L_0x007c:
            ...
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            java.lang.String r7 = "Location"
            java.lang.String r7 = r1.getHeaderField(r7)     // Catch:{ all -> 0x0039 }
            r6.f12061a = r7     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            java.lang.String r7 = "Referer"
            java.lang.String r7 = r1.getHeaderField(r7)     // Catch:{ all -> 0x0039 }
            r6.f12064d = r7     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            int r7 = r1.getResponseCode()     // Catch:{ all -> 0x0039 }
            r6.f12066f = r7     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            java.lang.String r7 = r1.getContentType()     // Catch:{ all -> 0x0039 }
            r6.f12062b = r7     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            int r7 = r1.getContentLength()     // Catch:{ all -> 0x0039 }
            r6.f12065e = r7     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            java.lang.String r7 = r1.getContentEncoding()     // Catch:{ all -> 0x0039 }
            r6.f12063c = r7     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0039 }
            java.lang.String r6 = r6.f12063c     // Catch:{ all -> 0x0039 }
            boolean r6 = r0.equalsIgnoreCase(r6)     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.click.entity.a r7 = r4.f12087f     // Catch:{ all -> 0x0039 }
            int r8 = r7.f12066f     // Catch:{ all -> 0x0039 }
            r0 = 200(0xc8, float:2.8E-43)
            if (r8 != r0) goto L_0x010d
            boolean r8 = r4.f12085d     // Catch:{ all -> 0x0039 }
            if (r8 == 0) goto L_0x010d
            int r7 = r7.f12065e     // Catch:{ all -> 0x0039 }
            ...
            if (r7 >= r8) goto L_0x010d
            com.mbridge.msdk.click.entity.a r7 = r4.f12087f     // Catch:{ all -> 0x0103 }
            java.lang.String r6 = r6.trim()     // Catch:{ all -> 0x0103 }
            r7.f12067g = r6     // Catch:{ all -> 0x0103 }
            goto L_0x010d
        L_0x0103:
            r6 = move-exception
            java.lang.String r7 = f12082a     // Catch:{ all -> 0x0039 }
            java.lang.String r6 = r6.getMessage()     // Catch:{ all -> 0x0039 }
            com.mbridge.msdk.foundation.tools.af.b(r7, r6)     // Catch:{ all -> 0x0039 }
        L_0x010d:
            r4.f12084c = r5     // Catch:{ all -> 0x0039 }
            r1.disconnect()
            com.mbridge.msdk.click.entity.a r5 = r4.f12087f
            return r5
        L_0x0115:
            r5 = move-exception
        L_0x0116:
            com.mbridge.msdk.click.entity.a r6 = r4.f12087f     // Catch:{ all -> 0x0126 }
            java.lang.String r5 = r5.getMessage()     // Catch:{ all -> 0x0126 }
            r6.f12068h = r5     // Catch:{ all -> 0x0126 }
            com.mbridge.msdk.click.entity.a r5 = r4.f12087f     // Catch:{ all -> 0x0126 }
