...
public class a {
    ...
    public static final String f13875a = "a";

    /* renamed from: h  reason: collision with root package name */
    private static volatile a f13876h;

    /* renamed from: b  reason: collision with root package name */
    private Context f13877b = c.m().c();
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public com.mbridge.msdk.mbbanner.common.util.a f13878c = new com.mbridge.msdk.mbbanner.common.util.a();

    /* renamed from: d  reason: collision with root package name */
    private Map<String, b> f13879d = new ConcurrentHashMap();
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public Map<String, Boolean> f13880e = new ConcurrentHashMap();

    /* renamed from: f  reason: collision with root package name */
    private Map<String, Handler> f13881f = new ConcurrentHashMap();
    /* access modifiers changed from: private */

    /* renamed from: g  reason: collision with root package name */
    public Map<String, Integer> f13882g = new ConcurrentHashMap();
    ...
    public final void b(String str, String str2, com.mbridge.msdk.mbbanner.common.a.a aVar, com.mbridge.msdk.mbbanner.common.b.b bVar) {
        ...
        if (this.f13881f.containsKey(str2)) {
            handler = this.f13881f.get(str2);
        } else {
            handler = new Handler();
            this.f13881f.put(str2, handler);
        }
        ...
        AnonymousClass2 r02 = new Runnable() {
            public final void run() {
                int i4;
                Boolean bool;
                if (a.this.f13880e == null || !a.this.f13880e.containsKey(str6) || (bool = (Boolean) a.this.f13880e.get(str6)) == null || !bool.booleanValue()) {
                    if (a.this.f13882g.containsKey(str6)) {
                        Integer num = (Integer) a.this.f13882g.get(str6);
                        if (num != null) {
                            i4 = num.intValue();
                        } else {
                            i4 = 0;
    ...
    public final void a(String str, String str2, final com.mbridge.msdk.mbbanner.common.a.a aVar, com.mbridge.msdk.mbbanner.common.b.b bVar) {
        ...
        if (this.f13877b == null) {
            ...
            bVar3.a(mBridgeIds);
            bVar3.b(e5);
            this.f13878c.a(bVar, bVar3);
        } else if (bVar == null) {
            com.mbridge.msdk.foundation.c.b bVar4 = new com.mbridge.msdk.foundation.c.b(880001);
            bVar4.a(mBridgeIds);
            bVar4.b(e5);
            this.f13878c.a(bVar, bVar4);
        } else {
            Map<String, Boolean> map = this.f13880e;
            if (map == null || !map.containsKey(str2) || (bool = this.f13880e.get(str2)) == null || !bool.booleanValue()) {
                this.f13880e.put(str2, Boolean.TRUE);
                if (this.f13879d.containsKey(str2)) {
                    bVar2 = this.f13879d.get(str2);
                } else {
                    ...
                    this.f13879d.put(str2, bVar5);
                    bVar2 = bVar5;
                }
                bVar2.b(e5);
                new b(this.f13877b, bVar2, bVar, this.f13878c).a(str, str2, aVar, (d) new d() {
                    public final void a(String str) {
                        synchronized (a.a()) {
                            aVar.a("");
                            a.this.f13880e.put(str, Boolean.FALSE);
                        }
                    }
                });
            ...
            bVar6.a(mBridgeIds);
            bVar6.b(e5);
            this.f13878c.a(bVar, bVar6);
        }
    }

    public final void b() {
        Map<String, b> map = this.f13879d;
        if (map != null) {
            map.clear();
        }
        Map<String, Boolean> map2 = this.f13880e;
        if (map2 != null) {
            map2.clear();
        }
        Map<String, Handler> map3 = this.f13881f;
        if (map3 != null) {
        ...
        Map<String, Integer> map4 = this.f13882g;
        if (map4 != null) {
            map4.clear();
        }
    }
    ...
    public final void a(String str) {
        if (this.f13881f.containsKey(str)) {
            Handler handler = this.f13881f.get(str);
            if (handler != null) {
    ...
    public final void a(int r8, java.lang.String r9, java.lang.String r10, com.mbridge.msdk.mbbanner.common.a.a r11, com.mbridge.msdk.mbbanner.common.b.b r12) {
        /*
            r7 = this;
            java.util.Map<java.lang.String, java.lang.Integer> r0 = r7.f13882g
        ...
        L_0x0027:
            ...
            java.util.Map<java.lang.String, java.lang.Integer> r8 = r7.f13882g
            java.lang.Integer r9 = java.lang.Integer.valueOf(r1)
            r8.put(r10, r9)
            return
        L_0x0033:
            java.util.Map<java.lang.String, android.os.Handler> r9 = r7.f13881f
        ...
        L_0x0048:
            java.util.Map<java.lang.String, java.lang.Integer> r9 = r7.f13882g
