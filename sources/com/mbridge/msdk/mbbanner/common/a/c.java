...
public class c extends d {
    ...
    private static final String f13870a = "c";

    public static e a(boolean z4, Context context, String str, String str2, int i4, a aVar) {
        ...
        com.mbridge.msdk.foundation.same.net.e.b.a(eVar, e.f13343e, a5);
        com.mbridge.msdk.foundation.same.net.e.b.a(eVar, CampaignEx.JSON_KEY_AD_SOURCE_ID, "1");
        com.mbridge.msdk.foundation.same.net.e.b.a(eVar, e.f13344f, str2);
        com.mbridge.msdk.foundation.same.net.e.b.a(eVar, "ad_type", "296");
        com.mbridge.msdk.foundation.same.net.e.b.a(eVar, TypedValues.CycleType.S_WAVE_OFFSET, i4 + "");
        com.mbridge.msdk.foundation.same.net.e.b.a(eVar, e.f13342d, a6);
