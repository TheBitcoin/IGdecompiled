            ...
            com.mbridge.msdk.foundation.same.f.a.b().execute(new Runnable() {
                public final void run() {
                    ...
                    if ("v5".equals(optString)) {
                        campaignUnit = b.parseV5CampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), a.this.f13998b);
                    } else {
                        campaignUnit = b.parseCampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), a.this.f13998b);
                    }
                    com.mbridge.msdk.foundation.same.f.a.c().post(new Runnable() {
                        public final void run() {
                            ...
                            if (!TextUtils.isEmpty(a.this.f13998b)) {
