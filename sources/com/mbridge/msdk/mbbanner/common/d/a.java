...
public final class a {
    ...
    public static void a(String str, c cVar, e eVar) {
        ...
        try {
            String i4 = cVar.i();
            if (TextUtils.isEmpty(i4) && (h4 = cVar.h()) != null && !h4.isEmpty() && h4.get(0) != null) {
                i4 = h4.get(0).getCampaignUnitId();
                cVar.b(h4.get(0).getAdType());
                cVar.d(i4);
            }
            k c5 = h.a().c(com.mbridge.msdk.foundation.controller.c.m().k(), i4);
            if (c5 != null) {
                e eVar2 = eVar == null ? new e() : eVar;
                eVar2.a("us_rid", c5.s());
                HashMap<String, String> hashMap = com.mbridge.msdk.foundation.controller.a.f12767b;
                if (hashMap != null) {
                    String str2 = hashMap.get(i4);
                    if (!TextUtils.isEmpty(str2)) {
                        eVar2.a("u_stid", str2);
                    }
                } else {
