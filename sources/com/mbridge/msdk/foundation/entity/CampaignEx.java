...
public class CampaignEx extends DomainCampaignEx implements NoProGuard, Serializable {
    ...
    private int showIndex = com.mbridge.msdk.foundation.same.report.d.a.f13389a;
    private int showStoreMiniCardDelayTime;
    private int showType = com.mbridge.msdk.foundation.same.report.d.a.f13391c;
    ...
    public static final class a implements Serializable {
        ...
        private static com.mbridge.msdk.foundation.entity.CampaignEx.a a(org.json.JSONObject r3) {
            /*
                ...
                r1.f12937c = r0     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r0 = "adchoice_link"
                java.lang.String r0 = r3.optString(r0)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12938d = r0     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r0 = "adchoice_size"
                java.lang.String r0 = r3.optString(r0)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12939e = r0     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r2 = "ad_logo_link"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12935a = r2     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r2 = "adv_logo"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12942h = r2     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r2 = "adv_name"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12943i = r2     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r2 = "platform_logo"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12944j = r2     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r2 = "platform_name"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12945k = r2     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                int r2 = c(r0)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12940f = r2     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                int r0 = d(r0)     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12941g = r0     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                java.lang.String r3 = r3.toString()     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                r1.f12936b = r3     // Catch:{ Exception -> 0x005e, all -> 0x005b }
                return r1
            L_0x005b:
                r3 = move-exception
                r0 = r1
    ...
    public static final class b implements Serializable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public Map<Integer, String> f12946a;
    ...
    public static final class c implements Serializable {
        ...
        public static final class a implements Serializable {
            ...
            /* renamed from: a  reason: collision with root package name */
            public List<String> f12964a = new ArrayList();
        ...
        public static c a(JSONObject jSONObject) {
            ...
            try {
                ...
                cVar.f12963f = jSONObject.optInt("video_template", 1);
                cVar.f12962e = jSONObject.optString("template_url");
                cVar.f12959b = jSONObject.optInt("orientation");
                cVar.f12960c = jSONObject.optString("paused_url");
                ...
                if (optJSONObject != null) {
                    ...
                    while (keys != null && keys.hasNext()) {
                        ...
                        if (b5 != null && b5.size() > 0) {
                            a aVar = new a();
                            aVar.f12965b = next;
                            aVar.f12964a.addAll(b5);
                            arrayList.add(aVar);
                        }
                    }
                    cVar.f12958a = arrayList;
                }
                return cVar;
            } catch (Throwable unused) {
                return null;
        ...
        try {
            if (jSONObject.has(JSON_KEY_AD_TMP_IDS) && (optJSONArray = jSONObject.optJSONArray(JSON_KEY_AD_TMP_IDS)) != null && optJSONArray.length() > 0) {
                ...
                for (int i4 = 0; i4 < optJSONArray.length(); i4++) {
                    JSONObject a5 = com.mbridge.msdk.foundation.db.a.b.a().a(optJSONArray.getString(i4));
                    if (a5 != null) {
    ...
    public String getRsIgnoreCheckRuleString() {
        ...
        try {
            ...
            int i4 = 0;
            while (i4 < size) {
                Integer num = rsIgnoreCheckRule2.get(i4);
                i4++;
                sb.append(num);
                sb.append(",");
            }
    ...
    public boolean isEffectiveOffer(long j4) {
        ...
        if (getPlct() > 0) {
            ...
            return false;
        } else if (getTimestamp() + j4 >= currentTimeMillis) {
            return true;
        } else {
            return false;
        }
    ...
    public void setAutoShowStoreMiniCard(int i4) {
        this.autoShowStoreMiniCard = i4;
    }
    ...
    public void setCandidateCacheTime(long j4) {
        this.candidateCacheTime = j4;
    }
    ...
    public void setClickTempSource(int i4) {
        this.clickTempSource = i4;
    }
    ...
    public void setEcCrtvId(long j4) {
        this.ecCrtvId = j4;
    }

    public void setEcTemplateId(long j4) {
        this.ecTemplateId = j4;
    }
    ...
    public void setFilterCallBackState(int i4) {
        if (i4 == 2) {
    ...
    public void setImpReportType(int i4) {
        this.impReportType = i4;
        if (i4 == 1) {
            int i5 = this.adType;
            if (i5 == 296 || i5 == 42) {
                ...
                if (!TextUtils.isEmpty(impressionURL2) && !impressionURL2.contains(JSON_KEY_IMP_REPORT_TYPE)) {
                    setImpressionURL(impressionURL2 + "&imp_report_type=" + i4);
                }
                if (!TextUtils.isEmpty(onlyImpressionURL2) && !onlyImpressionURL2.contains(JSON_KEY_IMP_REPORT_TYPE)) {
                    setOnlyImpressionURL(onlyImpressionURL2 + "&imp_report_type=" + i4);
                }
            }
        }
    }
    ...
    public void setPrivacyButtonTemplateVisibility(int i4) {
        this.privacyButtonTemplateVisibility = i4;
    }
    ...
    public void setProgressBarShow(int i4) {
        this.progressBarShow = i4;
    }
    ...
    public void setShowIndex(int i4) {
        this.showIndex = i4;
    }

    public void setShowStoreMiniCardDelayTime(int i4) {
        this.showStoreMiniCardDelayTime = i4;
    }
    ...
    public void setTrackingTcpPort(int i4) {
        this.trackingTcpPort = i4;
    }

    public void setTriggerClickSource(int i4) {
        this.triggerClickSource = i4;
    }
    ...
    public void setTyped(int i4) {
        this.typed = i4;
    }

    public void setUseSkipTime(int i4) {
        this.useSkipTime = i4;
    }
    ...
    public void setVidCrtvId(long j4) {
        this.vidCrtvId = j4;
    }
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f12962e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
