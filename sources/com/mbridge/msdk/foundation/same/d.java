...
public final class d {
    ...
    private static final List<String> f13219a = new LinkedList();
    ...
    public static void a(String str, File file) {
        if (file != null && file.exists()) {
            try {
                List<String> list = f13219a;
                if (list.contains(str)) {
                    list.add(str);
                    System.gc();
                } else {
                    ad.a(b.c(p1.b.a(MBridgeConstans.OMID_JS_SERVICE_CONTENT, ad.b(file))).getBytes(), file);
                    list.add(str);
                    System.gc();
                }
