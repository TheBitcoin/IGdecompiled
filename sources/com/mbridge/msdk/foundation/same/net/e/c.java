...
public final class c {
    ...
    private ConcurrentHashMap<String, a> f13279c;

    /* renamed from: d  reason: collision with root package name */
    private ArrayList<Integer> f13280d;
    ...
    private d b(String str, String str2, String str3, String str4, String str5) {
        ...
        if (a5 != null && !TextUtils.isEmpty(a5.f13282b)) {
            try {
                if (a5.f13281a != -1) {
                    return d.a(new JSONObject(a5.f13282b), new com.mbridge.msdk.foundation.same.net.d.a(200, a5.f13282b.getBytes(), arrayList));
                }
                if (!TextUtils.isEmpty(str4)) {
                    return null;
                }
                if (!(str5 == null || TextUtils.isEmpty(str5) || (parseInt = Integer.parseInt(str5)) == 287 || parseInt == 94)) {
                    if (System.currentTimeMillis() < ((long) (com.mbridge.msdk.c.h.a().a(str, str2).n() * 1000)) + a5.f13283c) {
                        return d.a(new JSONObject(a5.f13282b), new com.mbridge.msdk.foundation.same.net.d.a(200, a5.f13282b.getBytes(), arrayList));
                    }
                    this.f13279c.remove(str6);
                    return null;
                }
            } catch (Exception e5) {
    ...
    private c() {
        this.f13277a = "IDErrorUtil";
        this.f13279c = new ConcurrentHashMap<>();
        ...
        this.f13278b = b5.A() * 1000;
        if (b5.E() == null || b5.E().size() <= 0) {
            af.b("IDErrorUtil", "Setting ercd is EMPTY and use default code list.");
            this.f13280d.addAll(Arrays.asList(new Integer[]{-1, -10, -1201, -1202, -1203, -1205, -1206, -1208, -1301, -1302, -1305, -1306, -1307, -1915, 10602, 10603, 10604, 10609, 10610, 10616}));
            return;
        }
        af.b("IDErrorUtil", "Setting ercd not EMPTY will use setting.");
        this.f13280d.addAll(b5.E());
    }
    ...
    public final synchronized void a(java.lang.String r4, int r5, java.lang.String r6, long r7) {
        /*
            r3 = this;
            monitor-enter(r3)
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, com.mbridge.msdk.foundation.same.net.e.c$a> r0 = r3.f13279c     // Catch:{ all -> 0x0048 }
        ...
        L_0x000b:
            ...
            return
        L_0x0013:
            java.util.ArrayList<java.lang.Integer> r0 = r3.f13280d     // Catch:{ all -> 0x0048 }
            ...
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, com.mbridge.msdk.foundation.same.net.e.c$a> r5 = r3.f13279c     // Catch:{ all -> 0x0048 }
    ...
    private synchronized com.mbridge.msdk.foundation.same.net.e.c.a a(java.lang.String r8) {
        /*
            ...
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, com.mbridge.msdk.foundation.same.net.e.c$a> r0 = r7.f13279c     // Catch:{ all -> 0x0087 }
            ...
            if (r0 == 0) goto L_0x00a5
            int r2 = r0.f13281a     // Catch:{ all -> 0x0087 }
            r3 = -1
            if (r2 != r3) goto L_0x0031
            monitor-exit(r7)
            return r0
        L_0x0031:
            long r2 = r0.f13283c     // Catch:{ all -> 0x0087 }
            int r4 = r7.f13278b     // Catch:{ all -> 0x0087 }
            ...
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, com.mbridge.msdk.foundation.same.net.e.c$a> r8 = r7.f13279c     // Catch:{ all -> 0x0087 }
        ...
        L_0x0056:
            ...
            long r5 = r2.f13283c     // Catch:{ all -> 0x0087 }
            long r3 = r3 - r5
            int r2 = r7.f13278b     // Catch:{ all -> 0x0087 }
            long r5 = (long) r2     // Catch:{ all -> 0x0087 }
            int r2 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r2 <= 0) goto L_0x0056
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, com.mbridge.msdk.foundation.same.net.e.c$a> r2 = r7.f13279c     // Catch:{ all -> 0x0087 }
        ...
        L_0x008b:
            ...
            java.lang.String r2 = "getErrorInfo : "
            r1.append(r2)     // Catch:{ all -> 0x0087 }
            java.lang.String r2 = r0.f13282b     // Catch:{ all -> 0x0087 }
            r1.append(r2)     // Catch:{ all -> 0x0087 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x0087 }
