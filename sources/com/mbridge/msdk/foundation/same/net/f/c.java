...
public class c {
    ...
    private static i<?> createRequest(int i4, int i5, String str, b bVar, String str2, long j4) {
        if (i4 == 0) {
            i iVar = new i(bVar);
            return new l(i5, str, str2, j4, iVar);
        } else if (i4 != 1) {
            return null;
        } else {
            return new j(i5, str, str2, j4, new i(bVar));
        }
    }
    ...
    private void post(int r11, java.lang.String r12, com.mbridge.msdk.foundation.same.net.f.e r13, com.mbridge.msdk.foundation.same.net.b r14, boolean r15, boolean r16, java.lang.String r17, long r18) {
        ...
        L_0x002a:
            ...
            java.lang.String r0 = r0.f13313c
        ...
        L_0x0113:
            com.mbridge.msdk.foundation.same.net.e.d r0 = com.mbridge.msdk.foundation.same.net.e.d.f()
            java.lang.String r0 = r0.f13317g
            boolean r0 = r12.contains(r0)
            ...
            java.lang.String r1 = r11.f13321k
            com.mbridge.msdk.foundation.same.net.e.d r11 = com.mbridge.msdk.foundation.same.net.e.d.f()
            int r2 = r11.f13325o
        ...
        L_0x0157:
            com.mbridge.msdk.foundation.same.net.e.d r0 = com.mbridge.msdk.foundation.same.net.e.d.f()
            java.lang.String r0 = r0.f13299O
            boolean r0 = r12.contains(r0)
            if (r0 == 0) goto L_0x0198
        ...
        L_0x017d:
            ...
            r0.<init>()
            java.lang.String r1 = com.mbridge.msdk.foundation.same.net.f.e.f13346h
            r0.a(r1, r13)
            r3 = r12
            r13 = r0
            goto L_0x0199
    ...
    public void choiceV3OrV5BySetting(int i4, e eVar, b bVar, String str, long j4) {
        int i5;
        e eVar2;
        ...
        String a6 = d.f().a(str, i5);
        if (i5 < 2) {
            postV5(i4, a6, eVar, bVar, "campaign", j4);
            return;
        }
        if (i5 % 2 == 0) {
            if (eVar == null) {
            ...
            if (b5 != null) {
                ...
                if (d5 <= 0 || jSONArray.length() <= d5) {
                    eVar2.a(e.f13346h, jSONArray);
                } else {
                    post(i4, a6, eVar2, bVar, "campaign", j4);
                    return;
                }
            }
        } else {
        ...
        getLoadOrSetting(i4, a6, eVar2, bVar, "campaign", j4);
    }

    public void get(int i4, String str, e eVar, b bVar, String str2, long j4) {
        get(i4, str, eVar, bVar, false, false, str2, j4);
    }

    public void getCampaign(int i4, String str, e eVar, b bVar, long j4) {
        int i5;
        e eVar2;
        try {
            g a5 = h.a().a(com.mbridge.msdk.foundation.controller.c.m().k());
            ...
            String a6 = d.f().a(str, i5);
            if (i5 < 2) {
                postV5(i4, a6, eVar, bVar, true, "campaign", j4);
                return;
            }
            if (i5 % 2 == 0) {
                if (eVar == null) {
                ...
                if (b5 != null) {
                    ...
                    if (d5 <= 0 || jSONArray.length() <= d5) {
                        ...
                        post(i4, a6, eVar2, bVar, true, false, "campaign", j4);
                        return;
                    }
                }
            } else {
            ...
            get(i4, a6, eVar2, bVar, true, true, "campaign", j4);
        } catch (Exception e5) {
            Exception exc = e5;
            if (MBridgeConstans.DEBUG) {
    ...
    public void getLoadOrSetting(int i4, String str, e eVar, b bVar, String str2, long j4) {
        getLoadOrSetting(i4, str, eVar, bVar, true, str2, j4);
    }

    public void postFocusReport(int i4, String str, e eVar, b bVar, String str2, long j4) {
        post(i4, str, eVar, bVar, false, true, str2, j4);
    }

    public void postV5(int i4, String str, e eVar, b bVar, String str2, long j4) {
        ...
        post(i4, str, eVar, bVar, false, false, str2, j4);
    }

    public void get(int i4, String str, e eVar, b bVar, boolean z4, boolean z5, String str2, long j4) {
        ...
        if (str.contains(d.f().f13318h) && d.f().f13328r) {
            try {
                jSONObject = new JSONObject();
                jSONObject.put("uri", d.f().f13322l + Uri.parse(str).getPath());
                jSONObject.put(DataSchemeDataSource.SCHEME_DATA, eVar.b());
            } catch (Throwable th) {
                af.b(TAG, th.getMessage());
            }
            e.a().a(d.f().f13322l, d.f().f13326p, jSONObject.toString(), true, bVar2);
            return;
        }
        String str5 = str + "?" + eVar.toString();
        g a6 = h.a().a(com.mbridge.msdk.foundation.controller.c.m().k());
        if (str5.length() < a6.ap() || !str5.contains(d.f().f13318h)) {
            e eVar2 = eVar;
            if (str5.length() < a6.R() || !z4) {
                e eVar3 = eVar2;
                i<?> createRequest = createRequest(i4, 0, str, bVar, str2, j4);
            ...
            post(i4, str, eVar2, bVar, z5, false, str2, j4);
            return;
        }
        post(i4, str, eVar, bVar, z5, false, str2, j4);
    }

    public void getLoadOrSetting(int i4, String str, e eVar, b bVar, boolean z4, String str2, long j4) {
        get(i4, str, eVar, bVar, z4, false, str2, j4);
    }

    public void postV5(int i4, String str, e eVar, b bVar, boolean z4, String str2, long j4) {
        String str3 = eVar.a().get("sign");
        if (str3 == null) {
            str3 = "";
        }
        ...
        eVar.a(CampaignEx.JSON_KEY_ST_TS, currentTimeMillis + "");
        eVar.a("st", SameMD5.getMD5(currentTimeMillis + str3));
        post(i4, str, eVar, bVar, z4, false, str2, j4);
    }

    public void get(int i4, String str, Map<String, String> map, b bVar, String str2, long j4) {
        if (map == null) {
            map = new HashMap<>();
        }
        ...
        i<?> createRequest = createRequest(i4, 0, str3, bVar, str2, j4);
        if (createRequest != null) {
    ...
    public void post(int i4, String str, e eVar, b bVar, String str2, long j4) {
        post(i4, str, eVar, bVar, false, false, str2, j4);
    }
}
