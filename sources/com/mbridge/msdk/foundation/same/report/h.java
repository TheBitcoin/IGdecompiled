...
public class h {
    ...
    public static final String f13475a = "h";
    ...
    public final void b(String str, String str2, String str3, String str4, String str5, boolean z4) {
        try {
            if (!TextUtils.isEmpty(str5)) {
                ...
                jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, URLEncoder.encode("2000066", "utf-8"));
    ...
    public final void a(int i4, int i5, String str, String str2, String str3) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000058");
            jSONObject.put("appid", c.m().k());
            jSONObject.put("dl_type", String.valueOf(i4));
            jSONObject.put("dl_link_type", String.valueOf(i5));
    ...
    public final void a(String str, File file) {
        ...
        if (file != null) {
            try {
                ...
                if (MBridgeConstans.DEBUG) {
                    af.b(f13475a, "reportException", e5);
                }
            }
        }
    }
    ...
    public final void a(String str, String str2, String str3, String str4, String str5, boolean z4) {
        try {
            ...
            jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, URLEncoder.encode("2000065", "utf-8"));
            jSONObject.put("rid", URLEncoder.encode(str, "utf-8"));
            jSONObject.put("rid_n", URLEncoder.encode(str2, "utf-8"));
            jSONObject.put("cid", URLEncoder.encode(str3, "utf-8"));
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, URLEncoder.encode(str4, "utf-8"));
        ...
        if (lVar.b().equals(ShareTarget.METHOD_GET)) {
            ...
            a.e().execute(new Runnable() {
                public final void run() {
                    try {
                        if (h.this.f13476b == null) {
                            return;
                        }
                        if (lVar != null) {
                            com.mbridge.msdk.foundation.db.l.a((f) g.a(h.this.f13476b)).a(lVar.d());
                            if (bool.booleanValue() && com.mbridge.msdk.foundation.db.l.a((f) g.a(h.this.f13476b)).b() > 20) {
                                com.mbridge.msdk.foundation.controller.d.a().b();
                            }
                        }
                    } catch (Exception e5) {
                        if (MBridgeConstans.DEBUG) {
                            af.b(h.f13475a, "reportNetError", e5);
                        }
                    }
                }
            });
            ...
            a.e().execute(new Runnable() {
                public final void run() {
                    if (h.this.f13476b != null && lVar != null) {
                        try {
                            com.mbridge.msdk.foundation.db.l.a((f) g.a(h.this.f13476b)).a(lVar.a(), lVar.d(), lVar.c());
                            if (bool.booleanValue() && com.mbridge.msdk.foundation.db.l.a((f) g.a(h.this.f13476b)).a() > 0) {
                                com.mbridge.msdk.foundation.controller.d.a().b();
                            }
                        } catch (Exception e5) {
                            if (MBridgeConstans.DEBUG) {
    ...
    public final void a(String str, String str2, String str3, String str4, String str5) {
        try {
            int m4 = ab.m(this.f13476b);
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, URLEncoder.encode("2000071", "utf-8"));
            jSONObject.put("rid", URLEncoder.encode(str, "utf-8"));
            jSONObject.put("rid_n", URLEncoder.encode(str2, "utf-8"));
            jSONObject.put("cid", URLEncoder.encode(str3, "utf-8"));
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, URLEncoder.encode(str4, "utf-8"));
            jSONObject.put("reason", URLEncoder.encode(str5, "utf-8"));
            jSONObject.put("network_type", URLEncoder.encode(String.valueOf(m4), "utf-8"));
    ...
    public final void a() {
        try {
            if (i.a()) {
                String k4 = c.m().k();
                com.mbridge.msdk.c.g b5 = com.mbridge.msdk.c.h.a().b(k4);
                if (b5 == null) {
                ...
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000053");
                jSONObject.put("Appid", k4);
