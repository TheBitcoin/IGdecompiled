...
public class d implements Thread.UncaughtExceptionHandler {
    ...
    private static volatile d f13380b;

    /* renamed from: a  reason: collision with root package name */
    Handler f13381a = new Handler() {
        public final void handleMessage(Message message) {
            Context context;
            HashMap hashMap;
            super.handleMessage(message);
            if (message.what == 101 && (context = (Context) d.this.f13382c.get()) != null) {
    ...
    public final WeakReference<Context> f13382c;

    /* renamed from: d  reason: collision with root package name */
    private Throwable f13383d;

    /* renamed from: e  reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f13384e;

    private d(Context context) {
        this.f13382c = new WeakReference<>(context);
    }
    ...
    private HashMap<String, Object> c() {
        ...
        try {
            ...
            printWriter.println(a(this.f13383d, format));
            printWriter.println("====");
            this.f13383d.printStackTrace(printWriter);
            printWriter.close();
    ...
    public final JSONObject b(String str) throws JSONException {
        ...
        Context context = this.f13382c.get();
        if (context == null) {
            return null;
        }
        float f4 = (float) ((((double) Runtime.getRuntime().totalMemory()) * 1.0d) / 1048576.0d);
        ...
        jSONObject.put("memoryby_app", String.valueOf(f4));
    ...
    public final void b() {
        this.f13384e = Thread.getDefaultUncaughtExceptionHandler();
    ...
    private void a(String str, String str2, Throwable th, Thread thread) {
        if (str.contains(str2)) {
            ...
            if (c5 != null && c5.get("file") != null) {
                ...
                obtain.obj = hashMap;
                obtain.what = 101;
                this.f13381a.sendMessage(obtain);
                a(thread, th);
                return;
            }
            return;
        }
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f13384e;
