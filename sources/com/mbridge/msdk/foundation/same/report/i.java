...
public class i extends b {
    ...
    public static final String f13483a = "i";
        ...
        if (context != null && campaignEx != null) {
            try {
                if (!TextUtils.isEmpty(str)) {
                    ...
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000054");
    ...
    public static JSONObject a(Campaign campaign, int i4, String str) {
        JSONObject jSONObject = new JSONObject();
        try {
    ...
    public static com.mbridge.msdk.foundation.same.net.f.e a(Context context) {
        ...
        try {
            ...
            if (com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_GENERAL_DATA)) {
                ...
                eVar.a("network_str", ab.a(context, m4));
    ...
    public static void b(String str) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000090");
    ...
    public static void a(Context context, String str, String str2, int i4, String str3) {
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str2)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000076");
                    jSONObject.put("network_type", ab.m(context));
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String str2, int i4, String str3, int i5) {
        if (context != null && campaignEx != null) {
            try {
                if (!TextUtils.isEmpty(str2)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000073");
                    jSONObject.put("network_type", ab.m(context));
                    jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str2);
                    jSONObject.put("cid", campaignEx.getId());
                    jSONObject.put("reason", str3);
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String str2, int i4, int i5, int i6) {
        if (context != null && campaignEx != null) {
            try {
                if (!TextUtils.isEmpty(str2)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000075");
                    jSONObject.put("network_type", ab.m(context));
                    jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str2);
                    jSONObject.put("cid", campaignEx.getId());
    ...
    public static void a(Context context, CampaignEx campaignEx, String str, String str2, int i4, int i5) {
        if (context != null && campaignEx != null) {
            try {
                if (!TextUtils.isEmpty(str2)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000074");
                    jSONObject.put("network_type", ab.m(context));
                    jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str2);
                    jSONObject.put("cid", campaignEx.getId());
                    jSONObject.put("type", i4);
        ...
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000047");
                    if (!TextUtils.isEmpty(str2)) {
                        String str3 = com.mbridge.msdk.foundation.controller.a.f12767b.get(str2);
                        if (str3 == null) {
                            str3 = "";
                        }
        ...
        if (context != null && list != null) {
            try {
                if (!list.isEmpty() && !TextUtils.isEmpty(str)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000048");
                    jSONObject.put("st", System.currentTimeMillis());
                    jSONObject.put("network_type", ab.m(context));
                    jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str);
                    jSONObject.put(CampaignEx.JSON_KEY_HB, z4 ? 1 : 0);
    ...
    public static void a(Context context, String str, String str2, boolean z4, String str3, String str4, String str5, String str6) {
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000104");
                    if (!TextUtils.isEmpty(str2)) {
                        String str7 = com.mbridge.msdk.foundation.controller.a.f12767b.get(str2);
                        if (str7 == null) {
                            str7 = "";
                        }
    ...
    public static void a(CampaignEx campaignEx, String str, int i4, int i5, String str2, int i6, int i7, int i8, String str3) {
        com.mbridge.msdk.foundation.same.report.d.c cVar;
        try {
            com.mbridge.msdk.foundation.same.report.d.e eVar = new com.mbridge.msdk.foundation.same.report.d.e();
            eVar.a(LeanbackPreferenceDialogFragment.ARG_KEY, URLEncoder.encode("2000094", "utf-8"));
            if (campaignEx != null) {
            ...
            eVar.a(TypedValues.CycleType.S_WAVE_PHASE, i5 + "");
            eVar.a("feedback_content", URLEncoder.encode(str2, "utf-8"));
            eVar.a("feedback_close", i6 + "");
            eVar.a("type", i8 + "");
            eVar.a("ad_type", i7 + "");
    ...
    public static void a(String str) {
        try {
            if (c.m().c() != null) {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000088");
    ...
    public static void a(Context context, CampaignEx campaignEx, int i4, String str, String str2) {
        ...
        if (context != null && campaignEx != null) {
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000114");
                jSONObject.put("network_type", ab.m(context));
    ...
    public static void a(int i4, String str, String str2) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000080");
            jSONObject.put("ad_type", i4);
            jSONObject.put("url", str);
            jSONObject.put("reason", str2);
            d.a().a(jSONObject);
        } catch (Exception e5) {
    ...
    public static void a(CampaignEx campaignEx, String str, int i4, int i5, String str2) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(LeanbackPreferenceDialogFragment.ARG_KEY, "2000121");
            jSONObject.put("rid", campaignEx.getRequestId());
            jSONObject.put("rid_n", campaignEx.getRequestIdNotice());
            jSONObject.put("cid", campaignEx.getId());
            jSONObject.put(MBridgeConstans.PROPERTIES_UNIT_ID, str);
    ...
    public static void a(String str, int i4, int i5, String str2, int i6, String str3) {
        try {
            com.mbridge.msdk.foundation.same.report.d.e eVar = new com.mbridge.msdk.foundation.same.report.d.e();
            eVar.a(LeanbackPreferenceDialogFragment.ARG_KEY, URLEncoder.encode("m_water_mark_result", "utf-8"));
            eVar.a("water_mark_result", i5 + "");
            eVar.a("water_mark_error_msg", URLEncoder.encode(str2, "utf-8"));
            eVar.a("render_result", i6 + "");
