...
public final class f {
    ...
    private Map<String, String> d(String str, c cVar) {
        ...
        try {
            if (Arrays.asList(b.f13408e).contains(str)) {
                String str2 = "";
                if (cVar != null) {
                    str2 = cVar.d();
                }
            ...
            if (cVar != null) {
                Map<String, Map<String, String>> p4 = cVar.p();
                String str3 = cVar.f() + str;
                if (p4.containsKey(str3) && p4.get(str3) != null) {
                    hashMap.putAll(p4.get(str3));
                }
                try {
                    Map<String, Map<String, String>> q4 = cVar.q();
                    String str4 = cVar.f() + "_" + cVar.b() + "_" + str;
                    if (q4.containsKey(str4) && q4.get(str4) != null) {
                        hashMap.putAll(q4.get(str4));
                    }
                } catch (Exception e5) {
                    e5.printStackTrace();
                }
    ...
    public final void a(String str, m mVar, c cVar, a aVar) {
        ...
        if (cVar != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                if (Arrays.asList(b.f13407d).contains(str) && (c5 = c(str, cVar)) != null) {
                    hashMap.putAll(c5);
                }
                ...
                if (cVar.d() == null || !cVar.d().equals("1") || !Arrays.asList(b.f13405b).contains(str) || cVar.j() == 296) {
    ...
    private java.util.Map<java.lang.String, java.lang.String> b(java.lang.String r20, com.mbridge.msdk.foundation.same.report.d.c r21) {
        /*
            ...
            r11.<init>()
            java.lang.String[] r0 = com.mbridge.msdk.foundation.same.report.d.b.f13410g     // Catch:{ Exception -> 0x002a }
        ...
        L_0x005f:
            java.lang.String[] r0 = com.mbridge.msdk.foundation.same.report.d.b.f13409f     // Catch:{ Exception -> 0x002a }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x002a }
            boolean r0 = r0.contains(r1)     // Catch:{ Exception -> 0x002a }
        ...
        L_0x0451:
            ...
            r11.a(r3, r0)     // Catch:{ Exception -> 0x002a }
        L_0x0458:
            java.util.HashMap<java.lang.String, java.lang.String> r0 = com.mbridge.msdk.foundation.controller.a.f12767b     // Catch:{ Exception -> 0x002a }
        ...
        L_0x0528:
            java.lang.String[] r0 = com.mbridge.msdk.foundation.same.report.d.b.f13413j     // Catch:{ Exception -> 0x002a }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x002a }
            boolean r0 = r0.contains(r1)     // Catch:{ Exception -> 0x002a }
            ...
            java.lang.Integer r6 = java.lang.Integer.valueOf(r6)     // Catch:{ Exception -> 0x002a }
            r11.a(r0, r6)     // Catch:{ Exception -> 0x002a }
            java.lang.String[] r0 = com.mbridge.msdk.foundation.same.report.d.b.f13415l     // Catch:{ Exception -> 0x002a }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x002a }
            boolean r0 = r0.contains(r1)     // Catch:{ Exception -> 0x002a }
            if (r0 == 0) goto L_0x056e
            boolean r0 = r17.isTemplateRenderSucc()     // Catch:{ Exception -> 0x002a }
            if (r0 == 0) goto L_0x0565
            int r0 = com.mbridge.msdk.foundation.same.report.d.a.f13393e     // Catch:{ Exception -> 0x002a }
            goto L_0x0567
        L_0x0565:
            int r0 = com.mbridge.msdk.foundation.same.report.d.a.f13394f     // Catch:{ Exception -> 0x002a }
        L_0x0567:
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ Exception -> 0x002a }
            r11.a(r2, r0)     // Catch:{ Exception -> 0x002a }
        L_0x056e:
        ...
        L_0x0581:
            ...
            r11.a(r2, r0)     // Catch:{ Exception -> 0x002a }
        L_0x0588:
            java.lang.String[] r0 = com.mbridge.msdk.foundation.same.report.d.b.f13414k     // Catch:{ Exception -> 0x002a }
            java.util.List r0 = java.util.Arrays.asList(r0)     // Catch:{ Exception -> 0x002a }
            boolean r0 = r0.contains(r1)     // Catch:{ Exception -> 0x002a }
        ...
        L_0x05cf:
            ...
            int r0 = com.mbridge.msdk.foundation.same.report.d.a.f13399k     // Catch:{ Exception -> 0x002a }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ Exception -> 0x002a }
            r11.a(r12, r0)     // Catch:{ Exception -> 0x002a }
            goto L_0x05e4
        L_0x05db:
            int r0 = com.mbridge.msdk.foundation.same.report.d.a.f13400l     // Catch:{ Exception -> 0x002a }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ Exception -> 0x002a }
            r11.a(r12, r0)     // Catch:{ Exception -> 0x002a }
        L_0x05e4:
            boolean r0 = r17.isECTemplateRenderSucc()     // Catch:{ Exception -> 0x002a }
    ...
    private List<CampaignEx> a(c cVar, String str) {
        ...
        if (cVar != null) {
            try {
                ...
                Map<String, Map<String, String>> p4 = cVar.p();
                int i4 = -1;
                if (p4 != null && p4.containsKey(str2)) {
                    try {
                        Object obj = p4.get(str2).get("resource_type");
                ...
                if (i4 == 1) {
                    List<CampaignEx> h4 = cVar.h() != null ? cVar.h() : cVar.e();
