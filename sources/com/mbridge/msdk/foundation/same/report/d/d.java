...
public class d {
    ...
    private static d f13445a;

    /* renamed from: b  reason: collision with root package name */
    private volatile m f13446b;

    /* renamed from: c  reason: collision with root package name */
    private Map<String, e> f13447c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    private LinkedHashMap<String, c> f13448d = new LinkedHashMap<>();

    /* renamed from: e  reason: collision with root package name */
    private Map<String, e> f13449e = new HashMap();

    private d() {
        if (this.f13446b == null) {
            this.f13446b = m.a("metrics_sdk", c.m().c(), d());
        }
    ...
    private w d() {
        ...
        try {
            ...
            if (a10 == 1) {
                oVar = new o(new l((byte) 2), com.mbridge.msdk.foundation.same.net.e.d.f().f13319i, com.mbridge.msdk.foundation.same.net.e.d.f().f13323m);
            } else {
                oVar = new o(new h(), com.mbridge.msdk.foundation.same.net.e.d.f().f13313c, 0);
            }
    ...
    public final e a(String str) {
        ...
        e eVar = new e();
        try {
            if (!TextUtils.isEmpty(str) && (map = this.f13447c) != null && map.containsKey(str)) {
    ...
    private void b(String str, c cVar, a aVar) {
        try {
            if (Arrays.asList(b.f13406c).contains(str)) {
                cVar.m(str);
            }
            Map<String, e> map = this.f13449e;
            if (map != null && map.containsKey(str)) {
                cVar.a(str, this.f13449e.get(str));
            }
    ...
    public final void c(String str) {
        try {
            ...
            if (a5.length() != 0) {
                String optString = a5.optString(LeanbackPreferenceDialogFragment.ARG_KEY);
    ...
    public final e a(int i4, int i5, String str, boolean z4, int i6) {
        e eVar = new e();
        try {
            eVar.a(CampaignEx.JSON_KEY_HB, Integer.valueOf(i4));
            eVar.a("adtp", Integer.valueOf(i5));
            eVar.a(MBridgeConstans.PROPERTIES_UNIT_ID, str);
            if (z4) {
                eVar.a("auto_load", Integer.valueOf(i6));
                return eVar;
            }
        } catch (Exception e5) {
            if (MBridgeConstans.DEBUG) {
    ...
    public final void b(String str, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str3) && (linkedHashMap = this.f13448d) != null) {
                if (linkedHashMap.containsKey(str3)) {
                    this.f13448d.remove(str3);
                }
            }
        } catch (Exception e5) {
            if (MBridgeConstans.DEBUG) {
    ...
    public final void a(String str, CampaignEx campaignEx, e eVar) {
        ...
        if (cVar == null) {
            cVar = new c();
        } else if (Arrays.asList(b.f13411h).contains(str)) {
            cVar = b(cVar);
        }
        cVar.a(campaignEx);
        cVar.c(str2);
    ...
    public final void a(String str, CampaignEx campaignEx) {
        ...
        if (cVar.h() != null && !cVar.h().isEmpty() && campaignEx != null) {
            ...
            while (true) {
                if (i4 >= cVar.h().size()) {
                    break;
                } else if (cVar.h().get(i4).getId().equals(campaignEx.getId())) {
                    cVar.h().set(i4, campaignEx);
                    break;
                } else {
                    i4++;
                }
