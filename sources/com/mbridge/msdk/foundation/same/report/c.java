...
public class c {
    ...
    public static final String f13386a = "c";
    ...
    public static h c() {
        return new h() {
            public final JSONObject a(e eVar) {
                ...
                try {
                    d5.put(LeanbackPreferenceDialogFragment.ARG_KEY, eVar.a());
                    Context c5 = com.mbridge.msdk.foundation.controller.c.m().c();
                    int m4 = ab.m(c5);
                    if (!d5.has("network_type")) {
                        d5.put("network_type", m4);
                        d5.put("network_str", ab.a(c5, m4));
                    }
                    if (!d5.has("st")) {
                    ...
                    if (!TextUtils.isEmpty(optString)) {
                        String str2 = a.f12767b.get(optString);
                        if (str2 != null) {
                            str = str2;
                        }
                        d5.put("u_stid", str);
                    }
                    if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f13124V) && !d5.has(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B)) {
                        d5.put(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f13124V);
                    }
                    if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f13133g) && !d5.has(c.f13386a)) {
                        d5.put(c.f13386a, com.mbridge.msdk.foundation.same.a.f13133g);
                        return d5;
                    }
                } catch (Exception e5) {
                    af.b(c.f13386a, e5.getMessage());
                }
                return d5;
            }
        };
    ...
    public static void a(JSONObject jSONObject) {
        if (jSONObject != null) {
            ...
            if (!com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_OTHER)) {
                jSONObject.remove(com.mbridge.msdk.foundation.same.net.f.e.f13339a);
                jSONObject.remove(com.mbridge.msdk.foundation.same.net.f.e.f13340b);
