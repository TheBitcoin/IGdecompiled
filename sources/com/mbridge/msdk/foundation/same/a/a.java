...
public final class a {
    ...
    private final LinkedHashMap<String, JSONObject> f13153a;
    ...
    public a(int i4) {
        if (i4 > 0) {
            this.f13154b = i4;
            this.f13153a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final boolean a(String str, JSONObject jSONObject) {
        ...
        synchronized (this) {
            try {
                this.f13155c++;
                if (this.f13153a.put(str, jSONObject) != null) {
                    this.f13155c--;
                }
            } catch (Throwable th) {
                while (true) {
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", new Object[]{Integer.valueOf(this.f13154b)});
    }
    ...
    public final JSONObject a(String str) {
        ...
        if (str != null) {
            synchronized (this) {
                jSONObject = this.f13153a.get(str);
            }
            return jSONObject;
        }
    ...
    public final Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f13153a.keySet());
        }
        return hashSet;
    }
    ...
    private void a(int r3) {
        ...
        L_0x0000:
            monitor-enter(r2)
            int r0 = r2.f13155c     // Catch:{ all -> 0x0012 }
            if (r0 < 0) goto L_0x0053
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r2.f13153a     // Catch:{ all -> 0x0012 }
        ...
        L_0x0035:
            ...
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r2.f13153a     // Catch:{ all -> 0x004f }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x004f }
            org.json.JSONObject r0 = (org.json.JSONObject) r0     // Catch:{ all -> 0x004f }
            int r0 = r2.f13155c     // Catch:{ all -> 0x004f }
            int r0 = r0 + -1
            r2.f13155c = r0     // Catch:{ all -> 0x004f }
        L_0x004f:
            monitor-exit(r2)     // Catch:{ all -> 0x0012 }
            goto L_0x0000
        L_0x0051:
