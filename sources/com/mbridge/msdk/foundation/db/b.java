...
public class b extends a {
    ...
    private static volatile b f12891a;
                ...
                if (cursor != null) {
                    if (cursor.getCount() > 0) {
                        while (cursor.moveToNext()) {
                            ...
                            int i4 = cursor.getInt(cursor.getColumnIndex("real_token_rule"));
                            int i5 = cursor.getInt(cursor.getColumnIndex("is_replace"));
                            dVar.a(string);
                            dVar.b(string2);
                            dVar.c(string3);
                            dVar.e(string4);
