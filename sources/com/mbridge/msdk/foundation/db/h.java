...
public class h extends a<Campaign> {
    ...
    private static final String f12921a = "com.mbridge.msdk.foundation.db.h";

    /* renamed from: b  reason: collision with root package name */
    private static h f12922b;
    ...
    private synchronized void c(java.lang.String r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            android.database.sqlite.SQLiteDatabase r0 = r4.getWritableDatabase()     // Catch:{ all -> 0x0031 }
            if (r0 != 0) goto L_0x0009
            monitor-exit(r4)
            return
        L_0x0009:
            android.content.ContentValues r0 = new android.content.ContentValues     // Catch:{ all -> 0x0031 }
            r0.<init>()     // Catch:{ all -> 0x0031 }
            java.lang.String r1 = "first_insert_timestamp"
            r2 = 0
            java.lang.Integer r3 = java.lang.Integer.valueOf(r2)     // Catch:{ all -> 0x0031 }
            r0.put(r1, r3)     // Catch:{ all -> 0x0031 }
            java.lang.String r1 = "play_time"
            java.lang.Integer r2 = java.lang.Integer.valueOf(r2)     // Catch:{ all -> 0x0031 }
            r0.put(r1, r2)     // Catch:{ all -> 0x0031 }
            java.lang.String r1 = "unit_id = ?"
            android.database.sqlite.SQLiteDatabase r2 = r4.getWritableDatabase()     // Catch:{ all -> 0x0031 }
            java.lang.String r3 = "dailyplaycap"
            java.lang.String[] r5 = new java.lang.String[]{r5}     // Catch:{ all -> 0x0031 }
            r2.update(r3, r0, r1, r5)     // Catch:{ all -> 0x0031 }
            goto L_0x0038
        L_0x0031:
            java.lang.String r5 = f12921a     // Catch:{ all -> 0x003a }
            java.lang.String r0 = "resetTimeAndTimestamp error"
            com.mbridge.msdk.foundation.tools.af.c(r5, r0)     // Catch:{ all -> 0x003a }
        L_0x0038:
            monitor-exit(r4)
            return
        L_0x003a:
    ...
    public final boolean a(java.lang.String r11, int r12) {
        ...
        L_0x0055:
            ...
            goto L_0x0072
        L_0x0059:
            java.lang.String r12 = f12921a     // Catch:{ all -> 0x0073 }
