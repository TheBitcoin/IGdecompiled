...
public class c extends a {
    ...
    private static final String f12892a = "com.mbridge.msdk.foundation.db.c";

    /* renamed from: b  reason: collision with root package name */
    private static volatile c f12893b;
    ...
    public final long a(String str, String str2, String str3, int i4) {
        if (!a(str, str3)) {
            return -1;
        }
        ContentValues contentValues = new ContentValues();
        contentValues.put(MRAIDCommunicatorUtil.KEY_STATE, Integer.valueOf(i4));
    ...
    public final synchronized void a(String str, int i4) {
        ...
        try {
            ...
            if (writableDatabase != null) {
                try {
                    writableDatabase.delete("CacheCampaign", str2, new String[]{str, String.valueOf(i4)});
                } catch (Exception e5) {
                    e5.printStackTrace();
                }
            }
