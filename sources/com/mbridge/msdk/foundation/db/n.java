...
public final class n extends a<Campaign> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00ab A[Catch:{ all -> 0x007e }] */
    ...
    public final synchronized com.mbridge.msdk.foundation.entity.m a(java.lang.String r7) {
        /*
            r6 = this;
            monitor-enter(r6)
            boolean r0 = android.text.TextUtils.isEmpty(r7)     // Catch:{ all -> 0x0090 }
            r1 = 0
        ...
        L_0x000a:
            ...
            java.lang.String[] r7 = new java.lang.String[]{r7}     // Catch:{ Exception -> 0x00a3, all -> 0x00a1 }
            android.database.sqlite.SQLiteDatabase r2 = r6.getReadableDatabase()     // Catch:{ Exception -> 0x00a3, all -> 0x00a1 }
            android.database.Cursor r7 = r2.rawQuery(r0, r7)     // Catch:{ Exception -> 0x00a3, all -> 0x00a1 }
            if (r7 == 0) goto L_0x008a
            int r0 = r7.getCount()     // Catch:{ Exception -> 0x0085 }
            if (r0 <= 0) goto L_0x008a
            com.mbridge.msdk.foundation.entity.m r0 = new com.mbridge.msdk.foundation.entity.m     // Catch:{ Exception -> 0x0085 }
            r0.<init>()     // Catch:{ Exception -> 0x0085 }
        L_0x0025:
            boolean r1 = r7.moveToNext()     // Catch:{ Exception -> 0x0081 }
            if (r1 == 0) goto L_0x0083
            java.lang.String r1 = "video_url"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = r7.getString(r1)     // Catch:{ Exception -> 0x0081 }
            r0.b((java.lang.String) r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = "video_state"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0081 }
            int r1 = r7.getInt(r1)     // Catch:{ Exception -> 0x0081 }
            r0.a((int) r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = "pregeress_size"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0081 }
            long r1 = r7.getLong(r1)     // Catch:{ Exception -> 0x0081 }
            r0.b((long) r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = "total_size"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0081 }
            int r1 = r7.getInt(r1)     // Catch:{ Exception -> 0x0081 }
            r0.b((int) r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = "video_path"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = r7.getString(r1)     // Catch:{ Exception -> 0x0081 }
            r0.a((java.lang.String) r1)     // Catch:{ Exception -> 0x0081 }
            java.lang.String r1 = "video_download_start"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0081 }
            long r1 = r7.getLong(r1)     // Catch:{ Exception -> 0x0081 }
            r3 = 1000(0x3e8, double:4.94E-321)
            long r1 = r1 * r3
            r0.a((long) r1)     // Catch:{ Exception -> 0x0081 }
            goto L_0x0025
        L_0x007e:
            r0 = move-exception
            r1 = r7
        ...
        L_0x0092:
            r7 = move-exception
            boolean r0 = com.mbridge.msdk.MBridgeConstans.DEBUG     // Catch:{ all -> 0x0090 }
            if (r0 == 0) goto L_0x00c9
            java.lang.String r0 = "VideoDao"
            java.lang.String r7 = r7.getLocalizedMessage()     // Catch:{ all -> 0x0090 }
            com.mbridge.msdk.foundation.tools.af.b(r0, r7)     // Catch:{ all -> 0x0090 }
            goto L_0x00c9
        L_0x00a1:
            r0 = move-exception
            goto L_0x00cb
        L_0x00a3:
            ...
            r7 = r0
        L_0x00a7:
            boolean r2 = com.mbridge.msdk.MBridgeConstans.DEBUG     // Catch:{ all -> 0x007e }
            if (r2 == 0) goto L_0x00b4
            java.lang.String r2 = "VideoDao"
            java.lang.String r1 = r1.getLocalizedMessage()     // Catch:{ all -> 0x007e }
            com.mbridge.msdk.foundation.tools.af.b(r2, r1)     // Catch:{ all -> 0x007e }
        L_0x00b4:
        ...
        L_0x00ba:
            r7 = move-exception
            boolean r1 = com.mbridge.msdk.MBridgeConstans.DEBUG     // Catch:{ all -> 0x0090 }
            if (r1 == 0) goto L_0x00c8
            java.lang.String r1 = "VideoDao"
            java.lang.String r7 = r7.getLocalizedMessage()     // Catch:{ all -> 0x0090 }
            com.mbridge.msdk.foundation.tools.af.b(r1, r7)     // Catch:{ all -> 0x0090 }
        L_0x00c8:
            r1 = r0
        L_0x00c9:
            monitor-exit(r6)
    ...
    public final synchronized com.mbridge.msdk.foundation.entity.m a(java.lang.String r6, java.lang.String r7) {
        /*
            r5 = this;
            monitor-enter(r5)
            boolean r7 = android.text.TextUtils.isEmpty(r6)     // Catch:{ all -> 0x0099 }
            r0 = 0
            if (r7 == 0) goto L_0x000a
            monitor-exit(r5)
            return r0
        L_0x000a:
            com.mbridge.msdk.foundation.entity.m r7 = new com.mbridge.msdk.foundation.entity.m     // Catch:{ all -> 0x0099 }
            ...
            java.lang.String r1 = r2.toString()     // Catch:{ all -> 0x0099 }
            android.database.sqlite.SQLiteDatabase r2 = r5.getReadableDatabase()     // Catch:{ Exception -> 0x0091 }
            android.database.Cursor r0 = r2.rawQuery(r1, r6)     // Catch:{ Exception -> 0x0091 }
            if (r0 == 0) goto L_0x0093
            int r6 = r0.getCount()     // Catch:{ Exception -> 0x0091 }
            if (r6 <= 0) goto L_0x0093
        L_0x0036:
            boolean r6 = r0.moveToNext()     // Catch:{ Exception -> 0x0091 }
            if (r6 == 0) goto L_0x0093
            java.lang.String r6 = "video_url"
            int r6 = r0.getColumnIndex(r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = r0.getString(r6)     // Catch:{ Exception -> 0x0091 }
            r7.b((java.lang.String) r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = "video_state"
            int r6 = r0.getColumnIndex(r6)     // Catch:{ Exception -> 0x0091 }
            int r6 = r0.getInt(r6)     // Catch:{ Exception -> 0x0091 }
            r7.a((int) r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = "pregeress_size"
            int r6 = r0.getColumnIndex(r6)     // Catch:{ Exception -> 0x0091 }
            long r1 = r0.getLong(r6)     // Catch:{ Exception -> 0x0091 }
            r7.b((long) r1)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = "total_size"
            int r6 = r0.getColumnIndex(r6)     // Catch:{ Exception -> 0x0091 }
            int r6 = r0.getInt(r6)     // Catch:{ Exception -> 0x0091 }
            r7.b((int) r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = "video_path"
            int r6 = r0.getColumnIndex(r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = r0.getString(r6)     // Catch:{ Exception -> 0x0091 }
            r7.a((java.lang.String) r6)     // Catch:{ Exception -> 0x0091 }
            java.lang.String r6 = "video_download_start"
            int r6 = r0.getColumnIndex(r6)     // Catch:{ Exception -> 0x0091 }
            long r1 = r0.getLong(r6)     // Catch:{ Exception -> 0x0091 }
            r3 = 1000(0x3e8, double:4.94E-321)
            long r1 = r1 * r3
            r7.a((long) r1)     // Catch:{ Exception -> 0x0091 }
            goto L_0x0036
        L_0x008f:
            r6 = move-exception
            goto L_0x00ad
        ...
        L_0x009b:
            ...
            java.lang.String r1 = "VideoDao"
            java.lang.String r6 = r6.getLocalizedMessage()     // Catch:{ all -> 0x008f }
            com.mbridge.msdk.foundation.tools.af.b(r1, r6)     // Catch:{ all -> 0x008f }
        L_0x00a8:
            if (r0 == 0) goto L_0x00ab
            goto L_0x0095
        L_0x00ab:
