...
public class e extends a<Campaign> {
    ...
    private static final String f12896a = "com.mbridge.msdk.foundation.db.e";

    /* renamed from: b  reason: collision with root package name */
    private static e f12897b;

    /* renamed from: c  reason: collision with root package name */
    private final String f12898c = "rid";

    /* renamed from: d  reason: collision with root package name */
    private final String f12899d = "lrid";

    /* renamed from: e  reason: collision with root package name */
    private final String f12900e = "cid";

    /* renamed from: f  reason: collision with root package name */
    private final String f12901f = CampaignEx.JSON_KEY_PLCT;

    /* renamed from: g  reason: collision with root package name */
    private final String f12902g = CampaignEx.JSON_KEY_PLCTB;

    /* renamed from: h  reason: collision with root package name */
    private final String f12903h = CampaignEx.JSON_KEY_TIMESTAMP;

    /* renamed from: i  reason: collision with root package name */
    private final String f12904i = "ridCount";

    /* renamed from: j  reason: collision with root package name */
    private final String f12905j = " WHERE ";

    /* renamed from: k  reason: collision with root package name */
    private final String f12906k = " AND ";

    /* renamed from: l  reason: collision with root package name */
    private final String f12907l = "SELECT ";

    /* renamed from: m  reason: collision with root package name */
    private final String f12908m = "*";

    /* renamed from: n  reason: collision with root package name */
    private final String f12909n = " FROM ";

    /* renamed from: o  reason: collision with root package name */
    private final String f12910o = " AND readyState = '0'";

    /* renamed from: p  reason: collision with root package name */
    private final String f12911p = " AND is_bid_campaign = 1";

    /* renamed from: q  reason: collision with root package name */
    private final String f12912q = " order by ts ASC";

    /* renamed from: r  reason: collision with root package name */
    private final String f12913r = " group by request_id";

    /* renamed from: s  reason: collision with root package name */
    private final String f12914s = " group by bid_token";
                    ...
                    if (cursor.getCount() > 0) {
                        while (cursor.moveToNext()) {
                            ...
                            if (!TextUtils.isEmpty(string)) {
                                ...
                                int i4 = cursor.getInt(cursor.getColumnIndex("ridCount"));
                                int i5 = cursor.getInt(cursor.getColumnIndex("token_r"));
                                long j4 = cursor.getLong(cursor.getColumnIndex(CampaignEx.JSON_KEY_TIMESTAMP));
                                int i6 = cursor.getInt(cursor.getColumnIndex("vcn"));
                                cVar.a(string);
                                cVar.a(i4);
                                cVar.c(j4);
                                cVar.b(i5);
            ...
            if (cursor != null) {
                if (cursor.getCount() > 0) {
                    while (cursor.moveToNext()) {
                        ...
                        long j4 = cursor.getLong(cursor.getColumnIndex(CampaignEx.JSON_KEY_PLCT));
                        long j5 = cursor.getLong(cursor.getColumnIndex(CampaignEx.JSON_KEY_PLCTB));
                        long j6 = cursor.getLong(cursor.getColumnIndex(CampaignEx.JSON_KEY_TIMESTAMP));
    ...
    public final synchronized void b(long j4, String str) {
        try {
            String[] strArr = {String.valueOf(System.currentTimeMillis() - j4), str};
    ...
    public final synchronized void a(long j4, String str) {
        try {
            ...
            String str2 = "(plctb>0 and (plctb* 1000+ts)< " + currentTimeMillis + " ) or (" + CampaignEx.JSON_KEY_PLCTB + "<=" + 0 + " and " + CampaignEx.JSON_KEY_ST_TS + "< " + (currentTimeMillis - j4) + " ) and " + "unitid" + "=?";
            String[] strArr = {str};
            if (getWritableDatabase() != null) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0064, code lost:
        return -1;
     */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x0070 A[Catch:{ all -> 0x005a }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized int a(java.lang.String r11, long r12) {
        /*
            ...
            monitor-enter(r10)
            r1 = 0
            com.mbridge.msdk.c.h r0 = com.mbridge.msdk.c.h.a()     // Catch:{ Exception -> 0x0069, all -> 0x0066 }
            com.mbridge.msdk.foundation.controller.c r2 = com.mbridge.msdk.foundation.controller.c.m()     // Catch:{ Exception -> 0x0069, all -> 0x0066 }
            java.lang.String r2 = r2.k()     // Catch:{ Exception -> 0x0069, all -> 0x0066 }
            com.mbridge.msdk.c.g r0 = r0.b(r2)     // Catch:{ Exception -> 0x0069, all -> 0x0066 }
        ...
        L_0x0020:
            ...
            goto L_0x006c
        L_0x0024:
            long r2 = r0.ad()     // Catch:{ Exception -> 0x0069, all -> 0x0066 }
            r4 = 1000(0x3e8, double:4.94E-321)
            long r2 = r2 * r4
            r10.a((long) r2, (java.lang.String) r11)     // Catch:{ Exception -> 0x0069, all -> 0x0066 }
            r8 = 1
            r9 = 0
            r6 = 0
            r7 = 0
            r4 = r10
            r5 = r11
            java.util.List r11 = r4.a((java.lang.String) r5, (int) r6, (int) r7, (int) r8, (boolean) r9)     // Catch:{ Exception -> 0x005d }
            if (r11 == 0) goto L_0x0063
            boolean r0 = r11.isEmpty()     // Catch:{ Exception -> 0x005d }
            if (r0 == 0) goto L_0x0042
            goto L_0x0063
        L_0x0042:
            java.util.Iterator r11 = r11.iterator()     // Catch:{ Exception -> 0x005d }
        L_0x0046:
            boolean r0 = r11.hasNext()     // Catch:{ Exception -> 0x005d }
            if (r0 == 0) goto L_0x0060
            java.lang.Object r0 = r11.next()     // Catch:{ Exception -> 0x005d }
            com.mbridge.msdk.foundation.entity.CampaignEx r0 = (com.mbridge.msdk.foundation.entity.CampaignEx) r0     // Catch:{ Exception -> 0x005d }
            boolean r0 = r0.isSpareOffer(r12, r2)     // Catch:{ Exception -> 0x005d }
        ...
        L_0x0069:
            ...
            goto L_0x005e
        L_0x006c:
            boolean r12 = com.mbridge.msdk.MBridgeConstans.DEBUG     // Catch:{ all -> 0x005a }
            if (r12 == 0) goto L_0x0079
            java.lang.String r12 = "CampaignDao"
            java.lang.String r11 = r11.getLocalizedMessage()     // Catch:{ all -> 0x005a }
            com.mbridge.msdk.foundation.tools.af.b(r12, r11)     // Catch:{ all -> 0x005a }
        L_0x0079:
            monitor-exit(r10)
            return r1
        L_0x007b:
    ...
    public final synchronized List<CampaignEx> a(String str, int i4, int i5, int i6, boolean z4) {
        ArrayList arrayList;
        String str2;
        String str3;
        try {
