...
public abstract class f {
    ...
    private class a extends SQLiteOpenHelper {
        public a(Context context, String str, int i4) {
            ...
            if (MBridgeConstans.DEBUG) {
                af.a("DatabaseOpenHelper", "数据库： name :" + str + "  " + i4);
            }
        }
        ...
        public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i4, int i5) {
            ...
            f.this.b(sQLiteDatabase, i4, i5);
        }
    }

    public f(Context context) {
        this.f12918a = new a(context, a(), b());
    }
    ...
    /* access modifiers changed from: protected */
    public abstract void a(SQLiteDatabase sQLiteDatabase, int i4, int i5);

    /* access modifiers changed from: protected */
    public abstract int b();

    /* access modifiers changed from: protected */
    public abstract void b(SQLiteDatabase sQLiteDatabase, int i4, int i5);

    public final SQLiteDatabase c() {
        return this.f12918a.getReadableDatabase();
    }
    ...
    public final synchronized android.database.sqlite.SQLiteDatabase d() {
        /*
            r1 = this;
            monitor-enter(r1)
            com.mbridge.msdk.foundation.db.f$a r0 = r1.f12918a     // Catch:{ Exception -> 0x000b }
