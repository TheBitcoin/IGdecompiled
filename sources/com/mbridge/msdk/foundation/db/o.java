...
public class o extends a<n> {
    ...
    private static final String f12930a = "com.mbridge.msdk.foundation.db.o";

    /* renamed from: b  reason: collision with root package name */
    private static o f12931b;
    ...
    public final synchronized java.util.List<com.mbridge.msdk.foundation.entity.n> a(java.lang.String r25) {
        ...
        L_0x0330:
            ...
            java.lang.String r1 = f12930a     // Catch:{ all -> 0x0130 }
        ...
        if (nVar != null) {
            try {
                ...
                if (!TextUtils.isEmpty(s4)) {
                    contentValues.put(CampaignEx.ENDCARD_URL, s4);
                }
                String q4 = nVar.q();
                if (!TextUtils.isEmpty(q4)) {
                    contentValues.put(CampaignEx.JSON_KEY_VIDEO_URL, q4);
                }
                String f4 = nVar.f();
                if (!TextUtils.isEmpty(f4)) {
                    contentValues.put("rid", f4);
                }
                String g4 = nVar.g();
                if (!TextUtils.isEmpty(g4)) {
                    contentValues.put("rid_n", g4);
                }
                String D4 = nVar.D();
                ...
                if (!TextUtils.isEmpty(j4)) {
                    contentValues.put("device_id", URLEncoder.encode(j4, "utf-8"));
                }
                String i4 = nVar.i();
                if (!TextUtils.isEmpty(i4)) {
                    contentValues.put("creative", URLEncoder.encode(i4, "utf-8"));
                }
