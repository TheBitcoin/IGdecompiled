...
public class BatchReportDao extends a<BatchReportMessage> implements NoProGuard, Serializable {
    ...
    public void addReportMessage(String str, int i4) {
    ...
    public void deleteBatchReportMessagesByTimestamp(long j4) {
        ...
        if (d.a(writableDatabase)) {
            try {
                synchronized (this.lock) {
                    writableDatabase.execSQL("delete from " + "batch_report" + " where " + "time" + " <= ?", new Object[]{Long.valueOf(j4)});
                }
            } catch (Exception e5) {
                e5.printStackTrace();
            }
    ...
    public void updateMessagesReportState(ArrayList<BatchReportMessage> arrayList) {
        ...
        if (arrayList != null && arrayList.size() != 0 && d.a(writableDatabase)) {
            ...
            int i4 = 0;
            while (i4 < size) {
                BatchReportMessage batchReportMessage = arrayList.get(i4);
                i4++;
