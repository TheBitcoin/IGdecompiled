...
public final class a {
    ...
    private static final SparseArray<String> f12748a;
    ...
    public static String a(int i4, String str) {
        return i4 + "#" + f12748a.get(i4) + "#" + str;
    }

    public static b a(int i4, int i5, String str) {
        return new b(i4, i5, str);
    }
}
