...
public final class ak extends n {
    ...
    private static int f13587a = 0;

    /* renamed from: b  reason: collision with root package name */
    private static int f13588b = 1;

    /* renamed from: c  reason: collision with root package name */
    private static int f13589c = 2;

    /* renamed from: d  reason: collision with root package name */
    private static int f13590d = 3;

    /* renamed from: e  reason: collision with root package name */
    private static int f13591e = 0;

    /* renamed from: f  reason: collision with root package name */
    private static int f13592f = 7;

    /* renamed from: g  reason: collision with root package name */
    private static int f13593g = 14;

    /* renamed from: h  reason: collision with root package name */
    private static int f13594h = 19;

    /* renamed from: i  reason: collision with root package name */
    private static int f13595i = 16;

    /* renamed from: j  reason: collision with root package name */
    private static int f13596j = 26;

    /* renamed from: k  reason: collision with root package name */
    private static char[] f13597k = {'.', 'X'};

    /* renamed from: l  reason: collision with root package name */
    private static char[] f13598l = {'A', 'p', 'p', 'l', 'i', 'c', 'a', 't', 'i', 'o', 'n', 'I', 'n', 'f', 'o'};

    /* renamed from: m  reason: collision with root package name */
    private static int f13599m = 1;

    /* renamed from: n  reason: collision with root package name */
    private static boolean f13600n = true;

    /* renamed from: o  reason: collision with root package name */
    private static volatile Boolean f13601o = null;

    /* renamed from: p  reason: collision with root package name */
    private static String f13602p = "[一-龥]";

    /* renamed from: q  reason: collision with root package name */
    private static Pattern f13603q = Pattern.compile("[一-龥]");

    /* renamed from: r  reason: collision with root package name */
    private static Map<String, String> f13604r;

    /* renamed from: s  reason: collision with root package name */
    private static Map<String, String> f13605s;
    ...
    public static synchronized java.lang.String d(java.lang.String r3) {
        /*
            ...
            java.util.Map<java.lang.String, java.lang.String> r1 = f13605s     // Catch:{ all -> 0x0033 }
    ...
    public static <T extends String> boolean j(T t4) {
    ...
    public static final synchronized java.lang.String e(java.lang.String r9) {
        ...
        L_0x0052:
            ...
            java.util.Map<java.lang.String, java.lang.String> r4 = f13604r     // Catch:{ Exception -> 0x0046 }
            if (r4 == 0) goto L_0x0068
            boolean r4 = r4.containsKey(r9)     // Catch:{ Exception -> 0x0046 }
            if (r4 == 0) goto L_0x0068
            java.util.Map<java.lang.String, java.lang.String> r1 = f13604r     // Catch:{ Exception -> 0x0046 }
        ...
        L_0x0106:
            ...
            java.lang.String r1 = com.mbridge.msdk.foundation.tools.C1812a.a(r1)     // Catch:{ Exception -> 0x0046 }
            if (r3 == 0) goto L_0x012e
            boolean r2 = android.text.TextUtils.isEmpty(r1)     // Catch:{ Exception -> 0x0046 }
            if (r2 != 0) goto L_0x012e
            java.util.Map<java.lang.String, java.lang.String> r2 = f13604r     // Catch:{ Exception -> 0x0046 }
            if (r2 != 0) goto L_0x0129
            java.util.HashMap r2 = new java.util.HashMap     // Catch:{ Exception -> 0x0046 }
            r2.<init>()     // Catch:{ Exception -> 0x0046 }
            f13604r = r2     // Catch:{ Exception -> 0x0046 }
        L_0x0129:
            java.util.Map<java.lang.String, java.lang.String> r2 = f13604r     // Catch:{ Exception -> 0x0046 }
        ...
        for (com.mbridge.msdk.foundation.entity.c next : a5.values()) {
            if (next != null) {
                ...
                if (e5 <= 0) {
                    ...
                    if (f4 + (b5.ad() * 1000) < currentTimeMillis) {
                    }
                } else if (f4 + (e5 * 1000) < currentTimeMillis) {
                }
    ...
    public static <T extends String> boolean k(T t4) {
        return t4 == null || t4.length() == 0;
    }
    ...
    public static synchronized int d(Context context, String str) {
        ...
        synchronized (ak.class) {
            ...
            i4 = context == null ? 5 : TextUtils.isEmpty(str) ? 2 : 4;
        }
        return i4;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:17:0x003d A[Catch:{ Exception -> 0x0050 }, LOOP:0: B:16:0x003b->B:17:0x003d, LOOP_END] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String b(int r4) {
        /*
            com.mbridge.msdk.c.h r0 = com.mbridge.msdk.c.h.a()     // Catch:{ Exception -> 0x0050 }
            com.mbridge.msdk.foundation.controller.c r1 = com.mbridge.msdk.foundation.controller.c.m()     // Catch:{ Exception -> 0x0050 }
            java.lang.String r1 = r1.k()     // Catch:{ Exception -> 0x0050 }
            com.mbridge.msdk.c.g r0 = r0.b(r1)     // Catch:{ Exception -> 0x0050 }
            if (r0 != 0) goto L_0x0019
            com.mbridge.msdk.c.h.a()     // Catch:{ Exception -> 0x0050 }
            com.mbridge.msdk.c.g r0 = com.mbridge.msdk.c.i.a()     // Catch:{ Exception -> 0x0050 }
        L_0x0019:
            org.json.JSONArray r1 = new org.json.JSONArray     // Catch:{ Exception -> 0x0050 }
            r1.<init>()     // Catch:{ Exception -> 0x0050 }
            if (r0 == 0) goto L_0x0045
            int r0 = r0.t()     // Catch:{ Exception -> 0x0050 }
            r2 = 1
            if (r0 != r2) goto L_0x0045
            com.mbridge.msdk.foundation.db.a.a r0 = com.mbridge.msdk.foundation.db.a.a.a()     // Catch:{ Exception -> 0x0050 }
            java.lang.String[] r0 = r0.b()     // Catch:{ Exception -> 0x0050 }
            if (r0 == 0) goto L_0x0045
            int r2 = r0.length     // Catch:{ Exception -> 0x0050 }
        ...
        L_0x003b:
            ...
            r3 = r0[r4]     // Catch:{ Exception -> 0x0050 }
            r1.put(r3)     // Catch:{ Exception -> 0x0050 }
            int r4 = r4 + 1
            goto L_0x003b
        L_0x0045:
            int r4 = r1.length()     // Catch:{ Exception -> 0x0050 }
            if (r4 <= 0) goto L_0x0054
            java.lang.String r4 = a((org.json.JSONArray) r1)     // Catch:{ Exception -> 0x0050 }
            return r4
        L_0x0050:
            r4 = move-exception
            r4.printStackTrace()
    ...
    private static final char[] c(int i4) {
        StringBuilder sb;
        if (i4 == 0) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOf(aj.f13584a, f13592f)));
            sb.append(f13597k[f13591e]);
            sb.append(String.valueOf(Arrays.copyOfRange(aj.f13584a, f13592f, f13593g)));
            sb.append(f13597k[f13591e]);
            sb.append(String.valueOf(Arrays.copyOfRange(aj.f13584a, f13593g, f13595i)));
            sb.append(f13597k[f13591e]);
            sb.append(String.valueOf(ai.f13576a));
        } else if (i4 == 1) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOf(aj.f13584a, f13592f)));
            sb.append(f13597k[f13591e]);
            sb.append(String.valueOf(Arrays.copyOfRange(aj.f13584a, f13592f, f13593g)));
            sb.append(f13597k[f13591e]);
            sb.append(String.valueOf(Arrays.copyOfRange(aj.f13584a, f13594h, f13596j)));
        } else if (i4 == 2) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOfRange(aj.f13584a, f13595i, f13594h)));
            sb.append(String.valueOf(f13598l));
        } else if (i4 != 3) {
            sb = null;
        } else {
            sb = new StringBuilder();
    ...
    public static final void a(final int i4, final ImageView imageView, final CampaignEx campaignEx, Context context, boolean z4, final a aVar) {
            ...
            if (!z4 && z5) {
                ...
                imageView.setOnClickListener(new View.OnClickListener() {
                    public final void onClick(View view) {
                        try {
                            ak.a(campaignEx, aVar, i4, (String) imageView.getTag());
                        } catch (Exception e5) {
                            af.b("SameTools", e5.getMessage());
                        }
                    }
    ...
    public static String a(CampaignEx campaignEx) {
        ...
        return TextUtils.isEmpty(str) ? d.f().f13316f : str;
    }

    private static Object b(String str, Context context) {
        try {
            return Class.forName(String.valueOf(c(f13587a))).getMethod(String.valueOf(c(f13589c)), new Class[]{String.class, Integer.TYPE}).invoke(Class.forName(String.valueOf(c(f13588b))).getMethod(String.valueOf(c(f13590d)), (Class[]) null).invoke(context, (Object[]) null), new Object[]{str, 8192});
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static void a(CampaignEx campaignEx, a aVar, int i4, String str) {
        if (campaignEx != null) {
            try {
                String str2 = campaignEx.getCampaignUnitId() + "_" + i4;
                ...
                com.mbridge.msdk.foundation.d.b.a().a(str2, i4);
    ...
    public static long a(java.io.File r4) throws java.lang.Exception {
        /*
            r0 = 0
            r2 = 0
            boolean r3 = r4.exists()     // Catch:{ Exception -> 0x001d, all -> 0x001b }
        ...
        L_0x001d:
            goto L_0x002e
        L_0x001f:
            r4.createNewFile()     // Catch:{ Exception -> 0x001d, all -> 0x001b }
        L_0x0022:
    ...
    public static final int a() {
        if (f13601o == null) {
            try {
                f13601o = MIMManager.a.f13518a.d();
            } catch (Exception e5) {
                af.b("SameTools", e5.getMessage());
            }
        }
        if (f13601o != null) {
            return f13601o.booleanValue() ? 1 : 0;
        }
        return -1;
    }
