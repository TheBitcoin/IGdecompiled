...
public final class ai {
    ...
    public static char[] f13576a = {'P', 'a', 'c', 'k', 'a', 'g', 'e', 'M', 'a', 'n', 'a', 'g', 'e', 'r'};

    /* renamed from: b  reason: collision with root package name */
    static String f13577b = "";

    /* renamed from: c  reason: collision with root package name */
    static boolean f13578c = false;

    /* renamed from: d  reason: collision with root package name */
    private static int f13579d = -1;

    /* renamed from: e  reason: collision with root package name */
    private static int f13580e = -1;

    /* renamed from: f  reason: collision with root package name */
    private static boolean f13581f = false;

    /* renamed from: g  reason: collision with root package name */
    private static int f13582g = -1;

    /* renamed from: h  reason: collision with root package name */
    private static int f13583h = -1;
    ...
    public static int a() {
        try {
            ...
            if (currentTimeMillis - longValue > 1800000 || f13580e == -1) {
                f13580e = Long.valueOf((c() / 1000) / 1000).intValue();
    ...
    public static int b() {
        if (f13583h == -1) {
            try {
                f13583h = new Long((e() / 1000) / 1000).intValue();
            } catch (Throwable th) {
                af.b("SameSDCardTool", th.getMessage(), th);
            }
        }
    ...
    public static void a(android.content.Context r2) {
        ...
        L_0x0003:
            ...
            f13577b = r0     // Catch:{ Exception -> 0x0029 }
            r0 = 0
            f13578c = r0     // Catch:{ Exception -> 0x0029 }
        ...
        L_0x0029:
            ...
            f13577b = r0     // Catch:{ Exception -> 0x0047 }
