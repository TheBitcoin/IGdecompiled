...
public final class ad extends l {
    ...
    public static java.lang.String b(java.io.File r4) {
        /*
            ...
            return r0
        L_0x0004:
            java.io.BufferedReader r1 = new java.io.BufferedReader     // Catch:{ IOException -> 0x003e, all -> 0x003c }
            java.io.FileReader r2 = new java.io.FileReader     // Catch:{ IOException -> 0x003e, all -> 0x003c }
            r2.<init>(r4)     // Catch:{ IOException -> 0x003e, all -> 0x003c }
            r1.<init>(r2)     // Catch:{ IOException -> 0x003e, all -> 0x003c }
            java.lang.StringBuffer r4 = new java.lang.StringBuffer     // Catch:{ IOException -> 0x0039 }
        ...
        try {
            ...
            Collections.sort(c5, new Comparator<File>() {
                public final /* synthetic */ int compare(Object obj, Object obj2) {
                    int i4 = ((((File) obj).lastModified() - ((File) obj2).lastModified()) > 0 ? 1 : ((((File) obj).lastModified() - ((File) obj2).lastModified()) == 0 ? 0 : -1));
                    if (i4 > 0) {
                        return 1;
                    }
                    if (i4 == 0) {
    ...
    public static void a(long j4) {
        try {
            ...
            while (i4 < size) {
                ...
                i4++;
                File file2 = file;
                if (file2.lastModified() < j4 && file2.exists() && file2.isFile()) {
                    file2.delete();
                }
            }
        } catch (Throwable th) {
    ...
    static /* synthetic */ void a(String str, int i4) {
        try {
            if (e(new File(str)) > ((long) (i4 * 1048576))) {
                e(str);
            }
        } catch (Exception e5) {
            e5.printStackTrace();
