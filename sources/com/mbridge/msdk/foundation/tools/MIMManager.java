...
public final class MIMManager {
    ...
    private static volatile String f13493a;
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public final AtomicBoolean f13494b;
    ...
    public CopyOnWriteArrayList<CampaignEx> f13496d;
    ...
    private CampaignEx f13499g;
    /* access modifiers changed from: private */

    /* renamed from: h  reason: collision with root package name */
    public volatile b f13500h;

    /* renamed from: i  reason: collision with root package name */
    private volatile MiOverseaMiniCardBroadcasterReceiver f13501i;
    ...
    public static class MiOverseaMiniCardBroadcasterReceiver extends BroadcastReceiver {
        public void onReceive(Context context, Intent intent) {
            ...
            if (z.a("DFKwWgtuDkKwLZPwD+z8H+N/xjK+n3eyNVx6ZVPn5jcincKZx5f5ncN=").equals(intent.getAction())) {
                ...
                if (intExtra < 0) {
                    i4 = intent.getIntExtra("reason", 0);
                } else {
                    i4 = -1;
                }
                af.b("MIMManager", stringExtra + " " + intExtra + " " + i4);
                if (intExtra == 1 || intExtra == 2 || intExtra == 3 || intExtra == 4 || intExtra == 7) {
                    try {
                        c cVar = new c();
                        e eVar = new e();
                        eVar.a(LeanbackPreferenceDialogFragment.ARG_KEY, URLEncoder.encode("m_mini_card", "utf-8"));
                        CampaignEx a5 = a.f13518a.a(stringExtra);
                        if (a5 != null) {
                            ...
                            eVar.a("u_stid", com.mbridge.msdk.foundation.controller.a.f12767b.get(a5.getCampaignUnitId()));
                            cVar.a(a5);
                        }
                        eVar.a(NotificationCompat.CATEGORY_EVENT, String.valueOf(intExtra));
                        eVar.a("pkg_name", stringExtra);
                        if (i4 != -1) {
                            eVar.a("reasonCode", String.valueOf(i4));
                        }
    ...
    private static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final MIMManager f13518a = new MIMManager();
    }
    ...
    private static class b extends BroadcastReceiver {
        ...
        public final void onReceive(android.content.Context r9, android.content.Intent r10) {
            ...
            L_0x003c:
                ...
                goto L_0x00b5
            L_0x0054:
                com.mbridge.msdk.foundation.tools.MIMManager r0 = com.mbridge.msdk.foundation.tools.MIMManager.a.f13518a     // Catch:{ Exception -> 0x0078 }
            ...
            L_0x0090:
                com.mbridge.msdk.foundation.tools.MIMManager r3 = com.mbridge.msdk.foundation.tools.MIMManager.a.f13518a     // Catch:{ Exception -> 0x0078 }
                java.lang.String r5 = "dm_page_status"
                com.mbridge.msdk.foundation.tools.MIMManager r10 = com.mbridge.msdk.foundation.tools.MIMManager.a.f13518a     // Catch:{ Exception -> 0x0078 }
                ...
                if (c5.getContentResolver() != null) {
                    ...
                    if (cursor != null) {
                        while (cursor.moveToNext()) {
                            ...
                            try {
                                f13493a = cursor.getString(cursor.getColumnIndex("detailStyle"));
                            } catch (Exception e6) {
    ...
    public final void f() {
        /*
            ...
            android.content.Context r0 = r4.f13497e
            java.lang.String r1 = "MIMManager"
            r2 = 0
            if (r0 == 0) goto L_0x0054
            com.mbridge.msdk.foundation.tools.MIMManager$b r3 = r4.f13500h     // Catch:{ Exception -> 0x001b }
        ...
        L_0x001b:
            ...
            goto L_0x0036
        L_0x001d:
            com.mbridge.msdk.foundation.tools.MIMManager$MiOverseaMiniCardBroadcasterReceiver r3 = r4.f13501i     // Catch:{ Exception -> 0x001b }
            if (r3 == 0) goto L_0x0026
            com.mbridge.msdk.foundation.tools.MIMManager$MiOverseaMiniCardBroadcasterReceiver r3 = r4.f13501i     // Catch:{ Exception -> 0x001b }
            r0.unregisterReceiver(r3)     // Catch:{ Exception -> 0x001b }
        L_0x0026:
            r4.f13499g = r2
            java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.foundation.entity.CampaignEx> r0 = r4.f13496d
        ...
        L_0x0044:
            r4.f13499g = r2
            java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.foundation.entity.CampaignEx> r1 = r4.f13496d
        ...
        L_0x004d:
            ...
            throw r0
        L_0x0054:
            com.mbridge.msdk.foundation.tools.MIMManager$MiOverseaMiniCardBroadcasterReceiver r0 = r4.f13501i     // Catch:{ Exception -> 0x006a }
            if (r0 == 0) goto L_0x0089
            ...
            com.mbridge.msdk.foundation.tools.MIMManager$MiOverseaMiniCardBroadcasterReceiver r3 = r4.f13501i     // Catch:{ Exception -> 0x006a }
        ...
        L_0x006a:
            ...
            goto L_0x007a
        L_0x006c:
            r4.f13499g = r2     // Catch:{ Exception -> 0x006a }
            java.util.concurrent.CopyOnWriteArrayList<com.mbridge.msdk.foundation.entity.CampaignEx> r0 = r4.f13496d     // Catch:{ Exception -> 0x006a }
            if (r0 == 0) goto L_0x0075
            r0.clear()     // Catch:{ Exception -> 0x006a }
        L_0x0075:
            r4.f13496d = r2     // Catch:{ Exception -> 0x006a }
            r4.f13501i = r2     // Catch:{ Exception -> 0x006a }
            goto L_0x0089
        L_0x007a:
    ...
    private MIMManager() {
        this.f13495c = 0;
        this.f13496d = new CopyOnWriteArrayList<>();
        this.f13494b = new AtomicBoolean(false);
    }
    ...
    public final String c() {
        try {
            ...
            return String.format("[%s]", new Object[]{f13493a});
        } catch (Exception unused) {
            return "";
        }
    }
    ...
    public final void b(CampaignEx campaignEx) {
        try {
            if (this.f13498f != null && campaignEx != null && this.f13498f.booleanValue()) {
                this.f13499g = null;
                try {
                    this.f13496d.remove(campaignEx);
                } catch (Exception e5) {
                    af.a("MIMManager", e5.getMessage());
                }
            }
    ...
    public CampaignEx a(String str) {
        try {
            CampaignEx campaignEx = this.f13499g;
            if (campaignEx != null && TextUtils.equals(campaignEx.getPackageName(), str)) {
                return this.f13499g;
            }
            CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = this.f13496d;
            if (copyOnWriteArrayList == null || copyOnWriteArrayList.size() <= 0) {
                return null;
            }
            Iterator<CampaignEx> it = this.f13496d.iterator();
            while (it.hasNext()) {
    ...
    public final void a(final Context context) {
        ...
        com.mbridge.msdk.foundation.same.f.a.b().execute(new Runnable() {
            public final void run() {
                if (MIMManager.this.f13494b.compareAndSet(false, true)) {
                    try {
                        MIMManager mIMManager = MIMManager.this;
                        Boolean unused = mIMManager.f13498f = mIMManager.g();
                    } catch (Exception e5) {
                        af.a("MIMManager", e5.getMessage());
                    }
                    if (MIMManager.this.f13498f != null && MIMManager.this.f13498f.booleanValue() && context != null) {
                        try {
                            b unused2 = MIMManager.this.f13500h = new b();
                            ...
                            context.registerReceiver(MIMManager.this.f13500h, intentFilter);
                        } catch (Exception e6) {
                            af.a("MIMManager", e6.getMessage());
                        }
                    }
