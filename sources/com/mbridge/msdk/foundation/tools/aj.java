...
public final class aj extends m {
    ...
    public static char[] f13584a = {'a', 'n', 'd', 'r', 'o', 'i', 'd', 'c', 'o', 'n', 't', 'e', 'n', 't', 'p', 'm', 'g', 'e', 't', 'C', 'o', 'n', 't', 'e', 'x', 't'};

    /* renamed from: b  reason: collision with root package name */
    public static boolean f13585b = false;

    /* renamed from: c  reason: collision with root package name */
    public static LinearLayout f13586c;
    ...
    public static void a(Campaign campaign, ViewGroup viewGroup) {
        if (campaign != null) {
            ...
            try {
                LinearLayout linearLayout = f13586c;
            ...
            try {
                if (f13586c == null) {
                    ...
                    if (c5 instanceof Activity) {
                        f13586c = (LinearLayout) LayoutInflater.from(c5.getApplicationContext()).inflate(x.a(c5.getApplicationContext(), "mbridge_cm_loading_layout", TtmlNode.TAG_LAYOUT), (ViewGroup) null);
                    } else {
                        f13586c = (LinearLayout) LayoutInflater.from(c5).inflate(x.a(c5, "mbridge_cm_loading_layout", TtmlNode.TAG_LAYOUT), (ViewGroup) null);
                    }
                }
                ...
                if (viewGroup instanceof FrameLayout) {
                    ...
                    at.a(f13586c);
                    viewGroup.addView(f13586c, layoutParams);
                    return;
                }
                ...
                at.a(f13586c);
                viewGroup.addView(f13586c, layoutParams2);
            } catch (Exception e5) {
                e5.printStackTrace();
            }
        }
