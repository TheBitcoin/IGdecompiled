...
public class CronetDownloadCallback extends UrlRequest.Callback {
    ...
    private void insertDownloadInfo(String str, String str2) {
        ...
        if (downloadModel2 == null) {
            ...
            i4 = downloadModel2.getUsageCounter();
        }
        String str4 = str;
        String str5 = str2;
        databaseHelper2.updateProgress(str4, str5, DownloadModel.create(str4, downloadUrl, resourceUrl, str3, str5, saveFileName, totalBytes, downloadedBytes, downloadRate, i4, this.downloadMessage.getDownloadResourceType()));
        if (!this.downloadResponse.isCancelled()) {
            this.downloadResponse.setSuccessful(true);
        }
    }

    private boolean isSuccessful(int i4) {
        return i4 >= 200 && i4 < 300;
    }

    private boolean isSupportResume(int i4, DownloadModel downloadModel2) {
        if (i4 != 206 || TextUtils.isEmpty(this.etag)) {
            return false;
        }
    ...
    private void sendProgress(DownloadRequest downloadRequest2, DownloadMessage downloadMessage2, long j4, long j5, int i4) {
        if (downloadRequest2.getStatus() != DownloadStatus.CANCELLED) {
            downloadRequest2.handlerProcessEvent(downloadMessage2, new DownloadProgress(j4, j5, i4));
        }
    }
