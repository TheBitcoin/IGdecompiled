...
public class DownloadMessage<T> {
    ...
    public DownloadMessage(T t4, String str, String str2, int i4, DownloadResourceType downloadResourceType2) {
        this.object = t4;
    ...
    public void setMd5VerifyResult(int i4) {
        this.md5VerifyResult = i4;
    }
    ...
    public void setUseCronetDownload(int i4) {
        boolean z4 = true;
        if (!(i4 == 1 || i4 == 2)) {
            z4 = false;
        }
