...
public final class a {
    ...
    public static volatile Boolean f14125a;

    /* renamed from: b  reason: collision with root package name */
    private static volatile Handler f14126b;

    /* renamed from: c  reason: collision with root package name */
    private static Boolean f14127c;
    ...
    public static boolean a(final Context context) {
        ...
        if (gVar != null) {
            f14127c = Boolean.valueOf(gVar.aF());
        } else {
            f14127c = Boolean.FALSE;
        }
        Boolean bool = f14127c;
        ...
        if (Looper.getMainLooper() == Looper.myLooper()) {
            if (f14125a == null) {
                try {
                    f14125a = Boolean.valueOf(b(context));
                } catch (Exception unused2) {
                    f14125a = Boolean.FALSE;
                }
            }
            if (f14125a == null) {
                f14125a = new Boolean(false);
            }
            return f14125a.booleanValue();
        }
        if (f14125a == null && f14126b == null) {
            f14126b = new Handler(Looper.getMainLooper());
            f14126b.post(new Runnable() {
                public final void run() {
                    if (a.f14125a == null) {
                        try {
                            Boolean unused = a.f14125a = Boolean.valueOf(a.b(context));
                        } catch (Exception unused2) {
                            Boolean unused3 = a.f14125a = Boolean.FALSE;
                        }
                    }
                }
            });
