...
public final class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f14102a = new CopyOnWriteArrayList<>();

    public final void a(WebChromeClient webChromeClient) {
        this.f14102a.add(webChromeClient);
    }

    public final void b(WebChromeClient webChromeClient) {
        this.f14102a.remove(webChromeClient);
    }
    ...
    public final void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f14102a.iterator();
        while (it.hasNext()) {
    ...
    public final void onConsoleMessage(String str, int i4, String str2) {
        Iterator<WebChromeClient> it = this.f14102a.iterator();
        while (it.hasNext()) {
            it.next().onConsoleMessage(str, i4, str2);
        }
    }
    ...
    public final void onExceededDatabaseQuota(String str, String str2, long j4, long j5, long j6, WebStorage.QuotaUpdater quotaUpdater) {
        Iterator<WebChromeClient> it = this.f14102a.iterator();
        while (it.hasNext()) {
            it.next().onExceededDatabaseQuota(str, str2, j4, j5, j6, quotaUpdater);
        }
    }
    ...
    public final void onProgressChanged(WebView webView, int i4) {
        Iterator<WebChromeClient> it = this.f14102a.iterator();
        while (it.hasNext()) {
            it.next().onProgressChanged(webView, i4);
        }
    }
    ...
    public final void onReachedMaxAppCacheSize(long j4, long j5, WebStorage.QuotaUpdater quotaUpdater) {
        Iterator<WebChromeClient> it = this.f14102a.iterator();
        while (it.hasNext()) {
            it.next().onReachedMaxAppCacheSize(j4, j5, quotaUpdater);
        }
    }
    ...
    public final void onShowCustomView(View view, int i4, WebChromeClient.CustomViewCallback customViewCallback) {
        Iterator<WebChromeClient> it = this.f14102a.iterator();
        while (it.hasNext()) {
            it.next().onShowCustomView(view, i4, customViewCallback);
        }
    }
}
