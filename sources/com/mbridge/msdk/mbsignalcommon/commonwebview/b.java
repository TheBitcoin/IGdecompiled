...
public final class b extends WebViewClient {
    ...
    private CopyOnWriteArrayList<WebViewClient> f14103a = new CopyOnWriteArrayList<>();

    public final void a(WebViewClient webViewClient) {
        this.f14103a.add(webViewClient);
    }

    public final void b(WebViewClient webViewClient) {
        this.f14103a.remove(webViewClient);
    }

    public final void doUpdateVisitedHistory(WebView webView, String str, boolean z4) {
        Iterator<WebViewClient> it = this.f14103a.iterator();
        while (it.hasNext()) {
    ...
    public final void onReceivedError(WebView webView, int i4, String str, String str2) {
        Iterator<WebViewClient> it = this.f14103a.iterator();
        while (it.hasNext()) {
            it.next().onReceivedError(webView, i4, str, str2);
        }
    }
    ...
    public final void onSafeBrowsingHit(WebView webView, WebResourceRequest webResourceRequest, int i4, SafeBrowsingResponse safeBrowsingResponse) {
        try {
            if (Build.VERSION.SDK_INT >= 27) {
                Iterator<WebViewClient> it = this.f14103a.iterator();
                while (it.hasNext()) {
                    it.next().onSafeBrowsingHit(webView, webResourceRequest, i4, safeBrowsingResponse);
                }
            }
        } catch (Exception e5) {
            af.b("CommonWebViewClient", e5.getMessage());
    ...
    public final void onScaleChanged(WebView webView, float f4, float f5) {
        Iterator<WebViewClient> it = this.f14103a.iterator();
        while (it.hasNext()) {
            it.next().onScaleChanged(webView, f4, f5);
        }
    }
