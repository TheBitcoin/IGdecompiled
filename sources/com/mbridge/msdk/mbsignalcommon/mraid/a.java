...
public final class a {
    ...
    public static a a() {
        return C0190a.f14114a;
    }

    public final void b(WebView webView, float f4, float f5) {
        c(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setScreenSize(%.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5)}));
    }

    public final void c(WebView webView, float f4, float f5) {
        c(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setMaxSize(%.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5)}));
    }
    ...
    public final void b(WebView webView, float f4, float f5, float f6, float f7) {
        c(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setCurrentPosition(%.1f, %.1f, %.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5), Float.valueOf(f6), Float.valueOf(f7)}));
    }
    ...
    public final void a(WebView webView, float f4, float f5) {
        c(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.notifySizeChangeEvent(%.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5)}));
    }
    ...
    public final void a(WebView webView, float f4, float f5, float f6, float f7) {
        c(webView, String.format(Locale.CHINA, "javascript:window.mraidbridge.setDefaultPosition(%.1f, %.1f, %.1f, %.1f);", new Object[]{Float.valueOf(f4), Float.valueOf(f5), Float.valueOf(f6), Float.valueOf(f7)}));
    }
