...
public class BaseWebView extends WebView {
    ...
    protected Context f14032a;
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public View.OnTouchListener f14033b;

    /* renamed from: c  reason: collision with root package name */
    private View.OnTouchListener f14034c = new View.OnTouchListener() {
        public final boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0) {
                BaseWebView.this.lastTouchTime = System.currentTimeMillis();
            }
            if (BaseWebView.this.f14033b != null) {
                return BaseWebView.this.f14033b.onTouch(view, motionEvent);
            }
            return false;
        }
    };
    ...
    public void setFilter(a aVar) {
        ...
        if (bVar != null && l.a(bVar)) {
            this.mWebViewClient.a(aVar);
        }
    }

    public void setOnTouchListener(View.OnTouchListener onTouchListener) {
        this.f14033b = onTouchListener;
    }
    ...
    public void a() {
        ...
        settings.setDatabaseEnabled(true);
        String path = this.f14032a.getDir("database", 0).getPath();
        ...
        super.setOnTouchListener(this.f14034c);
    }
