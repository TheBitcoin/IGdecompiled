...
public class j {
    ...
    public static final String f11962a = "j";

    private String b() {
        String str = d.f().f13328r ? d.f().f13292H : d.f().f13291G;
        try {
            if (d.f().f13328r && d.f().f13327q && d.f().f13332v < d.f().f13333w.size()) {
                String str2 = d.f().f13333w.get(d.f().f13332v);
        ...
        if (!d.f().a()) {
            try {
                if (!d.f().f13327q) {
                    ...
                    if (System.currentTimeMillis() >= a.a().b("mkey_spare_host_ts").longValue() + 86400000) {
                        ...
                        if (!TextUtils.isEmpty(a5)) {
                            for (String str3 : a5.split("\n")) {
                                if (!TextUtils.isEmpty(str3.trim()) && !d.f().f13330t.contains(str3.trim())) {
                                    d.f().f13330t.add(str3.trim());
                                    d.f().f13333w.add(str3.trim());
                                }
                            }
                            c(context, str, str2);
                            return;
                    ...
                    new c(context.getApplicationContext()).get(0, d.f().f13312b, new e(), (b) new com.mbridge.msdk.foundation.same.net.b.a() {
                        ...
                        public final void b(String str) {
                            af.a(j.f11962a, "fetch CNDSettingHost success, content = " + str);
                            if (!TextUtils.isEmpty(str)) {
                                a.a().a("mkey_spare_host_ts", System.currentTimeMillis());
                                a.a().a("mkey_spare_host", str);
                                for (String str2 : str.split("\n")) {
                                    if (!TextUtils.isEmpty(str2.trim()) && !d.f().f13330t.contains(str2.trim())) {
                                        d.f().f13330t.add(str2.trim());
                                        d.f().f13333w.add(str2.trim());
                                    }
                                }
    ...
    private void a(Context context, String str, String str2, String str3, com.mbridge.msdk.foundation.same.net.f.d dVar) {
        if (context != null) {
            ...
            if (d.f().f13327q) {
                eVar.a("st_net", d.f().f13329s + "");
            }
            eVar.a("only_p_info", str3);
            com.mbridge.msdk.c.a.c cVar = new com.mbridge.msdk.c.a.c(context);
            String str4 = d.f().f13291G;
            try {
                if (d.f().f13328r && d.f().f13327q && d.f().f13332v < d.f().f13333w.size()) {
                    String str5 = d.f().f13333w.get(d.f().f13332v);
        ...
        if (context != null) {
            a(context, str, str2, "0", new com.mbridge.msdk.foundation.same.net.f.d() {
                        ...
                        if (ak.a(jSONObject)) {
                            if (jSONObject.optInt("vtag_status", 0) == 1) {
                                ...
                                if (!TextUtils.isEmpty(g4)) {
                                    try {
                                        jSONObject = h.a().a(new JSONObject(g4), jSONObject);
                                    } catch (Exception e5) {
                                        af.b(j.f11962a, e5.getMessage());
                                    }
                                }
                            ...
                            if (d.f().f13328r) {
                                if (TextUtils.isEmpty(jSONObject.optString("hst_st_t"))) {
                                    jSONObject.put("hst_st_t", d.f().f13322l);
                                }
                            } else if (TextUtils.isEmpty(jSONObject.optString("hst_st"))) {
                                jSONObject.put("hst_st", d.f().f13318h);
                            }
                ...
                public final void a(String str) {
                    ...
                    j.this.c(context, str, str2);
                    j.a(j.this);
                    af.b(j.f11962a, "get app setting error" + str);
                }
            });
            a(3, 0, "");
        }
    ...
    public final void a(Context context, final String str, String str2, final String str3) {
        ...
        if (h.a().e(str3, str) && h.a().a(str, 2, str3)) {
            ...
            r6.setUnitId(str3);
            new com.mbridge.msdk.c.a.c(context).get(1, d.f().f13291G, eVar, (b) r6, "setting", (long) ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            a(3, 1, "");
        }
    }
    ...
    public void a(int i4, int i5, String str) {
        ...
        try {
            ...
            eVar.a(LeanbackPreferenceDialogFragment.ARG_KEY, "2000112");
            eVar.a("st_net", Integer.valueOf(d.f().f13329s));
            eVar.a("result", Integer.valueOf(i4));
            eVar.a("type", Integer.valueOf(i5));
            if (i5 == 0) {
                str2 = b();
            } else {
                str2 = d.f().f13328r ? d.f().f13292H : d.f().f13291G;
            }
            eVar.a("url", str2);
            eVar.a("reason", str);
            cVar.a("2000112", eVar);
