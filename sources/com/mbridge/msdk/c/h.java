...
public class h {
    ...
    public static final String f11958a = "h";

    /* renamed from: b  reason: collision with root package name */
    private static volatile h f11959b;

    /* renamed from: c  reason: collision with root package name */
    private static volatile g f11960c;

    /* renamed from: d  reason: collision with root package name */
    private static HashMap<String, k> f11961d = new HashMap<>();
                ...
                try {
                    for (String next : map.keySet()) {
                        if (next.startsWith(str + "_")) {
                            f11961d.put(next, k.g((String) map.get(next)));
                        }
                    }
                } catch (Exception e5) {
                    e5.printStackTrace();
            ...
            try {
                ...
                for (String next2 : all.keySet()) {
                    if (next2.startsWith(str + "_")) {
                        f11961d.put(next2, k.g((String) all.get(next2)));
                    }
                }
            } catch (Exception e6) {
                e6.printStackTrace();
    ...
    private k i(String str, String str2) {
        ...
        if (f11961d.containsKey(str3)) {
            return f11961d.get(str3);
        }
        k kVar = null;
        try {
            kVar = k.g(a.a().a(str3));
            f11961d.put(str3, kVar);
            return kVar;
        } catch (Exception e5) {
            e5.printStackTrace();
            return kVar;
        ...
        if (f11960c == null) {
            try {
                ...
                if (!TextUtils.isEmpty(a5)) {
                    ...
                    f11960c = g.e(jSONObject.toString());
                    if (f11960c != null) {
                        f11960c.aL();
                    }
                }
    ...
    public final boolean e(String str, String str2) {
        ...
        if (!(b5 == null || d5 == null)) {
            ...
            long i4 = d5.i() + (b5.at() * 1000);
            if (i4 > currentTimeMillis) {
                String str3 = f11958a;
                af.c(str3, "unit setting  nexttime is not ready  [settingNextRequestTime= " + i4 + " currentTime = " + currentTimeMillis + "]");
                return false;
            }
        }
        af.c(f11958a, "unit setting timeout or not exists");
        return true;
    }
    ...
    public final boolean d(String str) {
        ...
        af.c(f11958a, "app setting timeout or not exists");
        return true;
    }
    ...
    public final boolean a(String str, int i4, String str2) {
        try {
            ...
            if (j4 + (b5.ao() * 1000) > currentTimeMillis) {
                return false;
            }
    ...
    public final void a(String str, String str2, String str3) {
        ...
        a.a().a(str4, str3);
        f11961d.put(str4, k.g(str3));
    }

    public final k a(String str, String str2) {
        k i4 = i(str, str2);
        return i4 == null ? k.y() : i4;
    }
}
