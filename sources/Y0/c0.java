...
public abstract class c0 {
    ...
    private static final ExecutorService f22630a = F.c("awaitEvenIfOnMainThread task continuation executor");

    public static Object b(C0937l lVar) {
        CountDownLatch countDownLatch = new CountDownLatch(1);
        lVar.g(f22630a, new b0(countDownLatch));
