...
public final class ProfileVerifier {
    ...
    static class Cache {
        ...
        Cache(int i4, int i5, long j4, long j5) {
            this.mSchema = i4;
            this.mResultCode = i5;
            this.mPackageLastUpdateTime = j4;
            this.mInstalledCurrentProfileSize = j5;
        }
    ...
    public static class CompilationStatus {
        ...
        CompilationStatus(int i4, boolean z4, boolean z5, boolean z6) {
            this.mResultCode = i4;
    ...
    @NonNull
    public static C2172d getCompilationStatusAsync() {
        return sFuture;
    }
    ...
    private static CompilationStatus setCompilationStatus(int i4, boolean z4, boolean z5, boolean z6) {
        CompilationStatus compilationStatus = new CompilationStatus(i4, z4, z5, z6);
                    ...
                    try {
                        ...
                        if (cache != null && cache.mPackageLastUpdateTime == packageLastUpdateTime) {
                            ...
                            if (i7 != 2) {
                                ...
                                i4 = (cache != null || cache.mResultCode == 2 || i5 != 1 || length >= cache.mInstalledCurrentProfileSize) ? i5 : 3;
                                cache2 = new Cache(1, i4, packageLastUpdateTime, length2);
                                if (cache == null || !cache.equals(cache2)) {
                                    cache2.writeOnFile(file3);
                                }
                                CompilationStatus compilationStatus3 = setCompilationStatus(i4, z6, z7, z5);
                        ...
                        i5 = 2;
                        if (cache != null && cache.mResultCode == 2) {
                        }
                        cache2 = new Cache(1, i4, packageLastUpdateTime, length2);
                        try {
                            cache2.writeOnFile(file3);
                        ...
                        CompilationStatus compilationStatus32 = setCompilationStatus(i4, z6, z7, z5);
