...
public class ProfileInstaller {
    ...
    private static final DiagnosticsCallback EMPTY_DIAGNOSTICS = new DiagnosticsCallback() {
        public void onDiagnosticReceived(int i4, @Nullable Object obj) {
        }

        public void onResultReceived(int i4, @Nullable Object obj) {
        }
    };
    @NonNull
    ...
    public interface DiagnosticsCallback {
        void onDiagnosticReceived(int i4, @Nullable Object obj);

        void onResultReceived(int i4, @Nullable Object obj);
    }
    ...
    static void diagnostic(@NonNull Executor executor, @NonNull DiagnosticsCallback diagnosticsCallback, int i4, @Nullable Object obj) {
        executor.execute(new d(diagnosticsCallback, i4, obj));
    }
    ...
    static void result(@NonNull Executor executor, @NonNull DiagnosticsCallback diagnosticsCallback, int i4, @Nullable Object obj) {
        executor.execute(new c(diagnosticsCallback, i4, obj));
    }
    ...
    public static void writeProfile(@NonNull Context context) {
        writeProfile(context, new h(), EMPTY_DIAGNOSTICS);
    }
