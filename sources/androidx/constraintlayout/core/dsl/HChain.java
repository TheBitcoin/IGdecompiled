...
public class HChain extends Chain {
    ...
    public void linkToEnd(Constraint.HAnchor hAnchor, int i4) {
        linkToEnd(hAnchor, i4, Integer.MIN_VALUE);
    }

    public void linkToLeft(Constraint.HAnchor hAnchor, int i4) {
        linkToLeft(hAnchor, i4, Integer.MIN_VALUE);
    }

    public void linkToRight(Constraint.HAnchor hAnchor, int i4) {
        linkToRight(hAnchor, i4, Integer.MIN_VALUE);
    }

    public void linkToStart(Constraint.HAnchor hAnchor, int i4) {
        linkToStart(hAnchor, i4, Integer.MIN_VALUE);
    }

    public void linkToEnd(Constraint.HAnchor hAnchor, int i4, int i5) {
    ...
    public void linkToLeft(Constraint.HAnchor hAnchor, int i4, int i5) {
    ...
    public void linkToRight(Constraint.HAnchor hAnchor, int i4, int i5) {
    ...
    public void linkToStart(Constraint.HAnchor hAnchor, int i4, int i5) {
