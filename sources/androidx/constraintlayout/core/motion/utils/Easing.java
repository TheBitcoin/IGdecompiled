...
public class Easing {
    ...
    static class CubicEasing extends Easing {
        ...
        CubicEasing(String str) {
            ...
            this.mY1 = Double.parseDouble(str.substring(i4, indexOf3).trim());
            int i5 = indexOf3 + 1;
            int indexOf4 = str.indexOf(44, i5);
            this.mX2 = Double.parseDouble(str.substring(i5, indexOf4).trim());
            int i6 = indexOf4 + 1;
            this.mY2 = Double.parseDouble(str.substring(i6, str.indexOf(41, i6)).trim());
        }
