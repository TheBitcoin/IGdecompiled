    ...
    public void setInterpolatedValue(MotionWidget motionWidget, float[] fArr) {
        ...
        switch (i4) {
            ...
            case TypedValues.Custom.TYPE_BOOLEAN /*904*/:
                ...
                motionWidget.setCustomAttribute(str, i4, z4);
                return;
            default:
                return;
        }
    ...
    public void setValue(float[] fArr) {
        ...
        switch (this.mType) {
            ...
            case TypedValues.Custom.TYPE_COLOR /*902*/:
                ...
                float f5 = fArr[1];
                float f6 = fArr[2];
                this.mIntegerValue = ((Math.round(fArr[3] * 255.0f) & 255) << 24) | ((Math.round(((float) Math.pow((double) f4, 0.5d)) * 255.0f) & 255) << 16) | ((Math.round(((float) Math.pow((double) f5, 0.5d)) * 255.0f) & 255) << 8) | (Math.round(((float) Math.pow((double) f6, 0.5d)) * 255.0f) & 255);
                return;
            case TypedValues.Custom.TYPE_STRING /*903*/:
                throw new RuntimeException("Cannot interpolate String");
            case TypedValues.Custom.TYPE_BOOLEAN /*904*/:
