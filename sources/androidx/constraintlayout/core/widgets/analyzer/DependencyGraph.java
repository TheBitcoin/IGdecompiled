...
public class DependencyGraph {
            ...
            if (widgetRun != constraintWidgetContainer.mHorizontalRun && widgetRun != constraintWidgetContainer.mVerticalRun) {
                ...
                for (Dependency next : widgetRun.start.mDependencies) {
                    if (next instanceof DependencyNode) {
                        ...
                        applyGroup((DependencyNode) next, i6, 0, dependencyNode3, arrayList2, runGroup2);
                    } else {
                        i6 = i4;
                        dependencyNode3 = dependencyNode2;
                        arrayList2 = arrayList;
                ...
                for (Dependency next2 : widgetRun.end.mDependencies) {
                    if (next2 instanceof DependencyNode) {
                        applyGroup((DependencyNode) next2, i7, 1, dependencyNode4, arrayList3, runGroup2);
                    }
                }
                if (i7 == 1 && (widgetRun instanceof VerticalWidgetRun)) {
                    for (Dependency next3 : ((VerticalWidgetRun) widgetRun).baseline.mDependencies) {
                        if (next3 instanceof DependencyNode) {
                            applyGroup((DependencyNode) next3, i7, 2, dependencyNode4, arrayList3, runGroup2);
                        }
                    }
                }
                for (DependencyNode next4 : widgetRun.start.mTargets) {
                    ...
                    applyGroup(next4, i7, 0, dependencyNode4, arrayList3, runGroup2);
                }
                for (DependencyNode next5 : widgetRun.end.mTargets) {
                    if (next5 == dependencyNode4) {
                        runGroup2.dual = true;
                    }
                    applyGroup(next5, i7, 1, dependencyNode4, arrayList3, runGroup2);
                }
                if (i7 == 1 && (widgetRun instanceof VerticalWidgetRun)) {
                    for (DependencyNode applyGroup : ((VerticalWidgetRun) widgetRun).baseline.mTargets) {
                        try {
                            applyGroup(applyGroup, i7, 2, dependencyNode4, arrayList3, runGroup2);
                        } catch (Throwable th) {
                            throw th;
                        }
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:125:0x0283, code lost:
        r3 = r0.mListDimensionBehaviors;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean basicMeasureWidgets(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r21) {
        /*
            r20 = this;
            r0 = r21
        ...
        L_0x0058:
            r7.mMatchConstraintDefaultWidth = r11
            goto L_0x0078
        L_0x005b:
        ...
        L_0x0065:
            r7.mMatchConstraintDefaultHeight = r11
            goto L_0x0078
        L_0x0068:
        ...
        L_0x0078:
            ...
            int r10 = r7.mMatchConstraintDefaultWidth
            if (r10 != r12) goto L_0x008e
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r7.mLeft
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r10.mTarget
            if (r10 == 0) goto L_0x008c
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r7.mRight
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r10.mTarget
        ...
        L_0x008e:
            ...
            int r10 = r7.mMatchConstraintDefaultHeight
            if (r10 != r12) goto L_0x00a2
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r7.mTop
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r10.mTarget
            if (r10 == 0) goto L_0x00a0
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r7.mBottom
            androidx.constraintlayout.core.widgets.ConstraintAnchor r10 = r10.mTarget
        ...
        L_0x00a2:
            r10 = r5
            androidx.constraintlayout.core.widgets.analyzer.HorizontalWidgetRun r5 = r7.mHorizontalRun
            r5.mDimensionBehavior = r6
            int r14 = r7.mMatchConstraintDefaultWidth
            r5.matchConstraintsType = r14
            androidx.constraintlayout.core.widgets.analyzer.VerticalWidgetRun r5 = r7.mVerticalRun
            r5.mDimensionBehavior = r10
            int r15 = r7.mMatchConstraintDefaultHeight
            r5.matchConstraintsType = r15
        ...
        L_0x02e7:
            ...
            int r3 = r0.getWidth()
            androidx.constraintlayout.core.widgets.ConstraintAnchor r6 = r7.mLeft
            int r6 = r6.mMargin
            int r3 = r3 - r6
            androidx.constraintlayout.core.widgets.ConstraintAnchor r6 = r7.mRight
            int r6 = r6.mMargin
            int r3 = r3 - r6
    ...
    private void findGroup(WidgetRun widgetRun, int i4, ArrayList<RunGroup> arrayList) {
        ...
        for (Dependency next : widgetRun2.start.mDependencies) {
            if (next instanceof DependencyNode) {
                applyGroup((DependencyNode) next, i4, 0, widgetRun2.end, arrayList, (RunGroup) null);
            } else if (next instanceof WidgetRun) {
                applyGroup(((WidgetRun) next).start, i4, 0, widgetRun2.end, arrayList, (RunGroup) null);
            }
        }
        for (Dependency next2 : widgetRun2.end.mDependencies) {
            if (next2 instanceof DependencyNode) {
                applyGroup((DependencyNode) next2, i4, 1, widgetRun2.start, arrayList, (RunGroup) null);
            } else if (next2 instanceof WidgetRun) {
                applyGroup(((WidgetRun) next2).end, i4, 1, widgetRun2.start, arrayList, (RunGroup) null);
            }
        }
        int i5 = i4;
        if (i5 == 1) {
            for (Dependency next3 : ((VerticalWidgetRun) widgetRun2).baseline.mDependencies) {
                if (next3 instanceof DependencyNode) {
                    applyGroup((DependencyNode) next3, i5, 2, (DependencyNode) null, arrayList, (RunGroup) null);
                }
                i5 = i4;
            }
        }
    ...
    public void defineTerminalWidgets(ConstraintWidget.DimensionBehaviour dimensionBehaviour, ConstraintWidget.DimensionBehaviour dimensionBehaviour2) {
        ...
        if (this.mNeedBuildGraph) {
            ...
            if (!z6) {
                ...
                int i5 = 0;
                while (i5 < size2) {
                    RunGroup runGroup = arrayList2.get(i5);
                    i5++;
                    RunGroup runGroup2 = runGroup;
    ...
    public boolean directMeasure(boolean z4) {
        ...
        if (dimensionBehaviour == dimensionBehaviour3 || dimensionBehaviour2 == dimensionBehaviour3) {
            if (z4) {
                ...
                while (true) {
                    ...
                    WidgetRun widgetRun = arrayList2.get(i5);
                    i5++;
        ...
        int i6 = 0;
        while (i6 < size3) {
            WidgetRun widgetRun2 = arrayList3.get(i6);
            i6++;
        ...
        while (true) {
            ...
            WidgetRun widgetRun4 = arrayList4.get(i7);
            i7++;
    ...
    public void buildGraph(ArrayList<WidgetRun> arrayList) {
        ...
        int i5 = 0;
        while (i5 < size) {
            ConstraintWidget constraintWidget = arrayList2.get(i5);
            i5++;
            ConstraintWidget constraintWidget2 = constraintWidget;
        ...
        while (i4 < size3) {
            WidgetRun widgetRun2 = arrayList.get(i4);
            i4++;
            WidgetRun widgetRun3 = widgetRun2;
