...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i4, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z4) {
        ...
        if (!constraintWidget2.isHorizontalSolvingPassDone()) {
            ...
            if (!(constraintWidget2 instanceof ConstraintWidgetContainer) && constraintWidget2.isMeasureRequested()) {
                int i5 = i4 + 1;
                if (canMeasure(i5, constraintWidget2)) {
                    ConstraintWidgetContainer.measure(i5, constraintWidget2, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                }
            }
            ...
            if (anchor.getDependents() != null && anchor.hasFinalValue()) {
                ...
                while (it.hasNext()) {
                    ...
                    int i6 = i4 + 1;
                    boolean canMeasure = canMeasure(i6, constraintWidget3);
                    if (constraintWidget3.isMeasureRequested() && canMeasure) {
                        ConstraintWidgetContainer.measure(i6, constraintWidget3, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                    }
                    ...
                    if (horizontalDimensionBehaviour != dimensionBehaviour || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            ...
                            if (next == constraintAnchor5 && constraintWidget3.mRight.mTarget == null) {
                                ...
                                horizontalSolvingPass(i6, constraintWidget3, measurer2, z7);
                            } else {
                                ...
                                if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                                    ...
                                    solveHorizontalCenterConstraints(i6, measurer2, constraintWidget3, z7);
                                }
                            }
                        }
                    } else if (constraintWidget3.getHorizontalDimensionBehaviour() == dimensionBehaviour && constraintWidget3.mMatchConstraintMaxWidth >= 0 && constraintWidget3.mMatchConstraintMinWidth >= 0 && ((constraintWidget3.getVisibility() == 8 || (constraintWidget3.mMatchConstraintDefaultWidth == 0 && constraintWidget3.getDimensionRatio() == 0.0f)) && !constraintWidget3.isInHorizontalChain() && !constraintWidget3.isInVirtualLayout() && z6 && !constraintWidget3.isInHorizontalChain())) {
                        solveHorizontalMatchConstraint(i6, constraintWidget2, measurer2, constraintWidget3, z7);
                    }
                }
            }
            if (!(constraintWidget2 instanceof Guideline)) {
                if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        int i7 = i4 + 1;
                        boolean canMeasure2 = canMeasure(i7, constraintWidget4);
                        if (constraintWidget4.isMeasureRequested() && canMeasure2) {
                            ConstraintWidgetContainer.measure(i7, constraintWidget4, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                        }
                        ...
                        if (horizontalDimensionBehaviour2 != dimensionBehaviour2 || canMeasure2) {
                            if (!constraintWidget4.isMeasureRequested()) {
                                ...
                                if (next2 == constraintAnchor7 && constraintWidget4.mRight.mTarget == null) {
                                    ...
                                    horizontalSolvingPass(i7, constraintWidget4, measurer2, z7);
                                } else {
                                    ...
                                    if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                                        ...
                                        solveHorizontalCenterConstraints(i7, measurer2, constraintWidget4, z7);
                                    }
                                }
                            }
                            ...
                            if ((constraintWidget4.getVisibility() == 8 || (constraintWidget4.mMatchConstraintDefaultWidth == 0 && constraintWidget4.getDimensionRatio() == 0.0f)) && !constraintWidget4.isInHorizontalChain() && !constraintWidget4.isInVirtualLayout() && z5 && !constraintWidget4.isInHorizontalChain()) {
                                solveHorizontalMatchConstraint(i7, constraintWidget2, measurer2, constraintWidget4, z7);
                            }
                        }
                    }
                }
    ...
    private static void solveHorizontalCenterConstraints(int i4, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget, boolean z4) {
        ...
        if (i5 > 0) {
            f4 = (horizontalBiasPercent * ((float) i5)) + 0.5f;
        } else {
            f4 = horizontalBiasPercent * ((float) i5);
        }
        int i6 = ((int) f4) + finalValue;
        int i7 = i6 + width;
        if (finalValue > finalValue2) {
            i7 = i6 - width;
        }
    ...
    private static void solveHorizontalMatchConstraint(int i4, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2, boolean z4) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            if (constraintWidget2.getVisibility() != 8) {
                ...
                if (i6 == 2) {
                    if (constraintWidget instanceof ConstraintWidgetContainer) {
                        i5 = constraintWidget.getWidth();
                    } else {
                        i5 = constraintWidget.getParent().getWidth();
                    }
                    width = (int) (constraintWidget2.getHorizontalBiasPercent() * 0.5f * ((float) i5));
                } else if (i6 == 0) {
            ...
            int i8 = finalValue + ((int) ((horizontalBiasPercent * ((float) ((finalValue2 - finalValue) - width))) + 0.5f));
    ...
    private static void solveVerticalCenterConstraints(int i4, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget) {
        ...
        if (i5 > 0) {
            f4 = (verticalBiasPercent * ((float) i5)) + 0.5f;
        } else {
            f4 = verticalBiasPercent * ((float) i5);
        }
        int i6 = (int) f4;
    ...
    private static void solveVerticalMatchConstraint(int i4, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, ConstraintWidget constraintWidget2) {
        ...
        if (finalValue2 >= finalValue) {
            ...
            if (constraintWidget2.getVisibility() != 8) {
                ...
                if (i6 == 2) {
                    if (constraintWidget instanceof ConstraintWidgetContainer) {
                        ...
                        i5 = constraintWidget.getParent().getHeight();
                    }
                    height = (int) (verticalBiasPercent * 0.5f * ((float) i5));
                } else if (i6 == 0) {
            ...
            int i8 = finalValue + ((int) ((verticalBiasPercent * ((float) ((finalValue2 - finalValue) - height))) + 0.5f));
                    ...
                    if (verticalDimensionBehaviour != dimensionBehaviour || canMeasure) {
                        if (!constraintWidget3.isMeasureRequested()) {
                            ...
                            if (next == constraintAnchor5 && constraintWidget3.mBottom.mTarget == null) {
                                ...
                                verticalSolvingPass(i6, constraintWidget3, measurer2);
                            } else {
                                ...
                                if (next == constraintAnchor6 && constraintAnchor5.mTarget == null) {
                                    ...
                                    solveVerticalCenterConstraints(i6, measurer2, constraintWidget3);
                                }
                            }
                        }
                        ...
                        solveVerticalMatchConstraint(i6, constraintWidget2, measurer2, constraintWidget3);
                    }
                }
            }
            if (!(constraintWidget2 instanceof Guideline)) {
                        ...
                        if (verticalDimensionBehaviour2 != dimensionBehaviour2 || canMeasure2) {
                            if (!constraintWidget4.isMeasureRequested()) {
                                ...
                                if (next2 == constraintAnchor7 && constraintWidget4.mBottom.mTarget == null) {
                                    ...
                                    verticalSolvingPass(i7, constraintWidget4, measurer2);
                                } else {
                                    ...
                                    if (next2 == constraintAnchor8 && constraintAnchor7.mTarget == null) {
                                        ...
                                        solveVerticalCenterConstraints(i7, measurer2, constraintWidget4);
                                    }
                                }
                            }
                            ...
                            if ((constraintWidget4.getVisibility() == 8 || (constraintWidget4.mMatchConstraintDefaultHeight == 0 && constraintWidget4.getDimensionRatio() == 0.0f)) && !constraintWidget4.isInVerticalChain() && !constraintWidget4.isInVirtualLayout() && z4 && !constraintWidget4.isInVerticalChain()) {
                                solveVerticalMatchConstraint(i7, constraintWidget2, measurer2, constraintWidget4);
                            }
                        }
                    }
                }
                ...
                if (anchor3.getDependents() != null && anchor3.hasFinalValue()) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        int i8 = i4 + 1;
                        boolean canMeasure3 = canMeasure(i8, constraintWidget5);
                        if (constraintWidget5.isMeasureRequested() && canMeasure3) {
                            ConstraintWidgetContainer.measure(i8, constraintWidget5, measurer2, new BasicMeasure.Measure(), BasicMeasure.Measure.SELF_DIMENSIONS);
                        }
                        if ((constraintWidget5.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || canMeasure3) && !constraintWidget5.isMeasureRequested() && next3 == constraintWidget5.mBaseline) {
                            ...
                            verticalSolvingPass(i8, constraintWidget5, measurer2);
                        }
                    }
                }
