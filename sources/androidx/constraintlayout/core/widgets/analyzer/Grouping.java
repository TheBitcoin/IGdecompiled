...
public class Grouping {
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int i4, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        ...
        int i6 = 0;
        if (i5 != -1 && (widgetGroup == null || i5 != widgetGroup.getId())) {
            int i7 = 0;
            while (true) {
        ...
        if (widgetGroup.add(constraintWidget)) {
            if (constraintWidget instanceof Guideline) {
                ...
                anchor.findDependents(i6, arrayList, widgetGroup);
            }
            if (i4 == 0) {
    ...
    public static boolean simpleSolvingPass(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r17, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measurer r18) {
        ...
        L_0x0141:
            ...
            r13 = 0
            r14 = 0
            androidx.constraintlayout.core.widgets.analyzer.WidgetGroup r12 = findDependents(r6, r13, r3, r14)
            r6.addDependents(r3, r13, r12)
            r12.cleanup(r3)
            goto L_0x0141
        L_0x0158:
        ...
        L_0x0205:
            ...
            r14 = 0
            r15 = 1
            androidx.constraintlayout.core.widgets.analyzer.WidgetGroup r7 = findDependents(r6, r15, r3, r14)
        ...
        L_0x032c:
            r13 = 0
            r6.setAuthoritative(r13)
            androidx.constraintlayout.core.LinearSystem r7 = r0.getSystem()
            int r7 = r6.measureWrap((androidx.constraintlayout.core.LinearSystem) r7, (int) r13)
