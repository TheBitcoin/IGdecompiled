...
public abstract class ViewSpline extends SplineSet {
    ...
    public static class CustomSet extends ViewSpline {
        ...
        public void setup(int i4) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                dArr[i5] = ((double) this.mConstraintAttributeList.keyAt(i5)) * 0.01d;
    ...
    public static class PathRotate extends ViewSpline {
        public void setPathRotate(View view, float f4, double d5, double d6) {
            view.setRotation(get(f4) + ((float) Math.toDegrees(Math.atan2(d6, d5))));
        }
    ...
    static class ProgressSet extends ViewSpline {
        ...
        public void setProperty(View view, float f4) {
            ...
            if (view instanceof MotionLayout) {
                ...
                if (method != null) {
                    try {
                        method.invoke(view, new Object[]{Float.valueOf(get(f4))});
