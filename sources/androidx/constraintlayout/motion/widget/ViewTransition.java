...
public class ViewTransition {
    ...
    static class Animate {
        ...
        Animate(ViewTransitionController viewTransitionController, MotionController motionController, int i4, int i5, int i6, Interpolator interpolator, int i7, int i8) {
            float f4;
        ...
        public void mutateForward() {
            ...
            long nanoTime = System.nanoTime();
            this.mLastRender = nanoTime;
            float f4 = this.mPosition + (((float) (((double) (nanoTime - this.mLastRender)) * 1.0E-6d)) * this.mDpositionDt);
            this.mPosition = f4;
            if (f4 >= 1.0f) {
                this.mPosition = 1.0f;
            }
            ...
            boolean interpolate = motionController.interpolate(motionController.mView, f5, nanoTime, this.mCache);
        ...
        public void reactTo(int i4, float f4, float f5) {
            if (i4 != 1) {
                if (i4 == 2) {
                    ...
                    if (!this.mTempRec.contains((int) f4, (int) f5) && !this.mReverse) {
                        reverse(true);
                    }
                }
    ...
    /* access modifiers changed from: package-private */
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i4, ConstraintSet constraintSet, View... viewArr) {
        if (!this.mDisabled) {
            int i5 = this.mViewTransitionMode;
            if (i5 == 2) {
            ...
            MotionScene.Transition transition = new MotionScene.Transition(-1, motionLayout.mScene, i7, i4);
    ...
    public void setSharedValue(int i4) {
        this.mSharedValueTarget = i4;
    }

    public void setSharedValueCurrent(int i4) {
        this.mSharedValueCurrent = i4;
    }

    public void setSharedValueID(int i4) {
        this.mSharedValueID = i4;
    }

    public void setStateTransition(int i4) {
        this.mOnStateTransition = i4;
    }

    /* access modifiers changed from: package-private */
    public boolean supports(int i4) {
