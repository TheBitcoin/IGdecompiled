...
class TouchResponse {
    ...
    public void processTouchEvent(MotionEvent motionEvent, MotionLayout.MotionTracker motionTracker, int i4, MotionScene motionScene) {
        ...
        if (this.mIsRotateMode) {
            processTouchRotateEvent(motionEvent, motionTracker, i4, motionScene);
            return;
        }
        MotionEvent motionEvent2 = motionEvent;
        motionTracker2.addMovement(motionEvent2);
        int action = motionEvent2.getAction();
        if (action == 0) {
            this.mLastTouchX = motionEvent2.getRawX();
            this.mLastTouchY = motionEvent2.getRawY();
            ...
            float rawY = motionEvent2.getRawY() - this.mLastTouchY;
            float rawX = motionEvent2.getRawX() - this.mLastTouchX;
            if (Math.abs((this.mTouchDirectionX * rawX) + (this.mTouchDirectionY * rawY)) > this.mDragThreshold || this.mDragStarted) {
                ...
                if (i7 != -1) {
                    ...
                    c6 = 0;
                    f7 = progress2;
                    motionLayout.getAnchorDpDt(i7, f7, f13, this.mTouchAnchorY, this.mAnchorDpDt);
                } else {
                    f7 = progress2;
                    c7 = 1;
                    c6 = 0;
                ...
                if (((double) Math.abs(((f14 * fArr4[c6]) + (this.mTouchDirectionY * fArr4[c7])) * this.mDragScale)) < 0.01d) {
                    float[] fArr5 = this.mAnchorDpDt;
                    fArr5[c6] = 0.01f;
                    fArr5[c7] = 0.01f;
                }
                if (this.mTouchDirectionX != 0.0f) {
                    f8 = rawX / this.mAnchorDpDt[c6];
                } else {
                    f8 = rawY / this.mAnchorDpDt[c7];
                }
                float max = Math.max(Math.min(f7 + f8, 1.0f), 0.0f);
                ...
                if (max != progress3) {
                    ...
                    if (this.mTouchDirectionX != 0.0f) {
                        f9 = xVelocity2 / this.mAnchorDpDt[c6];
                    } else {
                        f9 = yVelocity2 / this.mAnchorDpDt[c7];
                    }
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Removed duplicated region for block: B:55:0x0279  */
    /* JADX WARNING: Removed duplicated region for block: B:56:0x0293  */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x02b2  */
    /* JADX WARNING: Removed duplicated region for block: B:61:0x02c0  */
    /* JADX WARNING: Removed duplicated region for block: B:68:0x02cf  */
    /* JADX WARNING: Removed duplicated region for block: B:90:0x031e  */
    ...
    public void scrollMove(float f4, float f5) {
        ...
        float[] fArr = this.mAnchorDpDt;
        if (((double) Math.abs((f7 * fArr[0]) + (this.mTouchDirectionY * fArr[1]))) < 0.01d) {
            float[] fArr2 = this.mAnchorDpDt;
            fArr2[0] = 0.01f;
            fArr2[1] = 0.01f;
        }
    ...
    public void scrollUp(float f4, float f5) {
        ...
        if (progress != 0.0f && progress != 1.0f && (i4 = this.mOnTouchUp) != 3) {
            MotionLayout motionLayout = this.mMotionLayout;
            if (((double) progress) >= 0.5d) {
                f11 = 1.0f;
            }
            motionLayout.touchAnimateTo(i4, f11, f6);
        }
    }
