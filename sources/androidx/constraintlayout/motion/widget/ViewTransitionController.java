...
public class ViewTransitionController {
    ...
    private void listenForSharedVariable(ViewTransition viewTransition, boolean z4) {
        ...
        ConstraintLayout.getSharedValues().addListener(viewTransition.getSharedValueID(), new SharedValues.SharedValuesListener() {
            public void onNewValue(int i4, int i5, int i6) {
                ...
                viewTransition2.setSharedValueCurrent(i5);
                if (sharedValueID == i4 && sharedValueCurrent != i5) {
                    if (z5) {
                        if (sharedValue == i5) {
                            int childCount = ViewTransitionController.this.mMotionLayout.getChildCount();
                            for (int i7 = 0; i7 < childCount; i7++) {
                                View childAt = ViewTransitionController.this.mMotionLayout.getChildAt(i7);
    ...
    public void animate() {
        ...
        if (arrayList != null) {
            ...
            int i4 = 0;
            while (i4 < size) {
                ViewTransition.Animate animate = arrayList.get(i4);
                i4++;
                animate.mutate();
            }
    ...
    public void remove(int i4) {
        ...
        while (true) {
            ...
            ViewTransition viewTransition2 = arrayList.get(i5);
            i5++;
            viewTransition = viewTransition2;
            if (viewTransition.getId() == i4) {
                break;
            }
        }
    ...
    public void touchEvent(MotionEvent motionEvent) {
        ...
        if (currentState != -1) {
            if (viewTransitionController.mRelatedViews == null) {
                ...
                int i4 = 0;
                while (i4 < size) {
                    ViewTransition viewTransition = arrayList.get(i4);
                    i4++;
                    ViewTransition viewTransition2 = viewTransition;
            ...
            if (arrayList2 != null && !arrayList2.isEmpty()) {
                ...
                int i6 = 0;
                while (i6 < size2) {
                    ViewTransition.Animate animate = arrayList3.get(i6);
                    i6++;
            ...
            if (action == 0 || action == 1) {
                ...
                while (i7 < size3) {
                    int i8 = i7 + 1;
                    ViewTransition viewTransition3 = arrayList4.get(i7);
    ...
    public void viewTransition(int i4, View... viewArr) {
        ...
        int i5 = 0;
        while (i5 < size) {
            ViewTransition viewTransition2 = arrayList2.get(i5);
            i5++;
            ViewTransition viewTransition3 = viewTransition2;
            if (viewTransition3.getId() == i4) {
