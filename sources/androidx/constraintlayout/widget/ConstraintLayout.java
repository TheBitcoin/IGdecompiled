...
public class ConstraintLayout extends ViewGroup {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public void captureLayoutInfo(int i4, int i5, int i6, int i7, int i8, int i9) {
            ...
            this.mPaddingWidth = i8;
            this.mPaddingHeight = i9;
            this.mLayoutWidthSpec = i4;
            this.mLayoutHeightSpec = i5;
        }
        ...
        public final void didMeasures() {
            ...
            if (size > 0) {
                for (int i5 = 0; i5 < size; i5++) {
                    ((ConstraintHelper) this.mLayout.mConstraintHelpers.get(i5)).updatePostMeasure(this.mLayout);
                }
            }
        }
    ...
    public interface ValueModifier {
        boolean update(int i4, int i5, int i6, View view, LayoutParams layoutParams);
    }
    ...
    private ConstraintWidget getTargetWidget(int i4) {
        if (i4 == 0) {
    ...
    private void setWidgetBaseline(ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray, int i4, ConstraintAnchor.Type type) {
        View view = this.mChildrenByIds.get(i4);
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (!(childAt.getVisibility() == 8 || (tag = childAt.getTag()) == null || !(tag instanceof String))) {
                    ...
                    if (split.length == 4) {
                        ...
                        canvas2.drawLine(f4, f5, f6, f5, paint);
                        float f7 = f4;
                        float parseInt4 = (float) (i7 + ((int) ((((float) Integer.parseInt(split[3])) / 1920.0f) * height)));
                        float f8 = f6;
                        canvas2.drawLine(f8, f5, f6, parseInt4, paint);
                        float f9 = f5;
                        float f10 = parseInt4;
                        float f11 = f7;
                        canvas2.drawLine(f8, f10, f11, parseInt4, paint);
                        float f12 = f8;
                        float f13 = f11;
                        float f14 = f9;
                        ...
                        float f18 = f12;
                        canvas2.drawLine(f13, f17, f18, f16, paint);
                        canvas2.drawLine(f13, f16, f18, f17, paint);
                    }
                }
            }
        }
    ...
    public boolean dynamicUpdateConstraints(int i4, int i5) {
        ...
        while (i6 < size3) {
            int i7 = i6 + 1;
            ValueModifier valueModifier = arrayList.get(i6);
            ArrayList<ConstraintWidget> children = this.mLayoutWidget.getChildren();
            int size4 = children.size();
            for (int i8 = 0; i8 < size4; i8++) {
                View view = (View) children.get(i8).getCompanionWidget();
    ...
    public void onMeasure(int i4, int i5) {
        ...
        Metrics metrics = this.mMetrics;
        if (metrics != null) {
            metrics.mMeasureDuration += System.nanoTime() - j4;
        }
    }
    ...
    public void resolveMeasuredDimension(int i4, int i5, int i6, int i7, boolean z4, boolean z5) {
        ...
        int i8 = measurer.mPaddingHeight;
        int resolveSizeAndState = View.resolveSizeAndState(i6 + measurer.mPaddingWidth, i4, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i4, int i5, int i6) {
        ...
        this.mMeasurer.captureLayoutInfo(i5, i6, max, max2, paddingWidth, i8);
        ...
        int i102 = size2 - i8;
        setSelfDimensionBehaviour(constraintWidgetContainer, mode, i92, mode2, i102);
        constraintWidgetContainer.measure(i4, mode, i92, mode2, i102, this.mLastMeasureWidth, this.mLastMeasureHeight, i7, max);
    }
