...
public class ConstraintSet {
        ...
        static class Delta {
            ...
            public void applyDelta(Constraint constraint) {
                for (int i4 = 0; i4 < this.mCountInt; i4++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeInt[i4], this.mValueInt[i4]);
                }
                for (int i5 = 0; i5 < this.mCountFloat; i5++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeFloat[i5], this.mValueFloat[i5]);
                }
                ...
                for (int i7 = 0; i7 < this.mCountBoolean; i7++) {
                    ConstraintSet.setDeltaValue(constraint, this.mTypeBoolean[i7], this.mValueBoolean[i7]);
                }
            }
            ...
            public void printDelta(String str) {
                Log.v(str, "int");
                for (int i4 = 0; i4 < this.mCountInt; i4++) {
                    Log.v(str, this.mTypeInt[i4] + " = " + this.mValueInt[i4]);
                }
                Log.v(str, TypedValues.Custom.S_FLOAT);
                for (int i5 = 0; i5 < this.mCountFloat; i5++) {
                    Log.v(str, this.mTypeFloat[i5] + " = " + this.mValueFloat[i5]);
                }
                Log.v(str, "strings");
                for (int i6 = 0; i6 < this.mCountString; i6++) {
                ...
                for (int i7 = 0; i7 < this.mCountBoolean; i7++) {
                    Log.v(str, this.mTypeBoolean[i7] + " = " + this.mValueBoolean[i7]);
                }
            }
    ...
    public static class Layout {
        ...
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            ...
            for (int i4 = 0; i4 < indexCount; i4++) {
                ...
                int i5 = sMapToConstant.get(index);
                switch (i5) {
                    case 1:
    ...
    class WriteXmlEngine {
        ...
        WriteXmlEngine(Writer writer, ConstraintLayout constraintLayout, int i4) throws IOException {
            this.mWriter = writer;
        ...
        private void writeEnum(String str, int i4, String[] strArr, int i5) throws IOException {
            if (i4 != i5) {
                Writer writer = this.mWriter;
                writer.write(SPACE + str + "=\"" + strArr[i4] + "\"");
            }
        }

        /* access modifiers changed from: package-private */
        public String getName(int i4) {
            if (this.mIdMap.containsKey(Integer.valueOf(i4))) {
                return "@+id/" + this.mIdMap.get(Integer.valueOf(i4)) + "";
            } else if (i4 == 0) {
                return ConstraintSet.KEY_PERCENT_PARENT;
            } else {
                String lookup = lookup(i4);
                this.mIdMap.put(Integer.valueOf(i4), lookup);
                return "@+id/" + lookup + "";
            }
        }
        ...
        public String lookup(int i4) {
            if (i4 != -1) {
                try {
                    return this.mContext.getResources().getResourceEntryName(i4);
                } catch (Exception unused) {
                    StringBuilder sb = new StringBuilder();
                    sb.append(EnvironmentCompat.MEDIA_UNKNOWN);
                    int i5 = this.mUnknownCount + 1;
                    this.mUnknownCount = i5;
                    sb.append(i5);
                    return sb.toString();
                }
            } else {
        ...
        public void writeVariable(String str, int i4) throws IOException {
            if (i4 != 0 && i4 != -1) {
                Writer writer = this.mWriter;
                writer.write(SPACE + str + "=\"" + i4 + "\"\n");
            }
        }

        /* access modifiers changed from: package-private */
        public void writeXmlConstraint(String str, int i4) throws IOException {
            if (i4 != -1) {
                Writer writer = this.mWriter;
                writer.write(SPACE + str);
                Writer writer2 = this.mWriter;
                writer2.write("=\"" + getName(i4) + "\"");
            }
        }
    ...
    static {
        ...
        sOverrideMapToConstant.append(i4, 7);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i5 < split.length) {
            ...
            try {
                i4 = R.id.class.getField(trim).getInt((Object) null);
            } catch (Exception unused) {
                i4 = 0;
            }
            if (i4 == 0) {
    ...
    static void parseDimensionRatioString(ConstraintLayout.LayoutParams layoutParams, String str) {
        ...
        layoutParams.mDimensionRatioValue = f4;
        layoutParams.mDimensionRatioSide = i4;
    }
    ...
    /* access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i4, float f4) {
        if (i4 == 19) {
    ...
    public void addToHorizontalChain(int i4, int i5, int i6) {
        ...
        connect(i4, 1, i5, i7, 0);
        if (i6 == 0) {
            i8 = 2;
        } else {
            i8 = 1;
        }
        connect(i4, 2, i6, i8, 0);
        if (i5 != 0) {
            connect(i5, 2, i4, 1, 0);
        }
        if (i6 != 0) {
    ...
    public void addToHorizontalChainRTL(int i4, int i5, int i6) {
        ...
        connect(i4, 6, i5, i7, 0);
        if (i6 == 0) {
            i8 = 7;
        } else {
            i8 = 6;
        }
        connect(i4, 7, i6, i8, 0);
        if (i5 != 0) {
            connect(i5, 7, i4, 6, 0);
        }
        if (i6 != 0) {
    ...
    public void addToVerticalChain(int i4, int i5, int i6) {
        ...
        connect(i4, 3, i5, i7, 0);
        if (i6 == 0) {
            i8 = 4;
        } else {
            i8 = 3;
        }
        connect(i4, 4, i6, i8, 0);
        if (i5 != 0) {
            connect(i5, 4, i4, 3, 0);
        }
        if (i6 != 0) {
    ...
    public void applyToLayoutParams(int i4, ConstraintLayout.LayoutParams layoutParams) {
        Constraint constraint;
        if (this.mConstraints.containsKey(Integer.valueOf(i4)) && (constraint = this.mConstraints.get(Integer.valueOf(i4))) != null) {
            constraint.applyTo(layoutParams);
        }
    }
    ...
    public void center(int i4, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        if (i7 < 0) {
            ...
            int i15 = i5;
            int i16 = i4;
            connect(i16, 1, i15, i6, i13);
            connect(i16, 2, i14, i11, i12);
            Constraint constraint = this.mConstraints.get(Integer.valueOf(i16));
            if (constraint != null) {
                constraint.layout.horizontalBias = f4;
            }
        } else if (i6 == 6 || i6 == 7) {
            ...
            int i21 = i5;
            int i22 = i4;
            connect(i22, 6, i21, i6, i19);
            connect(i22, 7, i20, i17, i18);
            Constraint constraint2 = this.mConstraints.get(Integer.valueOf(i22));
            if (constraint2 != null) {
                constraint2.layout.horizontalBias = f4;
            }
        } else {
            int i23 = i4;
            connect(i23, 3, i5, i6, i7);
            int i24 = i23;
            connect(i24, 4, i8, i9, i10);
            Constraint constraint3 = this.mConstraints.get(Integer.valueOf(i24));
            if (constraint3 != null) {
    ...
    public void centerHorizontally(int i4, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        int i11 = i4;
        connect(i11, 1, i5, i6, i7);
        int i12 = i11;
        connect(i12, 2, i8, i9, i10);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i12));
        if (constraint != null) {
            constraint.layout.horizontalBias = f4;
        }
    }
    ...
    public void centerHorizontallyRtl(int i4, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        int i11 = i4;
        connect(i11, 6, i5, i6, i7);
        int i12 = i11;
        connect(i12, 7, i8, i9, i10);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i12));
        if (constraint != null) {
            constraint.layout.horizontalBias = f4;
        }
    ...
    public void centerVertically(int i4, int i5, int i6, int i7, int i8, int i9, int i10, float f4) {
        int i11 = i4;
        connect(i11, 3, i5, i6, i7);
        int i12 = i11;
        connect(i12, 4, i8, i9, i10);
        Constraint constraint = this.mConstraints.get(Integer.valueOf(i12));
        if (constraint != null) {
            constraint.layout.verticalBias = f4;
        }
    ...
    public void constrainedHeight(int i4, boolean z4) {
        get(i4).layout.constrainedHeight = z4;
    }

    public void constrainedWidth(int i4, boolean z4) {
        get(i4).layout.constrainedWidth = z4;
    }
    ...
    public void createVerticalChain(int i4, int i5, int i6, int i7, int[] iArr, float[] fArr, int i8) {
        ...
        if (iArr2.length < 2) {
            ...
            get(iArr2[0]).layout.verticalChainStyle = i8;
            connect(iArr2[0], 3, i4, i5, 0);
            for (int i9 = 1; i9 < iArr2.length; i9++) {
                int i10 = i9 - 1;
                connect(iArr2[i9], 3, iArr2[i10], 4, 0);
                connect(iArr2[i10], 4, iArr2[i9], 3, 0);
                if (fArr2 != null) {
                    get(iArr2[i9]).layout.verticalWeight = fArr2[i9];
                }
            }
            connect(iArr2[iArr2.length - 1], 4, i6, i7, 0);
        } else {
            throw new IllegalArgumentException("must have 2 or more widgets in a chain");
        }
    }
    ...
    public void load(Context context, int i4) {
        ...
        try {
            ...
            Log.e(TAG, "Error parsing resource: " + i4, e5);
        } catch (IOException e6) {
            Log.e(TAG, "Error parsing resource: " + i4, e6);
        }
    }
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i4 = 0; i4 < split.length; i4++) {
            ...
            if (split2.length != 2) {
                Log.w(TAG, " Unable to parse " + split[i4]);
            } else {
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i4 = 0; i4 < splitString.length; i4++) {
            ...
            Log.w(TAG, " Unable to parse " + splitString[i4]);
    ...
    public void removeFromHorizontalChain(int i4) {
        ...
        if (i5 == -1 || i6 == -1) {
            ...
            if (i12 != -1) {
                connect(i5, 2, i12, 2, 0);
            } else {
                int i13 = layout.leftToLeft;
                if (i13 != -1) {
                    int i14 = i11;
                    connect(i14, 1, i13, 1, 0);
                }
            }
        } else {
            connect(i5, 2, i6, 1, 0);
    ...
    public void setApplyElevation(int i4, boolean z4) {
        get(i4).transform.applyElevation = z4;
    }
    ...
    public void writeState(Writer writer, ConstraintLayout constraintLayout, int i4) throws IOException {
        writer.write("\n---------------------------------------------\n");
        if ((i4 & 1) == 1) {
            new WriteXmlEngine(writer, constraintLayout, i4).writeLayout();
        } else {
            new WriteJsonEngine(writer, constraintLayout, i4).writeLayout();
        }
        writer.write("\n---------------------------------------------\n");
    }
    ...
    private void createHorizontalChain(int i4, int i5, int i6, int i7, int[] iArr, float[] fArr, int i8, int i9, int i10) {
        ...
        if (iArr2.length < 2) {
            ...
            get(iArr2[0]).layout.horizontalChainStyle = i8;
            connect(iArr2[0], i9, i4, i5, -1);
            for (int i11 = 1; i11 < iArr2.length; i11++) {
                int i12 = i11 - 1;
                connect(iArr2[i11], i9, iArr2[i12], i10, -1);
                connect(iArr2[i12], i10, iArr2[i11], i9, -1);
                if (fArr2 != null) {
                    get(iArr2[i11]).layout.horizontalWeight = fArr2[i11];
                }
            }
            connect(iArr2[iArr2.length - 1], i10, i6, i7, -1);
        } else {
            throw new IllegalArgumentException("must have 2 or more widgets in a chain");
        }
    }
    ...
    class WriteJsonEngine {
        ...
        WriteJsonEngine(Writer writer, ConstraintLayout constraintLayout, int i4) throws IOException {
            this.mWriter = writer;
            this.mLayout = constraintLayout;
            this.mContext = constraintLayout.getContext();
            this.mFlags = i4;
            ...
            if (i4 == 0) {
                if (i7 == -1 && i6 == -1) {
                    if (i5 == 1) {
                        ...
                        Writer writer2 = this.mWriter;
                        writer2.write(SPACE + str + ": '" + f4 + "%',\n");
                    }
                } else if (i5 == 0) {
                    Writer writer3 = this.mWriter;
                    writer3.write(SPACE + str + ": {'spread' ," + i6 + ", " + i7 + "}\n");
                } else if (i5 == 1) {
                    Writer writer4 = this.mWriter;
                    writer4.write(SPACE + str + ": {'wrap' ," + i6 + ", " + i7 + "}\n");
                } else if (i5 == 2) {
                    Writer writer5 = this.mWriter;
                    writer5.write(SPACE + str + ": {'" + f4 + "'% ," + i6 + ", " + i7 + "}\n");
                }
            } else if (i4 == -2) {
                ...
                writer8.write(SPACE + str + ": " + i4 + ",\n");
            }
        }

        private void writeGuideline(int i4, int i5, int i6, float f4) throws IOException {
            writeVariable("'orientation'", i4);
            writeVariable("'guideBegin'", i5);
            writeVariable("'guideEnd'", i6);
        ...
        public String getName(int i4) {
            if (this.mIdMap.containsKey(Integer.valueOf(i4))) {
                return "'" + this.mIdMap.get(Integer.valueOf(i4)) + "'";
            } else if (i4 == 0) {
                return "'parent'";
            } else {
                String lookup = lookup(i4);
    ...
    /* access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i4, int i5) {
        if (i4 == 6) {
            constraint.layout.editorAbsoluteX = i5;
        } else if (i4 == 7) {
            constraint.layout.editorAbsoluteY = i5;
        } else if (i4 == 8) {
            constraint.layout.endMargin = i5;
        } else if (i4 == 27) {
            constraint.layout.orientation = i5;
        } else if (i4 == 28) {
            constraint.layout.rightMargin = i5;
        } else if (i4 == 41) {
            constraint.layout.horizontalChainStyle = i5;
        } else if (i4 == 42) {
            constraint.layout.verticalChainStyle = i5;
        } else if (i4 == 61) {
            constraint.layout.circleConstraint = i5;
        } else if (i4 == 62) {
            constraint.layout.circleRadius = i5;
        } else if (i4 == 72) {
            constraint.layout.mBarrierDirection = i5;
        } else if (i4 != 73) {
            switch (i4) {
                case 2:
                    ...
                    return;
                case 11:
                    constraint.layout.goneBottomMargin = i5;
                    return;
                case 12:
                    constraint.layout.goneEndMargin = i5;
                    return;
                case 13:
                    constraint.layout.goneLeftMargin = i5;
                    return;
                case 14:
                    constraint.layout.goneRightMargin = i5;
                    return;
                case 15:
                    constraint.layout.goneStartMargin = i5;
                    return;
                case 16:
                    constraint.layout.goneTopMargin = i5;
                    return;
                case 17:
                    constraint.layout.guideBegin = i5;
                    return;
                case 18:
                    constraint.layout.guideEnd = i5;
                    return;
                case 31:
                ...
                case 34:
                    ...
                    return;
                case 38:
                    constraint.mViewId = i5;
                    return;
                case 64:
                    constraint.motion.mAnimateRelativeTo = i5;
                    return;
                case 66:
                    constraint.motion.mDrawPath = i5;
                    return;
                case 76:
                    constraint.motion.mPathMotionArc = i5;
                    return;
                case 78:
                    constraint.propertySet.mVisibilityMode = i5;
                    return;
                case 93:
                    constraint.layout.baselineMargin = i5;
                    return;
                case 94:
                    constraint.layout.goneBaselineMargin = i5;
                    return;
                case 97:
                    constraint.layout.mWrapBehavior = i5;
                    return;
                default:
                    switch (i4) {
                        case 21:
                            constraint.layout.mHeight = i5;
                            return;
                        case 22:
                            constraint.propertySet.visibility = i5;
                            return;
                        case 23:
                            constraint.layout.mWidth = i5;
                            return;
                        case 24:
                        ...
                        default:
                            switch (i4) {
                                case 54:
                                    constraint.layout.widthDefault = i5;
                                    return;
                                case 55:
                                    constraint.layout.heightDefault = i5;
                                    return;
                                case 56:
                                    constraint.layout.widthMax = i5;
                                    return;
                                case 57:
                                    constraint.layout.heightMax = i5;
                                    return;
                                case 58:
                                    constraint.layout.widthMin = i5;
                                    return;
                                case 59:
                                    constraint.layout.heightMin = i5;
                                    return;
                                default:
                                    switch (i4) {
                                        case 82:
                                            constraint.motion.mAnimateCircleAngleTo = i5;
                                            return;
                                        case 83:
                                            constraint.transform.transformPivotTarget = i5;
                                            return;
                                        case 84:
                                            constraint.motion.mQuantizeMotionSteps = i5;
                                            return;
                                        default:
                                            switch (i4) {
                                                case 87:
                                                    return;
                                                case 88:
                                                    constraint.motion.mQuantizeInterpolatorType = i5;
                                                    return;
                                                case 89:
                                                    constraint.motion.mQuantizeInterpolatorID = i5;
                                                    return;
                                                default:
                                                    Log.w(TAG, "Unknown attribute 0x");
                                                    return;
            ...
            constraint.layout.mBarrierMargin = i5;
        }
    }
    ...
    /* access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i4, String str) {
        if (i4 == 5) {
    ...
    /* access modifiers changed from: private */
    public static void setDeltaValue(Constraint constraint, int i4, boolean z4) {
        if (i4 == 44) {
