...
public abstract class Utf8 {
    ...
    static class DecodeUtil {
        ...
        static void handleFourBytes(byte b5, byte b6, byte b7, byte b8, char[] cArr, int i4) throws IllegalArgumentException {
        ...
        static void handleOneByte(byte b5, char[] cArr, int i4) {
            cArr[i4] = (char) b5;
        }

        static void handleThreeBytes(byte b5, byte b6, byte b7, char[] cArr, int i4) throws IllegalArgumentException {
        ...
        static void handleTwoBytes(byte b5, byte b6, char[] cArr, int i4) throws IllegalArgumentException {
            if (b5 < -62) {
