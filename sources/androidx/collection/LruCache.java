...
public class LruCache<K, V> {
    ...
    private int safeSizeOf(K k4, V v4) {
        int sizeOf = sizeOf(k4, v4);
        if (sizeOf >= 0) {
            return sizeOf;
        }
    ...
    /* access modifiers changed from: protected */
    public void entryRemoved(boolean z4, @NonNull K k4, @NonNull V v4, @Nullable V v5) {
    }
    ...
    @Nullable
    public final V put(@NonNull K k4, @NonNull V v4) {
        V put;
        if (k4 == null || v4 == null) {
        ...
        synchronized (this) {
            try {
                this.putCount++;
                this.size += safeSizeOf(k4, v4);
                put = this.map.put(k4, v4);
                if (put != null) {
    ...
    public final V remove(@NonNull K k4) {
        ...
        if (k4 != null) {
            ...
            if (remove != null) {
                entryRemoved(false, k4, remove, (V) null);
            }
            return remove;
        }
    ...
    /* access modifiers changed from: protected */
    public int sizeOf(@NonNull K k4, @NonNull V v4) {
        return 1;
    }
    ...
    public final synchronized String toString() {
        ...
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i4)});
    }
