...
public class CheckBoxPreference extends TwoStatePreference {
    ...
    public CheckBoxPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
    ...
    public CheckBoxPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
        super(context, attributeSet, i4, i5);
        this.mListener = new Listener();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.CheckBoxPreference, i4, i5);
