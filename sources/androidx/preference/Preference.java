...
public class Preference implements Comparable<Preference> {
    ...
    public Preference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
        ...
        this.mLayoutResId = TypedArrayUtils.getResourceId(obtainStyledAttributes, R.styleable.Preference_layout, R.styleable.Preference_android_layout, i6);
        ...
        this.mAllowDividerAbove = TypedArrayUtils.getBoolean(obtainStyledAttributes, i7, i7, this.mSelectable);
        int i8 = R.styleable.Preference_allowDividerBelow;
        this.mAllowDividerBelow = TypedArrayUtils.getBoolean(obtainStyledAttributes, i8, i8, this.mSelectable);
        int i9 = R.styleable.Preference_defaultValue;
        if (obtainStyledAttributes.hasValue(i9)) {
            this.mDefaultValue = onGetDefaultValue(obtainStyledAttributes, i9);
        } else {
        ...
        if (hasValue) {
            this.mSingleLineTitle = TypedArrayUtils.getBoolean(obtainStyledAttributes, i11, R.styleable.Preference_android_singleLineTitle, true);
        }
        ...
        this.mVisible = TypedArrayUtils.getBoolean(obtainStyledAttributes, i12, i12, true);
        int i13 = R.styleable.Preference_enableCopying;
        this.mCopyingEnabled = TypedArrayUtils.getBoolean(obtainStyledAttributes, i13, i13, false);
    ...
    public Drawable getIcon() {
        ...
        if (this.mIcon == null && (i4 = this.mIconResId) != 0) {
            this.mIcon = AppCompatResources.getDrawable(this.mContext, i4);
        }
        return this.mIcon;
    }
    ...
    public float getPersistedFloat(float f4) {
        ...
        PreferenceDataStore preferenceDataStore = getPreferenceDataStore();
        if (preferenceDataStore != null) {
            return preferenceDataStore.getFloat(this.mKey, f4);
        }
        return this.mPreferenceManager.getSharedPreferences().getFloat(this.mKey, f4);
    }
    ...
    public int getPersistedInt(int i4) {
        ...
        PreferenceDataStore preferenceDataStore = getPreferenceDataStore();
        if (preferenceDataStore != null) {
            return preferenceDataStore.getInt(this.mKey, i4);
        }
        return this.mPreferenceManager.getSharedPreferences().getInt(this.mKey, i4);
    }
    ...
    public long getPersistedLong(long j4) {
        ...
        PreferenceDataStore preferenceDataStore = getPreferenceDataStore();
        if (preferenceDataStore != null) {
            return preferenceDataStore.getLong(this.mKey, j4);
        }
        return this.mPreferenceManager.getSharedPreferences().getLong(this.mKey, j4);
    }
    ...
    public void notifyDependencyChange(boolean z4) {
        ...
        if (list != null) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                list.get(i4).onDependencyChanged(this, z4);
            }
        }
    }
    ...
    public boolean persistFloat(float f4) {
        ...
        PreferenceDataStore preferenceDataStore = getPreferenceDataStore();
        if (preferenceDataStore != null) {
            preferenceDataStore.putFloat(this.mKey, f4);
        } else {
            SharedPreferences.Editor editor = this.mPreferenceManager.getEditor();
            editor.putFloat(this.mKey, f4);
            tryCommit(editor);
        }
        return true;
    }
    ...
    public boolean persistInt(int i4) {
        ...
        PreferenceDataStore preferenceDataStore = getPreferenceDataStore();
        if (preferenceDataStore != null) {
            preferenceDataStore.putInt(this.mKey, i4);
        } else {
            SharedPreferences.Editor editor = this.mPreferenceManager.getEditor();
            editor.putInt(this.mKey, i4);
            tryCommit(editor);
        }
        return true;
    }
    ...
    public boolean persistLong(long j4) {
        ...
        PreferenceDataStore preferenceDataStore = getPreferenceDataStore();
        if (preferenceDataStore != null) {
            preferenceDataStore.putLong(this.mKey, j4);
        } else {
            SharedPreferences.Editor editor = this.mPreferenceManager.getEditor();
            editor.putLong(this.mKey, j4);
            tryCommit(editor);
        }
        return true;
    }
    ...
    public void setIcon(int i4) {
        setIcon(AppCompatResources.getDrawable(this.mContext, i4));
        this.mIconResId = i4;
    }

    public void setSummary(int i4) {
        setSummary((CharSequence) this.mContext.getString(i4));
    }
