...
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
        ...
        AnonymousClass3 r02 = new Runnable() {
            public void run() {
                ...
                if (adapter instanceof PreferenceGroup.PreferencePositionCallback) {
                    ...
                    if (i4 != -1) {
                        PreferenceFragmentCompat.this.mList.scrollToPosition(i4);
                    } else {
    ...
    public void addPreferencesFromResource(@XmlRes int i4) {
        ...
        setPreferenceScreen(this.mPreferenceManager.inflateFromResource(requireContext(), i4, getPreferenceScreen()));
    }
    ...
    public void setPreferencesFromResource(@XmlRes int i4, @Nullable String str) {
        requirePreferenceManager();
        PreferenceScreen inflateFromResource = this.mPreferenceManager.inflateFromResource(requireContext(), i4, (PreferenceScreen) null);
