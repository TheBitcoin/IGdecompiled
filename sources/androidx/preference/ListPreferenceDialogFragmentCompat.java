...
public class ListPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    public void onDialogClosed(boolean z4) {
        int i4;
        if (z4 && (i4 = this.mClickedDialogEntryIndex) >= 0) {
            String charSequence = this.mEntryValues[i4].toString();
            ListPreference listPreference = getListPreference();
    ...
    public void onPrepareDialogBuilder(@NonNull AlertDialog.Builder builder) {
        ...
        builder.setSingleChoiceItems(this.mEntries, this.mClickedDialogEntryIndex, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i4) {
                ...
                listPreferenceDialogFragmentCompat.mClickedDialogEntryIndex = i4;
