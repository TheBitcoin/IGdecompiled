...
public class SwitchPreferenceCompat extends TwoStatePreference {
    ...
    public SwitchPreferenceCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
    ...
    public void setSwitchTextOff(int i4) {
        setSwitchTextOff((CharSequence) getContext().getString(i4));
    }

    public void setSwitchTextOn(int i4) {
        setSwitchTextOn((CharSequence) getContext().getString(i4));
    }
