...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4, int i5) {
        ...
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(obtainStyledAttributes, i6, i6, true);
    ...
    public boolean addPreference(@NonNull Preference preference) {
        ...
        if (preference.getOrder() == Integer.MAX_VALUE) {
            if (this.mOrderingAsAdded) {
                int i4 = this.mCurrentPreferenceOrder;
                this.mCurrentPreferenceOrder = i4 + 1;
        ...
        if (key2 == null || !this.mIdRecycleCache.containsKey(key2)) {
            j4 = preferenceManager.getNextId();
        } else {
            j4 = this.mIdRecycleCache.get(key2).longValue();
    ...
    public void dispatchRestoreInstanceState(@NonNull Bundle bundle) {
        ...
        for (int i4 = 0; i4 < preferenceCount; i4++) {
            getPreference(i4).dispatchRestoreInstanceState(bundle);
        }
    }
    ...
    public void dispatchSaveInstanceState(@NonNull Bundle bundle) {
        ...
        int preferenceCount = getPreferenceCount();
        for (int i4 = 0; i4 < preferenceCount; i4++) {
            getPreference(i4).dispatchSaveInstanceState(bundle);
        }
    }
    ...
    public Preference getPreference(int i4) {
        return this.mPreferences.get(i4);
    }
    ...
    public void notifyDependencyChange(boolean z4) {
        ...
        int preferenceCount = getPreferenceCount();
        for (int i4 = 0; i4 < preferenceCount; i4++) {
            getPreference(i4).onParentChanged(this, z4);
        }
    }
    ...
    public void setInitialExpandedChildrenCount(int i4) {
        ...
        this.mInitialExpandedChildrenCount = i4;
    }
