        ...
        if (preferenceManager == null || preferenceManager.getPreferenceComparisonCallback() == null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() {
                public boolean areContentsTheSame(int i4, int i5) {
                    return preferenceComparisonCallback.arePreferenceContentsTheSame((Preference) list.get(i4), (Preference) createVisiblePreferencesList.get(i5));
                }

                public boolean areItemsTheSame(int i4, int i5) {
                    return preferenceComparisonCallback.arePreferenceItemsTheSame((Preference) list.get(i4), (Preference) createVisiblePreferencesList.get(i5));
                }
