...
public final class SidecarCompat implements ExtensionInterfaceCompat {
    ...
    public boolean validateExtensionInterface() {
        /*
            ...
            r0 = 0
            r1 = 1
            androidx.window.sidecar.SidecarInterface r2 = r9.sidecar     // Catch:{ all -> 0x018b }
            r3 = 0
        ...
        L_0x0007:
            ...
            goto L_0x001c
        L_0x0009:
            java.lang.Class r2 = r2.getClass()     // Catch:{ all -> 0x018b }
            if (r2 != 0) goto L_0x0010
            goto L_0x0007
        L_0x0010:
            java.lang.String r4 = "setSidecarCallback"
            java.lang.Class[] r5 = new java.lang.Class[r1]     // Catch:{ all -> 0x018b }
            ...
            java.lang.reflect.Method r2 = r2.getMethod(r4, r5)     // Catch:{ all -> 0x018b }
        L_0x001c:
            if (r2 != 0) goto L_0x0020
            r2 = r3
            goto L_0x0024
        L_0x0020:
            java.lang.Class r2 = r2.getReturnType()     // Catch:{ all -> 0x018b }
        L_0x0024:
            java.lang.Class r4 = java.lang.Void.TYPE     // Catch:{ all -> 0x018b }
            boolean r5 = kotlin.jvm.internal.m.a(r2, r4)     // Catch:{ all -> 0x018b }
            if (r5 == 0) goto L_0x017f
            androidx.window.sidecar.SidecarInterface r2 = r9.sidecar     // Catch:{ all -> 0x018b }
            if (r2 != 0) goto L_0x0031
            goto L_0x0034
        L_0x0031:
            r2.getDeviceState()     // Catch:{ all -> 0x018b }
        L_0x0034:
            androidx.window.sidecar.SidecarInterface r2 = r9.sidecar     // Catch:{ all -> 0x018b }
            if (r2 != 0) goto L_0x0039
            goto L_0x003c
        L_0x0039:
            r2.onDeviceStateListenersChanged(r1)     // Catch:{ all -> 0x018b }
        L_0x003c:
            androidx.window.sidecar.SidecarInterface r2 = r9.sidecar     // Catch:{ all -> 0x018b }
        ...
        L_0x004b:
            ...
            java.lang.Class[] r7 = new java.lang.Class[r1]     // Catch:{ all -> 0x018b }
            r7[r0] = r5     // Catch:{ all -> 0x018b }
            java.lang.reflect.Method r2 = r2.getMethod(r6, r7)     // Catch:{ all -> 0x018b }
        L_0x0055:
        ...
        L_0x005d:
            ...
            boolean r6 = kotlin.jvm.internal.m.a(r2, r6)     // Catch:{ all -> 0x018b }
        ...
        L_0x0080:
            java.lang.Class r2 = r2.getReturnType()     // Catch:{ all -> 0x018b }
        L_0x0084:
            boolean r6 = kotlin.jvm.internal.m.a(r2, r4)     // Catch:{ all -> 0x018b }
        ...
        L_0x00a5:
            java.lang.Class r2 = r2.getReturnType()     // Catch:{ all -> 0x018b }
        L_0x00a9:
            boolean r4 = kotlin.jvm.internal.m.a(r2, r4)     // Catch:{ all -> 0x018b }
            if (r4 == 0) goto L_0x015b
            androidx.window.sidecar.SidecarDeviceState r2 = new androidx.window.sidecar.SidecarDeviceState     // Catch:{ all -> 0x018b }
            r2.<init>()     // Catch:{ all -> 0x018b }
            r4 = 3
            r2.posture = r4     // Catch:{ NoSuchFieldError -> 0x00b8 }
            goto L_0x00e7
        L_0x00b8:
            ...
            java.lang.Object[] r7 = new java.lang.Object[r1]     // Catch:{ all -> 0x018b }
            r7[r0] = r6     // Catch:{ all -> 0x018b }
            r5.invoke(r2, r7)     // Catch:{ all -> 0x018b }
            java.lang.Class<androidx.window.sidecar.SidecarDeviceState> r5 = androidx.window.sidecar.SidecarDeviceState.class
            java.lang.String r6 = "getPosture"
            java.lang.reflect.Method r5 = r5.getMethod(r6, r3)     // Catch:{ all -> 0x018b }
            java.lang.Object r2 = r5.invoke(r2, r3)     // Catch:{ all -> 0x018b }
            if (r2 == 0) goto L_0x0153
            java.lang.Integer r2 = (java.lang.Integer) r2     // Catch:{ all -> 0x018b }
            int r2 = r2.intValue()     // Catch:{ all -> 0x018b }
            if (r2 != r4) goto L_0x014b
        L_0x00e7:
            androidx.window.sidecar.SidecarDisplayFeature r2 = new androidx.window.sidecar.SidecarDisplayFeature     // Catch:{ all -> 0x018b }
            r2.<init>()     // Catch:{ all -> 0x018b }
            android.graphics.Rect r4 = r2.getRect()     // Catch:{ all -> 0x018b }
            java.lang.String r5 = "displayFeature.rect"
            kotlin.jvm.internal.m.d(r4, r5)     // Catch:{ all -> 0x018b }
            r2.setRect(r4)     // Catch:{ all -> 0x018b }
            r2.getType()     // Catch:{ all -> 0x018b }
            r2.setType(r1)     // Catch:{ all -> 0x018b }
        ...
        L_0x0106:
            ...
            r7[r0] = r8     // Catch:{ all -> 0x018b }
            java.lang.reflect.Method r2 = r2.getMethod(r6, r7)     // Catch:{ all -> 0x018b }
            java.lang.Object[] r6 = new java.lang.Object[r1]     // Catch:{ all -> 0x018b }
            r6[r0] = r5     // Catch:{ all -> 0x018b }
            r2.invoke(r4, r6)     // Catch:{ all -> 0x018b }
            java.lang.Class<androidx.window.sidecar.SidecarWindowLayoutInfo> r2 = androidx.window.sidecar.SidecarWindowLayoutInfo.class
            java.lang.String r6 = "getDisplayFeatures"
            java.lang.reflect.Method r2 = r2.getMethod(r6, r3)     // Catch:{ all -> 0x018b }
            java.lang.Object r2 = r2.invoke(r4, r3)     // Catch:{ all -> 0x018b }
            if (r2 == 0) goto L_0x0143
            java.util.List r2 = (java.util.List) r2     // Catch:{ all -> 0x018b }
            boolean r2 = kotlin.jvm.internal.m.a(r5, r2)     // Catch:{ all -> 0x018b }
        ...
        L_0x0153:
            ...
            throw r1     // Catch:{ all -> 0x018b }
        L_0x015b:
            java.lang.NoSuchMethodException r1 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x018b }
            java.lang.String r3 = "Illegal return type for 'onWindowLayoutChangeListenerRemoved': "
            java.lang.String r2 = kotlin.jvm.internal.m.m(r3, r2)     // Catch:{ all -> 0x018b }
            r1.<init>(r2)     // Catch:{ all -> 0x018b }
            throw r1     // Catch:{ all -> 0x018b }
        L_0x0167:
            java.lang.NoSuchMethodException r1 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x018b }
    ...
    public SidecarCompat(Context context) {
        this(Companion.getSidecarCompat$window_release(context), new SidecarAdapter((SpecificationComputer.VerificationMode) null, 1, (C2103g) null));
        m.e(context, "context");
    }
}
