...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        ...
        int K4 = m3.m.K(obj, '/', 0, false, 6, (Object) null);
        if (K4 > 0) {
            str = obj.substring(0, K4);
            m.d(str, "this as java.lang.String…ing(startIndex, endIndex)");
            obj = obj.substring(K4 + 1);
            m.d(obj, "this as java.lang.String).substring(startIndex)");
        }
        String str2 = obj;
        if (m.a(str2, "*") || m3.m.K(str2, '.', 0, false, 6, (Object) null) >= 0) {
    ...
    private final ActivityRule parseSplitActivityRule(Context context, XmlResourceParser xmlResourceParser) {
        return new ActivityRule(N.d(), context.getTheme().obtainStyledAttributes(xmlResourceParser, R.styleable.ActivityRule, 0, 0).getBoolean(R.styleable.ActivityRule_alwaysExpand, false));
    }
    ...
    private final SplitPairRule parseSplitPairRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        int i4 = obtainStyledAttributes.getInt(R.styleable.SplitPairRule_splitLayoutDirection, 3);
        return new SplitPairRule(N.d(), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_finishPrimaryWithSecondary, false), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_finishSecondaryWithPrimary, true), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_clearTop, false), dimension, dimension2, f4, i4);
    }
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        int i4 = obtainStyledAttributes.getInt(R.styleable.SplitPlaceholderRule_splitLayoutDirection, 3);
        String packageName = context.getApplicationContext().getPackageName();
        m.d(packageName, "packageName");
        ...
        return new SplitPlaceholderRule(d5, component, dimension, dimension2, f4, i4);
    }
    ...
    public final Set<EmbeddingRule> parseSplitRules$window_release(Context context, int i4) {
        m.e(context, "context");
        return parseSplitXml(context, i4);
    }
}
