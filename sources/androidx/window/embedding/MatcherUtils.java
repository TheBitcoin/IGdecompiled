...
public final class MatcherUtils {
    ...
    private final boolean wildcardMatch(String str, String str2) {
        if (!m.D(str2, "*", false, 2, (Object) null)) {
            return false;
        }
        ...
        String str3 = str2;
        if (m.L(str3, "*", 0, false, 6, (Object) null) != m.R(str3, "*", 0, false, 6, (Object) null) || !m.o(str3, "*", false, 2, (Object) null)) {
            throw new IllegalArgumentException("Name pattern with a wildcard must only contain a single wildcard in the end");
        }
        String substring = str3.substring(0, str3.length() - 1);
        kotlin.jvm.internal.m.d(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        return m.y(str, substring, false, 2, (Object) null);
    }
    ...
    public final boolean areActivityOrIntentComponentsMatching$window_release(Activity activity, ComponentName componentName) {
        ...
        kotlin.jvm.internal.m.e(componentName, "ruleComponent");
    ...
    public final boolean areComponentsMatching$window_release(android.content.ComponentName r7, android.content.ComponentName r8) {
        ...
        L_0x0021:
            ...
            r4 = 2
            r5 = 0
            boolean r0 = m3.m.D(r3, r0, r2, r4, r5)
