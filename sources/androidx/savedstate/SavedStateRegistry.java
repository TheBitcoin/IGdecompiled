...
public final class SavedStateRegistry {
    private static final Companion Companion = new Companion((C2103g) null);
    @Deprecated
    ...
    public final void performSave(Bundle bundle) {
        ...
        m.d(iteratorWithAdditions, "this.components.iteratorWithAdditions()");
    ...
    public final void registerSavedStateProvider(String str, SavedStateProvider savedStateProvider) {
        m.e(str, LeanbackPreferenceDialogFragment.ARG_KEY);
        m.e(savedStateProvider, "provider");
