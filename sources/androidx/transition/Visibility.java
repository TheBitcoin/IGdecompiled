...
public abstract class Visibility extends Transition {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        int i4 = visibilityChangeInfo.mStartVisibility;
        int i5 = visibilityChangeInfo.mEndVisibility;
        return onDisappear(viewGroup, transitionValues, i4, transitionValues2, i5);
    }
    ...
    @Nullable
    public Animator onAppear(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, int i4, @Nullable TransitionValues transitionValues2, int i5) {
