...
class ViewGroupUtils {
    ...
    static class Api29Impl {
        ...
        @DoNotInline
        static int getChildDrawingOrder(ViewGroup viewGroup, int i4) {
    ...
    static int getChildDrawingOrder(@NonNull ViewGroup viewGroup, int i4) {
        if (Build.VERSION.SDK_INT >= 29) {
            return Api29Impl.getChildDrawingOrder(viewGroup, i4);
        }
        ...
        if (method != null) {
            try {
                return ((Integer) method.invoke(viewGroup, new Object[]{Integer.valueOf(viewGroup.getChildCount()), Integer.valueOf(i4)})).intValue();
