...
public abstract class Transition implements Cloneable {
    ...
    class SeekController extends TransitionListenerAdapter implements TransitionSeekController, DynamicAnimation.OnAnimationUpdateListener {
        ...
        public static /* synthetic */ void a(SeekController seekController, DynamicAnimation dynamicAnimation, boolean z4, float f4, float f5) {
            if (z4) {
        ...
        public void initPlayTime() {
            ...
            Transition.this.setCurrentPlayTimeMillis(j4, this.mCurrentPlayTime);
            this.mCurrentPlayTime = j4;
        }
        ...
        public void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f4, float f5) {
            long max = Math.max(-1, Math.min(getDurationMillis() + 1, Math.round((double) f4)));
        ...
        public void setCurrentFraction(float f4) {
            if (this.mSpringAnimation == null) {
                setCurrentPlayTimeMillis((long) (f4 * ((float) getDurationMillis())));
                return;
            }
        ...
        public void setCurrentPlayTimeMillis(long j4) {
            if (this.mSpringAnimation != null) {
            ...
            } else if (j4 != this.mCurrentPlayTime && isReady()) {
                if (!this.mIsCanceled) {
                    if (j4 != 0 || this.mCurrentPlayTime <= 0) {
                        long durationMillis = getDurationMillis();
                        if (j4 == durationMillis && this.mCurrentPlayTime < durationMillis) {
                            j4 = 1 + durationMillis;
                        }
                    } else {
                        j4 = -1;
                    }
                    long j5 = this.mCurrentPlayTime;
                    if (j4 != j5) {
                ...
                callProgressListeners();
                this.mVelocityTracker.addDataPoint(AnimationUtils.currentAnimationTimeMillis(), (float) j4);
            }
        }
    }
    ...
    public void createAnimators(@NonNull ViewGroup viewGroup, @NonNull TransitionValuesMaps transitionValuesMaps, @NonNull TransitionValuesMaps transitionValuesMaps2, @NonNull ArrayList<TransitionValues> arrayList, @NonNull ArrayList<TransitionValues> arrayList2) {
        ...
        int i6 = 0;
        while (i6 < size) {
            TransitionValues transitionValues2 = arrayList.get(i6);
            TransitionValues transitionValues3 = arrayList2.get(i6);
        ...
        if (sparseIntArray.size() != 0) {
            for (int i10 = 0; i10 < sparseIntArray.size(); i10++) {
                AnimationInfo animationInfo3 = runningAnimators.get(this.mAnimators.get(sparseIntArray.keyAt(i10)));
                animationInfo3.mAnimator.setStartDelay((((long) sparseIntArray.valueAt(i10)) - j4) + animationInfo3.mAnimator.getStartDelay());
            }
        }
    }
    ...
    public void end() {
        ...
        if (i4 == 0) {
            ...
            for (int i5 = 0; i5 < this.mStartValues.mItemIdValues.size(); i5++) {
                View valueAt = this.mStartValues.mItemIdValues.valueAt(i5);
                if (valueAt != null) {
                    valueAt.setHasTransientState(false);
                }
            }
            for (int i6 = 0; i6 < this.mEndValues.mItemIdValues.size(); i6++) {
                View valueAt2 = this.mEndValues.mItemIdValues.valueAt(i6);
                if (valueAt2 != null) {
    ...
    public void setCurrentPlayTimeMillis(long j4, long j5) {
        ...
        if ((i5 < 0 && j6 >= 0) || (j5 > totalDurationMillis && j6 <= totalDurationMillis)) {
            this.mEnded = false;
        ...
        while (i4 < size) {
            Animator animator = animatorArr[i4];
            animatorArr[i4] = null;
            Impl26.setCurrentPlayTime(animator, Math.min(Math.max(0, j6), Impl26.getTotalDuration(animator)));
            i4++;
            z4 = z4;
        }
        boolean z5 = z4;
        this.mAnimatorCache = animatorArr;
        int i6 = (j6 > totalDurationMillis ? 1 : (j6 == totalDurationMillis ? 0 : -1));
        if ((i6 > 0 && j5 <= totalDurationMillis) || (j6 < 0 && i5 >= 0)) {
            if (i6 > 0) {
                this.mEnded = true;
            }
            notifyListeners(TransitionNotification.ON_END, z5);
        }
    }
    ...
    public void setMatchOrder(@Nullable int... iArr) {
        ...
        while (i4 < iArr.length) {
            ...
            } else if (!alreadyContains(iArr, i4)) {
                i4++;
            } else {
