...
public final class OkioWriteScope<T> extends OkioReadScope<T> implements WriteScope<T> {
    ...
    public OkioWriteScope(C2520k kVar, Q q4, OkioSerializer<T> okioSerializer) {
        super(kVar, q4, okioSerializer);
        m.e(kVar, "fileSystem");
        m.e(q4, MBridgeConstans.DYNAMIC_VIEW_WX_PATH);
        m.e(okioSerializer, "serializer");
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v2, resolved type: N3.i} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v3, resolved type: N3.i} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v4, resolved type: N3.i} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r9v16, resolved type: N3.f} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v14, resolved type: N3.i} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v7, resolved type: N3.i} */
    /* JADX WARNING: type inference failed for: r1v1, types: [N3.i] */
    ...
    public java.lang.Object writeData(T r9, V2.d r10) {
        /*
            r8 = this;
        ...
        L_0x0018:
            ...
            N3.i r1 = (N3.C2518i) r1
            java.lang.Object r0 = r0.L$0
            java.io.Closeable r0 = (java.io.Closeable) r0
            R2.n.b(r10)     // Catch:{ all -> 0x0036 }
            goto L_0x0072
        L_0x0036:
            r10 = move-exception
            goto L_0x0085
        ...
        L_0x0040:
            R2.n.b(r10)
            r8.checkClose()
            N3.k r10 = r8.getFileSystem()
            N3.Q r2 = r8.getPath()
            N3.i r10 = r10.j(r2)
            r5 = 0
            N3.X r2 = N3.C2518i.x(r10, r5, r3, r4)     // Catch:{ all -> 0x00a5 }
            N3.f r2 = N3.L.c(r2)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0072:
            ...
            R2.s r10 = R2.s.f8222a     // Catch:{ all -> 0x0036 }
        ...
        L_0x008b:
            r9 = move-exception
            R2.a.a(r10, r9)     // Catch:{ all -> 0x0090 }
            goto L_0x0093
        L_0x0090:
            r9 = move-exception
            r10 = r0
        ...
        L_0x0095:
            ...
            kotlin.jvm.internal.m.b(r10)     // Catch:{ all -> 0x0090 }
            R2.s r9 = R2.s.f8222a     // Catch:{ all -> 0x0090 }
        ...
        L_0x00bb:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.okio.OkioWriteScope.writeData(java.lang.Object, V2.d):java.lang.Object");
    }
}
