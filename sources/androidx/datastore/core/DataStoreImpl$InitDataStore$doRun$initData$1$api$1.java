...
public final class DataStoreImpl$InitDataStore$doRun$initData$1$api$1 implements InitializerApi<T> {
    final /* synthetic */ C $currentData;
    final /* synthetic */ z $initializationComplete;
    final /* synthetic */ a $updateLock;
    final /* synthetic */ DataStoreImpl<T> this$0;

    DataStoreImpl$InitDataStore$doRun$initData$1$api$1(a aVar, z zVar, C c5, DataStoreImpl<T> dataStoreImpl) {
        this.$updateLock = aVar;
        this.$initializationComplete = zVar;
        this.$currentData = c5;
    ...
    public java.lang.Object updateData(d3.p r10, V2.d r11) {
        /*
            r9 = this;
        ...
        L_0x0076:
            R2.n.b(r11)
            x3.a r11 = r9.$updateLock
            kotlin.jvm.internal.z r2 = r9.$initializationComplete
            kotlin.jvm.internal.C r7 = r9.$currentData
        ...
        L_0x0094:
            ...
            r2 = r7
        L_0x0096:
            boolean r5 = r5.f20985a     // Catch:{ all -> 0x00d8 }
            if (r5 != 0) goto L_0x00db
            java.lang.Object r5 = r2.f20968a     // Catch:{ all -> 0x00d8 }
        ...
        L_0x00af:
            ...
            r10 = r8
        L_0x00b2:
            java.lang.Object r5 = r2.f20968a     // Catch:{ all -> 0x0056 }
            boolean r5 = kotlin.jvm.internal.m.a(r11, r5)     // Catch:{ all -> 0x0056 }
        ...
        L_0x00ca:
            ...
            r0 = r4
        L_0x00cd:
            r1.f20968a = r10     // Catch:{ all -> 0x003b }
            r2 = r1
            goto L_0x00d2
        L_0x00d1:
            r0 = r4
        L_0x00d2:
            java.lang.Object r10 = r2.f20968a     // Catch:{ all -> 0x003b }
            r0.d(r6)
            return r10
        L_0x00d8:
            r10 = move-exception
        ...
        L_0x00e3:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl$InitDataStore$doRun$initData$1$api$1.updateData(d3.p, V2.d):java.lang.Object");
    }
}
