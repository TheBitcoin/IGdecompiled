...
final class DataStoreImpl$readDataOrHandleCorruption$2 extends l implements p {
    ...
    DataStoreImpl$readDataOrHandleCorruption$2(DataStoreImpl<T> dataStoreImpl, int i4, d dVar) {
        super(2, dVar);
        this.this$0 = dataStoreImpl;
        this.$preLockVersion = i4;
    }
    ...
    public final Object invoke(boolean z4, d dVar) {
        return ((DataStoreImpl$readDataOrHandleCorruption$2) create(Boolean.valueOf(z4), dVar)).invokeSuspend(s.f8222a);
    }
}
