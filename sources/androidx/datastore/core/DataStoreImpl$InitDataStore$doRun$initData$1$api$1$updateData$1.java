...
final class DataStoreImpl$InitDataStore$doRun$initData$1$api$1$updateData$1 extends d {
    ...
    DataStoreImpl$InitDataStore$doRun$initData$1$api$1$updateData$1(DataStoreImpl$InitDataStore$doRun$initData$1$api$1 dataStoreImpl$InitDataStore$doRun$initData$1$api$1, V2.d dVar) {
        super(dVar);
