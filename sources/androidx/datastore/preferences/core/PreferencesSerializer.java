...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    private final void addProtoEntryToPreferences(String str, PreferencesProto.Value value, MutablePreferences mutablePreferences) {
        ...
        if (valueCase == null) {
            ...
            i4 = WhenMappings.$EnumSwitchMapping$0[valueCase.ordinal()];
        }
        switch (i4) {
            case -1:
                throw new CorruptionException("Value case is null.", (Throwable) null, 2, (C2103g) null);
            case 1:
            ...
            case 7:
                ...
                mutablePreferences.set(stringSetKey, C1601o.d0(stringsList));
                return;
            case 8:
                Preferences.Key<byte[]> byteArrayKey = PreferencesKeys.byteArrayKey(str);
                byte[] byteArray = value.getBytes().toByteArray();
                m.d(byteArray, "value.bytes.toByteArray()");
                mutablePreferences.set(byteArrayKey, byteArray);
                return;
            case 9:
                throw new CorruptionException("Value not set.", (Throwable) null, 2, (C2103g) null);
            default:
                throw new k();
        }
    }
    ...
    public Object readFrom(C2516g gVar, d dVar) throws IOException, CorruptionException {
    ...
    public Object writeTo(Preferences preferences, C2515f fVar, d dVar) throws IOException, CorruptionException {
