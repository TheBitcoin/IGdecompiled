...
public final class PreferencesProto {
    ...
    public static final class StringSet extends GeneratedMessageLite<StringSet, Builder> implements StringSetOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<StringSet, Builder> implements StringSetOrBuilder {
            ...
            public String getStrings(int i4) {
                return ((StringSet) this.instance).getStrings(i4);
            }

            public ByteString getStringsBytes(int i4) {
                return ((StringSet) this.instance).getStringsBytes(i4);
            }
            ...
            public Builder setStrings(int i4, String str) {
                copyOnWrite();
                ((StringSet) this.instance).setStrings(i4, str);
                return this;
            }
        ...
        public ByteString getStringsBytes(int i4) {
            return ByteString.copyFromUtf8(this.strings_.get(i4));
        }
    ...
    public interface StringSetOrBuilder extends MessageLiteOrBuilder {
        String getStrings(int i4);

        ByteString getStringsBytes(int i4);
    ...
    public static final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
            ...
            public Builder setInteger(int i4) {
                copyOnWrite();
                ((Value) this.instance).setInteger(i4);
                return this;
            }

            public Builder setLong(long j4) {
                copyOnWrite();
                ((Value) this.instance).setLong(j4);
                return this;
            }
