    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private long readVarint64SlowPath() throws IOException {
            ...
            for (int i4 = 0; i4 < 64; i4 += 7) {
                ...
                j4 |= ((long) (readByte & Byte.MAX_VALUE)) << i4;
                if ((readByte & 128) == 0) {
                    return j4;
                }
            }
        ...
        private void requireBytes(int i4) throws IOException {
        ...
        private void skipBytes(int i4) throws IOException {
            requireBytes(i4);
            this.pos += i4;
        }
        ...
        public String readStringInternal(boolean z4) throws IOException {
            ...
            if (z4) {
                byte[] bArr = this.buffer;
                int i4 = this.pos;
                if (!Utf8.isValidUtf8(bArr, i4, i4 + readVarint32)) {
        ...
        public boolean skipField() throws IOException {
            int i4;
            if (isAtEnd() || (i4 = this.tag) == this.endGroupTag) {
                return false;
            }
