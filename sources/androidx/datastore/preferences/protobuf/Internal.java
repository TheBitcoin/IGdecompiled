...
public final class Internal {
    ...
    public interface BooleanList extends ProtobufList<Boolean> {
        ...
        /* bridge */ /* synthetic */ ProtobufList mutableCopyWithCapacity(int i4);
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        private class EntryAdapter implements Map.Entry<K, V> {
            ...
            public V setValue(V v4) {
                RealValue value = this.realEntry.setValue(MapAdapter.this.valueConverter.doBackward(v4));
                if (value == null) {
                    return null;
                }
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t4) {
            return new Converter<Integer, T>() {
                public Integer doBackward(T t4) {
                    return Integer.valueOf(t4.getNumber());
                }
        ...
        public V put(K k4, V v4) {
            RealValue put = this.realMap.put(k4, this.valueConverter.doBackward(v4));
            if (put == null) {
                return null;
            }
    ...
    public static int hashCodeByteBuffer(List<ByteBuffer> list) {
        ...
        for (ByteBuffer hashCodeByteBuffer : list) {
            i4 = (i4 * 31) + hashCodeByteBuffer(hashCodeByteBuffer);
        }
        return i4;
    }
    ...
    static int partialHash(int i4, byte[] bArr, int i5, int i6) {
    ...
    static <T> T checkNotNull(T t4, String str) {
        if (t4 != null) {
            return t4;
        }
    ...
    public static int hashCodeByteBuffer(ByteBuffer byteBuffer) {
        ...
        while (duplicate.remaining() > 0) {
            int remaining = duplicate.remaining() <= i4 ? duplicate.remaining() : i4;
