...
interface Reader {
    ...
    <T> void mergeGroupField(T t4, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t4, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;
