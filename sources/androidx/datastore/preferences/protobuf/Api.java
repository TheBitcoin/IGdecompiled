...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        ...
        public Method getMethods(int i4) {
            return ((Api) this.instance).getMethods(i4);
        }
        ...
        public Mixin getMixins(int i4) {
            return ((Api) this.instance).getMixins(i4);
        }
        ...
        public Option getOptions(int i4) {
            return ((Api) this.instance).getOptions(i4);
        }
        ...
        public Builder removeMethods(int i4) {
            copyOnWrite();
            ((Api) this.instance).removeMethods(i4);
            return this;
        }

        public Builder removeMixins(int i4) {
            copyOnWrite();
            ((Api) this.instance).removeMixins(i4);
            return this;
        }

        public Builder removeOptions(int i4) {
            copyOnWrite();
            ((Api) this.instance).removeOptions(i4);
            return this;
        }

        public Builder setMethods(int i4, Method method) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i4, method);
            return this;
        }

        public Builder setMixins(int i4, Mixin mixin) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i4, mixin);
            return this;
        }
        ...
        public Builder setOptions(int i4, Option option) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i4, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i4) {
            copyOnWrite();
            ((Api) this.instance).setSyntaxValue(i4);
            return this;
        }
        ...
        public Builder addMethods(int i4, Method method) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i4, method);
            return this;
        }

        public Builder addMixins(int i4, Mixin mixin) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i4, mixin);
            return this;
        }

        public Builder addOptions(int i4, Option option) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i4, option);
            return this;
        }

        public Builder setMethods(int i4, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i4, (Method) builder.build());
            return this;
        }

        public Builder setMixins(int i4, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i4, (Mixin) builder.build());
            return this;
        }

        public Builder setOptions(int i4, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i4, (Option) builder.build());
            return this;
        }
        ...
        public Builder addMethods(int i4, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i4, (Method) builder.build());
            return this;
        }

        public Builder addMixins(int i4, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i4, (Mixin) builder.build());
            return this;
        }

        public Builder addOptions(int i4, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i4, (Option) builder.build());
            return this;
        }
    }
    ...
    /* access modifiers changed from: private */
    public void removeMethods(int i4) {
        ensureMethodsIsMutable();
        this.methods_.remove(i4);
    }

    /* access modifiers changed from: private */
    public void removeMixins(int i4) {
        ensureMixinsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setMethods(int i4, Method method) {
        method.getClass();
        ensureMethodsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setMixins(int i4, Mixin mixin) {
        mixin.getClass();
        ensureMixinsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addMethods(int i4, Method method) {
        method.getClass();
        ensureMethodsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addMixins(int i4, Mixin mixin) {
        mixin.getClass();
        ensureMixinsIsMutable();
