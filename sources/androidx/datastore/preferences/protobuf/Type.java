...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        ...
        public Field getFields(int i4) {
            return ((Type) this.instance).getFields(i4);
        }
        ...
        public String getOneofs(int i4) {
            return ((Type) this.instance).getOneofs(i4);
        }

        public ByteString getOneofsBytes(int i4) {
            return ((Type) this.instance).getOneofsBytes(i4);
        }
        ...
        public Option getOptions(int i4) {
            return ((Type) this.instance).getOptions(i4);
        }
        ...
        public Builder removeFields(int i4) {
            copyOnWrite();
            ((Type) this.instance).removeFields(i4);
            return this;
        }

        public Builder removeOptions(int i4) {
            copyOnWrite();
            ((Type) this.instance).removeOptions(i4);
            return this;
        }

        public Builder setFields(int i4, Field field) {
            copyOnWrite();
            ((Type) this.instance).setFields(i4, field);
            return this;
        }
        ...
        public Builder setOneofs(int i4, String str) {
            copyOnWrite();
            ((Type) this.instance).setOneofs(i4, str);
            return this;
        }

        public Builder setOptions(int i4, Option option) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i4, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i4) {
            copyOnWrite();
            ((Type) this.instance).setSyntaxValue(i4);
            return this;
        }
        ...
        public Builder addFields(int i4, Field field) {
            copyOnWrite();
            ((Type) this.instance).addFields(i4, field);
            return this;
        }

        public Builder addOptions(int i4, Option option) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i4, option);
            return this;
        }

        public Builder setFields(int i4, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i4, (Field) builder.build());
            return this;
        }

        public Builder setOptions(int i4, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i4, (Option) builder.build());
            return this;
        }
        ...
        public Builder addFields(int i4, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i4, (Field) builder.build());
            return this;
        }

        public Builder addOptions(int i4, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i4, (Option) builder.build());
            return this;
        }
    }
    ...
    /* access modifiers changed from: private */
    public void setFields(int i4, Field field) {
        field.getClass();
        ensureFieldsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void setOneofs(int i4, String str) {
        str.getClass();
        ensureOneofsIsMutable();
    ...
    /* access modifiers changed from: private */
    public void addFields(int i4, Field field) {
        field.getClass();
        ensureFieldsIsMutable();
