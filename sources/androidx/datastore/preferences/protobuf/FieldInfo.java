...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static final class Builder {
        ...
        public Builder withPresence(Field field2, int i4) {
    ...
    private FieldInfo(Field field2, int i4, FieldType fieldType, Class<?> cls, Field field3, int i5, boolean z4, boolean z5, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier2, Field field4) {
        this.field = field2;
        this.type = fieldType;
    ...
    public static FieldInfo forField(Field field2, int i4, FieldType fieldType, boolean z4) {
        ...
        if (fieldType2 != FieldType.MESSAGE_LIST && fieldType2 != FieldType.GROUP_LIST) {
            return new FieldInfo(field2, i4, fieldType2, (Class<?>) null, (Field) null, 0, false, z4, (OneofInfo) null, (Class<?>) null, (Object) null, (Internal.EnumVerifier) null, (Field) null);
        }
        throw new IllegalStateException("Shouldn't be called for repeated message fields.");
    }

    public static FieldInfo forFieldWithEnumVerifier(Field field2, int i4, FieldType fieldType, Internal.EnumVerifier enumVerifier2) {
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        return new FieldInfo(field2, i4, fieldType, (Class<?>) null, (Field) null, 0, false, false, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
    }

    public static FieldInfo forMapField(Field field2, int i4, Object obj, Internal.EnumVerifier enumVerifier2) {
        Object obj2 = obj;
        Internal.checkNotNull(obj2, "mapDefaultEntry");
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        return new FieldInfo(field2, i4, FieldType.MAP, (Class<?>) null, (Field) null, 0, false, true, (OneofInfo) null, (Class<?>) null, obj2, enumVerifier2, (Field) null);
    }

    public static FieldInfo forOneofMemberField(int i4, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z4, Internal.EnumVerifier enumVerifier2) {
        checkFieldNumber(i4);
        ...
        if (fieldType.isScalar()) {
            return new FieldInfo((Field) null, i4, fieldType, (Class<?>) null, (Field) null, 0, false, z4, oneofInfo2, cls2, (Object) null, enumVerifier2, (Field) null);
        }
        throw new IllegalArgumentException("Oneof is only supported for scalar fields. Field " + i4 + " is of type " + fieldType);
    }

    public static FieldInfo forPackedField(Field field2, int i4, FieldType fieldType, Field field3) {
        FieldType fieldType2 = fieldType;
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        Internal.checkNotNull(fieldType2, "fieldType");
        if (fieldType2 != FieldType.MESSAGE_LIST && fieldType2 != FieldType.GROUP_LIST) {
            return new FieldInfo(field2, i4, fieldType2, (Class<?>) null, (Field) null, 0, false, false, (OneofInfo) null, (Class<?>) null, (Object) null, (Internal.EnumVerifier) null, field3);
        }
        throw new IllegalStateException("Shouldn't be called for repeated message fields.");
    }

    public static FieldInfo forPackedFieldWithEnumVerifier(Field field2, int i4, FieldType fieldType, Internal.EnumVerifier enumVerifier2, Field field3) {
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        return new FieldInfo(field2, i4, fieldType, (Class<?>) null, (Field) null, 0, false, false, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, field3);
    }

    public static FieldInfo forProto2OptionalField(Field field2, int i4, FieldType fieldType, Field field3, int i5, boolean z4, Internal.EnumVerifier enumVerifier2) {
        Field field4 = field3;
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        FieldType fieldType2 = fieldType;
        ...
        if (field4 == null || isExactlyOneBitSet(i5)) {
            return new FieldInfo(field2, i4, fieldType2, (Class<?>) null, field4, i5, false, z4, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i5);
    }

    public static FieldInfo forProto2RequiredField(Field field2, int i4, FieldType fieldType, Field field3, int i5, boolean z4, Internal.EnumVerifier enumVerifier2) {
        Field field4 = field3;
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        FieldType fieldType2 = fieldType;
        ...
        Internal.checkNotNull(field4, "presenceField");
        if (field4 == null || isExactlyOneBitSet(i5)) {
            return new FieldInfo(field2, i4, fieldType2, (Class<?>) null, field4, i5, true, z4, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i5);
    }

    public static FieldInfo forRepeatedMessageField(Field field2, int i4, FieldType fieldType, Class<?> cls) {
        checkFieldNumber(i4);
        Internal.checkNotNull(field2, "field");
        FieldType fieldType2 = fieldType;
        Internal.checkNotNull(fieldType2, "fieldType");
        ...
        return new FieldInfo(field2, i4, fieldType2, cls2, (Field) null, 0, false, false, (OneofInfo) null, (Class<?>) null, (Object) null, (Internal.EnumVerifier) null, (Field) null);
    }
    ...
    public Class<?> getMessageFieldClass() {
        int i4 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i4 == 1 || i4 == 2) {
