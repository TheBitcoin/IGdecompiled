...
public class LazyFieldLite {
    ...
    public void writeTo(Writer writer, int i4) throws IOException {
        if (this.memoizedBytes != null) {
            writer.writeBytes(i4, this.memoizedBytes);
            return;
        }
        ByteString byteString = this.delayedBytes;
        if (byteString != null) {
            ...
            writer.writeMessage(i4, this.value);
        } else {
            writer.writeBytes(i4, ByteString.EMPTY);
        }
    }
