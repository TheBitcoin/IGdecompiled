...
final class MessageSetSchema<T> implements Schema<T> {
    ...
    private <UT, UB> int getUnknownFieldsSerializedSize(UnknownFieldSchema<UT, UB> unknownFieldSchema2, T t4) {
        return unknownFieldSchema2.getSerializedSizeAsMessageSet(unknownFieldSchema2.getFromMessage(t4));
    }

    private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema2, ExtensionSchema<ET> extensionSchema2, T t4, Reader reader, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        UnknownFieldSchema<UT, UB> unknownFieldSchema3;
        UB builderFromMessage = unknownFieldSchema2.getBuilderFromMessage(t4);
        FieldSet<ET> mutableExtensions = extensionSchema2.getMutableExtensions(t4);
            ...
            try {
                ...
                try {
                    if (parseMessageSetItemOrUnknownField(reader2, extensionRegistryLite2, extensionSchema3, mutableExtensions, unknownFieldSchema3, builderFromMessage)) {
                        ...
                        unknownFieldSchema3.setBuilderToMessage(t4, builderFromMessage);
                        return;
                    }
                } catch (Throwable th) {
                    th = th;
        ...
        if (tag == WireFormat.MESSAGE_SET_ITEM_TAG) {
            ...
            while (reader.getFieldNumber() != Integer.MAX_VALUE) {
                ...
                if (tag2 == WireFormat.MESSAGE_SET_TYPE_ID_TAG) {
                    ...
                    obj = extensionSchema2.findExtensionByNumber(extensionRegistryLite, this.defaultInstance, i4);
            ...
            if (reader.getTag() == WireFormat.MESSAGE_SET_ITEM_END_TAG) {
                if (byteString != null) {
                    if (obj != null) {
                        ...
                        unknownFieldSchema2.addLengthDelimited(ub, i4, byteString);
                    }
                }
                return true;
            }
    ...
    private <UT, UB> void writeUnknownFieldsHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema2, T t4, Writer writer) throws IOException {
        unknownFieldSchema2.writeAsMessageSetTo(unknownFieldSchema2.getFromMessage(t4), writer);
    }
    ...
    public int getSerializedSize(T t4) {
        ...
        if (this.hasExtensions) {
            return unknownFieldsSerializedSize + this.extensionSchema.getExtensions(t4).getMessageSetSerializedSize();
        }
    ...
    public int hashCode(T t4) {
        ...
        if (this.hasExtensions) {
            return (hashCode * 53) + this.extensionSchema.getExtensions(t4).hashCode();
        }
        return hashCode;
    }
