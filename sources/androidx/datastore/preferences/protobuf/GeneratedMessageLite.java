...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public BuilderType mergeFrom(byte[] bArr, int i4, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            copyOnWrite();
            try {
                Protobuf.getInstance().schemaFor(this.instance).mergeFrom(this.instance, bArr, i4, i4 + i5, new ArrayDecoders.Registers(extensionRegistryLite));
                return this;
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        public final <Type> BuilderType setExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int i4, Type type) {
            ...
            verifyExtensionContainingType(access$000);
            copyOnWrite();
            ensureExtensionsAreMutable().setRepeatedField(access$000.descriptor, i4, access$000.singularToFieldSetType(type));
            return this;
        }
    }
    ...
    static <T extends GeneratedMessageLite<?, ?>> T getDefaultInstance(Class<T> cls) {
        T t4 = (GeneratedMessageLite) defaultInstanceMap.get(cls);
        if (t4 == null) {
            try {
                Class.forName(cls.getName(), true, cls.getClassLoader());
                t4 = (GeneratedMessageLite) defaultInstanceMap.get(cls);
            } catch (ClassNotFoundException e5) {
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newRepeatedGeneratedExtension(ContainingType containingtype, MessageLite messageLite, Internal.EnumLiteMap<?> enumLiteMap, int i4, WireFormat.FieldType fieldType, boolean z4, Class cls) {
        ...
        int i5 = i4;
        return new GeneratedExtension<>(containingtype, Collections.EMPTY_LIST, messageLite, new ExtensionDescriptor(enumLiteMap2, i5, fieldType, true, z4), cls);
    }
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newSingularGeneratedExtension(ContainingType containingtype, Type type, MessageLite messageLite, Internal.EnumLiteMap<?> enumLiteMap, int i4, WireFormat.FieldType fieldType, Class cls) {
        ...
        return new GeneratedExtension<>(containingtype, type, messageLite2, new ExtensionDescriptor(enumLiteMap2, i4, fieldType, false, false), cls);
    }

    protected static <T extends GeneratedMessageLite<T, ?>> T parseDelimitedFrom(T t4, InputStream inputStream) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialDelimitedFrom(t4, inputStream, ExtensionRegistryLite.getEmptyRegistry()));
    }

    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parseFrom(t4, CodedInputStream.newInstance(byteBuffer), extensionRegistryLite));
    }
    ...
    private static <T extends GeneratedMessageLite<T, ?>> T parsePartialDelimitedFrom(T t4, InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            ...
            T parsePartialFrom = parsePartialFrom(t4, newInstance, extensionRegistryLite);
            try {
    ...
    static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t4, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        T newMutableInstance = t4.newMutableInstance();
        try {
    ...
    protected static <T extends GeneratedMessageLite<?, ?>> void registerDefaultInstance(Class<T> cls, T t4) {
        t4.markImmutable();
    ...
    /* access modifiers changed from: protected */
    public boolean parseUnknownField(int i4, CodedInputStream codedInputStream) throws IOException {
    ...
    protected static final <T extends GeneratedMessageLite<T, ?>> boolean isInitialized(T t4, boolean z4) {
        ...
        boolean isInitialized = Protobuf.getInstance().schemaFor(t4).isInitialized(t4);
        if (z4) {
            t4.dynamicMethod(MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED, isInitialized ? t4 : null);
        }
    ...
    protected static class DefaultInstanceBasedParser<T extends GeneratedMessageLite<T, ?>> extends AbstractParser<T> {
        ...
        public T parsePartialFrom(byte[] bArr, int i4, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parsePartialFrom(this.defaultInstance, bArr, i4, i5, extensionRegistryLite);
        }
    }
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, ByteBuffer byteBuffer) throws InvalidProtocolBufferException {
        return parseFrom(t4, byteBuffer, ExtensionRegistryLite.getEmptyRegistry());
    }

    protected static <T extends GeneratedMessageLite<T, ?>> T parseDelimitedFrom(T t4, InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialDelimitedFrom(t4, inputStream, extensionRegistryLite));
    }

    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, ByteString byteString) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parseFrom(t4, byteString, ExtensionRegistryLite.getEmptyRegistry()));
    }
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private void eagerlyMergeMessageSetExtension(CodedInputStream codedInputStream, GeneratedExtension<?, ?> generatedExtension, ExtensionRegistryLite extensionRegistryLite, int i4) throws IOException {
            ExtensionRegistryLite extensionRegistryLite2 = extensionRegistryLite;
            parseExtension(codedInputStream, extensionRegistryLite2, generatedExtension, WireFormat.makeTag(i4, 2), i4);
        }
        ...
        private <MessageType extends MessageLite> void mergeMessageSetExtensionFromCodedStream(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            ...
            while (true) {
                ...
                if (readTag == 0) {
                    ...
                    if (i4 != 0) {
                        generatedExtension = extensionRegistryLite.findLiteExtensionByNumber(messagetype, i4);
                    }
                } else if (readTag == WireFormat.MESSAGE_SET_MESSAGE_TAG) {
                    if (i4 == 0 || generatedExtension == null) {
                        byteString = codedInputStream.readBytes();
                    } else {
                        eagerlyMergeMessageSetExtension(codedInputStream, generatedExtension, extensionRegistryLite, i4);
                        byteString = null;
                    }
        ...
        /* access modifiers changed from: protected */
        public <MessageType extends MessageLite> boolean parseUnknownField(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int i4) throws IOException {
            int tagFieldNumber = WireFormat.getTagFieldNumber(i4);
            return parseExtension(codedInputStream, extensionRegistryLite, extensionRegistryLite.findLiteExtensionByNumber(messagetype, tagFieldNumber), i4, tagFieldNumber);
        }

        /* access modifiers changed from: protected */
        public <MessageType extends MessageLite> boolean parseUnknownFieldAsMessageSet(MessageType messagetype, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite, int i4) throws IOException {
            if (i4 == WireFormat.MESSAGE_SET_ITEM_TAG) {
                mergeMessageSetExtensionFromCodedStream(messagetype, codedInputStream, extensionRegistryLite);
                return true;
            } else if (WireFormat.getTagWireType(i4) == 2) {
                return parseUnknownField(messagetype, codedInputStream, extensionRegistryLite, i4);
            } else {
                return codedInputStream.skipField(i4);
            }
        }
        ...
        public final <Type> Type getExtension(ExtensionLite<MessageType, List<Type>> extensionLite, int i4) {
            GeneratedExtension access$000 = GeneratedMessageLite.checkIsLite(extensionLite);
            verifyExtensionContainingType(access$000);
            return access$000.singularFromFieldSetType(this.extensions.getRepeatedField(access$000.descriptor, i4));
        }
    }
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialFrom(t4, byteString, extensionRegistryLite));
    }
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, byte[] bArr) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialFrom(t4, bArr, 0, bArr.length, ExtensionRegistryLite.getEmptyRegistry()));
    }
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, byte[] bArr, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialFrom(t4, bArr, 0, bArr.length, extensionRegistryLite));
    }
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, InputStream inputStream) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialFrom(t4, CodedInputStream.newInstance(inputStream), ExtensionRegistryLite.getEmptyRegistry()));
    }

    /* access modifiers changed from: private */
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t4, byte[] bArr, int i4, int i5, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        T newMutableInstance = t4.newMutableInstance();
        try {
            Schema schemaFor = Protobuf.getInstance().schemaFor(newMutableInstance);
            schemaFor.mergeFrom(newMutableInstance, bArr, i4, i4 + i5, new ArrayDecoders.Registers(extensionRegistryLite));
            schemaFor.makeImmutable(newMutableInstance);
            return newMutableInstance;
        } catch (InvalidProtocolBufferException e5) {
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialFrom(t4, CodedInputStream.newInstance(inputStream), extensionRegistryLite));
    }

    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, CodedInputStream codedInputStream) throws InvalidProtocolBufferException {
        return parseFrom(t4, codedInputStream, ExtensionRegistryLite.getEmptyRegistry());
    }

    protected static <T extends GeneratedMessageLite<T, ?>> T parseFrom(T t4, CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        return checkMessageInitialized(parsePartialFrom(t4, codedInputStream, extensionRegistryLite));
    }
    ...
    protected static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t4, CodedInputStream codedInputStream) throws InvalidProtocolBufferException {
        return parsePartialFrom(t4, codedInputStream, ExtensionRegistryLite.getEmptyRegistry());
    }
    ...
    private static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t4, ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        T parsePartialFrom = parsePartialFrom(t4, newCodedInput, extensionRegistryLite);
        try {
