...
public final class Enum extends GeneratedMessageLite<Enum, Builder> implements EnumOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Enum, Builder> implements EnumOrBuilder {
        ...
        public EnumValue getEnumvalue(int i4) {
            return ((Enum) this.instance).getEnumvalue(i4);
        }
        ...
        public Option getOptions(int i4) {
            return ((Enum) this.instance).getOptions(i4);
        }
        ...
        public Builder removeEnumvalue(int i4) {
            copyOnWrite();
            ((Enum) this.instance).removeEnumvalue(i4);
            return this;
        }

        public Builder removeOptions(int i4) {
            copyOnWrite();
            ((Enum) this.instance).removeOptions(i4);
            return this;
        }

        public Builder setEnumvalue(int i4, EnumValue enumValue) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i4, enumValue);
            return this;
        }
        ...
        public Builder setOptions(int i4, Option option) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i4, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i4) {
            copyOnWrite();
            ((Enum) this.instance).setSyntaxValue(i4);
            return this;
        }
        ...
        public Builder addEnumvalue(int i4, EnumValue enumValue) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i4, enumValue);
            return this;
        }

        public Builder addOptions(int i4, Option option) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i4, option);
            return this;
        }

        public Builder setEnumvalue(int i4, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i4, (EnumValue) builder.build());
            return this;
        }

        public Builder setOptions(int i4, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i4, (Option) builder.build());
            return this;
        }
        ...
        public Builder addEnumvalue(int i4, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i4, (EnumValue) builder.build());
            return this;
        }

        public Builder addOptions(int i4, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i4, (Option) builder.build());
            return this;
        }
    }
