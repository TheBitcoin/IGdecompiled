...
final class ArrayDecoders {
    ...
    static int decodeBoolList(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
        boolean z4;
        boolean z5;
        BooleanArrayList booleanArrayList = (BooleanArrayList) protobufList;
        int decodeVarint64 = decodeVarint64(bArr, i5, registers);
    ...
    static int decodeBytes(byte[] bArr, int i4, Registers registers) throws InvalidProtocolBufferException {
        ...
        if (i5 < 0) {
            ...
            registers.object1 = ByteString.copyFrom(bArr, decodeVarint32, i5);
    ...
    static double decodeDouble(byte[] bArr, int i4) {
        return Double.longBitsToDouble(decodeFixed64(bArr, i4));
    }

    static int decodeDoubleList(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
        DoubleArrayList doubleArrayList = (DoubleArrayList) protobufList;
        doubleArrayList.addDouble(decodeDouble(bArr, i5));
        int i7 = i5 + 8;
        while (i7 < i6) {
            int decodeVarint32 = decodeVarint32(bArr, i7, registers);
            if (i4 != registers.int1) {
                break;
            }
    ...
    static int decodeExtensionOrUnknownField(int i4, byte[] bArr, int i5, int i6, Object obj, MessageLite messageLite, UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> unknownFieldSchema, Registers registers) throws IOException {
        GeneratedMessageLite.GeneratedExtension findLiteExtensionByNumber = registers.extensionRegistry.findLiteExtensionByNumber(messageLite, i4 >>> 3);
        if (findLiteExtensionByNumber == null) {
            return decodeUnknownField(i4, bArr, i5, i6, MessageSchema.getMutableUnknownFields(obj), registers);
        }
        GeneratedMessageLite.ExtendableMessage extendableMessage = (GeneratedMessageLite.ExtendableMessage) obj;
        extendableMessage.ensureExtensionsAreMutable();
        return decodeExtension(i4, bArr, i5, i6, extendableMessage, findLiteExtensionByNumber, unknownFieldSchema, registers);
    }

    static int decodeFixed32(byte[] bArr, int i4) {
        return ((bArr[i4 + 3] & 255) << 24) | (bArr[i4] & 255) | ((bArr[i4 + 1] & 255) << 8) | ((bArr[i4 + 2] & 255) << 16);
    }

    static int decodeFixed32List(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
    ...
    static long decodeFixed64(byte[] bArr, int i4) {
    ...
    static int decodeFixed64List(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
    ...
    static float decodeFloat(byte[] bArr, int i4) {
        return Float.intBitsToFloat(decodeFixed32(bArr, i4));
    }

    static int decodeFloatList(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
    ...
    static int decodeGroupField(Schema schema, byte[] bArr, int i4, int i5, int i6, Registers registers) throws IOException {
        Object newInstance = schema.newInstance();
        Schema schema2 = schema;
        Registers registers2 = registers;
        int mergeGroupField = mergeGroupField(newInstance, schema2, bArr, i4, i5, i6, registers2);
        schema2.makeImmutable(newInstance);
        registers2.object1 = newInstance;
        return mergeGroupField;
    }

    static int decodeGroupList(Schema schema, int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        int i7 = (i4 & -8) | 4;
        Schema schema2 = schema;
        byte[] bArr2 = bArr;
        int i8 = i6;
        Registers registers2 = registers;
        int decodeGroupField = decodeGroupField(schema2, bArr2, i5, i8, i7, registers2);
        ...
        while (decodeGroupField < i8) {
            ...
            if (i4 != registers2.int1) {
                break;
            }
            decodeGroupField = decodeGroupField(schema2, bArr2, decodeVarint32, i8, i7, registers2);
            protobufList.add(registers2.object1);
        }
        return decodeGroupField;
    }

    static int decodeMessageField(Schema schema, byte[] bArr, int i4, int i5, Registers registers) throws IOException {
        Object newInstance = schema.newInstance();
        Schema schema2 = schema;
        Registers registers2 = registers;
        int mergeMessageField = mergeMessageField(newInstance, schema2, bArr, i4, i5, registers2);
        schema2.makeImmutable(newInstance);
        registers2.object1 = newInstance;
        return mergeMessageField;
    }

    static int decodeMessageList(Schema<?> schema, int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        int decodeMessageField = decodeMessageField(schema, bArr, i5, i6, registers);
        protobufList.add(registers.object1);
        while (decodeMessageField < i6) {
            int decodeVarint32 = decodeVarint32(bArr, decodeMessageField, registers);
            if (i4 != registers.int1) {
                break;
            }
            decodeMessageField = decodeMessageField(schema, bArr, decodeVarint32, i6, registers);
            protobufList.add(registers.object1);
        }
        return decodeMessageField;
    }

    static int decodePackedBoolList(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        boolean z4;
        BooleanArrayList booleanArrayList = (BooleanArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
    ...
    static int decodePackedDoubleList(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        DoubleArrayList doubleArrayList = (DoubleArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedFixed32List(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        IntArrayList intArrayList = (IntArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedFixed64List(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        LongArrayList longArrayList = (LongArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedFloatList(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        FloatArrayList floatArrayList = (FloatArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedSInt32List(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        IntArrayList intArrayList = (IntArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedSInt64List(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        LongArrayList longArrayList = (LongArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedVarint32List(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        IntArrayList intArrayList = (IntArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodePackedVarint64List(byte[] bArr, int i4, Internal.ProtobufList<?> protobufList, Registers registers) throws IOException {
        LongArrayList longArrayList = (LongArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1 + decodeVarint32;
        while (decodeVarint32 < i5) {
    ...
    static int decodeSInt32List(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
        IntArrayList intArrayList = (IntArrayList) protobufList;
    ...
    static int decodeSInt64List(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
        LongArrayList longArrayList = (LongArrayList) protobufList;
        int decodeVarint64 = decodeVarint64(bArr, i5, registers);
        longArrayList.addLong(CodedInputStream.decodeZigZag64(registers.long1));
        while (decodeVarint64 < i6) {
    ...
    static int decodeString(byte[] bArr, int i4, Registers registers) throws InvalidProtocolBufferException {
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1;
        if (i5 < 0) {
            throw InvalidProtocolBufferException.negativeSize();
            ...
            registers.object1 = new String(bArr, decodeVarint32, i5, Internal.UTF_8);
            return decodeVarint32 + i5;
        }
    }
    ...
    static int decodeStringRequireUtf8(byte[] bArr, int i4, Registers registers) throws InvalidProtocolBufferException {
        int decodeVarint32 = decodeVarint32(bArr, i4, registers);
        int i5 = registers.int1;
        if (i5 < 0) {
            throw InvalidProtocolBufferException.negativeSize();
            ...
            registers.object1 = Utf8.decodeUtf8(bArr, decodeVarint32, i5);
            return decodeVarint32 + i5;
        }
    }

    static int decodeUnknownField(int i4, byte[] bArr, int i5, int i6, UnknownFieldSetLite unknownFieldSetLite, Registers registers) throws InvalidProtocolBufferException {
        if (WireFormat.getTagFieldNumber(i4) != 0) {
            int tagWireType = WireFormat.getTagWireType(i4);
            if (tagWireType == 0) {
                Registers registers2 = registers;
                int decodeVarint64 = decodeVarint64(bArr, i5, registers2);
                unknownFieldSetLite.storeField(i4, Long.valueOf(registers2.long1));
                return decodeVarint64;
            } else if (tagWireType == 1) {
                unknownFieldSetLite.storeField(i4, Long.valueOf(decodeFixed64(bArr, i5)));
                return i5 + 8;
            } else if (tagWireType == 2) {
                byte[] bArr2 = bArr;
                Registers registers3 = registers;
                int decodeVarint32 = decodeVarint32(bArr2, i5, registers3);
                int i7 = registers3.int1;
                if (i7 < 0) {
                    throw InvalidProtocolBufferException.negativeSize();
                } else if (i7 <= bArr2.length - decodeVarint32) {
                    if (i7 == 0) {
                        unknownFieldSetLite.storeField(i4, ByteString.EMPTY);
                    } else {
                        unknownFieldSetLite.storeField(i4, ByteString.copyFrom(bArr2, decodeVarint32, i7));
                    }
                ...
                while (true) {
                    ...
                    int decodeVarint322 = decodeVarint32(bArr, i5, registers);
                    i9 = registers.int1;
                    if (i9 == i8) {
                        i5 = decodeVarint322;
                        break;
                    }
                    i5 = decodeUnknownField(i9, bArr, decodeVarint322, i6, newInstance, registers);
                }
                if (i5 > i6 || i9 != i8) {
                ...
                unknownFieldSetLite.storeField(i4, Integer.valueOf(decodeFixed32(bArr, i5)));
                return i5 + 4;
            } else {
    ...
    static int decodeVarint32(byte[] bArr, int i4, Registers registers) {
        int i5 = i4 + 1;
        byte b5 = bArr[i4];
        if (b5 < 0) {
            return decodeVarint32(b5, bArr, i5, registers);
        }
        registers.int1 = b5;
        return i5;
    }

    static int decodeVarint32List(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
        IntArrayList intArrayList = (IntArrayList) protobufList;
        int decodeVarint32 = decodeVarint32(bArr, i5, registers);
        intArrayList.addInt(registers.int1);
        while (decodeVarint32 < i6) {
    ...
    static int decodeVarint64(byte[] bArr, int i4, Registers registers) {
        int i5 = i4 + 1;
        long j4 = (long) bArr[i4];
        if (j4 < 0) {
            return decodeVarint64(j4, bArr, i5, registers);
        }
        registers.long1 = j4;
        return i5;
    }

    static int decodeVarint64List(int i4, byte[] bArr, int i5, int i6, Internal.ProtobufList<?> protobufList, Registers registers) {
        LongArrayList longArrayList = (LongArrayList) protobufList;
        int decodeVarint64 = decodeVarint64(bArr, i5, registers);
        longArrayList.addLong(registers.long1);
        while (decodeVarint64 < i6) {
    ...
    static int mergeGroupField(Object obj, Schema schema, byte[] bArr, int i4, int i5, int i6, Registers registers) throws IOException {
        MessageSchema messageSchema = (MessageSchema) schema;
        Object obj2 = obj;
        int parseProto2Message = messageSchema.parseProto2Message(obj2, bArr, i4, i5, i6, registers);
    ...
    static int skipField(int i4, byte[] bArr, int i5, int i6, Registers registers) throws InvalidProtocolBufferException {
        if (WireFormat.getTagFieldNumber(i4) != 0) {
            int tagWireType = WireFormat.getTagWireType(i4);
            if (tagWireType == 0) {
            ...
            if (tagWireType == 3) {
                ...
                while (i5 < i6) {
                    ...
                    i5 = skipField(i8, bArr, i5, i6, registers);
                }
                if (i5 <= i6 && i8 == i7) {
                    return i5;
                }
    ...
    static int decodeVarint32(int i4, byte[] bArr, int i5, Registers registers) {
        int i6 = i4 & ModuleDescriptor.MODULE_VERSION;
        int i7 = i5 + 1;
        byte b5 = bArr[i5];
        if (b5 >= 0) {
            registers.int1 = i6 | (b5 << 7);
            return i7;
        }
    ...
    static int decodeVarint64(long j4, byte[] bArr, int i4, Registers registers) {
        int i5 = i4 + 1;
        byte b5 = bArr[i4];
