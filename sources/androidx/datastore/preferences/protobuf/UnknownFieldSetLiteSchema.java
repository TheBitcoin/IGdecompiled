...
class UnknownFieldSetLiteSchema extends UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> {
    ...
    /* access modifiers changed from: package-private */
    public void addFixed32(UnknownFieldSetLite unknownFieldSetLite, int i4, int i5) {
        unknownFieldSetLite.storeField(WireFormat.makeTag(i4, 5), Integer.valueOf(i5));
    }

    /* access modifiers changed from: package-private */
    public void addFixed64(UnknownFieldSetLite unknownFieldSetLite, int i4, long j4) {
        unknownFieldSetLite.storeField(WireFormat.makeTag(i4, 1), Long.valueOf(j4));
    }

    /* access modifiers changed from: package-private */
    public void addGroup(UnknownFieldSetLite unknownFieldSetLite, int i4, UnknownFieldSetLite unknownFieldSetLite2) {
        unknownFieldSetLite.storeField(WireFormat.makeTag(i4, 3), unknownFieldSetLite2);
    }

    /* access modifiers changed from: package-private */
    public void addLengthDelimited(UnknownFieldSetLite unknownFieldSetLite, int i4, ByteString byteString) {
        unknownFieldSetLite.storeField(WireFormat.makeTag(i4, 2), byteString);
    }

    /* access modifiers changed from: package-private */
    public void addVarint(UnknownFieldSetLite unknownFieldSetLite, int i4, long j4) {
        unknownFieldSetLite.storeField(WireFormat.makeTag(i4, 0), Long.valueOf(j4));
    }
