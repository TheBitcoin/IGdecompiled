...
final class CodedInputStreamReader implements Reader {
    ...
    private <T> void mergeGroupFieldInternal(T t4, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        int i4 = this.endGroupTag;
        this.endGroupTag = WireFormat.makeTag(WireFormat.getTagFieldNumber(this.tag), 4);
        try {
            schema.mergeFrom(t4, this, extensionRegistryLite);
    ...
    private <T> void mergeMessageFieldInternal(T t4, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
    ...
    private void requirePosition(int i4) throws IOException {
        if (this.input.getTotalBytesRead() != i4) {
            throw InvalidProtocolBufferException.truncatedMessage();
        }
    }

    private void requireWireType(int i4) throws IOException {
        if (WireFormat.getTagWireType(this.tag) != i4) {
    ...
    public <T> void mergeGroupField(T t4, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(3);
        mergeGroupFieldInternal(t4, schema, extensionRegistryLite);
    }

    public <T> void mergeMessageField(T t4, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(2);
        mergeMessageFieldInternal(t4, schema, extensionRegistryLite);
    }
    ...
    public boolean skipField() throws IOException {
        int i4;
        if (this.input.isAtEnd() || (i4 = this.tag) == this.endGroupTag) {
            return false;
        }
        return this.input.skipField(i4);
    }
