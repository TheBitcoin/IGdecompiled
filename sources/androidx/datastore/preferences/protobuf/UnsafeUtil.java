...
final class UnsafeUtil {
    ...
    private static final class Android32MemoryAccessor extends MemoryAccessor {
        ...
        public boolean getBoolean(Object obj, long j4) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                return UnsafeUtil.getBooleanBigEndian(obj, j4);
            }
            return UnsafeUtil.getBooleanLittleEndian(obj, j4);
        }

        public byte getByte(Object obj, long j4) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                return UnsafeUtil.getByteBigEndian(obj, j4);
            }
            return UnsafeUtil.getByteLittleEndian(obj, j4);
        }
        ...
        public void putBoolean(Object obj, long j4, boolean z4) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                UnsafeUtil.putBooleanBigEndian(obj, j4, z4);
            } else {
                UnsafeUtil.putBooleanLittleEndian(obj, j4, z4);
            }
        }

        public void putByte(Object obj, long j4, byte b5) {
            if (UnsafeUtil.IS_BIG_ENDIAN) {
                UnsafeUtil.putByteBigEndian(obj, j4, b5);
            } else {
                UnsafeUtil.putByteLittleEndian(obj, j4, b5);
            }
        }

        public void putDouble(Object obj, long j4, double d5) {
            putLong(obj, j4, Double.doubleToLongBits(d5));
        }
        ...
        public void putByte(long j4, byte b5) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private static final class JvmMemoryAccessor extends MemoryAccessor {
        ...
        public void copyMemory(long j4, byte[] bArr, long j5, long j6) {
            this.unsafe.copyMemory((Object) null, j4, bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j5, j6);
        }
        ...
        public void putByte(Object obj, long j4, byte b5) {
            this.unsafe.putByte(obj, j4, b5);
        }

        public void putDouble(Object obj, long j4, double d5) {
            this.unsafe.putDouble(obj, j4, d5);
        }
        ...
        public void copyMemory(byte[] bArr, long j4, long j5, long j6) {
            byte[] bArr2 = bArr;
            this.unsafe.copyMemory(bArr2, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j4, (Object) null, j5, j6);
        }
    ...
    private static abstract class MemoryAccessor {
        ...
        public abstract void putBoolean(Object obj, long j4, boolean z4);

        public abstract void putByte(long j4, byte b5);

        public abstract void putByte(Object obj, long j4, byte b5);

        public abstract void putDouble(Object obj, long j4, double d5);
        ...
        public abstract void putLong(long j4, long j5);
    ...
    static void copyMemory(byte[] bArr, long j4, long j5, long j6) {
        MEMORY_ACCESSOR.copyMemory(bArr, j4, j5, j6);
    }
    ...
    private static int firstDifferingByteIndexNativeEndian(long j4, long j5) {
        int i4;
        if (IS_BIG_ENDIAN) {
            i4 = Long.numberOfLeadingZeros(j4 ^ j5);
        } else {
            i4 = Long.numberOfTrailingZeros(j4 ^ j5);
        }
        return i4 >> 3;
    }

    static boolean getBoolean(Object obj, long j4) {
        return MEMORY_ACCESSOR.getBoolean(obj, j4);
    }

    /* access modifiers changed from: private */
    public static boolean getBooleanBigEndian(Object obj, long j4) {
        if (getByteBigEndian(obj, j4) != 0) {
            return true;
        }
        return false;
    }
    ...
    public static boolean getBooleanLittleEndian(Object obj, long j4) {
        if (getByteLittleEndian(obj, j4) != 0) {
            return true;
        }
        return false;
    }

    static byte getByte(Object obj, long j4) {
        return MEMORY_ACCESSOR.getByte(obj, j4);
    }

    /* access modifiers changed from: private */
    public static byte getByteBigEndian(Object obj, long j4) {
        return (byte) ((getInt(obj, -4 & j4) >>> ((int) (((~j4) & 3) << 3))) & 255);
    }
    ...
    static double getDouble(Object obj, long j4) {
        return MEMORY_ACCESSOR.getDouble(obj, j4);
    }

    static float getFloat(Object obj, long j4) {
        return MEMORY_ACCESSOR.getFloat(obj, j4);
    }

    static int getInt(Object obj, long j4) {
        return MEMORY_ACCESSOR.getInt(obj, j4);
    }

    static long getLong(Object obj, long j4) {
    ...
    static Object getObject(Object obj, long j4) {
    ...
    static int mismatch(byte[] bArr, int i4, byte[] bArr2, int i5, int i6) {
        if (i4 < 0 || i5 < 0 || i6 < 0 || i4 + i6 > bArr.length || i5 + i6 > bArr2.length) {
            throw new IndexOutOfBoundsException();
        }
        int i7 = 0;
        if (HAS_UNSAFE_ARRAY_OPERATIONS) {
            int i8 = (BYTE_ARRAY_ALIGNMENT + i4) & 7;
            while (i7 < i6 && (i8 & 7) != 0) {
            ...
            while (i7 < i9) {
                ...
                long j5 = (long) i7;
                long j6 = getLong((Object) bArr, ((long) i4) + j4 + j5);
                long j7 = getLong((Object) bArr2, j4 + ((long) i5) + j5);
                if (j6 != j7) {
                    return i7 + firstDifferingByteIndexNativeEndian(j6, j7);
                }
                i7 += 8;
            }
        }
    ...
    static void putBoolean(Object obj, long j4, boolean z4) {
        MEMORY_ACCESSOR.putBoolean(obj, j4, z4);
    }

    /* access modifiers changed from: private */
    public static void putBooleanBigEndian(Object obj, long j4, boolean z4) {
        putByteBigEndian(obj, j4, z4 ? (byte) 1 : 0);
    }

    /* access modifiers changed from: private */
    public static void putBooleanLittleEndian(Object obj, long j4, boolean z4) {
        putByteLittleEndian(obj, j4, z4 ? (byte) 1 : 0);
    }

    static void putByte(Object obj, long j4, byte b5) {
        MEMORY_ACCESSOR.putByte(obj, j4, b5);
    }

    /* access modifiers changed from: private */
    public static void putByteBigEndian(Object obj, long j4, byte b5) {
        long j5 = -4 & j4;
        int i4 = getInt(obj, j5);
        int i5 = ((~((int) j4)) & 3) << 3;
        putInt(obj, j5, ((255 & b5) << i5) | (i4 & (~(255 << i5))));
    }

    /* access modifiers changed from: private */
    public static void putByteLittleEndian(Object obj, long j4, byte b5) {
        long j5 = -4 & j4;
        int i4 = (((int) j4) & 3) << 3;
        putInt(obj, j5, ((255 & b5) << i4) | (getInt(obj, j5) & (~(255 << i4))));
    }

    static void putDouble(Object obj, long j4, double d5) {
        MEMORY_ACCESSOR.putDouble(obj, j4, d5);
    }

    static void putFloat(Object obj, long j4, float f4) {
        MEMORY_ACCESSOR.putFloat(obj, j4, f4);
    }

    static void putInt(Object obj, long j4, int i4) {
        MEMORY_ACCESSOR.putInt(obj, j4, i4);
    }

    static void putLong(Object obj, long j4, long j5) {
        MEMORY_ACCESSOR.putLong(obj, j4, j5);
    }

    static void putObject(Object obj, long j4, Object obj2) {
    ...
    static void copyMemory(long j4, byte[] bArr, long j5, long j6) {
        MEMORY_ACCESSOR.copyMemory(j4, bArr, j5, j6);
    }

    static boolean getBoolean(boolean[] zArr, long j4) {
        return MEMORY_ACCESSOR.getBoolean(zArr, BOOLEAN_ARRAY_BASE_OFFSET + (j4 * BOOLEAN_ARRAY_INDEX_SCALE));
    }

    static byte getByte(byte[] bArr, long j4) {
        return MEMORY_ACCESSOR.getByte(bArr, BYTE_ARRAY_BASE_OFFSET + j4);
    }

    static double getDouble(double[] dArr, long j4) {
        return MEMORY_ACCESSOR.getDouble(dArr, DOUBLE_ARRAY_BASE_OFFSET + (j4 * DOUBLE_ARRAY_INDEX_SCALE));
    }

    static float getFloat(float[] fArr, long j4) {
        return MEMORY_ACCESSOR.getFloat(fArr, FLOAT_ARRAY_BASE_OFFSET + (j4 * FLOAT_ARRAY_INDEX_SCALE));
    }

    static int getInt(int[] iArr, long j4) {
        return MEMORY_ACCESSOR.getInt(iArr, INT_ARRAY_BASE_OFFSET + (j4 * INT_ARRAY_INDEX_SCALE));
    }

    static long getLong(long[] jArr, long j4) {
        return MEMORY_ACCESSOR.getLong(jArr, LONG_ARRAY_BASE_OFFSET + (j4 * LONG_ARRAY_INDEX_SCALE));
    }

    static Object getObject(Object[] objArr, long j4) {
        return MEMORY_ACCESSOR.getObject(objArr, OBJECT_ARRAY_BASE_OFFSET + (j4 * OBJECT_ARRAY_INDEX_SCALE));
    }

    static void putBoolean(boolean[] zArr, long j4, boolean z4) {
        MEMORY_ACCESSOR.putBoolean(zArr, BOOLEAN_ARRAY_BASE_OFFSET + (j4 * BOOLEAN_ARRAY_INDEX_SCALE), z4);
    }

    static void putByte(byte[] bArr, long j4, byte b5) {
        MEMORY_ACCESSOR.putByte(bArr, BYTE_ARRAY_BASE_OFFSET + j4, b5);
    }

    static void putDouble(double[] dArr, long j4, double d5) {
        double[] dArr2 = dArr;
        MEMORY_ACCESSOR.putDouble(dArr2, DOUBLE_ARRAY_BASE_OFFSET + (j4 * DOUBLE_ARRAY_INDEX_SCALE), d5);
    }

    static void putFloat(float[] fArr, long j4, float f4) {
        MEMORY_ACCESSOR.putFloat(fArr, FLOAT_ARRAY_BASE_OFFSET + (j4 * FLOAT_ARRAY_INDEX_SCALE), f4);
    }

    static void putInt(int[] iArr, long j4, int i4) {
        MEMORY_ACCESSOR.putInt(iArr, INT_ARRAY_BASE_OFFSET + (j4 * INT_ARRAY_INDEX_SCALE), i4);
    }

    static void putLong(long[] jArr, long j4, long j5) {
        long[] jArr2 = jArr;
        MEMORY_ACCESSOR.putLong(jArr2, LONG_ARRAY_BASE_OFFSET + (j4 * LONG_ARRAY_INDEX_SCALE), j5);
    }

    static void putObject(Object[] objArr, long j4, Object obj) {
        MEMORY_ACCESSOR.putObject(objArr, OBJECT_ARRAY_BASE_OFFSET + (j4 * OBJECT_ARRAY_INDEX_SCALE), obj);
    }

    static void copyMemory(byte[] bArr, long j4, byte[] bArr2, long j5, long j6) {
        System.arraycopy(bArr, (int) j4, bArr2, (int) j5, (int) j6);
    }

    static byte getByte(long j4) {
        return MEMORY_ACCESSOR.getByte(j4);
    }

    static int getInt(long j4) {
        return MEMORY_ACCESSOR.getInt(j4);
    }

    static long getLong(long j4) {
        return MEMORY_ACCESSOR.getLong(j4);
    }

    static void putByte(long j4, byte b5) {
        MEMORY_ACCESSOR.putByte(j4, b5);
    }

    static void putInt(long j4, int i4) {
        MEMORY_ACCESSOR.putInt(j4, i4);
    }

    static void putLong(long j4, long j5) {
        MEMORY_ACCESSOR.putLong(j4, j5);
    }
}
