...
final class MeasurementManagerFutures$Api33Ext5JavaImpl$registerSourceAsync$1 extends l implements p {
    ...
    MeasurementManagerFutures$Api33Ext5JavaImpl$registerSourceAsync$1(MeasurementManagerFutures.Api33Ext5JavaImpl api33Ext5JavaImpl, Uri uri, InputEvent inputEvent, d dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            this.label = 1;
            if (access$getMMeasurementManager$p.registerSource(uri, inputEvent, this) == c5) {
                return c5;
            }
        } else if (i4 == 1) {
            n.b(obj);
    ...
    public final Object invoke(J j4, d dVar) {
        return ((MeasurementManagerFutures$Api33Ext5JavaImpl$registerSourceAsync$1) create(j4, dVar)).invokeSuspend(s.f8222a);
    }
}
