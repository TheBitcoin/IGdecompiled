...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i4, int i5, int i6, int i7) {
        ...
        int i12 = (int) (((float) (i10 - i8)) - translationX);
        int i13 = (int) (((float) (i11 - i9)) - translationY);
        ...
        if (viewHolder2 != null) {
            ...
            viewHolder2.itemView.setTranslationX((float) (-i12));
            viewHolder2.itemView.setTranslationY((float) (-i13));
            viewHolder2.itemView.setAlpha(0.0f);
        }
        int i14 = i10;
        int i15 = i11;
        this.mPendingChanges.add(new ChangeInfo(viewHolder3, viewHolder2, i8, i9, i14, i15));
        return true;
    }
        ...
        if (!isEmpty || !isEmpty2 || !isEmpty4 || !isEmpty3) {
            ...
            if (!isEmpty4) {
                ...
                if (!isEmpty || !isEmpty2 || !isEmpty3) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder) arrayList4.get(0)).itemView, r4, j4 + Math.max(j5, j6));
                    return;
                }
                r4.run();
            }
