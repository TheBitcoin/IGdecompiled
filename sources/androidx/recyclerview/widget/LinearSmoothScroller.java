...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public int calculateDxToMakeVisible(View view, int i4) {
        ...
        return calculateDtToFit(layoutManager.getDecoratedLeft(view) - layoutParams.leftMargin, layoutManager.getDecoratedRight(view) + layoutParams.rightMargin, layoutManager.getPaddingLeft(), layoutManager.getWidth() - layoutManager.getPaddingRight(), i4);
    }
    ...
    public int calculateDyToMakeVisible(View view, int i4) {
        ...
        RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) view.getLayoutParams();
        return calculateDtToFit(layoutManager.getDecoratedTop(view) - layoutParams.topMargin, layoutManager.getDecoratedBottom(view) + layoutParams.bottomMargin, layoutManager.getPaddingTop(), layoutManager.getHeight() - layoutManager.getPaddingBottom(), i4);
    }
    ...
    public int calculateTimeForDeceleration(int i4) {
        return (int) Math.ceil(((double) calculateTimeForScrolling(i4)) / 0.3356d);
    }

    /* access modifiers changed from: protected */
    public int calculateTimeForScrolling(int i4) {
        return (int) Math.ceil((double) (((float) Math.abs(i4)) * getSpeedPerPixel()));
    }
