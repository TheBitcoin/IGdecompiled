...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        /* access modifiers changed from: package-private */
        public int addTransition(int i4, int i5, @NonNull Drawable drawable, boolean z4) {
            long j4;
            int addChild = super.addChild(drawable);
            long generateTransitionKey = generateTransitionKey(i4, i5);
            if (z4) {
                j4 = REVERSIBLE_FLAG_BIT;
            } else {
                j4 = 0;
            }
            long j5 = (long) addChild;
        ...
        public boolean isTransitionReversed(int i4, int i5) {
            if ((this.mTransitions.get(generateTransitionKey(i4, i5), -1L).longValue() & REVERSED_BIT) != 0) {
                return true;
            }
            return false;
        }
        ...
        public boolean transitionHasReversibleFlag(int i4, int i5) {
            if ((this.mTransitions.get(generateTransitionKey(i4, i5), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0) {
                return true;
            }
            return false;
        }
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        public float getInterpolation(float f4) {
            float f5;
            int i4 = (int) ((f4 * ((float) this.mTotalDuration)) + 0.5f);
            int i5 = this.mFrames;
            ...
            if (i6 < i5) {
                f5 = ((float) i4) / ((float) this.mTotalDuration);
            } else {
                f5 = 0.0f;
            }
    ...
    private boolean selectTransition(int i4) {
        ...
        if (transition2 == null) {
            i5 = getCurrentIndex();
        } else if (i4 == this.mTransitionToIndex) {
            return true;
        } else {
            if (i4 != this.mTransitionFromIndex || !transition2.canReverse()) {
                i5 = this.mTransitionToIndex;
                transition2.stop();
            } else {
                transition2.reverse();
        ...
        int keyframeIdAt = animatedStateListState.getKeyframeIdAt(i5);
