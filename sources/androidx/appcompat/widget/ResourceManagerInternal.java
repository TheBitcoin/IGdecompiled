...
public final class ResourceManagerInternal {
    ...
    private static class ColorFilterLruCache extends LruCache<Integer, PorterDuffColorFilter> {
        ...
        public PorterDuffColorFilter get(int i4, PorterDuff.Mode mode) {
            return (PorterDuffColorFilter) get(Integer.valueOf(generateCacheKey(i4, mode)));
        }

        /* access modifiers changed from: package-private */
        public PorterDuffColorFilter put(int i4, PorterDuff.Mode mode, PorterDuffColorFilter porterDuffColorFilter) {
            return (PorterDuffColorFilter) put(Integer.valueOf(generateCacheKey(i4, mode)), porterDuffColorFilter);
        }
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i4) {
        ...
        if (resourceManagerHooks == null) {
            ...
            drawable = resourceManagerHooks.createDrawableFor(this, context, i4);
        }
        if (drawable != null) {
    ...
    private ColorStateList getTintListFromCache(@NonNull Context context, @DrawableRes int i4) {
        ...
        return (ColorStateList) sparseArrayCompat.get(i4);
    }
    ...
    public synchronized ColorStateList getTintList(@NonNull Context context, @DrawableRes int i4) {
        ...
        if (tintListFromCache == null) {
            ...
            if (resourceManagerHooks == null) {
                ...
                tintListFromCache = resourceManagerHooks.getTintListForDrawableRes(context, i4);
            }
            if (tintListFromCache != null) {
    ...
    public boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int i4, @NonNull Drawable drawable) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if (resourceManagerHooks == null || !resourceManagerHooks.tintDrawableUsingColorFilter(context, i4, drawable)) {
            return false;
        }
        return true;
    }
