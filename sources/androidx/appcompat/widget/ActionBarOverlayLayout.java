...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private boolean applyInsets(@NonNull View view, @NonNull Rect rect, boolean z4, boolean z5, boolean z6, boolean z7) {
        ...
        if (!z4 || layoutParams.leftMargin == (i7 = rect.left)) {
            z8 = false;
        } else {
            layoutParams.leftMargin = i7;
            z8 = true;
        }
        if (z5 && layoutParams.topMargin != (i6 = rect.top)) {
            layoutParams.topMargin = i6;
            z8 = true;
        }
        if (z7 && layoutParams.rightMargin != (i5 = rect.right)) {
            layoutParams.rightMargin = i5;
            z8 = true;
        }
        if (!z6 || layoutParams.bottomMargin == (i4 = rect.bottom)) {
            return z8;
        }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null) {
            if (this.mActionBarTop.getVisibility() == 0) {
                i4 = (int) (((float) this.mActionBarTop.getBottom()) + this.mActionBarTop.getTranslationY() + 0.5f);
            } else {
                i4 = 0;
            }
            this.mWindowContentOverlay.setBounds(0, i4, getWidth(), this.mWindowContentOverlay.getIntrinsicHeight() + i4);
    ...
    public void onMeasure(int i4, int i5) {
        ...
        if (z4) {
            i6 = this.mActionBarHeight;
            if (this.mHasNonEmbeddedTabs && this.mActionBarTop.getTabContainer() != null) {
                i6 += this.mActionBarHeight;
            }
        } else {
            i6 = this.mActionBarTop.getVisibility() != 8 ? this.mActionBarTop.getMeasuredHeight() : 0;
        }
        this.mContentInsets.set(this.mBaseContentInsets);
        this.mInnerInsets = this.mBaseInnerInsets;
        if (this.mOverlayMode || z4 || !decorFitsSystemWindows()) {
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + i6, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
        } else {
            Rect rect = this.mContentInsets;
            rect.top += i6;
            rect.bottom = rect.bottom;
            this.mInnerInsets = this.mInnerInsets.inset(0, i6, 0, 0);
        }
    ...
    public void setActionBarHideOffset(int i4) {
        haltActionBarHideOffsetAnimations();
        this.mActionBarTop.setTranslationY((float) (-Math.max(0, Math.min(i4, this.mActionBarTop.getHeight()))));
    }
