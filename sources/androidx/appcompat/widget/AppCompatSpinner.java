...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i4) {
            ...
            if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                AppCompatSpinner.this.performItemClick((View) null, i4, this.mListAdapter.getItemId(i4));
            }
            dismiss();
        }
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(@Nullable SpinnerAdapter spinnerAdapter, @Nullable Resources.Theme theme) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && C0368v.a(spinnerAdapter)) {
                Api23Impl.setDropDownViewTheme(C0369w.a(spinnerAdapter), theme);
        ...
        public void computeContentWidth() {
            ...
            if (background != null) {
                ...
                if (ViewUtils.isLayoutRtl(AppCompatSpinner.this)) {
                    i4 = AppCompatSpinner.this.mTempRect.right;
                } else {
                    i4 = -AppCompatSpinner.this.mTempRect.left;
                }
            } else {
            ...
            if (ViewUtils.isLayoutRtl(AppCompatSpinner.this)) {
                i5 = i4 + (((width - paddingRight) - getWidth()) - getHorizontalOriginalOffset());
            } else {
                i5 = i4 + paddingLeft + getHorizontalOriginalOffset();
            }
    ...
    public AppCompatSpinner(@NonNull Context context, int i4) {
        this(context, (AttributeSet) null, R.attr.spinnerStyle, i4);
    }
