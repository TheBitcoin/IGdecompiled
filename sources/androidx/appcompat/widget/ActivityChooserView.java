...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getItemViewType(int i4) {
            if (!this.mShowFooterView || i4 != getCount() - 1) {
                return 0;
            }
            return 1;
        }
        ...
        public int measureContentWidth() {
            ...
            for (int i6 = 0; i6 < count; i6++) {
                view = getView(i6, view, (ViewGroup) null);
    ...
    public void showPopupUnchecked(int i4) {
        ...
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (i4 == Integer.MAX_VALUE || activityCount <= i4 + (z4 ? 1 : 0)) {
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context2, iArr, attributeSet, obtainStyledAttributes, i4, 0);
