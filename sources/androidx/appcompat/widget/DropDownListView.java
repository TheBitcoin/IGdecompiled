...
class DropDownListView extends ListView {
    ...
    static class Api21Impl {
        ...
        @DoNotInline
        static void drawableHotspotChanged(View view, float f4, float f5) {
    ...
    static class Api30Impl {
        ...
        static void positionSelectorForHoveredItem(DropDownListView dropDownListView, int i4, View view) {
            try {
                sPositionSelector.invoke(dropDownListView, new Object[]{Integer.valueOf(i4), view, Boolean.FALSE, -1, -1});
                sSetSelectedPositionInt.invoke(dropDownListView, new Object[]{Integer.valueOf(i4)});
                sSetNextSelectedPositionInt.invoke(dropDownListView, new Object[]{Integer.valueOf(i4)});
    ...
    private void setPressedItem(View view, int i4, float f4, float f5) {
        ...
        Api21Impl.drawableHotspotChanged(this, f4, f5);
        if (!isPressed()) {
            setPressed(true);
        }
        layoutChildren();
        ...
        Api21Impl.drawableHotspotChanged(view, f4 - ((float) view.getLeft()), f5 - ((float) view.getTop()));
        if (!view.isPressed()) {
    ...
    public int lookForSelectablePosition(int i4, boolean z4) {
        ...
        if (adapter != null && !isInTouchMode()) {
            ...
            if (!getAdapter().areAllItemsEnabled()) {
                if (z4) {
                    i5 = Math.max(0, i4);
                    while (i5 < count && !adapter.isEnabled(i5)) {
                        i5++;
                    }
                } else {
                    int min = Math.min(i4, count - 1);
                    while (i5 >= 0 && !adapter.isEnabled(i5)) {
                        min = i5 - 1;
                    }
                }
                if (i5 < 0 || i5 >= count) {
