...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private void addCustomViewsWithGravity(List<View> list, int i4) {
        ...
        int absoluteGravity = GravityCompat.getAbsoluteGravity(i4, getLayoutDirection());
        list.clear();
        if (z4) {
    ...
    private int getChildTop(View view, int i4) {
        ...
        if (childVerticalGravity == 80) {
            return (((getHeight() - getPaddingBottom()) - measuredHeight) - layoutParams.bottomMargin) - i5;
        }
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (i6 < size) {
            ...
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            int i8 = layoutParams.leftMargin - i4;
            int i9 = layoutParams.rightMargin - i5;
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Removed duplicated region for block: B:102:0x0298 A[LOOP:0: B:101:0x0296->B:102:0x0298, LOOP_END] */
    ...
    public void onLayout(boolean r20, int r21, int r22, int r23, int r24) {
        ...
        L_0x0282:
            ...
            int r3 = java.lang.Math.max(r5, r1)
        L_0x0288:
            java.util.ArrayList<android.view.View> r1 = r0.mTempViews
            r5 = 3
            r0.addCustomViewsWithGravity(r1, r5)
            java.util.ArrayList<android.view.View> r1 = r0.mTempViews
            int r1 = r1.size()
            r5 = r3
            r3 = 0
    ...
    public void onMeasure(int i4, int i5) {
        ...
        iArr2[isLayoutRtl] = Math.max(0, currentContentInsetStart - i8);
        ...
        iArr2[c5] = Math.max(0, currentContentInsetEnd - i9);
        ...
        for (int i15 = 0; i15 < childCount; i15++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType != 0 || !shouldLayout(childAt)) {
                ...
                i10 += measureChildCollapseMargins(childAt, i4, i10, i5, 0, iArr);
                int max3 = Math.max(i7, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i4, i16 + i18, i5, i17, iArr);
            int measuredWidth = this.mTitleTextView.getMeasuredWidth() + getHorizontalMargins(this.mTitleTextView);
            int measuredHeight = this.mTitleTextView.getMeasuredHeight() + getVerticalMargins(this.mTitleTextView);
            i13 = measuredWidth;
            i11 = View.combineMeasuredStates(i6, this.mTitleTextView.getMeasuredState());
            i12 = measuredHeight;
        } else {
            i11 = i6;
            i13 = 0;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i13 = Math.max(i13, measureChildCollapseMargins(this.mSubtitleTextView, i4, i16 + i18, i5, i17 + i12, iArr));
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (!(i4 == 0 || this.mExpandedMenuPresenter == null || menuBuilder == null || (findItem = menuBuilder.findItem(i4)) == null)) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z4 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new Q(this));
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new S(this));
