...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i4, String str) {
        ...
        try {
            ...
            return createIntent(str2, uri, SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i4, str);
            ...
            Log.w(LOG_TAG, "Search suggestions cursor at row " + i5 + " returned exception.", runtimeException);
            return null;
        }
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                i4 = resources.getDimensionPixelSize(R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                i4 = 0;
            }
            ...
            this.mSearchSrcTextView.setDropDownWidth((((this.mDropDownAnchor.getWidth() + rect.left) + rect.right) + i4) - paddingLeft);
        }
    }
    ...
    public void launchQuerySearch(int i4, String str, String str2) {
        getContext().startActivity(createIntent("android.intent.action.SEARCH", (Uri) null, (String) null, str2, i4, str));
    }
    ...
    public boolean onItemClicked(int i4, int i5, String str) {
        ...
        launchSuggestion(i4, 0, (String) null);
        this.mSearchSrcTextView.setImeVisibility(false);
        dismissSuggestions();
        return true;
    }
        ...
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            ...
            if (i4 == 21 || i4 == 22) {
                if (i4 == 21) {
                    ...
                    i5 = this.mSearchSrcTextView.length();
                }
                this.mSearchSrcTextView.setSelection(i5);
    ...
    public void setQueryRefinementEnabled(boolean z4) {
        ...
        if (cursorAdapter instanceof SuggestionsAdapter) {
            ...
            suggestionsAdapter.setQueryRefinement(i4);
        }
    }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        AnonymousClass8 r9 = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i4, long j4) {
                SearchView.this.onItemClicked(i4, 0, (String) null);
            }
        };
        ...
        int i5 = i4;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context2, attributeSet2, iArr, i5, 0);
