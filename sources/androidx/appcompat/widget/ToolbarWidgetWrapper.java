...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationMode(int i4) {
        ...
        if (i4 != i5) {
            ...
            } else if (i5 == 2 && (view = this.mTabView) != null && view.getParent() == (toolbar2 = this.mToolbar)) {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i4, long j4) {
        ...
        return animate.alpha(f4).setDuration(j4).setListener(new ViewPropertyAnimatorListenerAdapter() {
    ...
    public void setNavigationContentDescription(int i4) {
        setNavigationContentDescription((CharSequence) i4 == 0 ? null : getContext().getString(i4));
    }
