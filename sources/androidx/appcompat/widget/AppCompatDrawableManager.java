            ...
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() {
                    ...
                    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i4) {
                        ...
                        return new ColorStateList(new int[][]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.PRESSED_STATE_SET, ThemeUtils.FOCUSED_STATE_SET, ThemeUtils.EMPTY_STATE_SET}, new int[]{disabledThemeAttrColor, ColorUtils.compositeColors(themeAttrColor, i4), ColorUtils.compositeColors(themeAttrColor, i4), i4});
                    }
                    ...
                    private void setPorterDuffColorFilter(Drawable drawable, int i4, PorterDuff.Mode mode) {
                        ...
                        mutate.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(i4, mode));
                    }
