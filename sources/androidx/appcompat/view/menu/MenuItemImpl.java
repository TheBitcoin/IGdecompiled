...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    MenuItemImpl(MenuBuilder menuBuilder, int i4, int i5, int i6, int i7, CharSequence charSequence, int i8) {
    ...
    public String getShortcutLabel() {
        ...
        if (this.mMenu.isQwertyMode()) {
            i4 = this.mShortcutAlphabeticModifiers;
        } else {
            i4 = this.mShortcutNumericModifiers;
        }
    ...
    public MenuItem setTitle(int i4) {
        return setTitle((CharSequence) this.mMenu.getContext().getString(i4));
    }

    @NonNull
    public SupportMenuItem setActionView(int i4) {
        Context context = this.mMenu.getContext();
        setActionView(LayoutInflater.from(context).inflate(i4, new LinearLayout(context), false));
        return this;
    }
}
