...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        private final AlertController.AlertParams f788P;
        ...
        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f788P.mContext, this.mTheme);
            this.f788P.apply(alertDialog.mAlert);
            alertDialog.setCancelable(this.f788P.mCancelable);
            if (this.f788P.mCancelable) {
                alertDialog.setCanceledOnTouchOutside(true);
            }
            alertDialog.setOnCancelListener(this.f788P.mOnCancelListener);
            alertDialog.setOnDismissListener(this.f788P.mOnDismissListener);
            DialogInterface.OnKeyListener onKeyListener = this.f788P.mOnKeyListener;
        ...
        public Context getContext() {
            return this.f788P.mContext;
        }

        public Builder setAdapter(ListAdapter listAdapter, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.f788P;
        ...
        public Builder setCustomTitle(@Nullable View view) {
            this.f788P.mCustomTitleView = view;
            return this;
        }

        public Builder setIcon(@DrawableRes int i4) {
            this.f788P.mIconId = i4;
            return this;
        }

        public Builder setIconAttribute(@AttrRes int i4) {
            TypedValue typedValue = new TypedValue();
            this.f788P.mContext.getTheme().resolveAttribute(i4, typedValue, true);
            this.f788P.mIconId = typedValue.resourceId;
            return this;
        }

        @Deprecated
        public Builder setInverseBackgroundForced(boolean z4) {
            this.f788P.mForceInverseBackground = z4;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int i4, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f788P.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int i4, boolean[] zArr, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) {
            AlertController.AlertParams alertParams = this.f788P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i4);
            AlertController.AlertParams alertParams2 = this.f788P;
        ...
        public Builder setNegativeButton(@StringRes int i4, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f788P.mNegativeButtonListener = onClickListener;
            return this;
        }

        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f788P.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int i4, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f788P.mNeutralButtonListener = onClickListener;
            return this;
        }

        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f788P.mNeutralButtonIcon = drawable;
            return this;
        }

        public Builder setOnCancelListener(DialogInterface.OnCancelListener onCancelListener) {
            this.f788P.mOnCancelListener = onCancelListener;
            return this;
        }

        public Builder setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
            this.f788P.mOnDismissListener = onDismissListener;
            return this;
        }

        public Builder setOnItemSelectedListener(AdapterView.OnItemSelectedListener onItemSelectedListener) {
            this.f788P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }

        public Builder setOnKeyListener(DialogInterface.OnKeyListener onKeyListener) {
            this.f788P.mOnKeyListener = onKeyListener;
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int i4, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f788P.mPositiveButtonListener = onClickListener;
            return this;
        }

        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f788P.mPositiveButtonIcon = drawable;
            return this;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Builder setRecycleOnMeasureEnabled(boolean z4) {
            this.f788P.mRecycleOnMeasure = z4;
            return this;
        }
        ...
        public Builder(@NonNull Context context, @StyleRes int i4) {
            this.f788P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i4)));
            this.mTheme = i4;
        }

        public Builder setIcon(@Nullable Drawable drawable) {
            this.f788P.mIcon = drawable;
            return this;
        }

        public Builder setMessage(@Nullable CharSequence charSequence) {
            this.f788P.mMessage = charSequence;
            return this;
        }

        public Builder setTitle(@Nullable CharSequence charSequence) {
            this.f788P.mTitle = charSequence;
            return this;
        }
    ...
    public void setButton(int i4, CharSequence charSequence, Message message) {
        this.mAlert.setButton(i4, charSequence, (DialogInterface.OnClickListener) null, message, (Drawable) null);
    }
    ...
    public void setButton(int i4, CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
        this.mAlert.setButton(i4, charSequence, onClickListener, (Message) null, (Drawable) null);
    }
    ...
    public void setButton(int i4, CharSequence charSequence, Drawable drawable, DialogInterface.OnClickListener onClickListener) {
        this.mAlert.setButton(i4, charSequence, onClickListener, (Message) null, drawable);
    }
