        ...
        private void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (alertParams.mIsSingleChoice) {
                    i4 = alertController2.mSingleChoiceItemLayout;
                } else {
                    i4 = alertController2.mListItemLayout;
                }
                int i5 = i4;
                if (alertParams.mCursor != null) {
                    listAdapter = new SimpleCursorAdapter(alertParams.mContext, i5, alertParams.mCursor, new String[]{alertParams.mLabelColumn}, new int[]{16908308});
                } else {
                    listAdapter = alertParams.mAdapter;
                    if (listAdapter == null) {
                        listAdapter = new CheckedItemAdapter(alertParams.mContext, i5, 16908308, alertParams.mItems);
                    }
                }
