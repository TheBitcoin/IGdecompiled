...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void updateScrollEventValues() {
        ...
        if (this.mLayoutManager.getOrientation() == 0) {
            i4 = (findViewByPosition.getLeft() - leftDecorationWidth) - this.mRecyclerView.getPaddingLeft();
            if (this.mViewPager.isRtl()) {
                i4 = -i4;
            }
            height = width;
        } else {
            i4 = (findViewByPosition.getTop() - topDecorationHeight) - this.mRecyclerView.getPaddingTop();
        }
        int i5 = -i4;
