...
class RoundRectDrawable extends Drawable {
    ...
    RoundRectDrawable(ColorStateList colorStateList, float f4) {
        this.mRadius = f4;
    ...
    /* access modifiers changed from: package-private */
    public void setPadding(float f4, boolean z4, boolean z5) {
        if (f4 != this.mPadding || this.mInsetForPadding != z4 || this.mInsetForRadius != z5) {
            this.mPadding = f4;
