    ...
    public int computeExpectedState() {
        ...
        if (fragment2.mFromLayout) {
            if (fragment2.mInLayout) {
                ...
                i4 = this.mFragmentManagerState < 4 ? Math.min(i4, fragment2.mState) : Math.min(i4, 1);
            }
        }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v("FragmentManager", "computeExpectedState() of " + i4 + " for " + this.mFragment);
        }
        return i4;
    }
            ...
            try {
                ...
                while (true) {
                    ...
                    if (computeExpectedState != i4) {
                        ...
                        if (!z4 && i4 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                            if (FragmentManager.isLoggingEnabled(3)) {
