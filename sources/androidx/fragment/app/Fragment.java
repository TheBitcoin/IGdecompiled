...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void onActivityResult(int i4, int i5, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i4 + " resultCode: " + i5 + " data: " + intent);
        }
    }
    ...
    public void performAttach() {
        ...
        int i4 = 0;
        while (i4 < size) {
            OnPreAttachedListener onPreAttachedListener = arrayList.get(i4);
            i4++;
            onPreAttachedListener.onPreAttached();
        }
    ...
    /* access modifiers changed from: package-private */
    public void setAnimations(@AnimRes int i4, @AnimRes int i5, @AnimRes int i6, @AnimRes int i7) {
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i4) {
        FragmentManager fragmentManager;
        if (fragment != null) {
            FragmentStrictMode.onSetTargetFragmentUsage(this, fragment, i4);
        }
    ...
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i4, @Nullable Intent intent, int i5, int i6, int i7, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        if (this.mHost != null) {
            ...
            getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i4, intent, i5, i6, i7, bundle2);
            return;
        }
        throw new IllegalStateException("Fragment " + this + " not attached to Activity");
    }
