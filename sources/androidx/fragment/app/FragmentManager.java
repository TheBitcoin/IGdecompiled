...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(@NonNull ArrayList<BackStackRecord> arrayList, int i4, int i5) {
        ...
        HashSet hashSet = new HashSet();
        while (i4 < i5) {
            ArrayList<FragmentTransaction.Op> arrayList2 = arrayList.get(i4).mOps;
    ...
    private void executeOpsTogether(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, int i4, int i5) {
        boolean z4 = arrayList.get(i4).mReorderingAllowed;
        ...
        if (!z4 && this.mCurState >= 1) {
            for (int i7 = i4; i7 < i5; i7++) {
                ArrayList<FragmentTransaction.Op> arrayList4 = arrayList.get(i7).mOps;
                int size = arrayList4.size();
                int i8 = 0;
                while (i8 < size) {
                    FragmentTransaction.Op op = arrayList4.get(i8);
                    i8++;
                    Fragment fragment = op.mFragment;
        ...
        for (int i9 = i4; i9 < i5; i9++) {
            ...
            if (booleanValue) {
                ...
                int i10 = 0;
                while (i10 < size3) {
                    FragmentTransaction.Op op2 = arrayList5.get(i10);
                    i10++;
        ...
        for (SpecialEffectsController next : collectChangedControllers(arrayList, i4, i5)) {
    ...
    private int findBackStackIndex(@Nullable String str, int i4, boolean z4) {
    ...
    public static boolean isLoggingEnabled(int i4) {
        if (DEBUG || Log.isLoggable(TAG, i4)) {
            return true;
        }
        return false;
    }
    ...
    static int reverseTransit(int i4) {
        if (i4 == 4097) {
            return 8194;
        }
        if (i4 == 8194) {
    ...
    public void launchStartIntentSenderForResult(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i4, @Nullable Intent intent, int i5, int i6, int i7, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        ...
        this.mHost.onStartIntentSenderFromFragment(fragment, intentSender, i4, intent, i5, i6, i7, bundle2);
    }
    ...
    /* access modifiers changed from: package-private */
    public boolean popBackStackState(@NonNull ArrayList<BackStackRecord> arrayList, @NonNull ArrayList<Boolean> arrayList2, @Nullable String str, int i4, int i5) {
        boolean z4;
        if ((i5 & 1) != 0) {
            z4 = true;
        } else {
        ...
        int findBackStackIndex = findBackStackIndex(str, i4, z4);
            ...
            if (fragmentManagerState != null) {
                ...
                if (arrayList3 != null) {
                    for (int i6 = 0; i6 < arrayList3.size(); i6++) {
                        this.mBackStackStates.put(arrayList3.get(i6), fragmentManagerState.mBackStackStates.get(i6));
                    }
                }
    ...
    public Bundle saveAllStateInternal() {
        ...
        if (!allSavedState.isEmpty()) {
            ...
            while (i4 < size2) {
                FragmentState fragmentState = allSavedState.get(i4);
                i4++;
    ...
    public boolean popBackStackImmediate(int i4, int i5) {
        if (i4 >= 0) {
            return popBackStackImmediate((String) null, i4, i5);
        }
        throw new IllegalArgumentException("Bad id: " + i4);
    }

    /* access modifiers changed from: package-private */
    public void popBackStack(int i4, int i5, boolean z4) {
        if (i4 >= 0) {
            enqueueAction(new PopBackStackState((String) null, i4, i5), z4);
            return;
        }
        throw new IllegalArgumentException("Bad id: " + i4);
    }
