...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i4, Bundle bundle) {
            ...
            mediaBrowserServiceCompat.mCurConnection = new ConnectionRecord(str2, -1, i5, bundle3, (ServiceCallbacks) null);
            BrowserRoot onGetRoot = MediaBrowserServiceCompat.this.onGetRoot(str2, i5, bundle3);
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(String str, int i4, int i5, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i5)) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str2, i6, i7, bundle2, serviceCallbacks2);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
                        BrowserRoot onGetRoot = mediaBrowserServiceCompat.onGetRoot(str2, i7, bundle2);
        ...
        public void getMediaItem(final String str, final C0909b bVar, final ServiceCallbacks serviceCallbacks) {
        ...
        public void registerCallbacks(ServiceCallbacks serviceCallbacks, String str, int i4, int i5, Bundle bundle) {
            final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
            final String str2 = str;
            final int i6 = i4;
            final int i7 = i5;
        ...
        public void search(String str, Bundle bundle, C0909b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final String str2 = str;
                final Bundle bundle2 = bundle;
                final C0909b bVar2 = bVar;
                final ServiceCallbacks serviceCallbacks2 = serviceCallbacks;
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
        ...
        public void sendCustomAction(String str, Bundle bundle, C0909b bVar, ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && bVar != null) {
                final String str2 = str;
                final Bundle bundle2 = bundle;
                final C0909b bVar2 = bVar;
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (C0909b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (C0909b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (C0909b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    public boolean isValidPackage(String str, int i4) {
        ...
        for (String equals : getPackageManager().getPackagesForUid(i4)) {
    ...
    /* access modifiers changed from: package-private */
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final C0909b bVar) {
    ...
    /* access modifiers changed from: package-private */
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final C0909b bVar) {
    ...
    /* access modifiers changed from: package-private */
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final C0909b bVar) {
