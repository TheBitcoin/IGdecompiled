...
public interface SupportSQLiteOpenHelper extends Closeable {
    ...
    public static abstract class Callback {
        ...
        private final void deleteDatabaseFile(String str) {
            ...
            if (!m.p(str, ":memory:", true)) {
                ...
                while (i5 <= length) {
                    ...
                    if (kotlin.jvm.internal.m.g(str.charAt(i4), 32) <= 0) {
                        z4 = true;
                    } else {
                        z4 = false;
                    }
        ...
        public void onConfigure(SupportSQLiteDatabase supportSQLiteDatabase) {
            kotlin.jvm.internal.m.e(supportSQLiteDatabase, "db");
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x004c, code lost:
            ...
            kotlin.jvm.internal.m.d(r1, "p.second");
        ...
        public abstract void onUpgrade(SupportSQLiteDatabase supportSQLiteDatabase, int i4, int i5);
    }
    ...
    public static final class Configuration {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public /* synthetic */ Configuration(android.content.Context r2, java.lang.String r3, androidx.sqlite.db.SupportSQLiteOpenHelper.Callback r4, boolean r5, boolean r6, int r7, kotlin.jvm.internal.C2103g r8) {
            /*
                r1 = this;
                r8 = r7 & 8
                r0 = 0
            ...
            L_0x0013:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.sqlite.db.SupportSQLiteOpenHelper.Configuration.<init>(android.content.Context, java.lang.String, androidx.sqlite.db.SupportSQLiteOpenHelper$Callback, boolean, boolean, int, kotlin.jvm.internal.g):void");
        }
    }
}
