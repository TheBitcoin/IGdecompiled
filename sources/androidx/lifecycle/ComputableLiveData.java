...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData() {
        this((Executor) null, 1, (C2103g) null);
    }
    ...
    public ComputableLiveData(Executor executor2) {
        ...
        this.refreshRunnable = new a(this);
        this.invalidationRunnable = new b(this);
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ ComputableLiveData(java.util.concurrent.Executor r1, int r2, kotlin.jvm.internal.C2103g r3) {
        /*
            r0 = this;
            r2 = r2 & 1
