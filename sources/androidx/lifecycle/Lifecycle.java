...
public abstract class Lifecycle {
    ...
    public enum Event {
        ...
        static {
            Companion = new Companion((C2103g) null);
        }
    ...
    public static final void _get_currentStateFlow_$lambda$0(t tVar, LifecycleOwner lifecycleOwner, Event event) {
        m.e(tVar, "$mutableStateFlow");
        m.e(lifecycleOwner, "<anonymous parameter 0>");
        m.e(event, NotificationCompat.CATEGORY_EVENT);
        tVar.setValue(event.getTargetState());
    }
    ...
    public I getCurrentStateFlow() {
        t a5 = K.a(getCurrentState());
        addObserver(new g(a5));
        return C1037g.a(a5);
    }
