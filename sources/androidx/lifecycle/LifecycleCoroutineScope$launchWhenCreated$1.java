...
final class LifecycleCoroutineScope$launchWhenCreated$1 extends l implements p {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            ...
            p pVar = this.$block;
            this.label = 1;
            if (PausingDispatcherKt.whenCreated(lifecycle$lifecycle_common, pVar, (d) this) == c5) {
                return c5;
            }
        } else if (i4 == 1) {
            n.b(obj);
    ...
    public final Object invoke(J j4, d dVar) {
        return ((LifecycleCoroutineScope$launchWhenCreated$1) create(j4, dVar)).invokeSuspend(s.f8222a);
    }
}
