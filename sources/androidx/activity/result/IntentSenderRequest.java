...
public final class IntentSenderRequest implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder(IntentSender intentSender2) {
            m.e(intentSender2, "intentSender");
        ...
        public final Builder setFlags(int i4, int i5) {
            this.flagsValues = i4;
            this.flagsMask = i5;
            return this;
        }
    ...
    public IntentSenderRequest(IntentSender intentSender2, Intent intent, int i4, int i5) {
        m.e(intentSender2, "intentSender");
        this.intentSender = intentSender2;
        this.fillInIntent = intent;
        this.flagsMask = i4;
    ...
    public /* synthetic */ IntentSenderRequest(IntentSender intentSender2, Intent intent, int i4, int i5, int i6, C2103g gVar) {
        this(intentSender2, (i6 & 2) != 0 ? null : intent, (i6 & 4) != 0 ? 0 : i4, (i6 & 8) != 0 ? 0 : i5);
    }
