...
public final class TextViewCompat {
    ...
    static class Api34Impl {
        ...
        @DoNotInline
        public static void setLineHeight(@NonNull TextView textView, int i4, @FloatRange(from = 0.0d) float f4) {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @Px @IntRange(from = 0) int i4) {
        int i5;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @Px @IntRange(from = 0) int i4) {
        int i5;
        Preconditions.checkArgumentNonnegative(i4);
        Paint.FontMetricsInt fontMetricsInt = textView.getPaint().getFontMetricsInt();
        if (textView.getIncludeFontPadding()) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @Px @IntRange(from = 0) int i4) {
        Preconditions.checkArgumentNonnegative(i4);
    ...
    public static ActionMode.Callback wrapCustomSelectionActionModeCallback(@NonNull TextView textView, @Nullable ActionMode.Callback callback) {
        int i4 = Build.VERSION.SDK_INT;
        if (i4 < 26 || i4 > 27 || (callback instanceof OreoCallback) || callback == null) {
            return callback;
        }
    ...
    public static void setLineHeight(@NonNull TextView textView, int i4, @FloatRange(from = 0.0d) float f4) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setLineHeight(textView, i4, f4);
        } else {
