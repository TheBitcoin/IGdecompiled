...
class RequestExecutor {
    ...
    static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i4, @IntRange(from = 0) int i5) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(0, 1, (long) i5, TimeUnit.MILLISECONDS, new LinkedBlockingDeque(), new DefaultThreadFactory(str, i4));
    ...
    static <T> T submit(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = 0) int i4) throws InterruptedException {
        try {
