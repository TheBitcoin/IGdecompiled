...
public class FontsContractCompat {
    ...
    public static class FontFamilyResult {
        ...
        static FontFamilyResult create(int i4, @Nullable FontInfo[] fontInfoArr) {
    ...
    public static class FontInfo {
        ...
        static FontInfo create(@NonNull Uri uri, @IntRange(from = 0) int i4, @IntRange(from = 1, to = 1000) int i5, boolean z4, int i6) {
    ...
    public static Typeface getFontSync(Context context, FontRequest fontRequest, @Nullable ResourcesCompat.FontCallback fontCallback, @Nullable Handler handler, boolean z4, int i4, int i5) {
        ...
        return requestFont(context, fontRequest, i6, z4, i4, ResourcesCompat.FontCallback.getHandler(handler), resourcesCallbackAdapter);
    }
    ...
    public static Typeface requestFont(@NonNull Context context, @NonNull FontRequest fontRequest, int i4, boolean z4, @IntRange(from = 0) int i5, @NonNull Handler handler, @NonNull FontRequestCallback fontRequestCallback) {
        ...
        return FontRequestWorker.requestFontAsync(context, fontRequest, i4, (Executor) null, callbackWithHandler);
    }
}
