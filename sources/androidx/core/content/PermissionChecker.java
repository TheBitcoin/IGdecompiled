...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i4, int i5, @Nullable String str2) {
        ...
        if (myUid != i5 || !ObjectsCompat.equals(packageName, str2)) {
            i6 = AppOpsManagerCompat.noteProxyOpNoThrow(context, permissionToOp, str2);
        } else {
            i6 = AppOpsManagerCompat.checkOrNoteProxyOp(context, i5, permissionToOp, str2);
        }
        if (i6 == 0) {
            return 0;
        }
