...
public class ContextCompat {
    ...
    static class Api26Impl {
        ...
        @DoNotInline
        static Intent registerReceiver(Context context, @Nullable BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, String str, Handler handler, int i4) {
            if ((i4 & 4) != 0 && str == null) {
    ...
    @Nullable
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, int i4) {
        return registerReceiver(context, broadcastReceiver, intentFilter, (String) null, (Handler) null, i4);
    }
    ...
    @Nullable
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, @Nullable String str, @Nullable Handler handler, int i4) {
        int i5 = i4 & 1;
        if (i5 == 0 || (i4 & 4) == 0) {
            if (i5 != 0) {
                i4 |= 2;
            ...
            if (i7 == 0 && (i6 & 4) == 0) {
                ...
                if (i8 >= 33) {
                    return Api33Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i6);
                }
                ...
                if (i8 >= 26) {
                    return Api26Impl.registerReceiver(context2, broadcastReceiver2, intentFilter2, str2, handler2, i6);
                }
                if ((i6 & 4) == 0 || str2 != null) {
