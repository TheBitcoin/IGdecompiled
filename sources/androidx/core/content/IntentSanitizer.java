...
public class IntentSanitizer {
    ...
    private static class Api31Impl {
        ...
        @DoNotInline
        static void checkOtherMembers(int i4, ClipData.Item item, Consumer<String> consumer) {
    ...
    public static final class Builder {
        ...
        private Predicate<String> mAllowedActions = new n();
        private Predicate<String> mAllowedCategories = new q();
        private Predicate<ClipData> mAllowedClipData = new u();
        private Predicate<Uri> mAllowedClipDataUri = new t();
        private Predicate<ComponentName> mAllowedComponents = new s();
        private Predicate<Uri> mAllowedData = new o();
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private int mAllowedFlags;
        private Predicate<String> mAllowedPackages = new r();
        private Predicate<String> mAllowedTypes = new p();
        ...
        public Builder allowAction(@NonNull String str) {
            ...
            allowAction((Predicate<String>) new e(str));
            return this;
        }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory((Predicate<String>) new e(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new k(str));
        }
        ...
        public Builder allowComponent(@NonNull ComponentName componentName) {
            ...
            return allowComponent((Predicate<ComponentName>) new i(componentName));
        }
        ...
        public Builder allowComponentWithPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            return allowComponent((Predicate<ComponentName>) new f(str));
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, new v());
        }

        @SuppressLint({"BuilderSetStyle"})
        @NonNull
        public Builder allowExtraOutput(@NonNull String str) {
            allowExtra("output", Uri.class, new d(str));
            return this;
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new m(str));
            return this;
        }
        ...
        public Builder allowFlags(int i4) {
            this.mAllowedFlags = i4 | this.mAllowedFlags;
            return this;
        }
        ...
        public Builder allowPackage(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage((Predicate<String>) new e(str));
        }
        ...
        public Builder allowType(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType((Predicate<String>) new e(str));
        }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull Class<T> cls, @NonNull Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, (Predicate<Object>) new h(cls, predicate));
        }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0012: CONSTRUCTOR  (r0v5 ? I:androidx.core.content.l) =  call: androidx.core.content.l.<init>():void type: CONSTRUCTOR in method: androidx.core.content.IntentSanitizer.Builder.allowExtra(java.lang.String, androidx.core.util.Predicate):androidx.core.content.IntentSanitizer$Builder, dex: classes.dex
        ...
        private static void checkOtherMembers(int i4, ClipData.Item item, Consumer<String> consumer) {
