...
public class ShortcutInfoCompat {
    ...
    private static class Api33Impl {
        ...
        static void setExcludedFromSurfaces(@NonNull ShortcutInfo.Builder builder, int i4) {
    ...
    static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo a5 : list) {
            arrayList.add(new Builder(context, C0376f.a(a5)).build());
        }
        return arrayList;
    }
    ...
    public boolean isExcludedFromSurfaces(int i4) {
        if ((i4 & this.mExcludedSurfaces) != 0) {
            return true;
        }
        return false;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        C0382l.a();
        ShortcutInfo.Builder a5 = C0381k.a(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
