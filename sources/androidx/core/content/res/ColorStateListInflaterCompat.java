...
public final class ColorStateListInflaterCompat {
    ...
    @ColorInt
    private static int modulateColorAlpha(@ColorInt int i4, @FloatRange(from = 0.0d, to = 1.0d) float f4, @FloatRange(from = 0.0d, to = 100.0d) float f5) {
        boolean z4;
        ...
        int clamp = MathUtils.clamp((int) ((((float) Color.alpha(i4)) * f4) + 0.5f), 0, 255);
        if (z4) {
            CamColor fromColor = CamColor.fromColor(i4);
            i4 = CamColor.toColor(fromColor.getHue(), fromColor.getChroma(), f5);
        }
        return (i4 & ViewCompat.MEASURED_SIZE_MASK) | (clamp << 24);
    }
