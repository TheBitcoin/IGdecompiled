...
public class NotificationChannelCompat {
    ...
    static class Api26Impl {
        ...
        @DoNotInline
        static NotificationChannel createNotificationChannel(String str, CharSequence charSequence, int i4) {
        ...
        @DoNotInline
        static void setLightColor(NotificationChannel notificationChannel, int i4) {
