...
public final class NotificationManagerCompat {
    ...
    private static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void handleServiceConnected(ComponentName componentName, IBinder iBinder) {
            ListenerRecord listenerRecord = this.mRecordMap.get(componentName);
            if (listenerRecord != null) {
                listenerRecord.service = a.C0015a.asInterface(iBinder);
                listenerRecord.retryCount = 0;
                processListenerQueue(listenerRecord);
            }
        }
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            if (!this.mHandler.hasMessages(3, listenerRecord.componentName)) {
                int i4 = listenerRecord.retryCount;
                int i5 = i4 + 1;
                ...
                this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(3, listenerRecord.componentName), (long) i6);
            }
        }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i4 >= 26) {
            for (NotificationChannelGroup a5 : getNotificationChannelGroups()) {
                NotificationChannelGroup a6 = r.a(a5);
    ...
    public void notify(int i4, @NonNull Notification notification) {
        notify((String) null, i4, notification);
    }
    ...
    public static class NotificationWithIdAndTag {
        ...
        public NotificationWithIdAndTag(@Nullable String str, int i4, @NonNull Notification notification) {
            this.mTag = str;
            this.mId = i4;
            this.mNotification = notification;
        }

        public NotificationWithIdAndTag(int i4, @NonNull Notification notification) {
            this((String) null, i4, notification);
        }
    }
    ...
    public void notify(@NonNull List<NotificationWithIdAndTag> list) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            NotificationWithIdAndTag notificationWithIdAndTag = list.get(i4);
