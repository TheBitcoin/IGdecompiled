...
public final class GrammaticalInflectionManagerCompat {
    ...
    static class Api34Impl {
        ...
        @DoNotInline
        static void setRequestedApplicationGrammaticalGender(Context context, int i4) {
            getGrammaticalInflectionManager(context).setRequestedApplicationGrammaticalGender(i4);
        }
    }
    ...
    @OptIn(markerClass = {BuildCompat.PrereleaseSdkCheck.class})
    @AnyThread
    public static void setRequestedApplicationGrammaticalGender(@NonNull Context context, int i4) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setRequestedApplicationGrammaticalGender(context, i4);
        }
    }
}
