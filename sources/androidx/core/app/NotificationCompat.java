...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Builder(int i4, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
                this(i4 != 0 ? IconCompat.createWithResource((Resources) null, "", i4) : null, charSequence, pendingIntent, new Bundle(), (RemoteInput[]) null, true, 0, true, false, false);
            }
        ...
        public Action(int i4, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
            this(i4 != 0 ? IconCompat.createWithResource((Resources) null, "", i4) : null, charSequence, pendingIntent);
        }
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i4 = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource((Resources) null, "", i4);
            }
            return this.mIcon;
        }
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        Action(int i4, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z4, int i5, boolean z5, boolean z6, boolean z7) {
            this(i4 != 0 ? IconCompat.createWithResource((Resources) null, "", i4) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z4, i5, z5, z6, z7);
        }
    ...
    public static class Builder {
        ...
        static class Api21Impl {
            ...
            @DoNotInline
            static AudioAttributes.Builder setContentType(AudioAttributes.Builder builder, int i4) {
                return builder.setContentType(i4);
            }

            @DoNotInline
            static AudioAttributes.Builder setLegacyStreamType(AudioAttributes.Builder builder, int i4) {
                return builder.setLegacyStreamType(i4);
            }

            @DoNotInline
            static AudioAttributes.Builder setUsage(AudioAttributes.Builder builder, int i4) {
        ...
        public Builder setSound(@Nullable Uri uri, int i4) {
            ...
            AudioAttributes.Builder legacyStreamType = Api21Impl.setLegacyStreamType(Api21Impl.setContentType(Api21Impl.createBuilder(), 4), i4);
    ...
    public static class CallStyle extends Style {
        ...
        static class Api20Impl {
            ...
            @DoNotInline
            static Notification.Action.Builder createActionBuilder(int i4, CharSequence charSequence, PendingIntent pendingIntent) {
        ...
        static class Api31Impl {
            ...
            @DoNotInline
            static Notification.CallStyle setAnswerButtonColorHint(Notification.CallStyle callStyle, @ColorInt int i4) {
            ...
            @DoNotInline
            static Notification.CallStyle setDeclineButtonColorHint(Notification.CallStyle callStyle, @ColorInt int i4) {
        ...
        @RequiresApi(20)
        @NonNull
        private Action makeAction(int i4, int i5, Integer num, int i6, PendingIntent pendingIntent) {
            if (num == null) {
                num = Integer.valueOf(ContextCompat.getColor(this.mBuilder.mContext, i6));
            }
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            spannableStringBuilder.append(this.mBuilder.mContext.getResources().getString(i5));
            spannableStringBuilder.setSpan(new ForegroundColorSpan(num.intValue()), 0, spannableStringBuilder.length(), 18);
            Action build = new Action.Builder(IconCompat.createWithResource(this.mBuilder.mContext, i4), (CharSequence) spannableStringBuilder, pendingIntent).build();
        ...
        private Action makeAnswerAction() {
            ...
            if (z4) {
                i5 = R.string.call_notification_answer_video_action;
            } else {
                i5 = R.string.call_notification_answer_action;
            }
            return makeAction(i4, i5, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        private Action makeNegativeAction() {
            ...
            if (pendingIntent == null) {
                return makeAction(i4, R.string.call_notification_hang_up_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i4, R.string.call_notification_decline_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, pendingIntent);
        }
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            if (arrayList2 != null) {
                ...
                while (i5 < size) {
                    ...
                    } else if (!isActionAddedByCallStyle(action2) && i4 > 1) {
                        arrayList.add(action2);
                        i4--;
                    }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            int i4 = Build.VERSION.SDK_INT;
            if (i4 >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
            ...
            if (i4 >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
        ...
        @NonNull
        public CallStyle setAnswerButtonColorHint(@ColorInt int i4) {
            this.mAnswerButtonColor = Integer.valueOf(i4);
            return this;
        }

        @NonNull
        public CallStyle setDeclineButtonColorHint(@ColorInt int i4) {
            this.mDeclineButtonColor = Integer.valueOf(i4);
            return this;
        }
        ...
        private CallStyle(int i4, @NonNull Person person, @Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable PendingIntent pendingIntent3) {
    ...
    public static abstract class Style {
        ...
        static class Api24Impl {
            ...
            @DoNotInline
            static void setChronometerCountDown(RemoteViews remoteViews, int i4, boolean z4) {
    ...
    public static final class WearableExtender implements Extender {
        ...
        static class Api20Impl {
            ...
            @DoNotInline
            public static Action getActionCompatFromAction(ArrayList<Parcelable> arrayList, int i4) {
                return NotificationCompat.getActionCompatFromAction((Notification.Action) arrayList.get(i4));
            }
        }
        ...
        public Builder extend(@NonNull Builder builder) {
            ...
            if (!this.mActions.isEmpty()) {
                ...
                int i4 = 0;
                while (i4 < size) {
                    Action action = arrayList2.get(i4);
                    i4++;
            ...
            if (bundle != null) {
                ...
                if (parcelableArrayList != null) {
                    ...
                    for (int i4 = 0; i4 < size; i4++) {
                        actionArr[i4] = Api20Impl.getActionCompatFromAction(parcelableArrayList, i4);
                    }
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i7 = 0; i7 < remoteInputs.length; i7++) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    i6 = Api29Impl.getEditChoicesBeforeSending(remoteInput);
                } else {
                    i6 = 0;
                }
                remoteInputArr2[i7] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i6, Api20Impl.getExtras(remoteInput), (Set<String>) null);
            }
        ...
        if (i8 >= 28) {
            i4 = Api28Impl.getSemanticAction(action2);
        } else {
            i4 = Api20Impl.getExtras(action2).getInt("android.support.action.semanticAction", 0);
        }
        int i9 = i4;
        if (i8 >= 29) {
        ...
        if (i8 < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z7, i9, z8, z5, z6);
        }
        if (Api23Impl.getIcon(action2) == null && (i5 = action2.icon) != 0) {
            return new Action(i5, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z7, i9, z8, z5, z6);
        }
        if (Api23Impl.getIcon(action2) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action2));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z7, i9, z8, z5, z6);
    }
    ...
    public static List<Person> getPeople(@NonNull Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (!(stringArray == null || stringArray.length == 0)) {
                ...
                while (i4 < length) {
                    arrayList.add(new Person.Builder().setUri(stringArray[i4]).build());
                    i4++;
                }
            }
        }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    i4 = Api29Impl.getEditChoicesBeforeSending(remoteInput2);
                } else {
                    i4 = 0;
                }
                remoteInput = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i4, Api20Impl.getExtras(remoteInput2), (Set<String>) null);
            } else {
                remoteInput = null;
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        private TextAppearanceSpan makeFontColorSpan(int i4) {
            return new TextAppearanceSpan((String) null, 0, 0, ColorStateList.valueOf(i4), (ColorStateList) null);
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i4 >= 24) {
                ...
                for (Message androidMessage : this.mMessages) {
                    Api24Impl.addMessage(n.a(messagingStyle), androidMessage.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message androidMessage2 : this.mHistoricMessages) {
                        Api26Impl.addHistoricMessage(n.a(messagingStyle), androidMessage2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(n.a(messagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(n.a(messagingStyle), this.mIsGroupConversation.booleanValue());
                }
        ...
        public static final class Message {
            ...
            static class Api24Impl {
                ...
                @DoNotInline
                static Notification.MessagingStyle.Message createMessage(CharSequence charSequence, long j4, CharSequence charSequence2) {
            ...
            static class Api28Impl {
                ...
                @DoNotInline
                static Notification.MessagingStyle.Message createMessage(CharSequence charSequence, long j4, android.app.Person person) {
