...
public final class SoftwareKeyboardControllerCompat {
    ...
    private static class Impl30 extends Impl20 {
        ...
        public static /* synthetic */ void b(AtomicBoolean atomicBoolean, WindowInsetsController windowInsetsController, int i4) {
            boolean z4;
            if ((i4 & 8) != 0) {
                z4 = true;
            } else {
        ...
        public void hide() {
            ...
            if (windowInsetsController != null) {
                ...
                F f4 = new F(atomicBoolean);
                windowInsetsController.addOnControllableInsetsChangedListener(f4);
                if (!atomicBoolean.get() && (view = this.mView) != null) {
                    ((InputMethodManager) view.getContext().getSystemService("input_method")).hideSoftInputFromWindow(this.mView.getWindowToken(), 0);
                }
                windowInsetsController.removeOnControllableInsetsChangedListener(f4);
