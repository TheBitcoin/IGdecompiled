...
public class ViewCompat {
    ...
    static class AccessibilityPaneVisibilityManager implements ViewTreeObserver.OnGlobalLayoutListener, View.OnAttachStateChangeListener {
        ...
        private void checkPaneVisibility(Map.Entry<View, Boolean> entry) {
            ...
            if (booleanValue != z4) {
                ...
                ViewCompat.notifyViewAccessibilityStateChangedIfNeeded(key, i4);
    ...
    static abstract class AccessibilityViewProperty<T> {
        ...
        public void set(View view, T t4) {
            ...
            } else if (shouldUpdate(get(view), t4)) {
    ...
    private static class Api21Impl {
        ...
        @DoNotInline
        static boolean dispatchNestedFling(@NonNull View view, float f4, float f5, boolean z4) {
            return view.dispatchNestedFling(f4, f5, z4);
        }

        @DoNotInline
        static boolean dispatchNestedPreFling(@NonNull View view, float f4, float f5) {
        ...
        @DoNotInline
        static void setZ(@NonNull View view, float f4) {
            view.setZ(f4);
        }
    ...
    static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            I i5 = new I(onUnhandledKeyEventListenerCompat);
            simpleArrayMap.put(onUnhandledKeyEventListenerCompat, i5);
            view.addOnUnhandledKeyEventListener(i5);
        }
    ...
    public static boolean dispatchNestedFling(@NonNull View view, float f4, float f5, boolean z4) {
        return Api21Impl.dispatchNestedFling(view, f4, f5, z4);
    }

    public static boolean dispatchNestedPreFling(@NonNull View view, float f4, float f5) {
        return Api21Impl.dispatchNestedPreFling(view, f4, f5);
    }
    ...
    public static boolean performHapticFeedback(@NonNull View view, int i4) {
        int feedbackConstantOrFallback = HapticFeedbackConstantsCompat.getFeedbackConstantOrFallback(i4);
    ...
    public static <T extends View> T requireViewById(@NonNull View view, @IdRes int i4) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (View) Api28Impl.requireViewById(view, i4);
        }
        T findViewById = view.findViewById(i4);
    ...
    public static void saveAttributeDataForStyleable(@NonNull View view, @SuppressLint({"ContextFirst"}) @NonNull Context context, @NonNull int[] iArr, @Nullable AttributeSet attributeSet, @NonNull TypedArray typedArray, int i4, int i5) {
        if (Build.VERSION.SDK_INT >= 29) {
    ...
    public static void setImportantForContentCapture(@NonNull View view, int i4) {
        if (Build.VERSION.SDK_INT >= 30) {
            Api30Impl.setImportantForContentCapture(view, i4);
        }
    }
    ...
    public static void dispatchNestedScroll(@NonNull View view, int i4, int i5, int i6, int i7, @Nullable int[] iArr, int i8, @NonNull int[] iArr2) {
        ...
        int i11 = i6;
        int i12 = i5;
        dispatchNestedScroll(view, i4, i12, i11, i10, iArr3, i9);
    }
    ...
    public static boolean performHapticFeedback(@NonNull View view, int i4, int i5) {
        int feedbackConstantOrFallback = HapticFeedbackConstantsCompat.getFeedbackConstantOrFallback(i4);
        if (feedbackConstantOrFallback == -1) {
            return false;
        }
        return view.performHapticFeedback(feedbackConstantOrFallback, i5);
    }
    ...
    public static boolean dispatchNestedScroll(@NonNull View view, int i4, int i5, int i6, int i7, @Nullable int[] iArr, int i8) {
        ...
        int i10 = i6;
        int i11 = i5;
        return dispatchNestedScroll(view, i4, i11, i10, i9, iArr2);
    }
}
