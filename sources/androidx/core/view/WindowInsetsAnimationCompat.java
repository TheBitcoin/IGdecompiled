...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static Interpolator createInsetInterpolator(int i4, WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2) {
            if ((i4 & 8) == 0) {
        ...
        @SuppressLint({"WrongConstant"})
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f4, int i4) {
            ...
            for (int i5 = 1; i5 <= 256; i5 <<= 1) {
                if ((i4 & i5) == 0) {
                    ...
                    float f5 = 1.0f - f4;
                    builder.setInsets(i5, WindowInsetsCompat.insetInsets(insets, (int) (((double) (((float) (insets.left - insets2.left)) * f5)) + 0.5d), (int) (((double) (((float) (insets.top - insets2.top)) * f5)) + 0.5d), (int) (((double) (((float) (insets.right - insets2.right)) * f5)) + 0.5d), (int) (((double) (((float) (insets.bottom - insets2.bottom)) * f5)) + 0.5d)));
                }
            }
    ...
    private static class Impl30 extends Impl {
        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(@NonNull WindowInsets windowInsets, @NonNull List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation a5 = C0438b0.a(list.get(size));
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(@NonNull BoundsCompat boundsCompat) {
            Q.a();
            return P.a(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
        ...
        Impl30(int i4, Interpolator interpolator, long j4) {
            this(C0411a0.a(i4, interpolator, j4));
        }
    }
