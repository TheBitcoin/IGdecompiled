...
public final class ContentInfoCompat {
    ...
    private static final class Api31Impl {
        ...
        public static Pair<ContentInfo, ContentInfo> partition(@NonNull ContentInfo contentInfo, @NonNull Predicate<ClipData.Item> predicate) {
            ...
            Pair<ClipData, ClipData> partition = ContentInfoCompat.partition(clip, (androidx.core.util.Predicate<ClipData.Item>) new C0437b(predicate));
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(@NonNull ContentInfo contentInfo) {
            this.mWrapped = C0410a.a(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(@NonNull ClipData clipData, int i4) {
            this.mPlatformBuilder = C0451i.a(clipData, i4);
        }
        ...
        public void setFlags(int i4) {
            ContentInfo.Builder unused = this.mPlatformBuilder.setFlags(i4);
        }
        ...
        public void setSource(int i4) {
            ContentInfo.Builder unused = this.mPlatformBuilder.setSource(i4);
        }

        BuilderCompat31Impl(@NonNull ContentInfoCompat contentInfoCompat) {
            C0455k.a();
            this.mPlatformBuilder = C0453j.a(contentInfoCompat.toContentInfo());
        }
    }
