...
public class AccessibilityWindowInfoCompat {
    ...
    private static class Api33Impl {
        ...
        @DoNotInline
        public static AccessibilityNodeInfoCompat getRoot(Object obj, int i4) {
    ...
    @Nullable
    public AccessibilityNodeInfoCompat getRoot(int i4) {
        if (Build.VERSION.SDK_INT >= 33) {
            return Api33Impl.getRoot(this.mInfo, i4);
        }
        return getRoot();
    }
