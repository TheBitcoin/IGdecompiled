...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public AccessibilityActionCompat(int i4, CharSequence charSequence) {
            this((Object) null, i4, charSequence, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        }
        ...
        public AccessibilityActionCompat(int i4, CharSequence charSequence, AccessibilityViewCommand accessibilityViewCommand) {
            this((Object) null, i4, charSequence, accessibilityViewCommand, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        }
        ...
        private AccessibilityActionCompat(int i4, CharSequence charSequence, Class<? extends AccessibilityViewCommand.CommandArguments> cls) {
            this((Object) null, i4, charSequence, (AccessibilityViewCommand) null, cls);
        }
    ...
    private static class Api21Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat createCollectionItemInfo(int i4, int i5, int i6, int i7, boolean z4, boolean z5) {
    ...
    private static class Api30Impl {
        ...
        @DoNotInline
        public static Object createRangeInfo(int i4, float f4, float f5, float f6) {
    ...
    private static class Api33Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat buildCollectionItemInfoCompat(boolean z4, int i4, int i5, int i6, int i7, boolean z5, String str, String str2) {
            return new CollectionItemInfoCompat(new AccessibilityNodeInfo.CollectionItemInfo.Builder().setHeading(z4).setColumnIndex(i4).setRowIndex(i5).setColumnSpan(i6).setRowSpan(i7).setSelected(z5).setRowTitle(str).setColumnTitle(str2).build());
        }

        @DoNotInline
        public static AccessibilityNodeInfoCompat getChild(AccessibilityNodeInfo accessibilityNodeInfo, int i4, int i5) {
            return AccessibilityNodeInfoCompat.wrapNonNullInstance(accessibilityNodeInfo.getChild(i4, i5));
        }
        ...
        @DoNotInline
        public static AccessibilityNodeInfoCompat getParent(AccessibilityNodeInfo accessibilityNodeInfo, int i4) {
            return AccessibilityNodeInfoCompat.wrapNonNullInstance(accessibilityNodeInfo.getParent(i4));
        }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static final class Builder {
            ...
            @NonNull
            public Builder setColumnIndex(int i4) {
                this.mColumnIndex = i4;
                return this;
            }

            @NonNull
            public Builder setColumnSpan(int i4) {
                this.mColumnSpan = i4;
                return this;
            }
            ...
            @NonNull
            public Builder setRowIndex(int i4) {
                this.mRowIndex = i4;
                return this;
            }

            @NonNull
            public Builder setRowSpan(int i4) {
                this.mRowSpan = i4;
                return this;
            }
    ...
    static String getActionSymbolicName(int i4) {
        if (i4 == 1) {
            return "ACTION_FOCUS";
        }
        if (i4 == 2) {
    ...
    private boolean getBooleanProperty(int i4) {
        ...
        if (extras != null && (extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & i4) == i4) {
            return true;
        }
        return false;
    }
    ...
    private int idForClickableSpan(ClickableSpan clickableSpan, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        if (sparseArray != null) {
            for (int i4 = 0; i4 < sparseArray.size(); i4++) {
                if (clickableSpan.equals((ClickableSpan) sparseArray.valueAt(i4).get())) {
    ...
    private void setBooleanProperty(int i4, boolean z4) {
        Bundle extras = getExtras();
        if (extras != null) {
            int i5 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~i4);
            if (!z4) {
                i4 = 0;
            }
    ...
    public void setMinDurationBetweenContentChangesMillis(long j4) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setMinDurationBetweenContentChangeMillis(this.mInfo, j4);
        } else {
            this.mInfo.getExtras().putLong(MIN_DURATION_BETWEEN_CONTENT_CHANGES_KEY, j4);
        }
    }
    ...
    public static class RangeInfoCompat {
        ...
        public RangeInfoCompat(int i4, float f4, float f5, float f6) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.mInfo = Api30Impl.createRangeInfo(i4, f4, f5, f6);
            } else {
                this.mInfo = AccessibilityNodeInfo.RangeInfo.obtain(i4, f4, f5, f6);
            }
        }
    }
    ...
    @Nullable
    public AccessibilityNodeInfoCompat getChild(int i4, int i5) {
        if (Build.VERSION.SDK_INT >= 33) {
            return Api33Impl.getChild(this.mInfo, i4, i5);
        }
        return getChild(i4);
    }

    @Nullable
    public AccessibilityNodeInfoCompat getParent(int i4) {
        if (Build.VERSION.SDK_INT >= 33) {
            return Api33Impl.getParent(this.mInfo, i4);
        }
        return getParent();
    }
