...
public class FingerprintManagerCompat {
    ...
    public static abstract class AuthenticationCallback {
        ...
        public void onAuthenticationHelp(int i4, @NonNull CharSequence charSequence) {
        }
    ...
    public void authenticate(@Nullable CryptoObject cryptoObject, int i4, @Nullable androidx.core.os.CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        authenticate(cryptoObject, i4, cancellationSignal != null ? (CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, authenticationCallback, handler);
    }
    ...
    public void authenticate(@Nullable CryptoObject cryptoObject, int i4, @Nullable CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && (fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext)) != null) {
            ...
            Api23Impl.authenticate(fingerprintManagerOrNull, wrapCryptoObject(cryptoObject), cancellationSignal2, i4, wrapCallback(authenticationCallback), handler);
        }
    }
