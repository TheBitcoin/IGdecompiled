...
public final class BundleKt {
    public static final Bundle bundleOf(l... lVarArr) {
        ...
        for (l lVar : lVarArr) {
            ...
            if (b5 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    m.c(b5, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) b5);
                } else if (String.class.isAssignableFrom(componentType)) {
                    m.c(b5, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) b5);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    m.c(b5, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
