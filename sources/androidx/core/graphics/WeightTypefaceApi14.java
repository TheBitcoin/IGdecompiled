...
final class WeightTypefaceApi14 {
    ...
    @Nullable
    static Typeface createWeightStyle(@NonNull TypefaceCompatBaseImpl typefaceCompatBaseImpl, @NonNull Context context, @NonNull Typeface typeface, int i4, boolean z4) {
        ...
        synchronized (sWeightCacheLock) {
            try {
                ...
                Typeface bestFontFromFamily = getBestFontFromFamily(typefaceCompatBaseImpl, context, typeface, i4, z4);
                if (bestFontFromFamily == null) {
                    bestFontFromFamily = platformTypefaceCreate(typeface, i4, z4);
                }
    ...
    @Nullable
    private static Typeface getBestFontFromFamily(@NonNull TypefaceCompatBaseImpl typefaceCompatBaseImpl, @NonNull Context context, @NonNull Typeface typeface, int i4, boolean z4) {
        FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamily = typefaceCompatBaseImpl.getFontFamily(typeface);
        if (fontFamily == null) {
            return null;
        }
        return typefaceCompatBaseImpl.createFromFontFamilyFilesResourceEntry(context, fontFamily, context.getResources(), i4, z4);
    }
    ...
    private static Typeface platformTypefaceCreate(Typeface typeface, int i4, boolean z4) {
        boolean z5;
        int i5 = 0;
        if (i4 >= 600) {
            z5 = true;
