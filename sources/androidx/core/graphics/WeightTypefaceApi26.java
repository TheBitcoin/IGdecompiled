...
final class WeightTypefaceApi26 {
    ...
    static Typeface createWeightStyle(@NonNull Typeface typeface, int i4, boolean z4) {
        ...
        synchronized (sWeightCacheLock) {
            try {
                ...
                Typeface create = create(nativeCreateFromTypefaceWithExactStyle(nativeInstance, i4, z4));
    ...
    private static long nativeCreateFromTypefaceWithExactStyle(long j4, int i4, boolean z4) {
        try {
            return ((Long) sNativeCreateFromTypefaceWithExactStyle.invoke((Object) null, new Object[]{Long.valueOf(j4), Integer.valueOf(i4), Boolean.valueOf(z4)})).longValue();
        } catch (IllegalAccessException e5) {
            throw new RuntimeException(e5);
