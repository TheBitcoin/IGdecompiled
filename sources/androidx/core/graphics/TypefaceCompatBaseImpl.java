...
class TypefaceCompatBaseImpl {
    ...
    private FontResourcesParserCompat.FontFileResourceEntry findBestEntry(FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i4) {
        return (FontResourcesParserCompat.FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i4, new StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry>() {
    ...
    private static <T> T findBestFont(T[] tArr, int i4, StyleExtractor<T> styleExtractor) {
        return findBestFont(tArr, (i4 & 1) == 0 ? 400 : TypedValues.TransitionType.TYPE_DURATION, (i4 & 2) != 0, styleExtractor);
    }
    ...
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface typeface, int i4, boolean z4) {
        Typeface typeface2;
        try {
            typeface2 = WeightTypefaceApi14.createWeightStyle(this, context, typeface, i4, z4);
        } catch (RuntimeException unused) {
            typeface2 = null;
        }
        if (typeface2 == null) {
    ...
    public FontsContractCompat.FontInfo findBestInfo(FontsContractCompat.FontInfo[] fontInfoArr, int i4) {
        return (FontsContractCompat.FontInfo) findBestFont(fontInfoArr, i4, new StyleExtractor<FontsContractCompat.FontInfo>() {
    ...
    private FontResourcesParserCompat.FontFileResourceEntry findBestEntry(FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i4, boolean z4) {
        return (FontResourcesParserCompat.FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i4, z4, new StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry>() {
            public int getWeight(FontResourcesParserCompat.FontFileResourceEntry fontFileResourceEntry) {
                return fontFileResourceEntry.getWeight();
            }
    ...
    private static <T> T findBestFont(T[] tArr, int i4, boolean z4, StyleExtractor<T> styleExtractor) {
        T t4 = null;
        int i5 = Integer.MAX_VALUE;
        for (T t5 : tArr) {
            int abs = (Math.abs(styleExtractor.getWeight(t5) - i4) * 2) + (styleExtractor.isItalic(t5) == z4 ? 0 : 1);
            if (t4 == null || i5 > abs) {
                t4 = t5;
                i5 = abs;
            }
    ...
    /* access modifiers changed from: package-private */
    @Nullable
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i4, boolean z4) {
        FontResourcesParserCompat.FontFileResourceEntry findBestEntry = findBestEntry(fontFamilyFilesResourceEntry, i4, z4);
        if (findBestEntry == null) {
            return null;
        }
