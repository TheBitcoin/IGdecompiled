...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean blocksInteractionBelow(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4) {
            if (getScrimOpacity(coordinatorLayout, v4) > 0.0f) {
                return true;
            }
            return false;
        }
        ...
        public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, float f4, float f5, boolean z4) {
            return false;
        }
        ...
        @Deprecated
        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, @NonNull View view2, int i4) {
        }
        ...
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, int i4, int i5, @NonNull int[] iArr, int i6) {
            if (i6 == 0) {
                onNestedPreScroll(coordinatorLayout, v4, view, i4, i5, iArr);
            }
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, int i4, int i5, int i6, int i7, int i8) {
            if (i8 == 0) {
                onNestedScroll(coordinatorLayout, v4, view, i4, i5, i6, i7);
            }
        }

        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, @NonNull View view2, int i4, int i5) {
            if (i5 == 0) {
                onNestedScrollAccepted(coordinatorLayout, v4, view, view2, i4);
            }
        }
        ...
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, @NonNull View view2, int i4, int i5) {
            if (i5 == 0) {
                return onStartNestedScroll(coordinatorLayout, v4, view, view2, i4);
            }
            return false;
        }

        public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, int i4) {
            if (i4 == 0) {
        ...
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v4, @NonNull View view, int i4, int i5, int i6, int i7, int i8, @NonNull int[] iArr) {
            iArr[0] = iArr[0] + i6;
            iArr[1] = iArr[1] + i7;
            onNestedScroll(coordinatorLayout, v4, view, i4, i5, i6, i7, i8);
        }
    }
    ...
    private void constrainChildRect(LayoutParams layoutParams, Rect rect, int i4, int i5) {
        ...
        int max = Math.max(getPaddingLeft() + layoutParams.leftMargin, Math.min(rect.left, ((width - getPaddingRight()) - i4) - layoutParams.rightMargin));
        int max2 = Math.max(getPaddingTop() + layoutParams.topMargin, Math.min(rect.top, ((height - getPaddingBottom()) - i5) - layoutParams.bottomMargin));
    ...
    private void offsetChildByInset(View view, Rect rect, int i4) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            boolean z6 = true;
            if ((absoluteGravity & 48) != 48 || (i9 = (acquireTempRect.top - layoutParams.topMargin) - layoutParams.mInsetOffsetY) >= (i10 = rect.top)) {
                z4 = false;
            } else {
                setInsetOffsetY(view, i10 - i9);
                z4 = true;
            }
            if ((absoluteGravity & 80) == 80 && (height = ((getHeight() - acquireTempRect.bottom) - layoutParams.bottomMargin) + layoutParams.mInsetOffsetY) < (i8 = rect.bottom)) {
            ...
            if ((absoluteGravity & 3) != 3 || (i6 = (acquireTempRect.left - layoutParams.leftMargin) - layoutParams.mInsetOffsetX) >= (i7 = rect.left)) {
                z5 = false;
            } else {
                setInsetOffsetX(view, i7 - i6);
                z5 = true;
            }
            if ((absoluteGravity & 5) != 5 || (width = ((getWidth() - acquireTempRect.right) - layoutParams.rightMargin) + layoutParams.mInsetOffsetX) >= (i5 = rect.right)) {
                z6 = z5;
            } else {
    ...
    public void getDesiredAnchoredChildRect(View view, int i4, Rect rect, Rect rect2) {
        ...
        int measuredHeight = view.getMeasuredHeight();
        Rect rect3 = rect2;
        getDesiredAnchoredChildRectWithoutConstraints(view, i4, rect, rect3, layoutParams, measuredWidth, measuredHeight);
    ...
    public void offsetChildToAnchor(View view, int i4) {
        ...
        if (layoutParams.mAnchorView != null) {
            ...
            int measuredHeight = view.getMeasuredHeight();
            View view2 = view;
            getDesiredAnchoredChildRectWithoutConstraints(view2, i4, acquireTempRect, acquireTempRect3, layoutParams, measuredWidth, measuredHeight);
            ...
            if (i5 != 0) {
                ViewCompat.offsetLeftAndRight(view2, i5);
            }
            if (i6 != 0) {
        ...
        while (i4 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(0) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    f6 = f5;
                    z5 = z4;
                    z6 |= behavior.onNestedFling(this, childAt, view2, f7, f6, z5);
                    i4++;
                    view = view2;
                    f4 = f7;
                    f5 = f6;
        ...
        while (i4 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(0) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    f7 = f4;
                    f6 = f5;
                    z4 |= behavior.onNestedPreFling(this, childAt, view2, f7, f6);
                    i4++;
                    view = view2;
                    f4 = f7;
                    f5 = f6;
    ...
    public void setStatusBarBackgroundResource(@DrawableRes int i4) {
        Drawable drawable;
        if (i4 != 0) {
            drawable = ContextCompat.getDrawable(getContext(), i4);
        } else {
            drawable = null;
        }
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i10) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedPreScroll(this, childAt, view, i4, i5, iArr2, i10);
    ...
    public void onNestedScrollAccepted(View view, View view2, int i4, int i5) {
        ...
        while (i8 < childCount) {
            ...
            if (layoutParams.isNestedScrollAccepted(i5) && (behavior = layoutParams.getBehavior()) != null) {
                ...
                i7 = i4;
                i6 = i5;
                behavior.onNestedScrollAccepted(this, childAt, view4, view3, i7, i6);
            } else {
                view4 = view;
                view3 = view2;
                i7 = i4;
    ...
    public boolean onStartNestedScroll(View view, View view2, int i4, int i5) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (behavior != null) {
                    int i8 = i5;
                    boolean onStartNestedScroll = behavior.onStartNestedScroll(this, childAt, view, view2, i4, i8);
                    z4 |= onStartNestedScroll;
                    layoutParams.setNestedScrollAccepted(i8, onStartNestedScroll);
                } else {
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i4) {
        ...
        if (Build.VERSION.SDK_INT < 29) {
            ...
            context2 = context;
            coordinatorLayout = this;
            coordinatorLayout.saveAttributeDataForStyleable(context2, R.styleable.CoordinatorLayout, attributeSet, typedArray, i4, 0);
        }
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i12) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedScroll(this, childAt, view, i4, i5, i6, i7, i12, iArr2);
                    int[] iArr3 = this.mBehaviorConsumed;
                    if (i6 > 0) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private boolean shouldDodge(View view, int i4) {
            ...
            if (absoluteGravity == 0 || (GravityCompat.getAbsoluteGravity(this.dodgeInsetEdges, i4) & absoluteGravity) != absoluteGravity) {
                return false;
            }
            return true;
        }
        ...
        /* access modifiers changed from: package-private */
        public void setNestedScrollAccepted(int i4, boolean z4) {
            if (i4 == 0) {
