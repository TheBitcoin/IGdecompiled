...
public class FullWidthDetailsOverviewRowPresenter extends RowPresenter {
    ...
    /* access modifiers changed from: protected */
    public void onLayoutLogo(ViewHolder viewHolder, int i4, boolean z4) {
    ...
    /* access modifiers changed from: protected */
    public void onStateChanged(ViewHolder viewHolder, int i4) {
        onLayoutOverviewFrame(viewHolder, i4, false);
        onLayoutLogo(viewHolder, i4, false);
    }
    ...
    public final void setActionsBackgroundColor(int i4) {
        this.mActionsBackgroundColor = i4;
        this.mActionsBackgroundColorSet = true;
    }

    public final void setAlignmentMode(int i4) {
    ...
    public final void setInitialState(int i4) {
        this.mInitialState = i4;
    }
    ...
    public final void setState(ViewHolder viewHolder, int i4) {
        if (viewHolder.getState() != i4) {
            int state = viewHolder.getState();
            viewHolder.mState = i4;
