...
public class PlaybackControlsRowPresenter extends PlaybackRowPresenter {
    ...
    public class ViewHolder extends PlaybackRowPresenter.ViewHolder {
        ...
        final PlaybackControlsRow.OnPlaybackProgressCallback mListener = new PlaybackControlsRow.OnPlaybackProgressCallback() {
            public void onBufferedPositionChanged(PlaybackControlsRow playbackControlsRow, long j4) {
                ...
                PlaybackControlsRowPresenter.this.mPlaybackControlsPresenter.setSecondaryProgressLong(viewHolder.mControlsVh, j4);
            }

            public void onCurrentPositionChanged(PlaybackControlsRow playbackControlsRow, long j4) {
                ViewHolder viewHolder = ViewHolder.this;
                PlaybackControlsRowPresenter.this.mPlaybackControlsPresenter.setCurrentTimeLong(viewHolder.mControlsVh, j4);
            }

            public void onDurationChanged(PlaybackControlsRow playbackControlsRow, long j4) {
                ViewHolder viewHolder = ViewHolder.this;
                PlaybackControlsRowPresenter.this.mPlaybackControlsPresenter.setTotalTimeLong(viewHolder.mControlsVh, j4);
            }
        };
    ...
    private void initRow(final ViewHolder viewHolder) {
        ...
        playbackControlsPresenter.setProgressColor(viewHolder2, i4);
        ...
        if (this.mBackgroundColorSet) {
            i5 = this.mBackgroundColor;
        } else {
            i5 = getDefaultBackgroundColor(viewHolder.view.getContext());
        }
        playbackControlsPresenter2.setBackgroundColor(viewHolder3, i5);
    ...
    private void updateCardLayout(ViewHolder viewHolder, int i4) {
        int i5;
        ...
        if (i4 == -2) {
            ...
            if (this.mBackgroundColorSet) {
                ...
                i5 = getDefaultBackgroundColor(viewGroup.getContext());
            }
