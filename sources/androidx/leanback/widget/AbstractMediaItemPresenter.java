...
public abstract class AbstractMediaItemPresenter extends RowPresenter {
    ...
    public static class ViewHolder extends RowPresenter.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            if (resolveAttribute) {
                ...
                i4 = R.layout.lb_media_item_number_view_flipper;
            }
            View inflate = from.inflate(i4, viewFlipper, true);
        ...
        public int findActionIndex(MultiActionsProvider.MultiAction multiAction) {
            ...
            while (true) {
                ...
                if (i4 >= multiActionArr.length) {
                    return -1;
                }
                if (multiActionArr[i4] == multiAction) {
                    return i4;
                }
                i4++;
            }
                ...
                if (actionPresenter != null) {
                    ...
                    if (this.mMediaItemActionsContainer != null) {
                        for (int i4 = 0; i4 < actions.length; i4++) {
                            Presenter.ViewHolder viewHolder = this.mActionViewHolders.get(i4);
                            actionPresenter.onUnbindViewHolder(viewHolder);
                            actionPresenter.onBindViewHolder(viewHolder, this.mMediaItemRowActions[i4]);
                        }
                    }
                }
            }
        ...
        public void setSelectedMediaItemNumberView(int i4) {
            if (i4 >= 0 && i4 < this.mMediaItemNumberViewFlipper.getChildCount()) {
                this.mMediaItemNumberViewFlipper.setDisplayedChild(i4);
            }
        }
    }
    ...
    static ValueAnimator updateSelector(View view, View view2, ValueAnimator valueAnimator, boolean z4) {
        ...
        final float f4 = (float) (marginLayoutParams.width - width);
        final float f5 = (float) (marginLayoutParams.leftMargin - i4);
        if (f5 == 0.0f && f4 == 0.0f) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                marginLayoutParams.leftMargin = Math.round(((float) i4) + (f5 * animatedFraction));
                marginLayoutParams.width = Math.round(((float) width) + (f4 * animatedFraction));
                view3.requestLayout();
            }
        });
        ofFloat.start();
    ...
    public void onBindRowViewHolder(RowPresenter.ViewHolder viewHolder, Object obj) {
        ...
        mediaItemRowSeparator.setVisibility(i4);
    ...
    public AbstractMediaItemPresenter(int i4) {
