...
public class SearchBar extends RelativeLayout {
    ...
    private void loadSounds(Context context) {
        ...
        for (int i4 = 0; i4 < 4; i4++) {
            int i5 = iArr[i4];
            this.mSoundMap.put(i5, this.mSoundPool.load(context, i5, 1));
        }
    }

    private void play(final int i4) {
        this.mHandler.post(new Runnable() {
            public void run() {
                SearchBar.this.mSoundPool.play(SearchBar.this.mSoundMap.get(i4), 1.0f, 1.0f, 1, 0, 1.0f);
            }
        });
    }
    ...
    public void setNextFocusDownId(int i4) {
        this.mSpeechOrbView.setNextFocusDownId(i4);
        this.mSearchTextEditor.setNextFocusDownId(i4);
    }
                ...
                if (getContext().checkCallingOrSelfPermission("android.permission.RECORD_AUDIO") == 0) {
                    ...
                    this.mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
                        ...
                        public void onRmsChanged(float f4) {
                            ...
                            SearchBar.this.mSpeechOrbView.setSoundLevel(i4);
                        }
                    });
