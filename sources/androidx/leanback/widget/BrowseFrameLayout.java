...
public class BrowseFrameLayout extends FrameLayout {
    ...
    public interface OnChildFocusListener {
        ...
        boolean onRequestFocusInDescendants(int i4, Rect rect);
    }

    public interface OnFocusSearchListener {
        View onFocusSearch(View view, int i4);
    }
    ...
    public View focusSearch(View view, int i4) {
        ...
        if (onFocusSearchListener == null || (onFocusSearch = onFocusSearchListener.onFocusSearch(view, i4)) == null) {
    ...
    public boolean onRequestFocusInDescendants(int i4, Rect rect) {
        ...
        if (onChildFocusListener == null || !onChildFocusListener.onRequestFocusInDescendants(i4, rect)) {
