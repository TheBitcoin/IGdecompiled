...
public abstract class RowPresenter extends Presenter {
    ...
    private void updateActivateStatus(ViewHolder viewHolder, View view) {
        int i4 = this.mSyncActivatePolicy;
        boolean z4 = true;
        if (i4 == 1) {
    ...
    public final void setSelectLevel(Presenter.ViewHolder viewHolder, float f4) {
        ViewHolder rowViewHolder = getRowViewHolder(viewHolder);
        rowViewHolder.mSelectLevel = f4;
        onSelectLevelChanged(rowViewHolder);
    }

    public final void setSyncActivatePolicy(int i4) {
        this.mSyncActivatePolicy = i4;
    }
}
