...
public class ScaleFrameLayout extends FrameLayout {
    ...
    private static int getScaledMeasureSpec(int i4, float f4) {
        if (f4 == 1.0f) {
            return i4;
        }
        return View.MeasureSpec.makeMeasureSpec((int) ((((float) View.MeasureSpec.getSize(i4)) / f4) + 0.5f), View.MeasureSpec.getMode(i4));
    }
    ...
    public void onMeasure(int i4, int i5) {
        float f4 = this.mLayoutScaleX;
        if (f4 == 1.0f && this.mLayoutScaleY == 1.0f) {
            super.onMeasure(i4, i5);
            return;
        }
        super.onMeasure(getScaledMeasureSpec(i4, f4), getScaledMeasureSpec(i5, this.mLayoutScaleY));
    ...
    public void setLayoutScaleX(float f4) {
        if (f4 != this.mLayoutScaleX) {
            this.mLayoutScaleX = f4;
            requestLayout();
        }
    }

    public void setLayoutScaleY(float f4) {
        if (f4 != this.mLayoutScaleY) {
