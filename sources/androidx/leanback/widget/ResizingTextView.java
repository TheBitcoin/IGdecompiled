...
class ResizingTextView extends TextView {
    ...
    public ResizingTextView(Context context, AttributeSet attributeSet, int i4, int i5) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.lbResizingTextView, i4, i5);
        try {
    ...
    private void setPaddingTopAndBottom(int i4, int i5) {
    ...
    public void setResizedPaddingAdjustmentBottom(int i4) {
        if (this.mResizedPaddingAdjustmentBottom != i4) {
            this.mResizedPaddingAdjustmentBottom = i4;
            resizeParamsChanged();
        }
    }

    public void setResizedPaddingAdjustmentTop(int i4) {
        if (this.mResizedPaddingAdjustmentTop != i4) {
            this.mResizedPaddingAdjustmentTop = i4;
            resizeParamsChanged();
        }
    }

    public void setResizedTextSize(int i4) {
        if (this.mResizedTextSize != i4) {
            this.mResizedTextSize = i4;
            resizeParamsChanged();
        }
    }

    public void setTriggerConditions(int i4) {
        if (this.mTriggerConditions != i4) {
            this.mTriggerConditions = i4;
            requestLayout();
        }
    }
