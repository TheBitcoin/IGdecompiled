...
public class GuidedAction extends Action {
    ...
    public static abstract class BuilderBase<B extends BuilderBase> {
        ...
        private void setFlags(int i4, int i5) {
            this.mActionFlags = (i4 & i5) | (this.mActionFlags & (~i5));
        }
        ...
        public B descriptionEditInputType(int i4) {
            this.mDescriptionEditInputType = i4;
            return this;
        }
        ...
        public B descriptionInputType(int i4) {
            this.mDescriptionInputType = i4;
            return this;
        }
        ...
        public B editInputType(int i4) {
            this.mEditInputType = i4;
            return this;
        }
        ...
        @Deprecated
        public B iconResourceId(@DrawableRes int i4, Context context) {
            return icon(ContextCompat.getDrawable(context, i4));
        }
        ...
        public B description(@StringRes int i4) {
            this.mDescription = getContext().getString(i4);
            return this;
        }

        public B editDescription(@StringRes int i4) {
            this.mEditDescription = getContext().getString(i4);
            return this;
        }

        public B editTitle(@StringRes int i4) {
            this.mEditTitle = getContext().getString(i4);
            return this;
        }

        public B icon(@DrawableRes int i4) {
            return icon(ContextCompat.getDrawable(getContext(), i4));
        }

        public B title(@StringRes int i4) {
            this.mTitle = getContext().getString(i4);
            return this;
        }
    }
    ...
    static boolean isPasswordVariant(int i4) {
        int i5 = i4 & 4080;
        return i5 == 128 || i5 == 144 || i5 == 224;
    }
