...
public class PlaybackControlsRow extends Row {
    ...
    public static class ClosedCaptioningAction extends MultiAction {
        ...
        public ClosedCaptioningAction(Context context, int i4) {
            ...
            setDrawables(new Drawable[]{bitmapDrawable, new BitmapDrawable(context.getResources(), PlaybackControlsRow.createBitmap(bitmapDrawable.getBitmap(), i4))});
    ...
    public static class FastForwardAction extends MultiAction {
        ...
        public FastForwardAction(Context context, int i4) {
            ...
            if (i4 >= 1) {
                ...
                while (i5 <= i4) {
                    int i6 = i5 + 1;
                    strArr[i5] = context.getResources().getString(R.string.lb_control_display_fast_forward_multiplier, new Object[]{Integer.valueOf(i6)});
                    strArr2[i5] = context.getResources().getString(R.string.lb_playback_controls_fast_forward_multiplier, new Object[]{Integer.valueOf(i6)});
                    i5 = i6;
                }
                setLabels(strArr);
    ...
    public static abstract class MultiAction extends Action {
        ...
        public String getSecondaryLabel(int i4) {
    ...
    public static class RepeatAction extends MultiAction {
        ...
        public RepeatAction(Context context, int i4, int i5) {
            ...
            if (bitmapDrawable2 == null) {
                ...
                bitmapDrawable = new BitmapDrawable(context.getResources(), PlaybackControlsRow.createBitmap(bitmapDrawable2.getBitmap(), i4));
            }
            setDrawables(new Drawable[]{bitmapDrawable2, bitmapDrawable, bitmapDrawable3 != null ? new BitmapDrawable(context.getResources(), PlaybackControlsRow.createBitmap(bitmapDrawable3.getBitmap(), i5)) : bitmapDrawable4});
    ...
    public static class RewindAction extends MultiAction {
        ...
        public RewindAction(Context context, int i4) {
            ...
            if (i4 >= 1) {
                ...
                while (i5 <= i4) {
                    int i6 = i5 + 1;
                    String string = context.getResources().getString(R.string.lb_control_display_rewind_multiplier, new Object[]{Integer.valueOf(i6)});
                    strArr[i5] = string;
                    strArr[i5] = string;
                    strArr2[i5] = context.getResources().getString(R.string.lb_playback_controls_rewind_multiplier, new Object[]{Integer.valueOf(i6)});
                    i5 = i6;
                }
                setLabels(strArr);
                setSecondaryLabels(strArr2);
    ...
    public static abstract class ThumbsAction extends MultiAction {
        ...
        public ThumbsAction(int i4, Context context, int i5, int i6) {
            super(i4);
            setDrawables(new Drawable[]{PlaybackControlsRow.getStyledDrawable(context, i5), PlaybackControlsRow.getStyledDrawable(context, i6)});
        }
    }
    ...
    static Bitmap createBitmap(Bitmap bitmap, int i4) {
    ...
    static Drawable getStyledDrawable(Context context, int i4) {
        TypedValue typedValue = new TypedValue();
    ...
    public Action getActionForKeyCode(int i4) {
        Action actionForKeyCode = getActionForKeyCode(getPrimaryActionsAdapter(), i4);
        if (actionForKeyCode != null) {
            return actionForKeyCode;
        }
        return getActionForKeyCode(getSecondaryActionsAdapter(), i4);
    }
    ...
    public void setBufferedPosition(long j4) {
        if (this.mBufferedProgressMs != j4) {
            this.mBufferedProgressMs = j4;
            OnPlaybackProgressCallback onPlaybackProgressCallback = this.mListener;
            if (onPlaybackProgressCallback != null) {
                onPlaybackProgressCallback.onBufferedPositionChanged(this, j4);
            }
        }
    }

    @Deprecated
    public void setBufferedProgress(int i4) {
        setBufferedPosition((long) i4);
    }

    @Deprecated
    public void setBufferedProgressLong(long j4) {
        setBufferedPosition(j4);
    }

    public void setCurrentPosition(long j4) {
        if (this.mCurrentTimeMs != j4) {
            this.mCurrentTimeMs = j4;
            OnPlaybackProgressCallback onPlaybackProgressCallback = this.mListener;
            if (onPlaybackProgressCallback != null) {
                onPlaybackProgressCallback.onCurrentPositionChanged(this, j4);
            }
        }
    }
    ...
    public void setCurrentTime(int i4) {
        setCurrentTimeLong((long) i4);
    }

    @Deprecated
    public void setCurrentTimeLong(long j4) {
        setCurrentPosition(j4);
    }

    public void setDuration(long j4) {
        if (this.mTotalTimeMs != j4) {
            this.mTotalTimeMs = j4;
            OnPlaybackProgressCallback onPlaybackProgressCallback = this.mListener;
            if (onPlaybackProgressCallback != null) {
                onPlaybackProgressCallback.onDurationChanged(this, j4);
            }
        }
    }
    ...
    @Deprecated
    public void setTotalTimeLong(long j4) {
        setDuration(j4);
    }
    ...
    public Action getActionForKeyCode(ObjectAdapter objectAdapter, int i4) {
        if (objectAdapter == this.mPrimaryActionsAdapter || objectAdapter == this.mSecondaryActionsAdapter) {
            for (int i5 = 0; i5 < objectAdapter.size(); i5++) {
                Action action = (Action) objectAdapter.get(i5);
