...
public class BrandedFragment extends Fragment {
    ...
    public void setSearchAffordanceColor(int i4) {
        setSearchAffordanceColors(new SearchOrbView.Colors(i4));
    }
    ...
    public void showTitle(int i4) {
        TitleViewAdapter titleViewAdapter = this.mTitleViewAdapter;
        if (titleViewAdapter != null) {
            titleViewAdapter.updateComponentsVisibility(i4);
        }
        showTitle(true);
    }
}
