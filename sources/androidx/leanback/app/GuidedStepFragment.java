...
public class GuidedStepFragment extends Fragment implements GuidedActionAdapter.FocusListener {
    ...
    public static int addAsRoot(Activity activity, GuidedStepFragment guidedStepFragment, int i4) {
        ...
        return beginTransaction.replace(i4, guidedStepFragment, TAG_LEAN_BACK_ACTIONS_FRAGMENT).commit();
    }
    ...
    private int getFirstCheckedAction() {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            if (this.mActions.get(i4).isChecked()) {
                return i4;
            }
        }
        return 0;
    ...
    private static boolean isGuidedStepTheme(Context context) {
        ...
        if (!context.getTheme().resolveAttribute(i4, typedValue, true) || typedValue.type != 18 || typedValue.data == 0) {
            return false;
        }
        return true;
    }
    ...
    public GuidedAction findActionById(long j4) {
        int findActionPositionById = findActionPositionById(j4);
    ...
    public GuidedAction findButtonActionById(long j4) {
        int findButtonActionPositionById = findButtonActionPositionById(j4);
    ...
    public int findButtonActionPositionById(long j4) {
        if (this.mButtonActions == null) {
            return -1;
        }
        for (int i4 = 0; i4 < this.mButtonActions.size(); i4++) {
            GuidedAction guidedAction = this.mButtonActions.get(i4);
            if (this.mButtonActions.get(i4).getId() == j4) {
                return i4;
            }
        }
        return -1;
    ...
    public View getActionItemView(int i4) {
        RecyclerView.ViewHolder findViewHolderForPosition = this.mActionsStylist.getActionsGridView().findViewHolderForPosition(i4);
    ...
    public View getButtonActionItemView(int i4) {
        RecyclerView.ViewHolder findViewHolderForPosition = this.mButtonActionsStylist.getActionsGridView().findViewHolderForPosition(i4);
        if (findViewHolderForPosition == null) {
            return null;
        }
        return findViewHolderForPosition.itemView;
    ...
    public void notifyActionChanged(int i4) {
        GuidedActionAdapter guidedActionAdapter = this.mAdapter;
        if (guidedActionAdapter != null) {
            guidedActionAdapter.notifyItemChanged(i4);
        }
    }

    public void notifyButtonActionChanged(int i4) {
    ...
    public void popBackStackToGuidedStepFragment(Class cls, int i4) {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setEntranceTransitionType(int i4) {
        this.entranceTransitionType = i4;
    }

    public void setSelectedActionPosition(int i4) {
        this.mActionsStylist.getActionsGridView().setSelectedPosition(i4);
    }

    public void setSelectedButtonActionPosition(int i4) {
        this.mButtonActionsStylist.getActionsGridView().setSelectedPosition(i4);
    }

    public void setUiStyle(int i4) {
        boolean z4;
        int uiStyle = getUiStyle();
        Bundle arguments = getArguments();
        if (arguments == null) {
    ...
    public static int add(FragmentManager fragmentManager, GuidedStepFragment guidedStepFragment, int i4) {
        GuidedStepFragment currentGuidedStepFragment = getCurrentGuidedStepFragment(fragmentManager);
        int i5 = currentGuidedStepFragment != null ? 1 : 0;
        if (Build.VERSION.SDK_INT < 23 && i5 == 0) {
            fragmentManager.beginTransaction().replace(i4, new DummyFragment(), TAG_LEAN_BACK_ACTIONS_FRAGMENT).commit();
        }
        FragmentTransaction beginTransaction = fragmentManager.beginTransaction();
        guidedStepFragment.setUiStyle(1 ^ i5);
    ...
    static String generateStackEntryName(int i4, Class cls) {
        if (i4 == 0) {
