...
public class DetailsFragment extends BaseFragment {
    ...
    public final Fragment findOrCreateVideoFragment() {
        ...
        int i4 = R.id.video_surface_container;
        ...
        if (findFragmentById == null && this.mDetailsBackgroundController != null) {
            ...
            beginTransaction.add(i4, onCreateVideoFragment);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (rowsFragment == null) {
            ...
            getChildFragmentManager().beginTransaction().replace(i4, this.mRowsFragment).commit();
        }
    ...
    /* access modifiers changed from: package-private */
    public void onRowSelected(int i4, int i5) {
        ...
        if (adapter != null && adapter.size() > i4) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                onSetRowStatus(rowPresenter, rowPresenter.getRowViewHolder(viewHolder.getViewHolder()), viewHolder.getAdapterPosition(), i4, i5);
            }
        }
    }
    ...
    /* access modifiers changed from: protected */
    public void onSetDetailsOverviewRowStatus(FullWidthDetailsOverviewRowPresenter fullWidthDetailsOverviewRowPresenter, FullWidthDetailsOverviewRowPresenter.ViewHolder viewHolder, int i4, int i5, int i6) {
        if (i5 > i4) {
    ...
    /* access modifiers changed from: protected */
    public void onSetRowStatus(RowPresenter rowPresenter, RowPresenter.ViewHolder viewHolder, int i4, int i5, int i6) {
        if (rowPresenter instanceof FullWidthDetailsOverviewRowPresenter) {
            onSetDetailsOverviewRowStatus((FullWidthDetailsOverviewRowPresenter) rowPresenter, (FullWidthDetailsOverviewRowPresenter.ViewHolder) viewHolder, i4, i5, i6);
        }
    }
    ...
    public void setupDetailsOverviewRowPresenter(FullWidthDetailsOverviewRowPresenter fullWidthDetailsOverviewRowPresenter) {
        ...
        itemAlignmentDef.setItemAlignmentViewId(i4);
        ...
        itemAlignmentDef2.setItemAlignmentViewId(i4);
    ...
    public void setupDpadNavigation() {
        ...
        this.mRootView.setOnFocusSearchListener(new BrowseFrameLayout.OnFocusSearchListener() {
            public View onFocusSearch(View view, int i4) {
                ...
                if (DetailsFragment.this.mRowsFragment.getVerticalGridView() == null || !DetailsFragment.this.mRowsFragment.getVerticalGridView().hasFocus()) {
                    if (DetailsFragment.this.getTitleView() == null || !DetailsFragment.this.getTitleView().hasFocus() || i4 != 130 || DetailsFragment.this.mRowsFragment.getVerticalGridView() == null) {
                        return view;
                    }
        ...
        this.mRootView.setOnDispatchKeyListener(new View.OnKeyListener() {
            public boolean onKey(View view, int i4, KeyEvent keyEvent) {
                ...
                if ((i4 != 4 && i4 != 111) || DetailsFragment.this.getVerticalGridView().getChildCount() <= 0) {
                    return false;
                }
