...
public class RowsFragment extends BaseRowFragment implements BrowseFragment.MainFragmentRowsAdapterProvider, BrowseFragment.MainFragmentAdapterProvider {
    ...
    public static class MainFragmentAdapter extends BrowseFragment.MainFragmentAdapter<RowsFragment> {
        ...
        public void setAlignment(int i4) {
            ((RowsFragment) getFragment()).setAlignment(i4);
        }
    ...
    public static class MainFragmentRowsAdapter extends BrowseFragment.MainFragmentRowsAdapter<RowsFragment> {
        ...
        public RowPresenter.ViewHolder findRowViewHolderByPosition(int i4) {
            return ((RowsFragment) getFragment()).findRowViewHolderByPosition(i4);
        }
        ...
        public void setSelectedPosition(int i4, boolean z4, Presenter.ViewHolderTask viewHolderTask) {
            ((RowsFragment) getFragment()).setSelectedPosition(i4, z4, viewHolderTask);
        }

        public void setSelectedPosition(int i4, boolean z4) {
            ((RowsFragment) getFragment()).setSelectedPosition(i4, z4);
        }
    }
