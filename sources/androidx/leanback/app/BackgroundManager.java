...
public final class BackgroundManager {
    ...
    private static class BackgroundContinuityService {
        ...
        public Drawable getThemeDrawable(Context context, int i4) {
            Drawable drawable;
            Drawable.ConstantState constantState;
            WeakReference<Drawable.ConstantState> weakReference = this.mLastThemeDrawableState;
            if (weakReference == null || this.mLastThemeDrawableId != i4 || (constantState = weakReference.get()) == null) {
                drawable = null;
            } else {
    ...
    static class BitmapDrawable extends Drawable {
        ...
        public void setAlpha(int i4) {
            mutate();
            if (this.mState.mPaint.getAlpha() != i4) {
    ...
    static final class TranslucentLayerDrawable extends LayerDrawable {
        ...
        TranslucentLayerDrawable(BackgroundManager backgroundManager, Drawable[] drawableArr) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                this.mWrapper[i4] = new DrawableWrapper(drawableArr[i4]);
            }
        }

        public void clearDrawable(int i4, Context context) {
            for (int i5 = 0; i5 < getNumberOfLayers(); i5++) {
                if (getId(i5) == i4) {
                    this.mWrapper[i5] = null;
                    if (!(getDrawable(i5) instanceof EmptyDrawable)) {
                        super.setDrawableByLayerId(i4, BackgroundManager.createEmptyDrawable(context));
                        return;
                    }
                    return;
                }
        ...
        public void draw(Canvas canvas) {
            ...
            while (true) {
                ...
                if (i6 < drawableWrapperArr.length) {
                    DrawableWrapper drawableWrapper = drawableWrapperArr[i6];
                    if (!(drawableWrapper == null || (drawable = drawableWrapper.getDrawable()) == null)) {
                        ...
                        int i8 = this.mWrapper[i6].mAlpha;
                        if (i8 < 255) {
                            i5 *= i8;
                            i4++;
                        }
                        if (i4 == 0) {
                            ...
                            if (i4 == 1) {
                                ...
                                i5 /= OggPageHeader.MAX_PAGE_PAYLOAD;
                            }
                            try {
        ...
        public int findWrapperIndexById(int i4) {
            for (int i5 = 0; i5 < getNumberOfLayers(); i5++) {
                if (getId(i5) == i4) {
                    return i5;
                }
        ...
        public boolean setDrawableByLayerId(int i4, Drawable drawable) {
            if (updateDrawable(i4, drawable) != null) {
                return true;
            }
            return false;
        }
        ...
        /* access modifiers changed from: package-private */
        public void setWrapperAlpha(int i4, int i5) {
            DrawableWrapper drawableWrapper = this.mWrapper[i4];
            if (drawableWrapper != null) {
                drawableWrapper.mAlpha = i5;
                invalidateSelf();
            }
        }

        public DrawableWrapper updateDrawable(int i4, Drawable drawable) {
            super.setDrawableByLayerId(i4, drawable);
            for (int i5 = 0; i5 < getNumberOfLayers(); i5++) {
                if (getId(i5) == i4) {
                    this.mWrapper[i5] = new DrawableWrapper(drawable);
                    invalidateSelf();
                    return this.mWrapper[i5];
                }
            }
            return null;
        }
    ...
    private BackgroundManager(Activity activity) {
        ...
        AnonymousClass2 r12 = new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                BackgroundManager backgroundManager = BackgroundManager.this;
                int i4 = backgroundManager.mImageInWrapperIndex;
                if (i4 != -1) {
                    backgroundManager.mLayerDrawable.setWrapperAlpha(i4, intValue);
                }
            }
        };
    ...
    private Drawable getThemeDrawable() {
        Drawable drawable;
        int i4 = this.mThemeDrawableResourceId;
        if (i4 != -1) {
            drawable = this.mService.getThemeDrawable(this.mContext, i4);
        } else {
            drawable = null;
        }
        if (drawable == null) {
    ...
    public TranslucentLayerDrawable createTranslucentLayerDrawable(LayerDrawable layerDrawable) {
        ...
        for (int i5 = 0; i5 < numberOfLayers; i5++) {
            translucentLayerDrawable.setId(i5, layerDrawable.getId(i5));
        }
    ...
    public void setBitmap(Bitmap bitmap) {
        ...
        if (bitmap == null) {
            ...
            if (!(bitmap.getWidth() == this.mWidthPx && bitmap.getHeight() == this.mHeightPx)) {
                ...
                if (i5 > i6 * height) {
                    f4 = ((float) i4) / ((float) height);
                } else {
                    f4 = ((float) i6) / ((float) width);
                }
                int max = Math.max(0, (width - Math.min((int) (((float) i6) / f4), width)) / 2);
    ...
    public void setThemeDrawableResourceId(int i4) {
        this.mThemeDrawableResourceId = i4;
    }
    ...
    static final class DrawableWrapper {
        ...
        public void setColor(int i4) {
            ((ColorDrawable) this.mDrawable).setColor(i4);
        }
