...
public class SearchSupportFragment extends Fragment {
    ...
    final Runnable mResultsChangedCallback = new Runnable() {
        public void run() {
            ...
            int i4 = searchSupportFragment3.mStatus | 1;
            searchSupportFragment3.mStatus = i4;
            if ((i4 & 2) != 0) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (childFragmentManager.findFragmentById(i4) == null) {
            ...
            this.mRowsSupportFragment = (RowsSupportFragment) getChildFragmentManager().findFragmentById(i4);
        }
    ...
    public void updateSearchBarNextFocusId() {
        ...
        if (this.mSearchBar != null && (objectAdapter = this.mResultAdapter) != null) {
            if (objectAdapter.size() == 0 || (rowsSupportFragment = this.mRowsSupportFragment) == null || rowsSupportFragment.getVerticalGridView() == null) {
                ...
                i4 = this.mRowsSupportFragment.getVerticalGridView().getId();
            }
    ...
    public void updateSearchBarVisibility() {
        ...
        RowsSupportFragment rowsSupportFragment = this.mRowsSupportFragment;
        if (rowsSupportFragment != null) {
            i4 = rowsSupportFragment.getSelectedPosition();
        } else {
            i4 = -1;
        }
        SearchBar searchBar = this.mSearchBar;
