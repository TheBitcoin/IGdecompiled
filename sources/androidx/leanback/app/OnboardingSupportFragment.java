...
public abstract class OnboardingSupportFragment extends Fragment {
    ...
    private Animator createAnimator(View view, boolean z4, int i4, long j4) {
        boolean z5;
        boolean z6;
        ...
        if ((!z5 || i4 != 8388613) && ((z5 || i4 != 8388611) && i4 != 5)) {
            z6 = false;
        } else {
            z6 = true;
        }
        if (z4) {
            ...
            objectAnimator = ObjectAnimator.ofFloat(view, property, new float[]{(float) i6, 0.0f});
            ...
            objectAnimator = ObjectAnimator.ofFloat(view, property2, new float[]{0.0f, (float) i5});
    ...
    private void onPageChangedInternal(int i4) {
        ...
        onPageChanged(onboardingSupportFragment.mCurrentPageIndex, i4);
    }
    ...
    /* access modifiers changed from: protected */
    public abstract CharSequence getPageDescription(int i4);

    /* access modifiers changed from: protected */
    public abstract CharSequence getPageTitle(int i4);
    ...
    public void hideLogoView() {
        ...
        int i4 = this.mIconResourceId;
        if (i4 != 0) {
            this.mMainIconView.setImageResource(i4);
    ...
    public void moveToPreviousPage() {
        int i4;
        if (this.mLogoAnimationFinished && (i4 = this.mCurrentPageIndex) > 0) {
            this.mCurrentPageIndex = i4 - 1;
            onPageChangedInternal(i4);
        }
    }
    ...
    public void setDescriptionViewTextColor(@ColorInt int i4) {
        this.mDescriptionViewTextColor = i4;
