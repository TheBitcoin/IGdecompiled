...
public class SearchFragment extends Fragment {
    ...
    final Runnable mResultsChangedCallback = new Runnable() {
        public void run() {
            ...
            int i4 = searchFragment3.mStatus | 1;
            searchFragment3.mStatus = i4;
            if ((i4 & 2) != 0) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (childFragmentManager.findFragmentById(i4) == null) {
            ...
            this.mRowsFragment = (RowsFragment) getChildFragmentManager().findFragmentById(i4);
        }
    ...
    public void updateSearchBarNextFocusId() {
        ...
        if (this.mSearchBar != null && (objectAdapter = this.mResultAdapter) != null) {
            if (objectAdapter.size() == 0 || (rowsFragment = this.mRowsFragment) == null || rowsFragment.getVerticalGridView() == null) {
                ...
                i4 = this.mRowsFragment.getVerticalGridView().getId();
            }
            this.mSearchBar.setNextFocusDownId(i4);
        }
    }
    ...
    public void updateSearchBarVisibility() {
        ...
        RowsFragment rowsFragment = this.mRowsFragment;
        if (rowsFragment != null) {
            i4 = rowsFragment.getSelectedPosition();
        } else {
            i4 = -1;
        }
        SearchBar searchBar = this.mSearchBar;
        if (i4 <= 0 || (objectAdapter = this.mResultAdapter) == null || objectAdapter.size() == 0) {
            i5 = 0;
        } else {
            i5 = 8;
        }
        searchBar.setVisibility(i5);
    }
