...
public abstract class PlaybackBaseControlGlue<T extends PlayerAdapter> extends PlaybackGlue implements OnActionClickedListener, View.OnKeyListener {
    ...
    public PlaybackBaseControlGlue(Context context, T t4) {
        ...
        AnonymousClass1 r22 = new PlayerAdapter.Callback() {
            ...
            public void onError(PlayerAdapter playerAdapter, int i4, String str) {
                ...
                playbackBaseControlGlue.mErrorCode = i4;
            ...
            public void onVideoSizeChanged(PlayerAdapter playerAdapter, int i4, int i5) {
                PlaybackBaseControlGlue playbackBaseControlGlue = PlaybackBaseControlGlue.this;
                playbackBaseControlGlue.mVideoWidth = i4;
                playbackBaseControlGlue.mVideoHeight = i5;
                PlaybackGlueHost.PlayerCallback playerCallback = playbackBaseControlGlue.mPlayerCallback;
                if (playerCallback != null) {
    ...
    public void onPlayCompleted() {
        ...
        if (playerCallbacks != null) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                playerCallbacks.get(i4).onPlayCompleted(this);
            }
        }
    }
    ...
    public void onPlayStateChanged() {
        ...
        if (playerCallbacks != null) {
            int size = playerCallbacks.size();
            for (int i4 = 0; i4 < size; i4++) {
                playerCallbacks.get(i4).onPlayStateChanged(this);
            }
        }
    }
    ...
    public void onPreparedStateChanged() {
        ...
        if (playerCallbacks != null) {
            int size = playerCallbacks.size();
            for (int i4 = 0; i4 < size; i4++) {
                playerCallbacks.get(i4).onPreparedStateChanged(this);
            }
        }
    }
    ...
    public void onUpdateDuration() {
        ...
        if (playbackControlsRow != null) {
            if (this.mPlayerAdapter.isPrepared()) {
                j4 = this.mPlayerAdapter.getDuration();
            } else {
                j4 = -1;
            }
