...
public abstract class PlaybackControlGlue extends PlaybackGlue implements OnActionClickedListener, View.OnKeyListener {
    ...
    private static String getSpeedString(int i4) {
        if (i4 == -1) {
        ...
        if (!(i4 == 4 || i4 == 111)) {
            switch (i4) {
                ...
                default:
                    ...
                    Action actionForKeyCode = this.mControlsRow.getActionForKeyCode(sparseArrayObjectAdapter, i4);
    ...
    public void updateControlButtons() {
        ...
        } else if (i4 == 0 && this.mSkipPreviousAction != null) {
        ...
        } else if (i5 == 0 && this.mRewindAction != null) {
        ...
        } else if (i6 == 0 && this.mPlayPauseAction != null) {
        ...
        } else if (i7 == 0 && this.mFastForwardAction != null) {
        ...
        } else if (i8 == 0 && this.mSkipNextAction != null) {
    ...
    private void updatePlaybackState(int i4) {
        if (this.mControlsRow != null) {
            SparseArrayObjectAdapter sparseArrayObjectAdapter = (SparseArrayObjectAdapter) getControlsRow().getPrimaryActionsAdapter();
            ...
            if (playPauseAction != null) {
                ...
                if (playPauseAction.getIndex() != i7) {
                    this.mPlayPauseAction.setIndex(i7);
