...
public class PlaybackBannerControlGlue<T extends PlayerAdapter> extends PlaybackBaseControlGlue<T> {
    ...
    private void updatePlaybackState(boolean z4) {
        ...
        if (this.mControlsRow != null) {
            ...
            if (fastForwardAction != null) {
                ...
                if (fastForwardAction.getIndex() != i4) {
                    this.mFastForwardAction.setIndex(i4);
            ...
            if (rewindAction != null) {
                ...
                if (rewindAction.getIndex() != i5) {
                    this.mRewindAction.setIndex(i5);
    ...
    public long getCurrentPosition() {
        ...
        long currentTimeMillis = this.mStartPosition + ((System.currentTimeMillis() - this.mStartTime) * ((long) i4));
    ...
    public void onCreatePrimaryActions(ArrayObjectAdapter arrayObjectAdapter) {
        ...
        int i4 = ((16 & supportedActions) > 0 ? 1 : ((16 & supportedActions) == 0 ? 0 : -1));
        if (i4 != 0 && this.mSkipPreviousAction == null) {
        ...
        } else if (i4 == 0 && (skipPreviousAction = this.mSkipPreviousAction) != null) {
            arrayObjectAdapter.remove(skipPreviousAction);
            this.mSkipPreviousAction = null;
        }
        int i5 = ((32 & supportedActions) > 0 ? 1 : ((32 & supportedActions) == 0 ? 0 : -1));
        if (i5 != 0 && this.mRewindAction == null) {
        ...
        } else if (i5 == 0 && (rewindAction = this.mRewindAction) != null) {
            arrayObjectAdapter.remove(rewindAction);
            this.mRewindAction = null;
        }
        int i6 = ((64 & supportedActions) > 0 ? 1 : ((64 & supportedActions) == 0 ? 0 : -1));
        if (i6 != 0 && this.mPlayPauseAction == null) {
        ...
        } else if (i6 == 0 && (playPauseAction = this.mPlayPauseAction) != null) {
            arrayObjectAdapter.remove(playPauseAction);
            this.mPlayPauseAction = null;
        }
        int i7 = ((128 & supportedActions) > 0 ? 1 : ((128 & supportedActions) == 0 ? 0 : -1));
        if (i7 != 0 && this.mFastForwardAction == null) {
        ...
        } else if (i7 == 0 && (fastForwardAction = this.mFastForwardAction) != null) {
            arrayObjectAdapter.remove(fastForwardAction);
            this.mFastForwardAction = null;
        }
        int i8 = ((supportedActions & 256) > 0 ? 1 : ((supportedActions & 256) == 0 ? 0 : -1));
        if (i8 != 0 && this.mSkipNextAction == null) {
        ...
        } else if (i8 == 0 && (skipNextAction = this.mSkipNextAction) != null) {
        ...
        if (!(i4 == 4 || i4 == 111)) {
            switch (i4) {
                ...
                case 22:
                    break;
                default:
                    Action actionForKeyCode = this.mControlsRow.getActionForKeyCode(this.mControlsRow.getPrimaryActionsAdapter(), i4);
