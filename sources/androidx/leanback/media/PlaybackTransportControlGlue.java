...
public class PlaybackTransportControlGlue<T extends PlayerAdapter> extends PlaybackBaseControlGlue<T> {
    ...
    class SeekUiClient extends PlaybackSeekUi.Client {
        ...
        public void onSeekFinished(boolean z4) {
            if (!z4) {
                long j4 = this.mLastUserPosition;
                if (j4 >= 0) {
                    PlaybackTransportControlGlue.this.seekTo(j4);
                }
            } else {
                long j5 = this.mPositionBeforeSeek;
                if (j5 >= 0) {
        ...
        public void onSeekPositionChanged(long j4) {
            ...
            if (playbackTransportControlGlue.mSeekProvider == null) {
                playbackTransportControlGlue.mPlayerAdapter.seekTo(j4);
            } else {
                this.mLastUserPosition = j4;
            }
        ...
        public void onSeekStarted() {
            ...
            PlaybackTransportControlGlue playbackTransportControlGlue = PlaybackTransportControlGlue.this;
            if (playbackTransportControlGlue.mSeekProvider == null) {
                j4 = playbackTransportControlGlue.mPlayerAdapter.getCurrentPosition();
            } else {
                j4 = -1;
            }
            this.mPositionBeforeSeek = j4;
