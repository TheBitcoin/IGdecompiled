...
public final class InvalidationTracker$refreshRunnable$1 implements Runnable {
    ...
    private final Set<Integer> checkUpdatedTable() {
        ...
        Set b5 = N.b();
        Cursor query$default = RoomDatabase.query$default(invalidationTracker.getDatabase$room_runtime_release(), new SimpleSQLiteQuery(InvalidationTracker.SELECT_UPDATED_TABLES_SQL), (CancellationSignal) null, 2, (Object) null);
        while (query$default.moveToNext()) {
            try {
                b5.add(Integer.valueOf(query$default.getInt(0)));
            } catch (Throwable th) {
                C1642b.a(query$default, th);
                throw th;
            }
        }
        s sVar = s.f8222a;
        C1642b.a(query$default, (Throwable) null);
        Set<Integer> a5 = N.a(b5);
        if (a5.isEmpty()) {
            return a5;
        }
    ...
    public void run() {
        ...
        L_0x0092:
            ...
            java.util.Set r2 = S2.N.d()     // Catch:{ all -> 0x0086 }
            r0.unlock()
            androidx.room.InvalidationTracker r0 = r4.this$0
            androidx.room.AutoCloser r0 = r0.autoCloser
            if (r0 == 0) goto L_0x00c0
        ...
        L_0x00ed:
            ...
            goto L_0x00f3
        L_0x00ef:
            R2.s r1 = R2.s.f8222a     // Catch:{ all -> 0x00ed }
            monitor-exit(r0)
            goto L_0x00f5
        L_0x00f3:
            monitor-exit(r0)
