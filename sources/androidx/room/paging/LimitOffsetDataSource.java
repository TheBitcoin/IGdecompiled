...
public abstract class LimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    private RoomSQLiteQuery getSQLiteQuery(int i4, int i5) {
        ...
        acquire.bindLong(acquire.getArgCount() - 1, (long) i5);
        acquire.bindLong(acquire.getArgCount(), (long) i4);
        return acquire;
    }
    ...
    public void loadInitial(@androidx.annotation.NonNull androidx.paging.PositionalDataSource.LoadInitialParams r7, @androidx.annotation.NonNull androidx.paging.PositionalDataSource.LoadInitialCallback<T> r8) {
        /*
            ...
            java.util.List r3 = r6.convertRows(r1)     // Catch:{ all -> 0x0031 }
    ...
    public List<T> loadRange(int i4, int i5) {
        RoomSQLiteQuery sQLiteQuery = getSQLiteQuery(i4, i5);
