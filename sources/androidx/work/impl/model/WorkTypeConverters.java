...
public final class WorkTypeConverters {
    ...
    public static final int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        ...
        int i4 = WhenMappings.$EnumSwitchMapping$1[backoffPolicy.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        if (i4 == 2) {
    ...
    public static final java.util.Set<androidx.work.Constraints.ContentUriTrigger> byteArrayToSetOfTriggers(byte[] r9) {
        /*
        ...
        L_0x001e:
            ...
            kotlin.jvm.internal.m.d(r5, r8)     // Catch:{ all -> 0x003c }
        ...
        L_0x003c:
            ...
            goto L_0x0048
        L_0x003e:
            R2.s r3 = R2.s.f8222a     // Catch:{ all -> 0x003c }
            b3.C1642b.a(r2, r9)     // Catch:{ IOException -> 0x0046 }
            goto L_0x0051
        L_0x0044:
            r9 = move-exception
            goto L_0x0057
        ...
        L_0x0049:
            r4 = move-exception
            b3.C1642b.a(r2, r3)     // Catch:{ IOException -> 0x0046 }
            throw r4     // Catch:{ IOException -> 0x0046 }
        L_0x004e:
            r2.printStackTrace()     // Catch:{ all -> 0x0044 }
        L_0x0051:
            R2.s r2 = R2.s.f8222a     // Catch:{ all -> 0x0044 }
            b3.C1642b.a(r1, r9)
            return r0
        L_0x0057:
    ...
    @TypeConverter
    public static final BackoffPolicy intToBackoffPolicy(int i4) {
        if (i4 == 0) {
    ...
    @TypeConverter
    public static final NetworkType intToNetworkType(int i4) {
        if (i4 == 0) {
    ...
    @TypeConverter
    public static final OutOfQuotaPolicy intToOutOfQuotaPolicy(int i4) {
        if (i4 == 0) {
    ...
    @TypeConverter
    public static final WorkInfo.State intToState(int i4) {
        if (i4 == 0) {
    ...
    public static final int networkTypeToInt(NetworkType networkType) {
        ...
        int i4 = WhenMappings.$EnumSwitchMapping$2[networkType.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        if (i4 == 2) {
    ...
    public static final int outOfQuotaPolicyToInt(OutOfQuotaPolicy outOfQuotaPolicy) {
        ...
        int i4 = WhenMappings.$EnumSwitchMapping$3[outOfQuotaPolicy.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        if (i4 == 2) {
    ...
    public static final byte[] setOfTriggersToByteArray(java.util.Set<androidx.work.Constraints.ContentUriTrigger> r4) {
        ...
        L_0x0043:
            ...
            goto L_0x005a
        L_0x0045:
            R2.s r4 = R2.s.f8222a     // Catch:{ all -> 0x0043 }
            r4 = 0
            b3.C1642b.a(r1, r4)     // Catch:{ all -> 0x0058 }
            b3.C1642b.a(r0, r4)
