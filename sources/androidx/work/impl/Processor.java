...
public class Processor implements ForegroundProcessor {
    ...
    public static /* synthetic */ void c(Processor processor, C2172d dVar, WorkerWrapper workerWrapper) {
        boolean z4;
        processor.getClass();
        try {
    ...
    private static boolean interrupt(@NonNull String str, @Nullable WorkerWrapper workerWrapper, int i4) {
        if (workerWrapper != null) {
    ...
    private void runOnExecuted(@NonNull WorkGenerationalId workGenerationalId, boolean z4) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new a(this, workGenerationalId, z4));
    }
    ...
    public boolean stopAndCancelWork(@NonNull String str, int i4) {
        ...
        return interrupt(str, cleanUpWorkerUnsafe, i4);
    }

    public boolean stopForegroundWork(@NonNull StartStopToken startStopToken, int i4) {
        WorkerWrapper cleanUpWorkerUnsafe;
        String workSpecId = startStopToken.getId().getWorkSpecId();
        synchronized (this.mLock) {
            cleanUpWorkerUnsafe = cleanUpWorkerUnsafe(workSpecId);
        }
        return interrupt(workSpecId, cleanUpWorkerUnsafe, i4);
    }

    public boolean stopWork(@NonNull StartStopToken startStopToken, int i4) {
        String workSpecId = startStopToken.getId().getWorkSpecId();
        synchronized (this.mLock) {
            try {
    ...
    public boolean startWork(@androidx.annotation.NonNull androidx.work.impl.StartStopToken r12, @androidx.annotation.Nullable androidx.work.WorkerParameters.RuntimeExtras r13) {
        /*
            r11 = this;
        ...
        L_0x003c:
            ...
            monitor-enter(r10)
            boolean r3 = r11.isEnqueued(r1)     // Catch:{ all -> 0x010f }
        ...
        L_0x0090:
            ...
            return r2
        L_0x0092:
            int r3 = r8.getGeneration()     // Catch:{ all -> 0x010f }
            int r4 = r0.getGeneration()     // Catch:{ all -> 0x010f }
            if (r3 == r4) goto L_0x00a1
            r11.runOnExecuted(r0, r2)     // Catch:{ all -> 0x0088 }
            monitor-exit(r10)     // Catch:{ all -> 0x0088 }
            return r2
        L_0x00a1:
            androidx.work.impl.WorkerWrapper$Builder r2 = new androidx.work.impl.WorkerWrapper$Builder     // Catch:{ all -> 0x010f }
            android.content.Context r3 = r11.mAppContext     // Catch:{ all -> 0x010f }
            androidx.work.Configuration r4 = r11.mConfiguration     // Catch:{ all -> 0x010f }
            androidx.work.impl.utils.taskexecutor.TaskExecutor r5 = r11.mWorkTaskExecutor     // Catch:{ all -> 0x010f }
            androidx.work.impl.WorkDatabase r7 = r11.mWorkDatabase     // Catch:{ all -> 0x010f }
            r6 = r11
            r2.<init>(r3, r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x010c }
            androidx.work.impl.WorkerWrapper$Builder r13 = r2.withRuntimeExtras(r13)     // Catch:{ all -> 0x010c }
            androidx.work.impl.WorkerWrapper r13 = r13.build()     // Catch:{ all -> 0x010c }
            o0.d r2 = r13.getFuture()     // Catch:{ all -> 0x010c }
            androidx.work.impl.c r3 = new androidx.work.impl.c     // Catch:{ all -> 0x010c }
            r3.<init>(r11, r2, r13)     // Catch:{ all -> 0x010c }
            androidx.work.impl.utils.taskexecutor.TaskExecutor r4 = r6.mWorkTaskExecutor     // Catch:{ all -> 0x010c }
            java.util.concurrent.Executor r4 = r4.getMainThreadExecutor()     // Catch:{ all -> 0x010c }
            r2.addListener(r3, r4)     // Catch:{ all -> 0x010c }
            java.util.Map<java.lang.String, androidx.work.impl.WorkerWrapper> r2 = r6.mEnqueuedWorkMap     // Catch:{ all -> 0x010c }
            r2.put(r1, r13)     // Catch:{ all -> 0x010c }
            java.util.HashSet r2 = new java.util.HashSet     // Catch:{ all -> 0x010c }
            r2.<init>()     // Catch:{ all -> 0x010c }
            r2.add(r12)     // Catch:{ all -> 0x010c }
            java.util.Map<java.lang.String, java.util.Set<androidx.work.impl.StartStopToken>> r12 = r6.mWorkRuns     // Catch:{ all -> 0x010c }
            r12.put(r1, r2)     // Catch:{ all -> 0x010c }
            monitor-exit(r10)     // Catch:{ all -> 0x010c }
            androidx.work.impl.utils.taskexecutor.TaskExecutor r12 = r6.mWorkTaskExecutor
            androidx.work.impl.utils.taskexecutor.SerialExecutor r12 = r12.getSerialTaskExecutor()
            r12.execute(r13)
            androidx.work.Logger r12 = androidx.work.Logger.get()
            java.lang.String r13 = TAG
            java.lang.StringBuilder r1 = new java.lang.StringBuilder
