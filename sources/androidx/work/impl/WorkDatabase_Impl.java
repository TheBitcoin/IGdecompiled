...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(20) {
            ...
            public void dropAllTables(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    ...
                    for (int i4 = 0; i4 < size; i4++) {
                        ((RoomDatabase.Callback) WorkDatabase_Impl.this.mCallbacks.get(i4)).onDestructiveMigration(supportSQLiteDatabase);
                    }
                }
            }
            ...
            public void onCreate(SupportSQLiteDatabase supportSQLiteDatabase) {
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    int size = WorkDatabase_Impl.this.mCallbacks.size();
                    for (int i4 = 0; i4 < size; i4++) {
                        ((RoomDatabase.Callback) WorkDatabase_Impl.this.mCallbacks.get(i4)).onCreate(supportSQLiteDatabase);
                    }
                }
            }
            ...
            public void onOpen(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                if (WorkDatabase_Impl.this.mCallbacks != null) {
                    int size = WorkDatabase_Impl.this.mCallbacks.size();
                    for (int i4 = 0; i4 < size; i4++) {
                        ((RoomDatabase.Callback) WorkDatabase_Impl.this.mCallbacks.get(i4)).onOpen(supportSQLiteDatabase);
                    }
                }
            }
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                hashMap2.put(MRAIDCommunicatorUtil.KEY_STATE, new TableInfo.Column(MRAIDCommunicatorUtil.KEY_STATE, "INTEGER", true, 0, (String) null, 1));
                ...
                hashMap5.put(RewardPlus.NAME, new TableInfo.Column(RewardPlus.NAME, "TEXT", true, 1, (String) null, 1));
                ...
                hashMap7.put(LeanbackPreferenceDialogFragment.ARG_KEY, new TableInfo.Column(LeanbackPreferenceDialogFragment.ARG_KEY, "TEXT", true, 1, (String) null, 1));
