...
public final class ProcessUtils {
    ...
    static {
        ...
        m.d(tagWithPrefix, "tagWithPrefix(\"ProcessUtils\")");
        TAG = tagWithPrefix;
    }
    ...
    public static final boolean isDefaultProcess(Context context, Configuration configuration) {
        ...
        if (defaultProcessName == null || defaultProcessName.length() == 0) {
            return m.a(processName, context.getApplicationInfo().processName);
        }
        return m.a(processName, configuration.getDefaultProcessName());
    }
}
