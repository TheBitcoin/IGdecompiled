...
class SystemJobInfoConverter {
    ...
    static int convertNetworkType(NetworkType networkType) {
        int i4 = AnonymousClass1.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        if (i4 == 2) {
    ...
    public JobInfo convert(WorkSpec workSpec, int i4) {
        boolean z4;
        int i5;
        ...
        JobInfo.Builder extras = new JobInfo.Builder(i4, this.mWorkServiceComponent).setRequiresCharging(constraints.requiresCharging()).setRequiresDeviceIdle(constraints.requiresDeviceIdle()).setExtras(persistableBundle);
        ...
        if (i7 >= 31 && workSpec.expedited && !z4 && !z5) {
