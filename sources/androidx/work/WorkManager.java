...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract C2172d getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract C2172d getWorkInfoById(@NonNull UUID uuid);

    @NonNull
    public abstract C1035e getWorkInfoByIdFlow(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract C2172d getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract C1035e getWorkInfosByTagFlow(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract C1035e getWorkInfosFlow(@NonNull WorkQuery workQuery);

    @NonNull
    public abstract C2172d getWorkInfosForUniqueWork(@NonNull String str);

    @NonNull
    public abstract C1035e getWorkInfosForUniqueWorkFlow(@NonNull String str);
    ...
    @NonNull
    public abstract C2172d updateWork(@NonNull WorkRequest workRequest);
