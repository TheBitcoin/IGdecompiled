...
public final class Data {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder putByte(@NonNull String str, byte b5) {
        ...
        public Builder putDouble(@NonNull String str, double d5) {
            this.mValues.put(str, Double.valueOf(d5));
            return this;
        }
        ...
        public Builder putInt(@NonNull String str, int i4) {
            this.mValues.put(str, Integer.valueOf(i4));
            return this;
        }
    ...
    public byte getByte(@NonNull String str, byte b5) {
        Object obj = this.mValues.get(str);
    ...
    public double getDouble(@NonNull String str, double d5) {
        Object obj = this.mValues.get(str);
