...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i4, int i5) {
            if (i4 == this.mCachedBitmap.getWidth() && i5 == this.mCachedBitmap.getHeight()) {
                return true;
            }
            return false;
        }
        ...
        public void updateCachedBitmap(int i4, int i5) {
            ...
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i4, i5, (ColorFilter) null);
        }
    ...
    static int applyAlpha(int i4, float f4) {
        return (i4 & ViewCompat.MEASURED_SIZE_MASK) | (((int) (((float) Color.alpha(i4)) * f4)) << 24);
    }
    ...
    private static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i4 = 0; i4 < pathDataNodeArr.length; i4++) {
                ...
                float[] fArr = pathDataNodeArr[i4].mParams;
    ...
    private static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i4, int i5, ColorFilter colorFilter) {
            ...
            while (i6 < vGroup2.mChildren.size()) {
                ...
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i4, i5, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i4, i5, colorFilter);
                }
                i6++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i4, int i5, ColorFilter colorFilter) {
            ...
            float f4 = ((float) i4) / this.mViewportWidth;
            float f5 = ((float) i5) / this.mViewportHeight;
