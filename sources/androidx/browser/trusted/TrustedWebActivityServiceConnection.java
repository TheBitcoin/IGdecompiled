...
public final class TrustedWebActivityServiceConnection {
    ...
    static class NotifyNotificationArgs {
        ...
        NotifyNotificationArgs(String str, int i4, Notification notification2, String str2) {
            this.platformTag = str;
            this.platformId = i4;
    ...
    public void cancel(@NonNull String str, int i4) throws RemoteException {
        this.mService.cancelNotification(new CancelNotificationArgs(str, i4).toBundle());
    }
    ...
    public boolean notify(@NonNull String str, int i4, @NonNull Notification notification, @NonNull String str2) throws RemoteException {
        return ResultArgs.fromBundle(this.mService.notifyNotificationWithChannel(new NotifyNotificationArgs(str, i4, notification, str2).toBundle())).success;
    }
