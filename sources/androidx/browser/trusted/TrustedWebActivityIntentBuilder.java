...
public class TrustedWebActivityIntentBuilder {
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setColorScheme(int i4) {
        this.mIntentBuilder.setColorScheme(i4);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setColorSchemeParams(int i4, @NonNull CustomTabColorSchemeParams customTabColorSchemeParams) {
        this.mIntentBuilder.setColorSchemeParams(i4, customTabColorSchemeParams);
        return this;
    }
    ...
    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setNavigationBarColor(@ColorInt int i4) {
        this.mIntentBuilder.setNavigationBarColor(i4);
        return this;
    }

    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setNavigationBarDividerColor(@ColorInt int i4) {
        this.mIntentBuilder.setNavigationBarDividerColor(i4);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setScreenOrientation(int i4) {
    ...
    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setToolbarColor(@ColorInt int i4) {
        this.mIntentBuilder.setToolbarColor(i4);
        return this;
    }
}
