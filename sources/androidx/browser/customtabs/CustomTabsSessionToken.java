...
public class CustomTabsSessionToken {
    ...
    static class MockCallback extends a.C0005a {
        MockCallback() {
        }
        ...
        public void onActivityLayout(int i4, int i5, int i6, int i7, int i8, @NonNull Bundle bundle) {
        }
    ...
    CustomTabsSessionToken(@Nullable a aVar, @Nullable PendingIntent pendingIntent) {
        ...
        if (aVar == null) {
            ...
            r12 = new CustomTabsCallback() {
                ...
                public void onActivityLayout(int i4, int i5, int i6, int i7, int i8, @NonNull Bundle bundle) {
                    try {
                        CustomTabsSessionToken.this.mCallbackBinder.onActivityLayout(i4, i5, i6, i7, i8, bundle);
                    } catch (RemoteException unused) {
                        Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                    }
                }
                ...
                public void onActivityResized(int i4, int i5, @NonNull Bundle bundle) {
                    try {
                        CustomTabsSessionToken.this.mCallbackBinder.onActivityResized(i4, i5, bundle);
                    } catch (RemoteException unused) {
                        Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                    }
                }
                ...
                public void onNavigationEvent(int i4, @Nullable Bundle bundle) {
                    try {
                        CustomTabsSessionToken.this.mCallbackBinder.onNavigationEvent(i4, bundle);
                    } catch (RemoteException unused) {
                        Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                    }
                }
                ...
                public void onRelationshipValidationResult(int i4, @NonNull Uri uri, boolean z4, @Nullable Bundle bundle) {
                    try {
                        CustomTabsSessionToken.this.mCallbackBinder.onRelationshipValidationResult(i4, uri, z4, bundle);
                    } catch (RemoteException unused) {
                        Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                    }
                }
    ...
    public static CustomTabsSessionToken getSessionTokenFromIntent(@NonNull Intent intent) {
        ...
        if (binder != null) {
            aVar = a.C0005a.asInterface(binder);
        }
