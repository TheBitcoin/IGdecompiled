...
public final class CustomTabsSession {
    ...
    static class MockSession extends b.a {
        ...
        public boolean receiveFile(a aVar, Uri uri, int i4, Bundle bundle) throws RemoteException {
            return false;
        }
        ...
        public boolean validateRelationship(a aVar, int i4, Uri uri, Bundle bundle) throws RemoteException {
            return false;
        }
    ...
    private c.a createEngagementSignalsCallbackWrapper(@NonNull final EngagementSignalsCallback engagementSignalsCallback) {
        return new c.a() {
            ...
            public void onGreatestScrollPercentageIncreased(int i4, Bundle bundle) {
                this.mHandler.post(new c(engagementSignalsCallback, i4, bundle));
            }
    ...
    public boolean receiveFile(@NonNull Uri uri, int i4, @Nullable Bundle bundle) {
        try {
            return this.mService.receiveFile(this.mCallback, uri, i4, createBundleWithId(bundle));
        } catch (RemoteException unused) {
            return false;
        }
    }
    ...
    @Deprecated
    public boolean setToolbarItem(int i4, @NonNull Bitmap bitmap, @NonNull String str) {
        Bundle bundle = new Bundle();
    ...
    public boolean validateRelationship(int i4, @NonNull Uri uri, @Nullable Bundle bundle) {
        if (i4 >= 1 && i4 <= 2) {
            try {
                return this.mService.validateRelationship(this.mCallback, i4, uri, createBundleWithId(bundle));
            } catch (RemoteException unused) {
            }
        }
        return false;
    ...
    private c.a createEngagementSignalsCallbackWrapper(@NonNull EngagementSignalsCallback engagementSignalsCallback, @NonNull Executor executor) {
        return new c.a(executor, engagementSignalsCallback) {
            ...
            public void onGreatestScrollPercentageIncreased(int i4, Bundle bundle) {
                ...
                try {
                    this.mExecutor.execute(new f(this.val$callback, i4, bundle));
                } finally {
