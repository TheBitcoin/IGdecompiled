...
public final class CustomTabColorSchemeParams {
    ...
    public static final class Builder {
        ...
        public Builder setNavigationBarColor(@ColorInt int i4) {
            this.mNavigationBarColor = Integer.valueOf(i4 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }

        @NonNull
        public Builder setNavigationBarDividerColor(@ColorInt int i4) {
            this.mNavigationBarDividerColor = Integer.valueOf(i4);
            return this;
        }

        @NonNull
        public Builder setSecondaryToolbarColor(@ColorInt int i4) {
            this.mSecondaryToolbarColor = Integer.valueOf(i4);
            return this;
        }

        @NonNull
        public Builder setToolbarColor(@ColorInt int i4) {
            this.mToolbarColor = Integer.valueOf(i4 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }
    }
