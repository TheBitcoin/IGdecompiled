...
public abstract class CustomTabsService extends Service {
    ...
    private b.a mBinder = new b.a() {
        ...
        public boolean receiveFile(@NonNull a aVar, @NonNull Uri uri, int i4, @Nullable Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), uri, i4, bundle);
        }
        ...
        public boolean validateRelationship(@NonNull a aVar, int i4, @NonNull Uri uri, @Nullable Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), i4, uri, bundle);
        }

        public boolean warmup(long j4) {
            return CustomTabsService.this.warmup(j4);
        }
    };
    ...
    /* access modifiers changed from: protected */
    public abstract boolean receiveFile(@NonNull CustomTabsSessionToken customTabsSessionToken, @NonNull Uri uri, int i4, @Nullable Bundle bundle);
    ...
    /* access modifiers changed from: protected */
    public abstract boolean validateRelationship(@NonNull CustomTabsSessionToken customTabsSessionToken, int i4, @NonNull Uri uri, @Nullable Bundle bundle);

    /* access modifiers changed from: protected */
    public abstract boolean warmup(long j4);
}
