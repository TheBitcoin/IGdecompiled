...
final class EngagementSignalsCallbackRemote implements EngagementSignalsCallback {
    ...
    public void onGreatestScrollPercentageIncreased(@IntRange(from = 1, to = 100) int i4, @NonNull Bundle bundle) {
        try {
            this.mCallbackBinder.onGreatestScrollPercentageIncreased(i4, bundle);
