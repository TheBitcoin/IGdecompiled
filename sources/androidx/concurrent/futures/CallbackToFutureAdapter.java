...
public final class CallbackToFutureAdapter {
    ...
    public static final class Completer<T> {
        ...
        public boolean set(T t4) {
            ...
            SafeFuture<T> safeFuture = this.future;
            if (safeFuture == null || !safeFuture.set(t4)) {
                z4 = false;
            }
            if (z4) {
    ...
    private static final class SafeFuture<T> implements C2172d {
    ...
    @NonNull
    public static <T> C2172d getFuture(@NonNull Resolver<T> resolver) {
