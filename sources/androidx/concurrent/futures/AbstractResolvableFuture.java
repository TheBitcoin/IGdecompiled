...
public abstract class AbstractResolvableFuture<V> implements C2172d {
    ...
    private static final class SetFuture<V> implements Runnable {
        ...
        SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, C2172d dVar) {
    ...
    static Object getFutureValue(C2172d dVar) {
    ...
    /* JADX WARNING: type inference failed for: r0v5, types: [java.util.concurrent.Future, o0.d] */
    ...
    public final V get(long j4, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            String str = "Waited " + j5 + " " + timeUnit2.toString().toLowerCase(locale);
            if (nanos + 1000 < 0) {
    ...
    public boolean set(@Nullable V v4) {
        ...
        if (!ATOMIC_HELPER.casValue(this, (Object) null, v4)) {
            return false;
        }
        complete(this);
        return true;
